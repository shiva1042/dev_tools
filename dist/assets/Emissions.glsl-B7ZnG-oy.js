import{jM as y,dF as f}from"./Expand-EkfAPcFa.js";import{t as c,n as m}from"./glsl-B5bJgrnA.js";let u=class{constructor(s,t,i,r,o=null){if(this.name=s,this.type=t,this.arraySize=o,this.bind={0:null,1:null,2:null},r)switch(i){case void 0:break;case 0:this.bind[0]=r;break;case 1:this.bind[1]=r;break;case 2:this.bind[2]=r}}equals(s){return this.type===s.type&&this.name===s.name&&this.arraySize===s.arraySize}},h=class extends u{constructor(s,t,i){super(s,"float",1,(r,o,n)=>r.setUniform1f(s,t(o,n),i))}},C=class extends u{constructor(s,t){super(s,"sampler2D",1,(i,r,o)=>i.bindTexture(s,t(r,o)))}};function w(e){return e===4||e===5||e===6||e===7||e===8}function I(e){return S(e)||e===3}function g(e){return e===9||e===10}function N(e){return p(e)||g(e)}function p(e){return e===0}function d(e){return p(e)||U(e)}function _(e){return d(e)||e===10}function T(e){return d(e)||g(e)}function S(e){return T(e)||$(e)}function $(e){return e===2}function U(e){return e===1}function H(e){return $(e)||w(e)}let V=class extends u{constructor(s,t,i){super(s,"vec3",1,(r,o,n)=>r.setUniform3fv(s,t(o,n),i))}},A=class extends u{constructor(s,t,i){super(s,"vec3",2,(r,o,n,v)=>r.setUniform3fv(s,t(o,n,v),i))}};function G(e,s){switch(s.textureCoordinateType){case 1:return e.attributes.add("uv0","vec2"),e.varyings.add("vuv0","vec2"),void e.vertex.code.add(c`void forwardTextureCoordinates() { vuv0 = uv0; }`);case 2:return e.attributes.add("uv0","vec2"),e.attributes.add("uvRegion","vec4"),e.varyings.add("vuv0","vec2"),e.varyings.add("vuvRegion","vec4"),void e.vertex.code.add(c`void forwardTextureCoordinates() {
vuv0 = uv0;
vuvRegion = uvRegion;
...
//# sourceMappingURL=Emissions.glsl-B7ZnG-oy.js.map
