import{j as e,r as b,L as $}from"./index-BkyuEPT-.js";import{c as N,j as T,B as o,I as f,H as A,T as s,P as y}from"./Paper-DfaW9WtE.js";import{A as S}from"./Add-Xpg_St2a.js";import{D as F}from"./Delete-DJrvTfeZ.js";import{P as L}from"./Print-BDg_exnq.js";import{T as E,C as R}from"./CssBaseline-DEevvCBI.js";import{B as C}from"./Button-BaUHX52Q.js";import{G as n}from"./Grid-7_99rt4x.js";import{T as a,F as B,I as W,S as k}from"./TextField-CKUhk3op.js";import{D as v}from"./Divider-D8e0OBqr.js";import{M as q}from"./MenuItem-KaSofiBm.js";import{T as O}from"./TableContainer-bZmUztRS.js";import{a as U,b as z,c as x,d as H}from"./TableRow-5E2OT9RA.js";import{T as G}from"./TableHead-DyYBFAo1.js";import"./Modal-BG9ZP5_0.js";import"./index-BTYDg4gW.js";import"./dividerClasses-BchBYyiZ.js";import"./listItemIconClasses-DiMy5ZeU.js";import"./listItemTextClasses-C6vt__np.js";const M=N(e.jsx("path",{d:"M18 17H6v-2h12zm0-4H6v-2h12zm0-4H6V7h12zM3 22l1.5-1.5L6 22l1.5-1.5L9 22l1.5-1.5L12 22l1.5-1.5L15 22l1.5-1.5L18 22l1.5-1.5L21 22V2l-1.5 1.5L18 2l-1.5 1.5L15 2l-1.5 1.5L12 2l-1.5 1.5L9 2 7.5 3.5 6 2 4.5 3.5 3 2z"})),V=T({palette:{mode:"dark",primary:{main:"#10b981"},background:{default:"#0f172a",paper:"#1e293b"}}}),I=[{code:"USD",symbol:"$"},{code:"EUR",symbol:"€"},{code:"GBP",symbol:"£"},{code:"INR",symbol:"₹"},{code:"JPY",symbol:"¥"},{code:"CAD",symbol:"C$"},{code:"AUD",symbol:"A$"}];function me(){const g=b.useRef(null),[t,r]=b.useState({invoiceNumber:"INV-001",invoiceDate:new Date().toISOString().split("T")[0],dueDate:new Date(Date.now()+720*60*60*1e3).toISOString().split("T")[0],fromName:"Your Company Name",fromAddress:`123 Business Street
...
Payment is due within 30 days.`,taxRate:10,currency:"USD"}),c=()=>I.find(i=>i.code===t.currency)?.symbol||"$",m=t.items.reduce((i,d)=>i+d.quantity*d.unitPrice,0),h=m*(t.taxRate/100),j=m+h,D=()=>{r({...t,items:[...t.items,{id:Date.now().toString(),description:"",quantity:1,unitPrice:0}]})},P=i=>{r({...t,items:t.items.filter(d=>d.id!==i)})},u=(i,d,l)=>{r({...t,items:t.items.map(p=>p.id===i?{...p,[d]:l}:p)})},w=()=>{if(!g.current)return;const d=window.open("","_blank");d&&(d.document.write(`
      <html>
        <head>
