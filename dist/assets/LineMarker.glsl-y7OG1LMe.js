import{_ as p,bb as N,b6 as G,s7 as X,aU as R}from"./Expand-BjFL9QNU.js";import{t as Z}from"./BufferView-BqhYxzSl.js";import{c as ee,o as V,q as te,s as U}from"./Emissions.glsl-h7htgatk.js";import{an as ie,Y as re,p as ae,ad as se,W as oe,x as ne,y as ce,aI as le,$ as pe,ap as de,ai as he,am as ve,a0 as ue,a6 as me,a7 as fe,ar as E,as as ge,at as I,au as Se,av as Pe,aw as ye,ax as _e,ay as we,b5 as ze,b6 as B,b7 as xe,b8 as $e,b9 as be,az as Te,aA as d,s as Ve,o as ke,ba as Oe,a$ as De,bb as We}from"./Texture-BuTJ8KiH.js";import{_ as Ce}from"./index-D7pXJXkH.js";import{Q as Me}from"./InterleavedLayout-ClSUHJar.js";import{T as M,d as L,r as q}from"./renderState-C6Fc3Ut3.js";import{t as o,n as w}from"./glsl-B5bJgrnA.js";import{s as Le}from"./ShaderBuilder-BJrxQwVx.js";import{t as je,v as Ae,w as Fe,y as Y,z as H,A as Ne,B as Re}from"./RibbonLine.glsl-Cii8xVhg.js";function J(r){const e=new Le,{space:i,anchor:t,hasTip:P,hasScreenSizePerspective:z}=r,u=i===2,g=i===1;e.include(je,r),e.include(Ae,r),e.include(ie,r);const{vertex:a,fragment:S,varyings:y}=e;re(a,r),e.attributes.add("position","vec3"),e.attributes.add("previousDelta","vec4"),e.attributes.add("uv0","vec2"),y.add("vColor","vec4"),y.add("vpos","vec3",{invariant:!0}),y.add("vUV","vec2"),y.add("vSize","float"),P&&y.add("vLineWidth","float"),a.uniforms.add(new ae("nearFar",({camera:l})=>l.nearFar),new se("viewport",({camera:l})=>l.fullViewport)).code.add(o`vec4 projectAndScale(vec4 pos) {
...
//# sourceMappingURL=LineMarker.glsl-y7OG1LMe.js.map
