...
var e3 = class extends r3 {
  ...
  marshalledCall(e4, a, l4, c3) {
    return c3(e4, a, (a2, o2, i4) => {
      i4 = i4.map((t3) => t3 instanceof r3 && !(t3 instanceof s3) ? n3(t3, e4, c3) : t3);
      const u = this.call(l4, { args: i4 });
...
var i3 = class _i extends t2 {
  constructor(t3, s4, i4, h4, e4, a) {
    super(t3), this._lazyPt = [], this._hasZ = false, this._hasM = false, this._spRef = s4, this._hasZ = i4, this._hasM = h4, this._cacheId = e4, this._partId = a;
  }
  get(t3) {
    if (void 0 === this._lazyPt[t3]) {
      const i4 = this._elements[t3];
      if (void 0 === i4) return;
      const h4 = new _(i4[0], i4[1], this._spRef);
      this._hasZ && (h4.z = i4[2]), this._hasM && (h4.m = this._hasZ ? i4[3] : i4[2]), h4.cache._arcadeCacheId = this._cacheId.toString() + "-" + this._partId.toString() + "-" + t3.toString(), this._lazyPt[t3] = h4;
    }
...
var h3 = class _h extends t2 {
  constructor(t3, s4, h4, i4, e4) {
    super(t3), this._lazyPath = [], this._hasZ = false, this._hasM = false, this._hasZ = h4, this._hasM = i4, this._spRef = s4, this._cacheId = e4;
  }
  get(t3) {
...
var P2 = { type: "VOID" };
var _2 = /* @__PURE__ */ Symbol("BREAK");
var I = /* @__PURE__ */ Symbol("CONTINUE");
function Y(e4, t3, n4) {
...
function oe(e4, t3, n4, r4, i4) {
  if (e4.length < t3 || e4.length > n4) throw new n(r4, "WrongNumberOfParameters", i4);
}
function ue(e4) {
...
function ce(e4, t3 = false) {
  ...
  for (const i4 of e4.match(r4) || []) switch (i4) {
    case "D":
      n4 += "d";
      break;
    case "DD":
    ...
    case "x":
      ...
      break;
    default:
      i4.length >= 2 && i4.startsWith("[") && i4.endsWith("]") ? n4 += `'${i4.slice(1, -1)}'` : n4 += `'${i4}'`;
  }
  return n4;
}
...
function de(e4, t3, r4) {
  ...
  if (e4 === P2) {
    ...
    if (ne(t3)) return e4.timeZone !== t3.timeZone && (e4.isUnknownTimeZone ? e4 = m2.arcadeDateAndZoneToArcadeDate(e4, t3.timeZone) : t3.isUnknownTimeZone && (t3 = m2.arcadeDateAndZoneToArcadeDate(t3, e4.timeZone))), me(e4.toNumber(), t3.toNumber(), r4);
...
function pe(e4, { useNumbersForDates: t3 }) {
  ...
  for (const r4 in e4) {
    "" !== n4 && (n4 += ",");
    const i4 = e4[r4];
    null == i4 ? n4 += JSON.stringify(r4) + ":null" : t(i4) || n2(i4) || e2(i4) ? n4 += JSON.stringify(r4) + ":" + JSON.stringify(i4) : U(i4) ? n4 += JSON.stringify(r4) + ":" + be(i4) : ie(i4) || re(i4) ? n4 += `${JSON.stringify(r4)}:${JSON.stringify(i4.toString())}` : te(i4) || Array.isArray(i4) ? n4 += JSON.stringify(r4) + ":" + be(i4, null, t3) : ne(i4) ? n4 += t3 ? JSON.stringify(r4) + ":" + JSON.stringify(i4.getTime()) : JSON.stringify(r4) + ":" + i4.stringify() : null !== i4 && "object" == typeof i4 && "castToText" in i4 && (n4 += JSON.stringify(r4) + ":" + i4.castToText(t3));
  }
  return "{" + n4 + "}";
}
function ge(e4, t3) {
...
function Ze(e4, t3) {
  ...
  if (e2(e4)) {
    const r4 = Te(e4, t3);
    if (r4) return m2.dateTimeToArcadeDate(r4);
  }
  return null;
}
function Te(e4, t3) {
  const n4 = / (\d\d)/, i4 = h2(t3);
  let a = DateTime.fromISO(e4, { zone: i4 });
...
function Ce(e4, t3, n4 = null, r4 = null) {
  ...
  let s4 = t3.typeIdField, l4 = "id", f3 = t3.types;
  if (t3.subtypeField && (s4 = t3.subtypeField, l4 = "code", f3 = t3.subtypes ?? []), null === r4 && n4 && s4) r4 = n4.hasField(s4) ? n4.field(s4) : null;
  else if (s4 && null !== r4) {
    let e5 = false;
    for (const t4 of f3 || []) if (r4 === t4[l4]) {
      e5 = true;
      break;
    }
    if (!e5) {
      for (const t4 of f3 || []) if (r4 === t4.name) {
        r4 = t4[l4], e5 = true;
        break;
      }
    }
  ...
  return null != r4 && f3.some((e5) => e5[l4] === r4 && (i4 = e5.domains?.[u.name], i4 && "inherited" === i4.type && (i4 = Fe(u.name, t3), o2 = true), true)), o2 || i4 || (i4 = Fe(e4, t3)), { field: u, domain: i4 };
}
function Fe(e4, t3) {
  let n4;
...
function we(e4, t3) {
  ...
  const n4 = "boolean" == typeof t3.cycles && t3.cycles, r4 = t3.cmp && (i4 = t3.cmp, function(e5) {
  ...
  return (function e5(t4) {
    ...
    let i5, o2;
    if (Array.isArray(t4)) {
      for (o2 = "[", i5 = 0; i5 < t4.length; i5++) i5 && (o2 += ","), o2 += e5(t4[i5]) || "null";
      return o2 + "]";
    }
    ...
    for (o2 = "", i5 = 0; i5 < s4.length; i5++) {
      const n5 = s4[i5], r5 = e5(t4[n5]);
...
function Re(e4, t3) {
  if (o(e4) || te(e4)) {
    let n4 = false, r4 = false, i4 = [], o2 = t3;
    if (o(e4)) {
      for (const t4 of e4) Me(i4, t4);
      i4.length > 0 && (o2 = e4[0].spatialReference, n4 = e4[0].hasZ, r4 = e4[0].hasM);
    } else if (e4 instanceof i3) i4 = e4._elements, i4.length > 0 && (n4 = e4._hasZ, r4 = e4._hasM, o2 = e4.get(0).spatialReference);
    else {
      if (!te(e4)) throw new n(null, "InvalidParameter", null);
      for (const t4 of e4.toArray()) Me(i4, t4);
      i4.length > 0 && (o2 = e4.get(0).spatialReference, n4 = true === e4.get(0).hasZ, r4 = true === e4.get(0).hasM);
    }
    if (0 === i4.length) return null;
    return h(i4) || (i4 = i4.slice().reverse()), new P({ rings: [i4], spatialReference: o2, hasZ: n4, hasM: r4 });
  }
  return e4;
}
function ve(e4, t3) {
  if (o(e4) || te(e4)) {
    let n4 = false, r4 = false, i4 = [], a = t3;
    if (o(e4)) {
      for (const t4 of e4) Me(i4, t4);
      i4.length > 0 && (a = e4[0].spatialReference, n4 = true === e4[0].hasZ, r4 = true === e4[0].hasM);
    } else if (e4 instanceof i3) i4 = e4._elements, i4.length > 0 && (n4 = e4._hasZ, r4 = e4._hasM, a = e4.get(0).spatialReference);
    else if (te(e4)) {
      for (const t4 of e4.toArray()) Me(i4, t4);
      i4.length > 0 && (a = e4.get(0).spatialReference, n4 = true === e4.get(0).hasZ, r4 = true === e4.get(0).hasM);
    }
    return 0 === i4.length ? null : new y({ paths: [i4], spatialReference: a, hasZ: n4, hasM: r4 });
  }
  return e4;
}
function Pe(e4, t3) {
  if (o(e4) || te(e4)) {
    ...
    return 0 === i4.length ? null : new m({ points: i4, spatialReference: a, hasZ: n4, hasM: r4 });
  }
  return e4;
}
...
async function Ve(e4, t3, n4, r4, i4) {
...
async function ze(e4, t3 = null, n4 = null) {
  ...
  if (Array.isArray(e4)) {
    const r4 = [], i4 = [];
    for (const a of e4) null === a || V(a) || a instanceof c || c2(a) || ne(a) ? i4.push(Ge(a, n4)) : (i4.push(null), r4.push(Ve(a, t3, n4, i4.length - 1, i4)));
    return r4.length > 0 && await Promise.all(r4), i4;
  }
...
function $e(e4, t3, n4, r4) {
  const i4 = Ee(e4.fullSchema());
  if (null === i4) return null;
  if (!i4.fields) return null;
  const a = Ce(t3, i4, e4, r4);
  if (void 0 === n4) try {
    n4 = e4.field(t3);
  } catch (o2) {
    return null;
...
function Xe(r4, i4) {
  const a = m2.systemTimeZoneCanonicalName;
  return "system" === r4 && (r4 = a), { version: et, engineVersion: e, timeZone: r4, userTimeZone: a, spatialReference: i4 instanceof f ? i4.toJSON() : i4, application: s.applicationName ?? "", engine: "web", locale: l() };
}
var et = "1.34";
...
//# sourceMappingURL=chunk-AAV377IE.js.map
