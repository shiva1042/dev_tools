...
var r2 = class extends b {
  ...
  transitionStep(t, e2) {
    ...
    if (0 === s) this.computedOpacity = this.opacity, this.computedVisible = this.visible;
      ...
      const e3 = this._fadeOutResolver || !this.visible ? 0 : this.opacity, i2 = this.computedOpacity;
      if (i2 === e3) this.computedVisible = this.visible;
      else {
        const o = t * s;
        this.computedOpacity = i2 > e3 ? Math.max(e3, i2 - o) : Math.min(e3, i2 + o), this.computedVisible = this.computedOpacity > 0;
      }
    }
    this.transitioning || (this._fadeInResolver?.(), this._fadeOutResolver?.(), this._fadeOutResolver = this._fadeInResolver = null);
  }
};
__decorate([m()], r2.prototype, "computedOpacity", void 0), __decorate([m()], r2.prototype, "computedVisible", void 0), __decorate([m()], r2.prototype, "opacity", void 0), __decorate([m()], r2.prototype, "visible", void 0), __decorate([m()], r2.prototype, "transitioning", null), __decorate([m()], r2.prototype, "_fadeOutResolver", void 0), __decorate([m()], r2.prototype, "_fadeInResolver", void 0), r2 = __decorate([a("esri.views.2d.engine.transitions.FadeTransition")], r2);
...
//# sourceMappingURL=chunk-ZUXS7BMM.js.map
