import {
  g
} from "./chunk-ZHJ7CAVL.js";
import {
  e,
  t
} from "./chunk-NJ33EMZK.js";
import {
  b,
  m2 as m
...
var a3 = class extends b {
  ...
  _applyTimeTransition(t2) {
    ...
    for (let s = 0; s < this._current.length; s++) {
      const t3 = this._current[s], r = this._from[s], i2 = this._to[s];
      t3.scale = p(r.scale, i2.scale, e2);
      for (let s2 = 0; s2 < t3.effects.length; s2++) {
        const n = t3.effects[s2], c = r.effects[s2], o = i2.effects[s2];
  ...
  _updateForScale(t2) {
    ...
    let r, i2, n = 1;
    if (1 === e2.length || t2 >= e2[0].scale) i2 = r = e2[0].effects;
    else if (t2 <= e2[s].scale) i2 = r = e2[s].effects;
    else for (let c = 0; c < s; c++) {
      const s2 = e2[c], o = e2[c + 1];
      if (s2.scale >= t2 && o.scale <= t2) {
        n = (t2 - s2.scale) / (o.scale - s2.scale), r = s2.effects, i2 = o.effects;
        break;
      }
    }
    for (let c = 0; c < this.effects.length; c++) {
      this.effects[c].interpolate(r[c], i2[c], n);
    }
  }
};
function h(t2) {
...
function _(t2, e2, s) {
  const r = t2.length > e2.length ? t2 : e2, i2 = t2.length > e2.length ? e2 : t2, n = i2[i2.length - 1], c = n?.scale ?? s, o = n?.effects ?? [];
  for (let f = i2.length; f < r.length; f++) i2.push({ scale: c, effects: [...o] });
  for (let a4 = 0; a4 < r.length; a4++) i2[a4].scale = i2[a4].scale === l ? s : i2[a4].scale, r[a4].scale = r[a4].scale === l ? s : r[a4].scale, e(i2[a4].effects, r[a4].effects);
}
function p(t2, e2, s) {
  return t2 + (e2 - t2) * s;
}
...
__decorate([m()], a3.prototype, "_to", void 0), __decorate([m()], a3.prototype, "duration", void 0), __decorate([m({ value: "" })], a3.prototype, "effect", null), __decorate([m({ readOnly: true })], a3.prototype, "effects", void 0), __decorate([m({ readOnly: true })], a3.prototype, "final", null), __decorate([m({ readOnly: true })], a3.prototype, "hasEffects", null), __decorate([m({ value: 0 })], a3.prototype, "scale", null), __decorate([m({ readOnly: true })], a3.prototype, "transitioning", null), a3 = __decorate([a2("esri.layers.effects.EffectView")], a3);

export {
  a3 as a
};
//# sourceMappingURL=chunk-EFHQG3CT.js.map
