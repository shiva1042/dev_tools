...
function E2(t2) {
  const e = t2?.size;
  return { width: null != e && "object" == typeof e && "width" in e ? u2(e.width) : null, height: null != e && "object" == typeof e && "height" in e ? u2(e.height) : null };
}
...
function A(t2, e, o, i, a) {
  ...
  null == t2.backgroundColor && null == t2.borderLineColor || (i[0] += 2 * s2, i[1] += 2 * s2, o.unshift([{ shape: { type: "rect", x: 0, y: 0, width: i[0], height: i[1] }, fill: t2.backgroundColor, stroke: { color: t2.borderLineColor, width: u2(t2.borderLineSize) } }]), a.masking?.unshift([]));
}
function Z(t2, e) {
  return t2 > e ? "dark" : "light";
}
function D(t2, e) {
  const o = "number" == typeof e?.size ? e?.size : null, i = null != o ? u2(o) : null, a = null != e?.maxSize ? u2(e.maxSize) : null;
  ...
  switch (t2.type) {
    case b: {
      ...
      let h2 = s4 === r2 && null != s4 ? s4 : null != i ? i : Math.min(u2(t2.size), a || L);
      if (true === e?.useMarkerSymbolSize && null !== s4 && null !== r2) {
        const e2 = Math.min(u2(t2.size), a || L);
    ...
    case w: {
      const o2 = Math.min(u2(t2.width), a || L), s4 = Math.min(u2(t2.height), a || L), { width: r2, height: h2 } = E2(e), c2 = r2 === h2 && null != r2 ? r2 : null != i ? i : Math.max(o2, s4), m = t2.width / t2.height;
    ...
    case M: {
      const o2 = t2, l3 = e?.overrideText || o2.text || k2, s4 = o2.font, { width: r2, height: h2 } = E2(e), c2 = null != h2 ? h2 : null != i ? i : Math.min(u2(s4.size), a || L), { width: m, height: u5 } = $(l3, { weight: s4.weight, size: c2, family: s4.family }), p = /[\uE600-\uE6FF]/.test(l3);
...
function T(o, i = j) {
  const n2 = u3(o), a = y(o), l2 = !n2 || "type" in n2 ? null : new u(n2), s3 = a?.color ? new u(a?.color) : null, r = l2 ? Z(E(l2), i) : null, m = s3 ? Z(E(s3), i) : null;
...
//# sourceMappingURL=previewSymbol2D-3325ABUS.js.map
