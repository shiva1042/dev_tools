...
var p = class _p {
  static async create(e3, r2, i2, n) {
    ...
    const u2 = { vars: n.reduce((e4, t2) => ({ ...e4, [t2]: null }), {}), spatialReference: r2, useAsync: false }, d2 = s2.compileScript(c, u2);
    let h2 = null;
    null != i2 && (h2 = new o(i2), h2.immutable = true);
    const m3 = new o();
    return m3.immutable = false, m3.setField("scale", 0), new _p(e3, s2, c, d2, r2, m3, h2, o);
  }
...
//# sourceMappingURL=chunk-Z3GAK6PH.js.map
