...
async function i5(n3, r3) {
  const a4 = m(n3);
  if (null == a4) throw new s2("imageToArrayBuffer", "Unsupported image type");
  const i6 = o2(n3), s6 = await new Promise((e5) => a4.toBlob(e5, i6));
  if (s3(r3), !s6) throw new s2("imageToArrayBuffer", "Failed to encode image");
  const c5 = await s6.arrayBuffer();
  return s3(r3), { data: c5, type: i6 };
}
function o2(e5) {
...
var _3 = class {
  ...
  _createTextureInfo(e5, t6) {
    ...
    return t6 ? (s6.extensions || (s6.extensions = {}), s6.extensions.KHR_texture_transform = { scale: t6.scale, offset: t6.offset, rotation: s(t6.rotation) }, s6) : s6;
  }
  _addTexture(e5) {
...
async function c4(e5, s6) {
  ...
  await Promise.allSettled(c5), s3(s6.signal);
...
//# sourceMappingURL=gltfexport-5XVIJZRR.js.map
