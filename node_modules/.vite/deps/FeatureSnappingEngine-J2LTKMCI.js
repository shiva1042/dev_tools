...
var f2 = class extends b {
  ...
  get subtypeFilter() {
    ...
    if (!d2(e4) || !e4.subtypes?.length || !t) return { mode: "not-in-use", filter: null };
  ...
  get floorFilter() {
    ...
    return e4 && t ? o({ view: e4, layer: t }) : null;
  }
  constructor(e4) {
  ...
  getFetchCandidatesParameters(e4, t, r3) {
    ...
    if (o3 && (y2.filter = m3(y2.filter, o3)), "not-in-use" !== u2.mode && "all-visible" !== u2.mode) {
      ...
      y2.filter ? y2.filter.where = l2(y2.filter.where, u2.mode) : y2.filter = new d({ where: u2.filter });
    }
    ...
    if (a2 && f3 && x(this.view?.map) && (o2(i3) || d2(i3)) && (o2(v2) || d2(v2)) && this.view.map.utilityNetworks?.find((e5) => e5.isUtilityLayer(v2))) {
  ...
  async loadRules() {
    ...
    if (i3 && e4 && t && x(t?.map) && (o2(e4) || d2(e4))) try {
...
function m3(e4, t) {
  return null == e4 ? new d({ where: t }) : e4.where ? new d({ where: l2(e4.where, t) }) : new d({ where: t });
}
...
var H = class extends b {
  ...
  _loadSourceModule(e4) {
    ...
    switch (e4) {
      case "featureService":
        return t.addPromise(import("./FeatureServiceSnappingSource-ENBESV6B.js"));
      case "featureCollection":
        return t.addPromise(import("./FeatureCollectionSnappingSource-2X4A3QB2.js"));
      case "graphics":
      case "notes":
        return t.addPromise(import("./GraphicsSnappingSource-OXS2TNVU.js"));
      case "scene":
        return t.addPromise(import("./SceneLayerSnappingSource-QWAFWG3C.js"));
    }
  }
  get test() {
  }
...
//# sourceMappingURL=FeatureSnappingEngine-J2LTKMCI.js.map
