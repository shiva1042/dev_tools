...
async function q(e2, t, r3) {
  const { applyEdits: n3 } = await import("./editingSupport-SATG2ZMW.js"), o2 = await e2.load();
  let i2 = r3;
...
async function S(e2, t, r3) {
  const { uploadAssets: n3 } = await import("./editingSupport-SATG2ZMW.js"), o2 = await e2.load();
...
async function J(t, r3) {
  if (!s2) return;
  const n3 = s2.findCredential(t);
  if (n3) return n3.userId;
  let o2;
  try {
    const n4 = await N(t, r3);
    n4 && (o2 = await s2.checkSignInStatus(`${n4}/sharing`));
  } catch (i2) {
  }
...
async function Z(t, r3) {
  ...
  try {
    ...
    o2 && (n3 = await s2.checkSignInStatus(`${o2}/sharing`));
  } catch (o2) {
  }
  if (n3) try {
    const n4 = null != r3 ? r3.signal : null;
    await s2.getCredential(t, { signal: n4 });
  } catch (o2) {
  }
}
...
//# sourceMappingURL=chunk-K5SRTFMQ.js.map
