...
function s() {
  return t ??= (async () => {
    const s3 = await import("./basis_encoder-4XLA3FGF.js"), t2 = await s3.default({ locateFile: (s4) => n(`esri/libs/basisu/${s4}`) });
...
function e() {
  return n2 ??= (async () => {
    const e2 = await import("./dxt_encoder-6ET4DEJO.js");
...
//# sourceMappingURL=TextureCompressionWorker-BWLC52A5.js.map
