...
var o4 = class extends e2 {
  ...
  setTransform(r5) {
    ...
    const m5 = (l6.extent.xmax - l6.extent.xmin) / l6.size[0] / r5.resolution, c3 = s(r5.rotation), { displayViewScreenMat3: x2 } = this.transforms;
...
function h8(t4, o6) {
  const i6 = new _({ x: (t4.xmax + t4.xmin) / 2, y: (t4.ymax + t4.ymin) / 2, spatialReference: t4.spatialReference }), a4 = t4.xmax - t4.xmin, r5 = t4.ymax - t4.ymin, l6 = Math.abs(Math.cos(s(o6))), p2 = Math.abs(Math.sin(s(o6))), c3 = l6 * a4 + p2 * r5, m5 = p2 * a4 + l6 * r5, d5 = new z({ xmin: i6.x - c3 / 2, ymin: i6.y - m5 / 2, xmax: i6.x + c3 / 2, ymax: i6.y + m5 / 2, spatialReference: t4.spatialReference });
...
//# sourceMappingURL=chunk-VLTMDIOR.js.map
