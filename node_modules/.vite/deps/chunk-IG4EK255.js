...
var _ = (_2) => {
  ...
  let E = class extends A {
    ...
    readTitleService(e, t) {
      ...
      return "item-title-and-service-name" === this.sublayerTitleMode && r2 && (o3 = r2 + " - " + o3), m(o3);
    }
    get parsedUrl() {
...
${t2.join("\n")}`;
  ...
  return __decorate([m2(u)], E.prototype, "id", void 0), __decorate([m2({ type: f })], E.prototype, "spatialReference", void 0), __decorate([o("spatialReference", ["spatialReference", "store.indexCRS", "store.geographicCRS"])], E.prototype, "readSpatialReference", null), __decorate([m2({ type: z })], E.prototype, "fullExtent", void 0), __decorate([o("fullExtent", ["fullExtent", "store.extent", "spatialReference", "store.indexCRS", "store.geographicCRS"])], E.prototype, "readFullExtent", null), __decorate([m2({ readOnly: true, type: m3 })], E.prototype, "heightModelInfo", void 0), __decorate([m2({ type: Number, json: { name: "layerDefinition.minScale", write: true, origins: { service: { read: { source: "minScale" }, write: false } } } })], E.prototype, "minScale", void 0), __decorate([m2({ type: Number, json: { name: "layerDefinition.maxScale", write: true, origins: { service: { read: { source: "maxScale" }, write: false } } } })], E.prototype, "maxScale", void 0), __decorate([m2({ readOnly: true })], E.prototype, "version", void 0), __decorate([o("version", ["store.version"])], E.prototype, "readVersion", null), __decorate([m2({ type: String, json: { read: { source: "copyrightText" } } })], E.prototype, "copyright", void 0), __decorate([m2({ type: String, json: { read: false } })], E.prototype, "sublayerTitleMode", void 0), __decorate([m2({ type: String })], E.prototype, "title", void 0), __decorate([o("portal-item", "title")], E.prototype, "readTitlePortalItem", null), __decorate([o("service", "title", ["name"])], E.prototype, "readTitleService", null), __decorate([m2({ type: Number, json: { origins: { service: { read: { source: "id" } }, "portal-item": { write: { target: "id", isRequired: true, ignoreOrigin: true }, read: false } } } })], E.prototype, "layerId", void 0), __decorate([m2(i2({ separator: "layers" }))], E.prototype, "url", void 0), __decorate([m2({ readOnly: true })], E.prototype, "parsedUrl", null), __decorate([m2({ readOnly: true })], E.prototype, "store", void 0), __decorate([m2({ type: String, readOnly: true, json: { read: { source: "store.rootNode" } } })], E.prototype, "rootNode", void 0), E = __decorate([a("esri.layers.mixins.SceneService")], E), E;
};
var R = -1e38;
function L2(e) {
...
//# sourceMappingURL=chunk-IG4EK255.js.map
