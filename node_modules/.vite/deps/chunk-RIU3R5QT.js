...
var t2 = class {
  ...
  registerOutgoing(e2) {
    ...
    const t3 = new i3(e2, { onEmit: (e3, t4, n2, i6) => {
      this._manager?.emit(e3.eventType, t4, n2, i6);
    }, onRemove: (e3) => {
...
var u = class extends b {
  ...
  _onEventReceived(e2, t3) {
    ...
    const r3 = this._testTimestamp ?? t3.native?.timestamp, i6 = t3.native?.cancelable;
  ...
  _emitInputEvent(e2, t3, r3, i6, n2, s3) {
    const o2 = i6 ?? this._currentPropagation?.timestamp ?? performance.now(), a2 = n2 ?? false, l = { event: new _(t3, r3, o2, s3 || this._activeKeyModifiers, a2), priorityIndex: e2 };
  ...
  _continuePropagation() {
    ...
    if (e2) {
      for (; e2.events.length > 0; ) {
        const { event: t3, priorityIndex: r3 } = e2.events.pop(), i6 = t3.data?.eventId;
...
//# sourceMappingURL=chunk-RIU3R5QT.js.map
