...
var f = class {
  ...
  _add(e2) {
    ...
    let i4;
    if (o2 ? (e2.displayId = o2.displayId, i4 = this._boundsStore.get(r), this._boundsStore.delete(r), this._usedMemory -= this.estimateFeatureUsedMemory?.(o2) ?? 0) : null != this.onFeatureAdd && this.onFeatureAdd(e2), !e2.geometry?.coords?.length) return this._boundsStore.set(r, null), void this._featuresById.set(r, e2);
    i4 = Mt(null != i4 ? i4 : i3(), e2.geometry, this.geometryInfo.hasZ, this.geometryInfo.hasM), null != i4 && this._boundsStore.set(r, i4), this._featuresById.set(r, e2), this._usedMemory += this.estimateFeatureUsedMemory?.(e2) ?? 0;
  }
  _upsert(e2) {
    const r = e2?.objectId;
    ...
    return i4 && (o2.geometry = i4, this._boundsStore.set(r, Mt(i3(), i4, this.geometryInfo.hasZ, this.geometryInfo.hasM) ?? null)), this._usedMemory += this.estimateFeatureUsedMemory?.(o2) ?? 0, o2;
  }
  _remove(e2) {
...
//# sourceMappingURL=chunk-VH7DDZGD.js.map
