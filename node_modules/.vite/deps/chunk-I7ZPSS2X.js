...
var b = I = (_a = class extends a3(u2) {
  ...
  async queryElevation(r4, e2) {
    ...
    const { queryAll: o3 } = await import("./ElevationQuery-OKU3QUGL.js");
    s2(e2);
    return o3(this.layers.filter(A).toArray(), r4, e2);
  }
  async createElevationSampler(r4, e2) {
    await this.load({ signal: e2?.signal });
    const { createSampler: o3 } = await import("./ElevationQuery-OKU3QUGL.js");
    s2(e2);
    return o3(this.layers.filter(A).toArray(), r4, e2);
  }
  clone() {
  ...
  async _loadLayersFromJSON(r4, e2, o3) {
    const t3 = e2?.origin || "web-scene", s4 = e2?.portal || null, a5 = e2?.url || null, { populateOperationalLayers: i4 } = await import("./layersCreator-ULS6PZAC.js");
    s2(o3);
    const n8 = [];
...
//# sourceMappingURL=chunk-I7ZPSS2X.js.map
