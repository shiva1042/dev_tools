...
var o8 = class {
  constructor(r10, t9) {
    ...
    for (const e9 in t9.vertex) {
      const { data: s12, layout: o18 } = t9.vertex[e9], n16 = new r6(r10, o18, s12);
      this.vertexBuffers.set(e9, n16);
    }
    for (const s12 in t9.index) {
      const { data: i10 } = t9.index[s12], o18 = o7.createIndex(r10, 35044, i10);
      this.indexBuffers.set(s12, o18);
    }
  ...
  bind(e9, s12, i10) {
    this._boundPart = i10;
    const { group: o18 } = this.parts[this._boundPart], n16 = this.groups[o18];
    if (!n16) throw new Error(`Missing group ${o18}.`);
    let f14 = n16.vertexArrays.get(s12.stringHash);
    if (!f14) {
      const i11 = r(new Set(s12.locations.keys())), o19 = n16.index ? this.indexBuffers.get(n16.index) : null, a8 = /* @__PURE__ */ new Map();
      for (const [r10, e10] of this.vertexBuffers) {
        e10.layout.filter((r11) => i11.has(r11.name)).length > 0 && a8.set(r10, e10);
      }
      f14 = new h3(e9, a8, o19), n16.vertexArrays.set(s12.stringHash, f14);
    }
    e9.bindVAO(f14);
  }
  draw(r10) {
    if (null == this._boundPart) throw new Error("Mesh.bind() has not been called.");
    const { start: e9, count: t9 } = this.parts[this._boundPart], { group: i10 } = this.parts[this._boundPart], { primitive: o18, index: n16 } = this.groups[i10];
    if (n16) {
      ...
      r10.drawElements(o18, t9, f14, e9 * T[f14]);
    } else r10.drawArrays(o18, e9, t9);
  }
  unbind(r10) {
...
var s6 = class _s extends o8 {
  static create(e9, r10) {
    ...
    for (const [s12, { count: d9, offset: f14, type: m12, normalized: x9 }] of Object.entries(r10.layout)) {
      null != f14 && (l9 = f14);
      const e10 = new t2(s12, d9, m12, l9, o18, null != x9 && x9, 0);
      i10.push(e10), l9 += d9 * T[m12];
    }
    const a8 = { primitive: r10.primitive };
    null != r10.index && (a8.index = "indexData");
    let { count: u18 } = r10;
    if (null == u18 && (u18 = r10.index ? r10.index.length : r10.vertex.byteLength / o18, Math.floor(u18) !== u18)) throw new Error(`The byte length of vertex data must be an exact multiple of the stride, which is ${o18}.`);
...
var B4 = class extends P2 {
  clip(t9, i10) {
    let e9 = new C2(0);
    const o18 = this.storage.getFilterFlags(t9);
    if (e9 = e9.add(st2(2).multiply(st2(1).subtract(q(o18, 0)))), this.inside ? e9 = e9.add(st2(2).multiply(st2(1).subtract(q(o18, 1)))) : this.outside ? e9 = e9.add(st2(2).multiply(q(o18, 1))) : this.highlight && (e9 = e9.add(st2(2).multiply(st2(1).subtract(this._checkHighlight(o18))))), null != i10) {
      const t10 = new C2(1).subtract(ln(i10.x, this.view.currentZoom)), o19 = ln(i10.y, this.view.currentZoom);
      e9 = e9.add(new C2(2).multiply(t10.add(o19)));
    }
    return e9;
  }
  ...
  _checkHighlight(t9) {
    ...
    for (let o18 = 1; o18 < P; o18++) e9 = e9.add(this._checkHighlightBit(t9, o18));
  ...
  maybeRunHittest(t9, i10, e9) {
    ...
    const o18 = this.hittest(t9, i10, e9);
    let s12 = zt(Gt(o18, this.hittestRequest.distance), new C2(2), new C2(0));
    const r10 = this.storage.getAttributeDataCoords(t9.id), h12 = g3(r10);
    s12 = s12.add(this.clip(t9.id, t9.zoomRange));
    const l9 = new _3(new C2(1 / 255), 0, 0, 0);
    return { glPointSize: new C2(1), glPosition: new _3(h12, s12, 1), color: l9 };
  }
...
var n3 = class extends w2 {
  getPatternOffsetAtTileOrigin(t9, i10 = new C2(0), l9 = new C2(1)) {
    ...
    return p9 = new X(p9.x.multiply(l9).subtract(p9.y.multiply(i10)), p9.x.multiply(i10).add(p9.y.multiply(l9))), Ge(p9, t9);
  }
};
...
var f5 = class extends w2 {
  getColor(t9, s12, o18) {
    return Tt([At(x2(t9), o18), s12], [_t(t9, this.values.first()), this.colors.first()], [Ht(t9, this.values.last()), this.colors.last()], [true, () => {
      const s13 = this.values.findIndex((s14) => Gt(s14, t9)), o19 = this.values.get(s13), r10 = s13.subtract(1), e9 = this.values.get(r10), i10 = t9.subtract(e9).divide(o19.subtract(e9));
...
var h6 = class extends w2 {
  getOpacity(t9) {
    return Tt([x2(t9), new C2(1)], [_t(t9, this.opacityValues.first()), this.opacities.first()], [Ht(t9, this.opacityValues.last()), this.opacities.last()], [true, () => {
      const i10 = this.opacityValues.findIndex((i11) => Gt(i11, t9)), s12 = this.opacityValues.get(i10), e9 = i10.subtract(1), o18 = this.opacityValues.get(e9), a8 = t9.subtract(o18).divide(s12.subtract(o18));
...
var u4 = class extends w2 {
  getSizeForViewScale(s12) {
    return Tt([_t(s12, this.values.first()), this.sizes.first()], [Ht(s12, this.values.last()), this.sizes.last()], [true, () => {
      const t9 = this.values.findIndex((t10) => Gt(t10, s12)), e9 = this.values.get(t9), i10 = t9.subtract(1), r10 = this.values.get(i10), o18 = s12.subtract(r10).divide(e9.subtract(r10));
      return _e(this.sizes.get(i10), this.sizes.get(t9), o18);
    }]);
  }
};
...
var f6 = class extends w2 {
  getSize(s12, t9) {
    const e9 = Tt([x2(s12), t9], [_t(s12, this.values.first()), this.sizes.first()], [Ht(s12, this.values.last()), this.sizes.last()], [true, () => {
      const t10 = this.values.findIndex((t11) => Gt(t11, s12)), e10 = this.values.get(t10), i10 = t10.subtract(1), r10 = this.values.get(i10), o18 = s12.subtract(r10).divide(e10.subtract(r10));
      return _e(this.sizes.get(i10), this.sizes.get(t10), o18);
    }]);
...
var s8 = class extends w2 {
  getSize(t9, o18) {
    return zt(x2(t9), o18, t9.multiply(this.unitValueToPixelsRatio));
  }
};
...
function r8(e9, i10, t9, l9 = new J2(false)) {
  if (null == e9.visualVariableColor) return t9;
  const r10 = e9.storage.getColorValue(i10);
  return e9.visualVariableColor.getColor(r10, t9, l9);
}
function n4(a8, i10) {
...
var H2 = class extends B4 {
  _vertexPreamble(i10, t9, e9) {
    const { id: o18, offset: a8, animationPointerAndBaseSizeAndReferenceSize: r10, sizing: s12 } = i10, l9 = r10.xy, n16 = r10.z, b8 = r10.w, S7 = s12.xy, h12 = this._getEvalParams(i10, S7, e9);
    let w7, g13;
    if (i10.value1Position2Value2) {
      const t10 = J3(l9, 6, h12).a, e10 = i10.pos, o19 = i10.value1Position2Value2.yz, a9 = i10.value1Position2Value2.x, r11 = i10.value1Position2Value2.w, s13 = t10.subtract(a9).divide(r11.subtract(a9));
      g13 = e10.add(o19.subtract(e10).multiply(s13)), w7 = ln(new C2(1), s13).add(ln(new C2(0), gt(s13)));
    } else g13 = i10.pos, w7 = new C2(0);
    const V4 = s12.z, x9 = h5(i10.bitset, o5.bitset.isStroke), z6 = s12.w, j6 = h5(i10.bitset, o5.bitset.scaleSymbolsProportionally), T6 = J3(l9, 0, h12), _5 = Tt([Ct(h5(i10.bitset, o5.bitset.isMapAligned), new C2(1)), this.view.rotation.divide(180).multiply(Math.PI)], [true, new C2(0)]), O4 = new nt(oe(_5), un(_5.multiply(-1)), un(_5), oe(_5)).multiply(T6.xy), C8 = T6.z.subtract(_5).subtract(t9.multiply(o6)), M3 = T6.w, A8 = h5(i10.bitset, o5.bitset.isSDF), F10 = l3(this, o18, new C2(b8)).divide(new C2(b8));
    return { baseSize: n16, animationPointer: l9, strokeWidth: V4, isOutline: x9, unscaledDistanceToPx: z6, scaleSymbolsProportionally: j6, isSDF: A8, position: this._getScreenPosition({ id: o18, pos: g13, offset: a8, referenceSize: b8, translation: O4, rotation: C8, scale: M3, vvScale: F10 }), evalParams: h12, vvScale: F10, scale: M3, clip: w7 };
  }
  _getScreenPosition(i10) {
    const { pos: t9, translation: e9, rotation: o18, scale: a8, offset: r10, id: s12, vvScale: l9 } = i10, n16 = o10(this, s12).multiply(Math.PI / 180), p9 = e9.x.multiply(4 / 3), d9 = e9.y.multiply(-1).multiply(4 / 3), c8 = un(n16), y6 = oe(n16), h12 = y6.multiply(p9).add(gt(c8).multiply(d9)), w7 = c8.multiply(p9).add(y6.multiply(d9)), g13 = un(o18.subtract(n16)), V4 = oe(o18.subtract(n16)), x9 = new C2(0), z6 = new C2(1), { pixelRatio: P10 } = this.animationInfo, j6 = new rt(z6, x9, x9, x9, z6, x9, h12.multiply(P10), w7.multiply(P10), z6), T6 = new rt(V4, g13.multiply(-1), x9, g13, V4, x9, 0, 0, z6), _5 = a8.multiply(l9).multiply(P10).multiply(4 / 3), I3 = T6.multiply(_5), O4 = this.animationInfo.toScreen.multiply(new Y2(t9, 1)), C8 = j6.multiply(O4).xy, M3 = I3.multiply(new Y2(r10, 0)).xy;
    return C8.add(M3);
  }
  _clip(i10, e9) {
    let o18 = super.clip(i10, e9);
    const a8 = _t(this._getLocalTimeOrigin(i10), new C2(0));
    return t4.forceGlobalTimeOrigin || (o18 = o18.add(Tt([a8, () => new C2(2)], [true, () => new C2(0)]))), o18;
  }
  ...
  _getEvalParams(i10, t9, e9) {
    const { globalTime: o18, animationTextureSize: a8, animationTexture: r10 } = this.animationInfo;
    return { globalTime: o18, localTimeOrigin: this._getLocalTimeOrigin(i10.id), animationTextureSize: a8, animationTexture: r10, pixelDimensions: t9, lineLength: e9 };
  }
  _getColor(i10, t9) {
  ...
  _getSDFColor(i10, t9) {
    const e9 = wn(this.mosaicInfo.texture, i10), o18 = new C2(0.5).subtract(C4(e9)).multiply(t9.distanceToPx).multiply(p), a8 = se(new C2(0.5).subtract(o18), new C2(0), new C2(1)), r10 = t9.color.multiply(a8), s12 = t9.outlineSize.multiply(0.5), n16 = Qt(o18).subtract(s12), p9 = se(new C2(0.5).subtract(n16), new C2(0), new C2(1)), u18 = t9.outlineColor.multiply(p9);
    return new C2(1).subtract(u18.a).multiply(r10).add(u18);
  }
};
function J3(i10, t9, o18) {
  const a8 = i10.add(new X(t9, 0)), r10 = wn(o18.animationTexture, a8.add(0.5).divide(o18.animationTextureSize)).xy;
  return i10 = i10.add(r10), xt({ animationPointer: i10, ...o18 }, _3, null, (i11) => {
    const { out: t10 } = i11;
...
var g5 = class extends H2 {
  ...
  _fragmentPoly(t9) {
    const e9 = Ge(t9.uv, new C2(1)), o18 = _e(t9.tlbr.xy, t9.tlbr.zw, e9);
    return this._getColor(o18, { color: t9.color, distanceToPx: t9.distanceToPx, isSDF: t9.isSDF, outlineColor: t9.outlineColor, outlineSize: t9.strokeWidth });
  }
  _vertexPoly(t9) {
    const { position: e9, animationPointer: o18, evalParams: s12, isOutline: c8, unscaledDistanceToPx: m12, vvScale: d9, strokeWidth: u18, scaleSymbolsProportionally: b8, scale: v7, isSDF: S7, baseSize: g13, clip: f14 } = this._vertexPreamble(t9, new C2(0), t9.lineLength || new C2(0)), w7 = this._toNdc(e9);
    let j6 = J3(o18, 1, s12);
    ...
    const D6 = J3(o18, 4, s12).a, T6 = J3(o18, 5, s12).a, _5 = r8(this, t9.id, j6, At(k(t9.bitset, o5.bitset.colorLocked), new J2(c8))), C8 = _e(_5, k7, z6), F10 = n4(this, t9.id), A8 = _e(F10, D6, T6), W4 = C8.multiply(A8), L5 = this.clip(t9.id, t9.zoomRange).add(f14.multiply(2)), O4 = m12.multiply(d9);
...
function j(i10, y6, s12) {
  const l9 = s12.subtract(y6), c8 = v3(i10.subtract(y6), l9), e9 = se(c8.divide(je(l9)), new C2(0), new C2(1));
...
function h7(t9, n16, r10, y6) {
  const s12 = new rt(r10.x.multiply(y6.y).subtract(y6.x.multiply(r10.y)), y6.x.multiply(n16.y).subtract(n16.x.multiply(y6.y)), n16.x.multiply(r10.y).subtract(r10.x.multiply(n16.y)), r10.y.subtract(y6.y), y6.y.subtract(n16.y), n16.y.subtract(r10.y), y6.x.subtract(r10.x), n16.x.subtract(y6.x), r10.x.subtract(n16.x)), l9 = n16.x.multiply(r10.y.subtract(y6.y)), c8 = r10.x.multiply(y6.y.subtract(n16.y)), e9 = y6.x.multiply(n16.y.subtract(r10.y)), o18 = l9.add(c8).add(e9);
  return new C2(1).divide(o18).multiply(s12.multiply(new Y2(1, t9)));
}
function M(t9, n16, r10, i10) {
  return Ct(g6(h7(t9, n16, r10, i10)), new C2(1));
}
function P4(t9, n16, r10, i10) {
  const a8 = r10.subtract(n16), o18 = i10.subtract(n16), p9 = z(a8, o18), x9 = Lt(Yt(p9, new C2(i4)), Gt(p9, new C2(-i4)));
...
function z2(t9, u18, n16) {
  const { viewMat3: r10, tileMat3: y6 } = t9.view, s12 = r10.multiply(y6), l9 = s12.multiply(new Y2(u18.pos, 1)), c8 = s12.multiply(new Y2(n16.nextPos1, 1)), e9 = s12.multiply(new Y2(n16.nextPos2, 1));
  return P4(t9.hittestRequest.position, l9.xy, c8.xy, e9.xy);
}
...
var x3 = class extends B4 {
  ...
  vertex(t9, o18) {
    ...
    return { glPosition: new _3(i10.xy, p9, 1), color: e9, ...this.maybeRunHittest(t9, o18, null) };
  }
  fragment(t9) {
    return this.getFragmentOutput(t9.color, t9, new C2(0));
  }
  hittest(t9, o18) {
    return z2(this, t9, o18);
  }
};
...
function P5(t9, e9, o18, i10, r10) {
  const l9 = Ct(h5(r10, C), st2(1)), f14 = C4(new _3(t9, 0));
  return zt(l9, ft(i10.divide(e9.x), o18.divide(e9.y), 0, gt(o18.divide(e9.x)), i10.divide(e9.y), 0, w3(ot(f14, 0)), w3(ot(0, f14)), 1), ft(i10.divide(e9.x), o18.divide(e9.y), 0, gt(o18.divide(e9.x)), i10.divide(e9.y), 0, 0, 0, 1));
}
function Z(t9, e9) {
  const o18 = t9.view.requiredZoomFactor, i10 = new X(e9.width, e9.height), r10 = i10.multiply(e9.scale).multiply(o18), s12 = e9.angle.multiply(o6), p9 = un(s12), n16 = oe(s12), d9 = P5(e9.id, r10, p9, n16, e9.bitset), m12 = t9.localTileOffset.getPatternOffsetAtTileOrigin(i10, p9, n16), u18 = o18.multiply(e9.scale).multiply(e9.offset.subtract(m12)).divide(r10), x9 = new Y2(e9.pos, 1), h12 = d9.multiply(x9).xy.subtract(u18), g13 = e9.tlbr.divide(t9.mosaicInfo.size.xyxy);
...
function k2(t9, e9) {
  const o18 = Ge(e9.tileTextureCoord, new C2(1)), i10 = _e(e9.tlbr.xy, e9.tlbr.zw, o18);
...
function G4(t9, i10) {
  const { halfWidth: e9, normal: o18 } = t9, l9 = D3(e9), a8 = je(o18).multiply(e9);
  return se(l9.multiply(e9.subtract(a8)).divide(i10.add(l9).subtract(new C2(1))), new C2(0), new C2(1));
}
function L3(t9, i10) {
  const { id: e9, halfWidth: o18, referenceHalfWidth: l9 } = i10;
  if (t5(t9)) {
    const i11 = new C2(2).multiply(l9), a8 = l3(t9, e9, i11);
    return new C2(0.5).multiply(o18.divide(Xe(l9, new C2(h)))).multiply(a8);
  }
  return o18;
}
function T2(t9, i10) {
  const { id: e9, offset: o18, pos: l9, normal: a8, zoomRange: r10 } = i10, { displayViewScreenMat3: p9, displayViewMat3: u18 } = t9.view, m12 = r8(t9, e9, i10.color), f14 = n4(t9, e9), h12 = L3(t9, i10), v7 = new C2(0.5).multiply(t9.antialiasingControls.antialiasing), w7 = Xe(h12.add(v7), new C2(0.45)).add(new C2(0.1).multiply(v7)), V4 = D3(w7).multiply(w7).multiply(o18), b8 = u18.multiply(new Y2(V4, new C2(0))), S7 = p9.multiply(new Y2(l9, new C2(1))).add(b8), x9 = new C2(2).multiply(ln(h12, new C2(0))).add(t9.clip(e9, r10)), g13 = new _3(S7.xy, x9, 1);
  return { color: m12, opacity: f14, halfWidth: w7, normal: a8, scaledOffset: V4, scaledHalfWidth: h12, glPosition: new _3(g13.xy, x9, 1) };
}
function k3(t9, i10) {
  const { opacity: e9, color: o18 } = t9, l9 = G4(t9, i10);
  return e9.multiply(o18).multiply(l9);
}
...
var j2 = class extends g5 {
  ...
  vertex(t9, i10) {
    const { animationPointerAndBaseSizeAndReferenceSize: e9 } = t9, s12 = e9.xy, { distanceToPx: l9, ndc: p9, z: u18, color: y6, isOutline: c8, strokeWidth: h12, isSDF: x9, baseSize: v7, scale: f14, scaleSymbolsProportionally: w7, evalParams: g13 } = this._vertexPoly(t9), S7 = t9.sizing.xy, P10 = S7.x.multiply(v7).divide(S7.y), z6 = J3(s12, 6, g13).a, A8 = t9.accumulatedDistance.subtract(z6), { normal: D6 } = t9, j6 = t9.normal.y, C8 = A8.divide(this.view.displayZoomFactor).add(we(t9.segmentDirection, t9.offset)).divide(P10), F10 = j6.add(1).divide(2), R8 = new X(C8, F10), W4 = t9.tlbr.divide(this.mosaicInfo.size.xyxy), M3 = v7.divide(2), O4 = new C2(0.5).multiply(this.antialiasingControls.antialiasing), T6 = Xe(M3.add(O4), new C2(0.45)).add(new C2(0.1).multiply(O4));
    return { glPosition: new _3(p9, u18, 1), tlbr: W4, uv: R8, color: y6.multiply(new C2(1).subtract(c8)), outlineColor: y6.multiply(c8), distanceToPx: l9, strokeWidth: h12.multiply(_e(new C2(1), f14, w7)), isOutline: c8, isSDF: x9, halfWidth: T6, normal: D6, ...this.maybeRunHittest(t9, i10, T6) };
  }
  fragment(t9) {
    const i10 = this._fragmentPoly(t9), e9 = G4(t9, this.antialiasingControls.blur), { halfWidth: s12, normal: l9 } = t9, o18 = D3(s12), a8 = je(l9).multiply(s12), r10 = se(o18.multiply(s12.subtract(a8)).divide(o18.subtract(new C2(1))), new C2(0), new C2(1));
    return this.getFragmentOutput(i10.multiply(r10).multiply(e9), t9);
  }
  hittest(t9, i10, e9) {
    const { viewMat3: s12, tileMat3: l9 } = this.view, o18 = s12.multiply(l9), a8 = o18.multiply(new Y2(t9.pos, 1)), n16 = o18.multiply(new Y2(i10.nextPos1, 1)), r10 = o18.multiply(new Y2(i10.nextPos2, 1)), { distance: d9, smallSymbolDistance: m12, smallSymbolSizeThreshold: p9 } = this.hittestRequest, u18 = ln(e9, p9.multiply(0.5)).multiply(d9.subtract(m12)), x9 = this.hittestRequest.position;
...
var U2 = class extends H2 {
  ...
  vertex(t9, e9) {
    const i10 = t9.uv.divide(this.mosaicInfo.size), { position: s12, animationPointer: o18, evalParams: l9, isOutline: p9, unscaledDistanceToPx: h12, vvScale: x9, strokeWidth: c8, scaleSymbolsProportionally: y6, scale: f14, isSDF: w7, baseSize: g13, clip: v7 } = this._vertexPreamble(t9, t9.angle, t9.lineLength || new C2(0)), b8 = this._toNdc(s12);
    let _5 = J3(o18, 1, l9);
    ...
    const P10 = J3(o18, 4, l9).a, N4 = J3(o18, 5, l9).a, R8 = r8(this, t9.id, _5, At(k(t9.bitset, o5.bitset.colorLocked), new J2(p9))), F10 = _e(R8, z6, C8), j6 = n4(this, t9.id), T6 = _e(j6, P10, N4), U3 = F10.multiply(T6), q7 = this.clip(t9.id, t9.zoomRange).add(v7.multiply(2)), A8 = h12.multiply(x9);
  ...
  _hittestSmallMarker(t9, e9, i10) {
    const { position: s12, distance: o18, smallSymbolDistance: l9 } = this.hittestRequest, r10 = o18.subtract(l9), { viewMat3: a8, tileMat3: n16 } = this.view, d9 = a8.multiply(n16).multiply(new Y2(i10.pos, 1)).xy, m12 = i10.size.multiply(0.5);
    return ye(d9, s12).subtract(m12).add(r10);
  }
  _hittestMarker(t9, e9, i10) {
    const s12 = this._vertexPreamble({ ...t9 }, t9.angle, new C2(0)).position, o18 = this._vertexPreamble({ ...t9, offset: e9.offsetNextVertex1 }, t9.angle, new C2(0)).position, l9 = this._vertexPreamble({ ...t9, offset: e9.offsetNextVertex2 }, t9.angle, new C2(0)).position, a8 = this.hittestRequest.position, n16 = this.hittestRequest.distance, d9 = P4(a8, s12, o18, l9);
    return zt(Gt(d9, n16), d9, this._hittestSamples(s12, o18, l9, t9, e9, i10));
  }
  _hittestSamples(t9, e9, i10, s12, o18, l9) {
    const { outlineSize: n16, isSDF: d9, distanceToPx: m12 } = l9, u18 = this.hittestRequest.position, p9 = this.hittestRequest.distance, h12 = h7(u18.add(new X(gt(p9), gt(p9))), t9, e9, i10), x9 = h7(u18.add(new X(0, gt(p9))), t9, e9, i10), c8 = h7(u18.add(new X(p9, gt(p9))), t9, e9, i10), y6 = h7(u18.add(new X(gt(p9), 0)), t9, e9, i10), v7 = h7(u18, t9, e9, i10), S7 = h7(u18.add(new X(p9, 0)), t9, e9, i10), b8 = h7(u18.add(new X(gt(p9), p9)), t9, e9, i10), _5 = h7(u18.add(new X(0, p9)), t9, e9, i10), V4 = h7(u18.add(new X(p9, p9)), t9, e9, i10), z6 = s12.uv.divide(this.mosaicInfo.size), k7 = o18.textureUVNextVertex1.divide(this.mosaicInfo.size), M3 = o18.textureUVNextVertex2.divide(this.mosaicInfo.size), D6 = { color: new _3(1, 1, 1, 1), outlineSize: n16, outlineColor: new _3(1, 1, 1, 1), isSDF: d9, distanceToPx: m12 };
    let R8 = new C2(0);
...
var f7 = class extends t6 {
  render(o18, f14) {
    const { context: g13, painter: p9, pixelRatio: d9 } = o18, { target: x9 } = f14, { freezeGlobalTime: b8 } = t4, h12 = 0, D6 = p9.textureManager.animationStore.getTexture(g13, h12), T6 = [2 / o18.state.size[0], 0, 0, 0, -2 / o18.state.size[1], 0, -1, 1, 1], R8 = Array.from(s2(e4(), T6)), j6 = Array.from(i2(e4(), R8, x9.transforms.displayViewScreenMat3)), y6 = f14.instance.getInput(), z6 = p9.textureManager.getMosaicInfo(o18, f14.textureKey, false), { optionalAttributes: S7 } = y6, A8 = S7.zoomRange, I3 = S7.value1Position2Value2, M3 = "accumulatedDistance" in S7 && S7.accumulatedDistance, q7 = "segmentDirection" in S7 && S7.segmentDirection, w7 = "normal" in S7 && S7.normal;
    p9.setShader({ shader: this.shaders.geometry, uniforms: { ...u3(o18, f14.target, y6.uniforms), ...f2(o18, f14.target), antialiasingControls: n5(d9), mosaicInfo: z6, animationInfo: { globalTime: o18.animationsEnabled ? false === b8 ? o18.time / 1e3 : b8 : 0, animationTextureSize: [D6.descriptor.width, D6.descriptor.height], animationTexture: { unit: 6, texture: D6 }, toScreen: j6, toNdc: T6, mapRotation: o18.state.rotation, pixelRatio: o18.state.pixelRatio }, localTileOffset: h4(f14.target) }, defines: { ...d2(o18) }, optionalAttributes: { zoomRange: A8, value1Position2Value2: I3, accumulatedDistance: M3, segmentDirection: q7, normal: w7 }, useComputeBuffer: a(o18) }), p9.setPipelineState({ ...m3(o18) }), p9.submitDraw(o18, f14), false === b8 && o18.animationsEnabled && x9.requestRender();
  }
};
...
var C5 = class extends P2 {
  ...
  vertex(t9) {
    const o18 = new rt(1, 0, 0, 0, -1, 0, 0, 1, 1).multiply(new Y2(t9.pos.xy.divide(o2), 1)), i10 = wn(this.draw.locations, o18.xy), r10 = Xe(this.instance.dotSize.divide(2), new C2(1));
    let s12 = new C2(0);
    s12 = s12.add(ln(i10.a, new C2(F4)).multiply(2));
    let d9 = r10.add(this.instance.dotSize);
    const n16 = this.view.displayViewScreenMat3.multiply(new Y2(t9.pos.add(0.5), 1)), p9 = new _3(n16.xy, s12, 1), l9 = this.instance.dotSize.divide(d9), h12 = new C2(-1).divide(r10.divide(d9));
    return d9 = d9.multiply(this.draw.pixelRatio.multiply(this.draw.tileZoomFactor)), { glPosition: p9, glPointSize: d9, color: i10, ratio: l9, invEdgeRatio: h12 };
  }
  fragment(t9) {
    const o18 = je(t9.glPointCoord.subtract(0.5)).multiply(2), e9 = on(new C2(0), new C2(1), t9.invEdgeRatio.multiply(o18.subtract(t9.ratio)).add(1)), i10 = new v();
...
var O2 = class extends B4 {
  ...
  _dotThreshold(t9, e9, o18) {
    return t9.divide(e9).divide(o18);
  }
  vertex(t9) {
    const e9 = new rt(2 / o2, 0, 0, 0, -2 / o2, 0, -1, 1, 1).multiply(new Y2(t9.pos, 1)), s12 = this.clip(t9.id), i10 = new _3(e9.xy, s12, 1), r10 = this.storage.getVVData(t9.id).multiply(this.instance.isActive.get(0)).multiply(t9.inverseArea), l9 = this.storage.getDataDrivenData0(t9.id).multiply(this.instance.isActive.get(1)).multiply(t9.inverseArea), d9 = this.draw.tileZoomFactor.multiply(o2).divide(this.draw.pixelRatio), n16 = this._dotThreshold(r10, this.instance.dotValue, this.draw.tileDotsOverArea), c8 = this._dotThreshold(l9, this.instance.dotValue, this.draw.tileDotsOverArea), u18 = t9.pos.add(0.5).divide(d9);
    return { glPosition: i10, color: new _3(0, 0, 0, 0), textureCoords: u18, thresholds0: n16, thresholds1: c8 };
  }
  fragment(t9) {
    const e9 = new v(), o18 = wn(this.draw.dotTexture0, t9.textureCoords), i10 = wn(this.draw.dotTexture1, t9.textureCoords), r10 = t9.thresholds0.subtract(o18), l9 = t9.thresholds1.subtract(i10);
    let d9;
    ...
    if (this.blending) {
      const t10 = ln(new C2(0), r10), e10 = ln(new C2(0), l9), o19 = we(t10, r10).add(we(e10, l9)), s12 = ln(o19, new C2(0)), i11 = new C2(1).subtract(s12), p9 = o19.add(s12), h12 = r10.multiply(t10).divide(p9), c8 = l9.multiply(e10).divide(p9), u18 = n16.multiply(h12).add(a8.multiply(c8));
      d9 = i11.multiply(u18);
    } else {
      const t10 = Xe(D2(r10), D2(l9)), e10 = ln(t10, new C2(0)), o19 = new C2(1).subtract(e10), s12 = ln(t10, r10), i11 = ln(t10, l9), p9 = n16.multiply(s12).add(a8.multiply(i11));
      d9 = o19.multiply(p9);
    }
...
var m6 = class {
  ...
  getDotDensityMesh(t9) {
    if (null == this._dotMesh) {
      const o18 = o2, r10 = o18 * o18, n16 = 2, d9 = new Int16Array(r10 * n16);
      for (let t10 = 0; t10 < o18; t10++) for (let e9 = 0; e9 < o18; e9++) d9[n16 * (e9 + t10 * o18)] = e9, d9[n16 * (e9 + t10 * o18) + 1] = t10;
      this._dotMesh = s6.create(t9, { primitive: _2.POINTS, vertex: d9, count: r10, layout: T4 });
    }
    return this._dotMesh;
  }
  getDotDensityTextures(e9, s12, o18) {
    if (this._dotTextureSize === s12 && this._seed === o18 || (this._disposeTextures(), this._dotTextureSize = s12, this._seed = o18), null === this._dotTextures) {
      const r10 = new t(o18);
  ...
  _allocDotDensityTexture(t9, e9, s12) {
    const o18 = new Float32Array(e9 * e9 * 4);
    for (let i10 = 0; i10 < o18.length; i10++) o18[i10] = s12.getFloat();
    const r10 = new h2(e9);
    return r10.dataType = N2.FLOAT, r10.samplingMode = 9728, new A(t9, r10, o18);
  }
};
...
var f8 = class extends t6 {
  ...
  _renderDotDensity(o18, r10) {
    const { context: s12, painter: u18, requiredLevel: c8 } = o18, p9 = r10.instance.getInput().uniforms, h12 = this._getOrCreateResourcesRecord(s12), f14 = h12.getDotDensityTextures(s12, o2, p9.seed), m12 = 1 / 2 ** (c8 - r10.target.key.level), w7 = o2, g13 = w7 * window.devicePixelRatio * w7 * window.devicePixelRatio, x9 = 1 / m12 * (1 / m12), D6 = p9.dotScale ? o18.state.scale / p9.dotScale : 1, b8 = p9.dotValue * D6 * x9;
    u18.setShader({ shader: this.shaders.polygon, uniforms: { ...f2(o18, r10.target), instance: { isActive: p9.isActive, colors: p9.colors, dotValue: Math.max(1, b8) }, draw: { dotTexture0: { unit: N3, texture: f14[0] }, dotTexture1: { unit: O, texture: f14[1] }, tileZoomFactor: m12, pixelRatio: window.devicePixelRatio, tileDotsOverArea: g13 / (o2 * window.devicePixelRatio * o2 * window.devicePixelRatio) } }, defines: { ...d2(o18), blending: p9.blending }, optionalAttributes: {}, useComputeBuffer: false });
    const y6 = s12.getViewport();
    s12.setViewport(0, 0, o2, o2);
    const R8 = s12.getBoundFramebufferObject(), v7 = h12.getFBO(s12);
    s12.bindFramebuffer(v7), s12.setClearColor(0, 0, 0, 0), s12.clear(16384), u18.setPipelineState({ color: { write: [true, true, true, true], blendMode: "composite" }, depth: false, stencil: false }), u18.updatePipelineState(s12), u18.submitDraw(o18, r10), s12.bindFramebuffer(R8), s12.setViewport(y6.x, y6.y, y6.width, y6.height);
    const P10 = h12.getFBO(s12).colorTexture, S7 = { shader: this.shaders.point, uniforms: { view: r7(o18, r10.target), instance: { dotSize: p9.dotSize }, draw: { locations: { unit: N3, texture: P10 }, tileZoomFactor: 1, pixelRatio: window.devicePixelRatio } }, defines: { ...d2(o18) }, optionalAttributes: {}, useComputeBuffer: false };
    u18.setPipelineState(m3(o18)), u18.submitDrawMesh(s12, S7, h12.getDotDensityMesh(s12), { stencilRef: r10.getStencilReference() });
  }
  shutdown(e9) {
...
function H3(t9, o18, i10) {
  const { id: e9, bitset: r10 } = o18, s12 = h5(r10, B), m12 = Gt(s12, new C2(0.5)), d9 = T2(t9, o18), c8 = zt(m12, d9.halfWidth, new C2(0)), f14 = n4(t9, e9), h12 = r8(t9, e9, o18.color), V4 = zt(m12, zt(k(r10, L), h12, o18.color), h12.multiply(f14)), S7 = t9.view.displayViewScreenMat3.multiply(new Y2(o18.pos.xy, 1)), j6 = t9.clip(o18.id), x9 = new _3(S7.xy, j6, 1), z6 = zt(m12, d9.glPosition, x9), M3 = i10 && t9.maybeRunHittest(o18, i10, m12);
...
var G5 = class extends q6 {
  ...
  vertex(t9, o18) {
    return H3(this, t9, o18);
  }
  fragment(t9) {
    const { color: o18, isOutline: i10 } = t9, e9 = Gt(i10, new C2(0.5)), r10 = k3(t9, this.antialiasingControls.blur), s12 = zt(e9, r10, o18), n16 = zt(e9, new C2(1 / 255), new C2(0));
    return this.getFragmentOutput(s12, t9, n16);
  }
  hittest(t9, o18, i10) {
    return zt(i10, q4(this.hittestRequest), z2(this, t9, o18));
  }
};
...
function O3(t9, e9) {
  const r10 = e9.tlbr.xy, o18 = e9.tlbr.zw, i10 = o18.x.subtract(r10.x), s12 = r10.y.subtract(o18.y), a8 = new X(i10, s12).multiply(e9.inverseRasterizationScale), p9 = a8.multiply(t9.view.requiredZoomFactor), u18 = j5(p9), d9 = t9.localTileOffset.getPatternOffsetAtTileOrigin(a8).divide(p9), c8 = new Y2(e9.pos, 1);
  return { tileTextureCoord: u18.multiply(c8).xy.subtract(d9), tlbr: e9.tlbr.divide(t9.mosaicInfo.size.xyxy) };
}
function S3(t9, e9) {
  const r10 = Ge(t9.tileTextureCoord, new C2(1)), o18 = _e(t9.tlbr.xy, t9.tlbr.zw, r10), i10 = wn(e9.texture, o18);
...
var x4 = class extends G5 {
  ...
  fragment(t9) {
    const { isOutline: r10 } = t9, e9 = Gt(r10, new C2(0.5)), o18 = k3(t9, this.antialiasingControls.blur), i10 = S3(t9, this.mosaicInfo), a8 = zt(e9, o18, i10), p9 = zt(e9, new C2(1 / 255), new C2(0));
...
var R6 = class extends q6 {
  ...
  vertex(t9, o18) {
    ...
    return { ...m12, ...u18, ...Object.assign({}, this.maybeRunHittest(t9, o18, h12)) };
  }
  fragment(t9) {
    const { isOutline: o18 } = t9, e9 = Gt(o18, new C2(0.5)), r10 = k3(t9, this.antialiasingControls.blur), i10 = k2(this, t9), a8 = zt(e9, r10, i10), n16 = zt(e9, new C2(1 / 255), new C2(0));
    return this.getFragmentOutput(a8, t9, n16);
  }
  hittest(t9, o18, e9) {
    return zt(e9, q4(this.hittestRequest), z2(this, t9, o18));
  }
};
...
var l4 = class extends t6 {
  ...
  render(e9, u18) {
    const { painter: l9, pixelRatio: m12 } = e9, p9 = u18.instance.getInput();
    l9.setShader({ shader: this.shaders.geometry, uniforms: { ...u3(e9, u18.target, p9.uniforms), ...f2(e9, u18.target), antialiasingControls: n5(m12), mosaicInfo: l9.textureManager.getMosaicInfo(e9, u18.textureKey), localTileOffset: h4(u18.target) }, defines: { ...d2(e9) }, optionalAttributes: p9.optionalAttributes, useComputeBuffer: a(e9) }), l9.setPipelineState(m3(e9)), l9.submitDraw(e9, u18);
  }
};
...
var A6 = class extends x3 {
  ...
  vertex(t9, e9) {
    const { tlbr: i10, relativePosition: r10, gradientMethod: o18, relativeGradientSize: a8 } = t9, d9 = zt(k(t9.bitset, e2.isAbsolute), this.view.displayZoomFactor, new C2(1));
    return { ...super.vertex(t9, e9), tlbr: i10, relativePosition: r10, gradientMethod: o18, gradientSize: a8.multiply(d9), isDiscrete: h5(t9.bitset, e2.isDiscrete) };
  }
  fragment(t9) {
    const { tlbr: e9, relativePosition: i10, gradientMethod: r10, gradientSize: o18, isDiscrete: g13 } = t9, w7 = zt(Gt(g13, new C2(0.5)), o18.subtract(1), new X(0)), b8 = Tt([Ct(r10, new C2(r5.rectangular)), () => {
      const t10 = Qt(i10).add(w7).divide(o18);
      return E2(Xe(t10.x, t10.y));
    }], [Ct(r10, new C2(r5.circular)), E2(hn(we(i10, i10)).add(w7.x).divide(o18.x))], [true, E2(i10.x.add(w7.x).divide(o18.x))]), S7 = new X(se(b8, new C2(0), new C2(1)), 0.5), j6 = _e(e9.xy, e9.zw, S7).divide(this.mosaicInfo.size), z6 = wn(this.mosaicInfo.texture, j6), F10 = t9.color.a;
...
var l5 = class extends t6 {
  ...
  render(e9, u18) {
    const { painter: l9, pixelRatio: m12 } = e9, f14 = u18.instance.getInput();
    l9.setShader({ shader: this.shaders.geometry, uniforms: { ...u3(e9, u18.target, f14.uniforms), ...f2(e9, u18.target), antialiasingControls: n5(m12), mosaicInfo: l9.textureManager.getMosaicInfo(e9, u18.textureKey), localTileOffset: h4(u18.target) }, defines: { ...d2(e9) }, optionalAttributes: f14.optionalAttributes, useComputeBuffer: a(e9) }), l9.setPipelineState(m3(e9)), l9.submitDraw(e9, u18);
  }
};
...
var m7 = class {
  ...
  ensureAccumulateFBO(e9, r10, t9) {
    if (null == this._accumulateFramebuffer) {
      const { dataType: s12, samplingMode: l9, pixelFormat: n16, internalFormat: m12 } = this.loadQualityProfile(e9), f14 = new h2(r10, t9);
      f14.pixelFormat = n16, f14.internalFormat = m12, f14.dataType = s12, f14.samplingMode = l9, f14.wrapMode = 33071;
...
var F7 = class extends B4 {
  ...
  vertex(t9) {
    const { radius: e9, isFieldActive: i10 } = this.kernelControls, s12 = t9.offset, l9 = i10.multiply(this.storage.getVVData(t9.id).x).add(new C2(1).subtract(i10)), o18 = this.view.displayViewScreenMat3.multiply(new Y2(t9.pos, 1)).add(this.view.displayViewMat3.multiply(new Y2(s12, 0)).multiply(e9)), r10 = this.clip(t9.id);
    return { glPosition: new _3(o18.xy, r10, 1), offset: s12, fieldValue: l9, color: new _3(0), ...this.maybeRunHittest(t9, {}, null) };
  }
  fragment(t9) {
    const { offset: e9, fieldValue: i10 } = t9, s12 = je(e9), l9 = ln(s12, new C2(1)), o18 = new C2(1).subtract(s12.multiply(s12)), r10 = o18.multiply(o18), a8 = l9.multiply(r10).multiply(i10).multiply(new C2(n10(this.usesHalfFloatPrecision)));
...
var b3 = class extends P2 {
  ...
  fragment(t9) {
    const { accumulatedDensity: e9, gradient: o18 } = this;
    ...
    const s12 = wn(o18.texture, new X(i10, 0.5)), n16 = new v();
...
var u9 = class extends t6 {
  ...
  render(e9, i10) {
    const { context: n16, painter: o18, state: u18 } = e9, a8 = i10.instance.getInput(), { isFieldActive: l9 } = a8.uniforms, h12 = this._getOrCreateResourcesRecord(n16), f14 = h12.loadQualityProfile(n16);
    a(e9) || this._bind(e9, h12, a8), o18.setShader({ shader: this.shaders.accumulate, uniforms: { ...f2(e9, i10.target), kernelControls: { radius: p3(a8, u18), isFieldActive: l9 ? 1 : 0 } }, defines: { ...d2(e9), ...f14.defines }, optionalAttributes: {}, useComputeBuffer: a(e9) });
    const m12 = a(e9) ? c3 : d5;
    o18.setPipelineState(m12), o18.submitDraw(e9, i10);
  }
  ...
  renderResolvePass(e9, r10) {
    ...
    const { defines: o18 } = n16.loadQualityProfile(s12), { minDensity: u18, maxDensity: a8, radius: l9 } = r10.getInput().uniforms, d9 = 8, c8 = 9, p9 = n16.accumulateFramebuffer, f14 = n16.resolveGradientTexture, m12 = { shader: this.shaders.resolve, uniforms: { accumulatedDensity: { texture: { unit: d9, texture: p9.colorTexture }, minAndInvRange: [u18, 1 / (a8 - u18)], normalization: 3 / (l9 * l9 * Math.PI) }, gradient: { texture: { unit: c8, texture: f14 } } }, defines: o18, optionalAttributes: {}, useComputeBuffer: false };
  ...
  _bind(e9, t9, r10) {
    ...
    const { context: s12, state: i10, pixelRatio: n16 } = e9, o18 = s12.getBoundFramebufferObject(), u18 = s12.getViewport();
    this._prevFBO = o18, this._prevViewport = u18;
    const { gradient: l9, gradientHash: d9 } = r10.uniforms;
    t9.ensureResolveGradientTexture(s12, d9, l9);
    const { width: c8, height: h12 } = u18, f14 = a4(p3(r10, i10), n16), m12 = c8 * f14, _5 = h12 * f14, w7 = t9.ensureAccumulateFBO(s12, m12, _5);
    s12.blitFramebuffer(o18, w7, 1024), s12.bindFramebuffer(w7), s12.setViewport(0, 0, w7.width, w7.height), s12.setColorMask(true, true, true, true), s12.setClearColor(0, 0, 0, 0), s12.clear(16384), this._isBound = true;
  }
};
function a4(e9, t9) {
...
var Y3 = class extends B4 {
  ...
  clipLabel(t9, e9) {
    const { clipAngle: o18, zoomRange: s12, visibility: l9 } = t9, a8 = o18.multiply(J4), r10 = Qt(this.view.rotation.subtract(a8)), n16 = Ye(new C2(360).subtract(r10), r10);
    let d9 = new C2(0);
    ...
    return d9 = d9.add(e9.multiply(w7)), d9 = d9.add(e9.multiply(x9)), d9 = d9.add(b8), l9 && (d9 = d9.add(l9)), d9;
  }
  vertex(t9, e9) {
    const i10 = h5(t9.bitset, F), s12 = new C2(1).subtract(i10);
    let l9 = t9.fontAndReferenceSize[0];
    ...
    if (this.isLabel) {
      ...
      const e10 = t9.referenceSymbol, i11 = e10.xy, s13 = e10.z, l10 = this._unpackDirection(e10.w), a9 = l3(this, t9.id, s13).divide(2), r11 = l10.multiply(a9.add(u2));
      c8 = i11.add(r11), p9 = p9.add(c8);
    } else {
      u18 = l3(this, t9.id, a8).divide(a8), l9 = l9.multiply(u18), r10 = r10.multiply(u18), p9 = p9.multiply(u18), m12 = u5(this, t9.id), p9 = m12.multiply(new Y2(p9, 0)).xy;
    }
    ...
    return { glPosition: new _3(d9.xy.add(z6.xy), R8, 1), color: n16, size: r10, textureUV: t9.textureUV.divide(this.mosaicInfo.size), antialiasingWidth: new C2(0.105 * d).divide(l9).divide(this.view.pixelRatio), outlineDistanceOffset: j6, ...this.maybeRunHittest(t9, e9, { vvSizeAdjustment: u18, vvRotation: m12, labelOffset: c8, labelClipped: A8 }) };
  }
  _getViewRotationMatrix(t9) {
    const e9 = this.view.displayViewMat3, i10 = this.view.displayMat3, o18 = new C2(1).subtract(t9);
    return e9.multiply(t9).add(i10.multiply(o18));
  }
  fragment(t9) {
    const e9 = new C2(2 / 8), i10 = new C2(1).subtract(e9), o18 = wn(this.mosaicInfo.texture, t9.textureUV).a;
    let s12 = i10.subtract(t9.outlineDistanceOffset);
    this.highlight && (s12 = s12.divide(2));
    const l9 = t9.antialiasingWidth, a8 = on(s12.subtract(l9), s12.add(l9), o18);
    return this.getFragmentOutput(t9.color.multiply(a8), t9);
  }
  hittest(t9, e9, { vvSizeAdjustment: i10, vvRotation: o18, labelOffset: s12, labelClipped: l9 }) {
    let a8, r10, n16;
    this.isLabel ? (a8 = new Y2(t9.offset.add(s12), 0), r10 = new Y2(e9.offsetNextVertex1.add(s12), 0), n16 = new Y2(e9.offsetNextVertex2.add(s12), 0)) : (a8 = o18.multiply(new Y2(t9.offset.multiply(i10), 0)), r10 = o18.multiply(new Y2(e9.offsetNextVertex1.multiply(i10), 0)), n16 = o18.multiply(new Y2(e9.offsetNextVertex2.multiply(i10), 0)));
    ...
    return this.isLabel ? zt(l9, q4(this.hittestRequest), h12) : h12;
  }
  _unpackDirection(t9) {
    const e9 = new W(t9), i10 = jt(e9, new W(2)), o18 = Pt(e9, new W(3));
    return new X(new C2(i10).subtract(1), new C2(o18).subtract(1));
  }
  _getVertexColor(t9) {
    let e9 = t9.color;
    ...
    if (this.visualVariableOpacity) {
      const i10 = this.storage.getOpacityValue(t9.id), o18 = this.visualVariableOpacity.getOpacity(i10);
      e9 = e9.multiply(o18);
    }
    return e9;
  }
...
var o12 = class extends t6 {
  constructor() {
    super(...arguments), this.type = 18, this.shaders = { geometry: new Y3() }, this.drawPhase = 14, this.symbologyPlane = 3;
  }
  render(e9, n16) {
    const { painter: o18 } = e9, u18 = d2(e9), d9 = { ...m3(e9), stencil: { write: false, test: { compare: 516, mask: 255, op: { fail: 7680, zFail: 7680, zPass: 7680 } } } }, m12 = n16.instance.getInput(), c8 = { shader: this.shaders.geometry, uniforms: { ...u3(e9, n16.target, m12.uniforms), ...f2(e9, n16.target), mosaicInfo: o18.textureManager.getMosaicInfo(e9, n16.textureKey) }, defines: { ...u18, textRenderPassType: 0, isBackgroundPass: true, isLabel: true }, optionalAttributes: m12.optionalAttributes, useComputeBuffer: a(e9) };
    o18.setPipelineState(d9), o18.setShader(c8), o18.submitDraw(e9, n16, { stencilRef: 255 }), o18.setShader({ ...c8, defines: { ...u18, textRenderPassType: 2, isBackgroundPass: false, isLabel: true } }), o18.submitDraw(e9, n16, { stencilRef: 255 }), o18.setShader({ ...c8, defines: { ...u18, textRenderPassType: 0, isBackgroundPass: false, isLabel: true } }), o18.submitDraw(e9, n16, { stencilRef: 255 });
  }
};
...
var k4 = class extends B6 {
  ...
  vertex(t9, e9) {
    const { totalLength: i10, gradientSize: o18, segmentDirection: r10, tlbr: s12 } = t9, p9 = T2(this, t9), m12 = h5(t9.bitset, e3.isAlongLine), c8 = i10.divide(this.view.displayZoomFactor), u18 = zt(k(t9.bitset, e3.isAbsoluteSize), () => {
      const t10 = zt(Gt(m12, new C2(0.5)), c8, p9.halfWidth);
      return o18.divide(t10);
    }, o18), h12 = t9.accumulatedDistance.add(we(r10, p9.scaledOffset).divide(c8)), y6 = s12.divide(this.mosaicInfo.size.xyxy);
  ...
  fragment(t9) {
    const { isAlongLine: e9, isDiscrete: i10, relativePositionAlongLine: o18, relativeGradientSize: r10, normal: s12, tlbr: d9 } = t9, v7 = G4(t9, this.antialiasingControls.blur), f14 = F8(s12.y).multiply(Ye(je(s12), new C2(1))), w7 = new C2(0.5).multiply(f14).add(new C2(0.5)), b8 = zt(Gt(e9, new C2(0.5)), o18, w7), x9 = zt(Gt(i10, new C2(0.5)), r10.subtract(1), new C2(0));
    let L5 = b8.add(x9).divide(r10);
    L5 = zt(Gt(e9, new C2(0.5)), L5, E2(L5));
...
var h10 = class extends t6 {
  ...
  _getShaderOptions(t9, o18, a8) {
    const { painter: p9, pixelRatio: h12 } = t9, l9 = o18.instance.getInput();
    return { shader: this.shaders.geometry, uniforms: { ...u3(t9, o18.target, l9.uniforms), ...f2(t9, o18.target), antialiasingControls: n5(h12), mosaicInfo: p9.textureManager.getMosaicInfo(t9, o18.textureKey), technique: { isColorPass: a8 } }, defines: { ...d2(t9) }, optionalAttributes: l9.optionalAttributes, useComputeBuffer: a(t9) };
  }
  render(t9, s12) {
...
var H4 = class extends B6 {
  ...
  _getDistanceRatio(t9, e9) {
    const o18 = h5(t9.bitset, D);
    return o18.multiply(Xe(e9, new C2(0.25)).multiply(new C2(2))).add(new C2(1).subtract(o18).multiply(u(1)));
  }
  _getSDFAlpha(t9) {
    const { halfWidth: e9, normal: i10, tlbr: r10, patternSize: a8, accumulatedDistance: l9, offsetAlongLine: x9, dashToPx: v7, capType: D6 } = t9, S7 = a8.x.divide(i3).multiply(v7), j6 = Te(l9.add(x9).divide(S7)), A8 = _e(r10.xy, r10.zw, new X(j6, 0.5)), z6 = C4(wn(this.mosaicInfo.texture, A8)).multiply(2).subtract(1).multiply(o4).multiply(v7), F10 = i10.y.multiply(e9), T6 = Tt([Ct(D6, new C2(1)), z6.subtract(e9)], [Ct(D6, new C2(2)), hn(We(Xe(z6, new C2(0)), new C2(2)).add(F10.multiply(F10))).subtract(e9)], [true, z6]), L5 = se(new C2(0.25).subtract(T6), new C2(0), new C2(1));
    return new _3(L5);
  }
  _getPatternColor(t9) {
    const { halfWidth: e9, normal: i10, color: o18, accumulatedDistance: s12, patternSize: r10, sampleAlphaOnly: a8, tlbr: l9 } = t9, n16 = r10.y.multiply(new C2(2).multiply(e9).divide(r10.x)), y6 = Te(s12.divide(n16)), h12 = new C2(0.5).multiply(i10.y).add(new C2(0.5)), f14 = _e(l9.xy, l9.zw, new X(h12, y6));
    let w7 = wn(this.mosaicInfo.texture, f14);
    return null != this.visualVariableColor && (w7 = zt(Gt(a8, new C2(0.5)), new _3(o18.a), o18)), w7;
  }
  vertex(t9, e9) {
    const { segmentDirection: i10, tlbr: o18, bitset: s12 } = t9, r10 = T2(this, t9), a8 = t9.accumulatedDistance.divide(this.view.displayZoomFactor).add(we(i10, r10.scaledOffset)), l9 = new X(o18.z.subtract(o18.x), o18.w.subtract(o18.y)), n16 = o18.divide(this.mosaicInfo.size.xyxy), c8 = h5(s12, E), m12 = h5(s12, w), d9 = zt(Gt(c8, new C2(0.5)), this._getDistanceRatio(t9, r10.scaledHalfWidth), new C2(1));
    return { ...r10, tlbr: n16, patternSize: l9, accumulatedDistance: a8, isSDF: c8, sampleAlphaOnly: m12, dashToPx: d9, offsetAlongLine: t9.offsetAlongLine, capType: t9.capType, ...this.maybeRunHittest(t9, e9, r10.halfWidth) };
  }
  fragment(t9) {
    const { color: e9, opacity: i10, isSDF: o18 } = t9, s12 = G4(t9, this.antialiasingControls.blur), r10 = zt(Gt(o18, new C2(0.5)), this._getSDFAlpha(t9), this._getPatternColor(t9)), a8 = e9.multiply(i10).multiply(s12).multiply(r10);
...
function $2(t9, e9, i10, o18) {
  return e9.multiply(t9.x).add(i10.multiply(t9.y)).add(o18.multiply(t9.z));
}
function tt(t9) {
...
var et = class extends B4 {
  ...
  vertex(t9, e9) {
    const i10 = tt(t9.sizing.x), o18 = tt(t9.sizing.y), s12 = tt(t9.sizing.z), l9 = t9.placementAngle, r10 = h5(t9.bitset, o5.bitset.isSDF), y6 = h5(t9.bitset, o5.bitset.isMapAligned), h12 = h5(t9.bitset, o5.bitset.scaleSymbolsProportionally), c8 = k(t9.bitset, o5.bitset.colorLocked), x9 = n4(this, t9.id), v7 = r8(this, t9.id, t9.color, c8).multiply(x9), f14 = this.view.displayViewScreenMat3.multiply(new Y2(t9.pos.xy, 1)), V4 = l3(this, t9.id, s12).divide(s12), w7 = i10.multiply(V4), S7 = t9.offset.xy.multiply(V4);
    let b8 = o18.multiply(h12.multiply(V4.subtract(1)).add(1));
    b8 = Ye(b8, Xe(w7.subtract(0.99), new C2(0)));
    const g13 = Xe(b8, new C2(1)), C8 = Ye(b8, new C2(1)), z6 = rt.fromRotation(l9.multiply(o6)), _5 = u5(this, t9.id), R8 = this._getViewRotationMatrix(y6).multiply(_5).multiply(z6).multiply(new Y2(S7.xy, 0)), U3 = this.clip(t9.id, t9.zoomRange), N4 = new _3(f14.xy.add(R8.xy), U3, 1), D6 = t9.textureUV.divide(this.mosaicInfo.size), F10 = t9.outlineColor.multiply(C8), I3 = h5(t9.bitset, o5.bitset.overrideOutlineColor), O4 = t9.sdfDecodeCoeff.multiply(w7);
  ...
  _getViewScreenMatrix(t9) {
    const e9 = this.view.viewMat3.multiply(this.view.tileMat3), i10 = this.view.tileMat3, o18 = new C2(1).subtract(t9);
    return e9.multiply(t9).add(i10.multiply(o18));
  }
  _getColor(t9, e9) {
  ...
  _getSDFColor(t9, e9) {
    const i10 = wn(this.mosaicInfo.texture, t9), o18 = new C2(0.5).subtract(C4(i10)).multiply(e9.distanceToPx).multiply(p), s12 = se(new C2(0.5).subtract(o18), new C2(0), new C2(1)), l9 = e9.color.multiply(s12);
    let r10 = e9.outlineSize;
    this.highlight && (r10 = Xe(r10, e9.overrideOutlineColor.multiply(4)));
    const a8 = r10.multiply(0.5), p9 = Qt(o18).subtract(a8), d9 = se(new C2(0.5).subtract(p9), new C2(0), new C2(1)), m12 = _e(e9.outlineColor, e9.color, e9.overrideOutlineColor).multiply(d9);
    return new C2(1).subtract(m12.a).multiply(l9).add(m12);
  }
  _hittestSmallMarker(t9, e9, i10) {
    const { position: o18, distance: s12, smallSymbolDistance: l9 } = this.hittestRequest, r10 = s12.subtract(l9), { viewMat3: p9, tileMat3: n16 } = this.view, u18 = p9.multiply(n16).multiply(new Y2(i10.pos, 1)).xy, d9 = i10.size.multiply(0.5);
    return ye(u18, o18).subtract(d9).add(r10);
  }
  _hittestMarker(t9, e9, i10) {
    const { pos: o18, sizeCorrection: s12, isMapAligned: l9 } = i10, r10 = new Y2(t9.offset.multiply(s12), 0), p9 = new Y2(e9.offsetNextVertex1.multiply(s12), 0), n16 = new Y2(e9.offsetNextVertex2.multiply(s12), 0), { viewMat3: u18, tileMat3: d9 } = this.view, m12 = u18.multiply(d9).multiply(new Y2(o18, 1)), h12 = this._getViewScreenMatrix(l9).multiply(i10.vvRotationMat3).multiply(i10.placementMat3), c8 = m12.add(h12.multiply(r10)).xy, x9 = m12.add(h12.multiply(p9)).xy, v7 = m12.add(h12.multiply(n16)).xy, f14 = this.hittestRequest.position, V4 = this.hittestRequest.distance, w7 = P4(f14, c8, x9, v7);
    return zt(Gt(w7, V4), w7, this._hittestSamples(c8, x9, v7, t9, e9, i10));
  }
  _hittestSamples(t9, e9, i10, o18, s12, l9) {
    const { outlineSize: r10, isSDF: a8, distanceToPx: p9 } = l9, n16 = this.hittestRequest.position, d9 = this.hittestRequest.distance, y6 = h7(n16.add(new X(gt(d9), gt(d9))), t9, e9, i10), h12 = h7(n16.add(new X(0, gt(d9))), t9, e9, i10), c8 = h7(n16.add(new X(d9, gt(d9))), t9, e9, i10), x9 = h7(n16.add(new X(gt(d9), 0)), t9, e9, i10), v7 = h7(n16, t9, e9, i10), f14 = h7(n16.add(new X(d9, 0)), t9, e9, i10), V4 = h7(n16.add(new X(gt(d9), d9)), t9, e9, i10), w7 = h7(n16.add(new X(0, d9)), t9, e9, i10), S7 = h7(n16.add(new X(d9, d9)), t9, e9, i10), M3 = o18.textureUV.divide(this.mosaicInfo.size), z6 = s12.textureUVNextVertex1.divide(this.mosaicInfo.size), _5 = s12.textureUVNextVertex2.divide(this.mosaicInfo.size), R8 = { color: new _3(1), outlineColor: new _3(1), overrideOutlineColor: new C2(1), outlineSize: r10, distanceToPx: p9, isSDF: a8 };
    let j6 = new C2(0);
...
var e7 = class {
  ...
  get renamedLocationsMap() {
    const t9 = /* @__PURE__ */ new Map();
    for (const [e9, o18] of this.locationsMap.entries()) t9.set("a_" + e9, o18);
    return t9;
  }
  getShaderKey(t9, e9, o18) {
    return `${Object.keys(t9).map((e10) => `${e10}.${t9[e10]}`).join(".")}.${Object.keys(o18).filter((t10) => o18[t10]).map((t10) => `${t10}_${o18[t10].toString()}`).join(".")}.${Object.keys(e9).filter((t10) => this.optionPropertyKeys.has(t10)).join(".")}`;
  }
  getProgram(e9, o18, n16, r10) {
    let i10 = "", s12 = "";
...
`;
    ...
    return i10 += this.vertexShader, s12 += this.fragmentShader, new f3(i10, s12, this.renamedLocationsMap, this._getUniformBindings(o18), this._transformFeedbackBindings);
  }
  _getUniformBindings(t9) {
    const e9 = [];
    for (const r10 in this.required) {
      const t10 = this.required[r10];
      e9.push({ uniformHydrated: null, shaderModulePath: r10, uniformName: r10, uniformType: t10.type, uniformArrayElementType: o13(t10), uniformArrayLength: n12(t10) });
    }
    for (const r10 in t9) {
      const i10 = this.options[r10];
      if (t9[r10]) for (const t10 in i10) {
        const s12 = i10[t10];
        e9.push({ uniformHydrated: null, shaderModulePath: `${r10}.${t10}`, uniformName: t10, uniformType: s12.type, uniformArrayElementType: o13(s12), uniformArrayLength: n12(s12) });
      }
    }
    return e9;
  }
};
var o13 = (t9) => "array" === t9.type ? t9.elementType?.type : void 0;
...
var u13 = class extends t6 {
  ...
  render(e9, h12) {
    const { painter: u18 } = e9, { instance: o18, target: n16 } = h12, l9 = this.shaders.geometry, m12 = o18.getInput(), f14 = m12.uniforms.numberOfFields, S7 = a(e9), V4 = f2(e9, n16), d9 = d2(e9);
    l9.setNumberOfFields(f14), u18.setShader({ shader: l9, uniforms: { ...u3(e9, h12.target, m12.uniforms.shader), ...V4.storage, ...V4.view, ...V4.highlight, highlightUniforms: V4.highlight, hittestUniforms: V4.hittestRequest ? { hittestDist: V4.hittestRequest?.distance, hittestPos: V4.hittestRequest?.position } : null }, defines: { VV_SIZE_MIN_MAX_VALUE: !!m12.uniforms.shader.visualVariableSizeMinMaxValue, VV_SIZE_SCALE_STOPS: !!m12.uniforms.shader.visualVariableSizeScaleStops, VV_SIZE_FIELD_STOPS: !!m12.uniforms.shader.visualVariableSizeStops, VV_SIZE_UNIT_VALUE: !!m12.uniforms.shader.visualVariableSizeUnitValue, VV_OPACITY: !!m12.uniforms.shader.visualVariableOpacity, HITTEST: S7, highlight: V4.highlight ? 1 : 0, ...d9, numberOfFields: f14 }, optionalAttributes: {}, useComputeBuffer: S7 }), u18.setPipelineState(m3(e9)), u18.submitDraw(e9, h12);
  }
};

// node_modules/@arcgis/core/views/2d/engine/webgl/shaderGraph/techniques/text/TextTechnique.js
var o14 = class extends t6 {
  constructor() {
    super(...arguments), this.type = 30, this.shaders = { geometry: new Y3() }, this.symbologyPlane = 3;
  }
  render(e9, n16) {
    const { painter: o18 } = e9, u18 = d2(e9), d9 = n16.instance.getInput(), m12 = { shader: this.shaders.geometry, uniforms: { ...u3(e9, n16.target, d9.uniforms), ...f2(e9, n16.target), mosaicInfo: o18.textureManager.getMosaicInfo(e9, n16.textureKey) }, defines: { ...u18, isBackgroundPass: true, isLabel: false, textRenderPassType: 0 }, optionalAttributes: d9.optionalAttributes, useComputeBuffer: a(e9) };
    o18.setShader(m12), o18.setPipelineState(m3(e9)), o18.submitDraw(e9, n16), o18.setShader({ ...m12, defines: { ...u18, isBackgroundPass: false, isLabel: false, textRenderPassType: 2 } }), o18.submitDraw(e9, n16), o18.setShader({ ...m12, defines: { ...u18, isBackgroundPass: false, isLabel: false, textRenderPassType: 1 } }), o18.submitDraw(e9, n16), o18.setShader({ ...m12, defines: { ...u18, isBackgroundPass: false, isLabel: false, textRenderPassType: 0 } }), o18.submitDraw(e9, n16);
  }
};

// node_modules/@arcgis/core/views/2d/engine/webgl/shaderGraph/techniques/TechniqueRegistry.js
var F9 = { fill: new n7(), patternFill: new u8(), complexFill: new u6(), gradientFill: new n8(), outlineFill: new u7(), patternOutlineFill: new l5(), complexOutlineFill: new l4(), marker: new n11(), pieChart: new u13(), line: new u10(), texturedLine: new u11(), gradientStroke: new h10(), text: new o14(), label: new o12(), heatmap: new u9(), dotDensity: new f8(), animatedMarker: new o11(), animatedMarkerShift: new i7(), animatedFill: new n6(), animatedLine: new a3() };
function x6() {
  for (const e9 in F9) {
    F9[e9].startup();
  }
...
function t7(n16) {
  ...
  const { r: t9, g: r10, b: e9, a: o18 } = n16;
  return [t9 * (o18 / 255), r10 * (o18 / 255), e9 * (o18 / 255), o18];
}
...
function p5(e9, o18, r10) {
  return (1 - r10) * e9 + r10 * o18;
}
function c4(e9, o18) {
  const [t9, ...l9] = o18, n16 = l9.pop(), u18 = l9[0].value, a8 = l9[l9.length - 1].value, i10 = (a8 - u18) / s9, c8 = [];
  for (let s12 = u18; s12 < a8; s12 += i10) {
    let t10 = 0;
    for (; s12 >= l9[t10].value; ) t10++;
    const n17 = l9[t10], u19 = o18[t10 - 1], a9 = s12 - u19.value, i11 = n17.value === u19.value ? 1 : a9 / (n17.value - u19.value);
    if ("color" === e9) {
      const e10 = l9[t10], r10 = o18[t10 - 1], n18 = e10.color.clone();
      ...
      const e10 = l9[t10], n18 = o18[t10 - 1], u20 = o(e10.size), a10 = p5(o(n18.size), u20, i11);
      c8.push({ value: s12, size: a10, label: e10.label });
    } else {
      const e10 = l9[t10], r10 = p5(o18[t10 - 1].opacity, e10.opacity, i11);
...
function f10(e9) {
  const [o18, ...r10] = e9, t9 = r10.pop();
  for (; r10.length > s9; ) {
    let e10 = 0, o19 = 0;
    for (let t10 = 1; t10 < r10.length; t10++) {
      const l9 = r10[t10 - 1], s12 = r10[t10], n16 = Math.abs(s12.value - l9.value);
      n16 > o19 && (o19 = n16, e10 = t10);
    }
    r10.splice(e10, 1);
  }
  return [o18, ...r10, t9];
...
function b4(e9, o18) {
  return o18.length <= l7 ? o18 : (n14().warn(`Found ${o18.length} Visual Variable stops, but MapView only supports ${l7}. Displayed stops will be simplified.`), o18.length > 2 * l7 ? c4(e9, o18) : f10(o18));
}
function g11() {
  const { supportsColorBufferFloat: e9, supportsColorBufferFloatBlend: o18, supportsColorBufferHalfFloat: r10 } = t3();
  return e9 && o18 || r10;
}
function m8(o18) {
  if (!o18) return true;
  switch (o18.type) {
    ...
    case "heatmap":
      if (!g11()) {
        const o19 = t3(), r10 = ["supportsColorBufferFloat", "supportsColorBufferFloatBlend", "supportsColorBufferHalfFloat"].filter((e9) => !o19[e9]).join(", ");
...
function p6(e9) {
  ...
  const a8 = e9.stops.sort((e10, a9) => e10.value - a9.value), i10 = n13(a8, 8), l9 = i10.map(({ value: e10 }) => e10), r10 = i10.map(({ color: e10 }) => t7(e10));
  return { values: l9, colors: r10 };
}
function c5(e9) {
  if (!e9.stops?.length) return null;
...
function m9(e9, a8) {
  ...
  for (let l9 = 1; l9 < i10; l9++) if (e9 < a8[l9].value) {
    const i11 = (e9 - a8[l9 - 1].value) / (a8[l9].value - a8[l9 - 1].value);
    return a8[l9 - 1].size + i11 * (a8[l9].size - a8[l9 - 1].size);
  }
  return a8[i10 - 1].size;
}
function S5(a8) {
  const { minDataValue: i10, maxDataValue: l9, minSize: s12, maxSize: t9 } = a8;
  if ("object" == typeof s12 && "object" == typeof t9) return (a9, r10) => {
    const u18 = a9.state.scale, n16 = u(m9(u18, s12.stops)), o18 = u(m9(u18, t9.stops));
    return { minMaxValueAndSize: [i10, l9, n16, o18] };
  };
  if ("object" == typeof s12 || "object" == typeof t9) throw new Error("InternalError: Found a partial VisualVariableSizeMinMaxValue");
  return { minMaxValueAndSize: [i10, l9, u(s12), u(t9)] };
}
...
function z4(e9, a8 = o15, i10 = u15) {
  ...
  if (e9.visualVariableSizeScaleStops) {
    ...
    const l9 = e9.visualVariableSizeScaleStops.sizes;
    return Math.max(l9[l9.length - 1] * i10, a8);
  }
  if (e9.visualVariableSizeStops) {
    if ("function" == typeof e9.visualVariableSizeStops) return n15;
    const l9 = e9.visualVariableSizeStops.sizes;
    return Math.max(l9[l9.length - 1] * i10, a8);
  }
...
function s10(e9) {
  ...
  if (Array.isArray(e9)) {
    const [a8, i10, l9, t9] = e9;
    return [a8, i10, l9, 255 * t9];
  }
  return "string" == typeof e9 ? e9 : { ...e9, defaultValue: s10(e9?.defaultValue) };
}
async function c6(a8, i10) {
  const { cimResourceManager: l9, cimAnalyzer: t9, scaleExpression: n16 } = i10.schemaOptions;
  await Promise.all(Y.fetchResources(a8.symbol, l9, []));
  const o18 = t9.analyzeSymbolReference(a8, false), s12 = { scaleInfo: r9(a8), scaleExpression: n16 }, c8 = [];
  for (const e9 of o18) switch (e9.type) {
    case "marker":
...
function S6(e9, a8, l9) {
  const { uniforms: n16, schemaOptions: o18 } = a8, { store: r10 } = o18, s12 = { visualVariableColor: e9.colorLocked ? null : n16.visualVariableColor, visualVariableOpacity: n16.visualVariableOpacity };
  if (e9.animationParams) {
    const a9 = F9.animatedFill;
    return m10(r10.ensureInstance(a9, { uniforms: { ...s12, visualVariableSizeMinMaxValue: null, visualVariableSizeStops: null, visualVariableSizeUnitValue: null, visualVariableSizeScaleStops: null, visualVariableRotation: null }, optionalAttributes: { zoomRange: true, value1Position2Value2: false, lineLength: false } }), e9, b5, l9);
  }
  return z5(r10.ensureInstance(F9.fill, { uniforms: s12, optionalAttributes: { zoomRange: !!l9.scaleInfo } }), e9, l9);
}
function b6(e9, a8, l9) {
  const { uniforms: t9, schemaOptions: n16 } = a8, { store: o18 } = n16;
  return V3(o18.ensureInstance(F9.outlineFill, { uniforms: { visualVariableColor: e9.colorLocked ? null : t9.visualVariableColor, visualVariableOpacity: t9.visualVariableOpacity, visualVariableSizeMinMaxValue: null, visualVariableSizeScaleStops: null, visualVariableSizeStops: null, visualVariableSizeUnitValue: null }, optionalAttributes: { zoomRange: !!l9.scaleInfo } }), e9, l9);
}
function V3(e9, a8, i10) {
  const l9 = s10(a8.color) ?? [0, 0, 0, 0], t9 = s10(a8.outlineColor) ?? [0, 0, 0, 0];
  return [e9.createMeshInfo({ color: l9, outlineColor: t9, width: a8.outlineWidth, referenceWidth: a8.referenceWidth, capType: a8.cap, joinType: a8.join, miterLimit: a8.miterLimit, outlineUsesColorVV: !a8.outlineColorLocked, hasSizeVV: false, scaleInfo: i10.scaleInfo, effects: a8.effects ? { type: "cim-effect-infos", effectInfos: a8.effects } : null, outlineEffects: a8.outlineEffects ? { type: "cim-effect-infos", effectInfos: a8.outlineEffects } : null })];
}
...
function h11(e9, a8, l9) {
  if (!e9.spriteRasterizationParam) return S6(e9, a8, l9);
  const { uniforms: n16, schemaOptions: o18 } = a8, { store: r10 } = o18, s12 = { visualVariableColor: e9.colorLocked ? null : n16.visualVariableColor, visualVariableOpacity: n16.visualVariableOpacity };
  if (e9.animationParams) {
    const a9 = F9.animatedFill;
    return m10(r10.ensureInstance(a9, { uniforms: { ...s12, visualVariableSizeMinMaxValue: null, visualVariableSizeStops: null, visualVariableSizeUnitValue: null, visualVariableSizeScaleStops: null, visualVariableRotation: null }, optionalAttributes: { zoomRange: true, value1Position2Value2: false, lineLength: false } }), e9, b5, l9);
  }
  return d7(r10.ensureInstance(F9.complexFill, { uniforms: s12, optionalAttributes: { zoomRange: !!l9.scaleInfo } }), e9, null != n16.visualVariableColor, l9);
}
function d7(e9, a8, i10, { scaleInfo: l9 }) {
  if (!a8.spriteRasterizationParam) throw new Error("InternalError: Sprite should always be defined");
  const t9 = !!a8.hasUnresolvedReplacementColor && (!i10 || a8.colorLocked), n16 = a8.sampleAlphaOnly && !t9, o18 = a8.spriteRasterizationParam;
  return [e9.createMeshInfo({ color: s10(a8.color) ?? [0, 0, 0, 0], height: a8.height, aspectRatio: a8.scaleX, offsetX: a8.offsetX, offsetY: a8.offsetY, scaleX: 1, scaleY: 1, angle: a8.angle, applyRandomOffset: a8.applyRandomOffset, sampleAlphaOnly: n16, scaleProportionally: "CIMHatchFill" === o18.resource.type, sprite: o18, scaleInfo: l9, effects: a8.effects ? { type: "cim-effect-infos", effectInfos: a8.effects } : null })];
}
function v6(e9, a8, l9) {
  const { uniforms: t9, schemaOptions: n16 } = a8, { store: o18 } = n16;
  return y5(o18.ensureInstance(F9.gradientFill, { uniforms: { visualVariableColor: null, visualVariableOpacity: t9.visualVariableOpacity }, optionalAttributes: { zoomRange: !!l9.scaleInfo } }), e9, l9);
}
function y5(e9, a8, { scaleInfo: i10 }) {
  if (!a8.spriteRasterizationParam) throw new Error("InternalError: Sprite should always be defined");
  const l9 = a8.spriteRasterizationParam;
  return [e9.createMeshInfo({ color: s10(a8.color) ?? [0, 0, 0, 0], angle: a8.angle, gradientMethod: a8.gradientMethod, gradientSize: a8.gradientSize, gradientSizeUnits: a8.gradientSizeUnits, gradientType: a8.gradientType, sprite: l9, scaleInfo: i10, effects: a8.effects ? { type: "cim-effect-infos", effectInfos: a8.effects } : null })];
}
function g12(e9, a8, l9) {
  const { uniforms: n16, schemaOptions: o18 } = a8, { store: r10 } = o18, s12 = e9.isOutline ? { ...b5, visualVariableSizeScaleStops: n16.visualVariableSizeOutlineScaleStops } : { visualVariableColor: e9.colorLocked ? null : n16.visualVariableColor, visualVariableOpacity: n16.visualVariableOpacity, visualVariableSizeMinMaxValue: n16.visualVariableSizeMinMaxValue, visualVariableSizeScaleStops: n16.visualVariableSizeScaleStops, visualVariableSizeStops: n16.visualVariableSizeStops, visualVariableSizeUnitValue: n16.visualVariableSizeUnitValue };
  if (e9.animationParams) {
    const { hasShiftAnimation: a9 } = e9.animationParams.params, n17 = F9.animatedLine;
    return m10(r10.ensureInstance(n17, { uniforms: { ...s12, visualVariableRotation: null }, optionalAttributes: { zoomRange: true, value1Position2Value2: false, accumulatedDistance: true, segmentDirection: true, normal: true, lineLength: a9 } }), e9, b5, l9);
  }
  const c8 = { uniforms: s12, optionalAttributes: { zoomRange: !!l9.scaleInfo } }, u18 = !!(s12.visualVariableSizeMinMaxValue || s12.visualVariableSizeScaleStops || s12.visualVariableSizeStops || s12.visualVariableSizeUnitValue);
  if (!e9.spriteRasterizationParam) {
    return M2(r10.ensureInstance(F9.line, c8), e9, u18, l9);
  }
  return P9(r10.ensureInstance(F9.texturedLine, c8), e9, u18, l9);
}
...
function M2(e9, a8, i10, l9) {
  if (a8.spriteRasterizationParam) throw new Error("InternalError: Sprite should not be defined");
  const t9 = I2(a8, i10, l9);
  return [e9.createMeshInfo(t9)];
}
function P9(e9, a8, i10, l9) {
  const { spriteRasterizationParam: t9, scaleDash: n16, sampleAlphaOnly: o18 } = a8;
  if (!t9) throw new Error("InternalError: Sprite should be defined");
  return [e9.createMeshInfo({ ...I2(a8, i10, l9), offsetAlongLine: a8.offsetAlongLine ?? 0, shouldScaleDash: n16 ?? false, shouldSampleAlphaOnly: o18, isSDF: "CIMPictureStroke" !== t9.resource.type && "CIMGradientStroke" !== t9.resource.type, sprite: t9 })];
}
function R7(e9, a8, l9) {
  const { uniforms: n16, schemaOptions: o18 } = a8, { store: r10 } = o18;
  return k6(r10.ensureInstance(F9.gradientStroke, { uniforms: e9.isOutline ? { ...b5, visualVariableSizeScaleStops: n16.visualVariableSizeOutlineScaleStops } : { visualVariableColor: null, visualVariableOpacity: n16.visualVariableOpacity, visualVariableSizeMinMaxValue: n16.visualVariableSizeMinMaxValue, visualVariableSizeScaleStops: n16.visualVariableSizeScaleStops, visualVariableSizeStops: n16.visualVariableSizeStops, visualVariableSizeUnitValue: n16.visualVariableSizeUnitValue }, optionalAttributes: { zoomRange: !!l9.scaleInfo } }), e9, l9);
}
function k6(e9, a8, i10) {
  if (!a8.spriteRasterizationParam) throw new Error("InternalError: Sprite should always be defined");
  const l9 = a8.spriteRasterizationParam;
  return [e9.createMeshInfo({ ...I2(a8, false, i10), gradientMethod: a8.gradientMethod, gradientSize: a8.gradientSize, gradientSizeUnits: a8.gradientSizeUnits, gradientType: a8.gradientType, sprite: l9, effects: a8.effects ? { type: "cim-effect-infos", effectInfos: a8.effects } : null })];
}
function C7(e9, a8, l9) {
  const { uniforms: t9, schemaOptions: n16 } = a8, { store: o18 } = n16;
  return L4(o18.ensureInstance(F9.text, { uniforms: { visualVariableColor: e9.colorLocked ? null : t9.visualVariableColor, visualVariableOpacity: t9.visualVariableOpacity, visualVariableRotation: t9.visualVariableRotation, visualVariableSizeMinMaxValue: t9.visualVariableSizeMinMaxValue, visualVariableSizeScaleStops: t9.visualVariableSizeScaleStops, visualVariableSizeStops: t9.visualVariableSizeStops, visualVariableSizeUnitValue: t9.visualVariableSizeUnitValue }, optionalAttributes: { zoomRange: !!l9.scaleInfo, referenceSymbol: false, clipAngle: false, visibility: false } }), e9, t9, l9);
}
...
function t8(e9, i10) {
  return { type: "simple", filters: i10, capabilities: { maxTextureSize: t3().maxTextureSize }, bindings: o17(e9) };
}
function s11(e9, r10) {
  const t9 = t3();
  return { type: "multi", target: "feature", keyField: r3, filters: r10, capabilities: { maxTextureSize: t9.maxTextureSize }, bindings: { 0: o17(e9.trackLines.renderer), 1: o17(e9.latestObservations.renderer), 2: o17(e9.previousObservations.renderer) } };
}
function a7(e9) {
  switch (e9) {
    case "opacity":
...
//# sourceMappingURL=chunk-CX6SZNRA.js.map
