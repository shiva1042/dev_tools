...
var S = class extends b {
  ...
  async featureSetFromJSON(e, t, r) {
    ...
    const { meshFeatureSetFromJSON: s3 } = await p(import("./meshFeatureSet-JGV42X3I.js"), r);
  ...
  async executeRelationshipQuery(e, t) {
    const [{ default: r }, { executeRelationshipQuery: s3 }] = await p(Promise.all([import("./RelationshipQuery-7ZQN2WAQ.js"), import("./executeRelationshipQuery-TGOBIT2K.js")]), t);
  ...
  async executeRelationshipQueryForCount(e, t) {
    const [{ default: r }, { executeRelationshipQueryForCount: s3 }] = await p(Promise.all([import("./RelationshipQuery-7ZQN2WAQ.js"), import("./executeRelationshipQuery-TGOBIT2K.js")]), t);
    return e = r.from(e), (this.gdbVersion || this.dynamicDataSource) && ((e = e.clone()).gdbVersion = e.gdbVersion || this.gdbVersion, e.dynamicDataSource = e.dynamicDataSource || this.dynamicDataSource), s3(this.url, e, t);
  }
  async executeAttachmentQuery(e, t) {
    const { executeAttachmentQuery: r, fetchAttachments: s3, processAttachmentQueryResult: i2 } = await p(import("./queryAttachments-EZZAUWUL.js"), t), u = f(this.url);
    return i2(u, await (this.queryAttachmentsSupported ? r(u, e, t) : s3(u, e, t)));
  }
  async executeAttributeBinsQuery(e, t) {
    const { executeAttributeBinsQuery: r } = await p(import("./executeAttributeBinsQuery-5EW7N7EC.js"), t);
    return r(this.parsedUrl, e, t);
  }
  async executePivotQuery(e, t) {
    const { executePivotQuery: r } = await p(import("./executePivotQuery-S5BZZSLQ.js"), t);
    return r(this.parsedUrl, e, t);
  }
  async executeTopFeaturesQuery(e, t) {
    const { executeTopFeaturesQuery: r } = await p(import("./executeTopFeaturesQuery-ED7FO7C6.js"), t);
    return r(this.parsedUrl, e, this.sourceSpatialReference, t);
  }
  async executeForTopIds(e, t) {
    const { executeForTopIds: r } = await p(import("./executeForTopIds-B5MSRS6V.js"), t);
    return r(this.parsedUrl, e, t);
  }
  async executeForTopExtents(e, t) {
    const { executeForTopExtents: r } = await p(import("./executeForTopExtents-2ZLXCWOE.js"), t);
    return r(this.parsedUrl, e, t);
  }
  async executeForTopCount(e, t) {
    const { executeForTopCount: r } = await p(import("./executeForTopCount-IKY4KIES.js"), t);
    return r(this.parsedUrl, e, t);
  }
  _normalizeQuery(e) {
    let t = b2.from(e);
...
//# sourceMappingURL=chunk-AAGHMGJD.js.map
