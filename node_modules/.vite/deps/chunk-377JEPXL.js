import {
  l as l5
} from "./chunk-OE3LHBN2.js";
import {
  j
} from "./chunk-EGQEIT6I.js";
import {
  n2 as n5,
  n3 as n6,
  t
} from "./chunk-IRIPNWBX.js";
import {
  l as l4
...
var b = I = (_a = class extends a3(u2) {
  ...
  async queryElevation(r4, e2) {
    ...
    const { queryAll: o3 } = await import("./ElevationQuery-IL3ALO6G.js");
    s2(e2);
    return o3(this.layers.filter(A).toArray(), r4, e2);
  }
  async createElevationSampler(r4, e2) {
    await this.load({ signal: e2?.signal });
    const { createSampler: o3 } = await import("./ElevationQuery-IL3ALO6G.js");
    s2(e2);
    return o3(this.layers.filter(A).toArray(), r4, e2);
  }
  clone() {
  ...
  async _loadLayersFromJSON(r4, e2, o3) {
    const t3 = e2?.origin || "web-scene", s4 = e2?.portal || null, a5 = e2?.url || null, { populateOperationalLayers: i4 } = await import("./layersCreator-NN22LFNJ.js");
    s2(o3);
    const n8 = [];
...
//# sourceMappingURL=chunk-377JEPXL.js.map
