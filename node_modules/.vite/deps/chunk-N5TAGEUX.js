...
function Y(n, l2, e2, t2) {
  ...
  let s4, o2, i, h, M2, d, E, R, m, w2, C3, I4, P2, T3, F2, S2, j2, q2, g2, W2, b2;
  s4 = Math.abs(c), o2 = u * u + a * a, i = Math.sqrt(o2), h = o2 + c * c, M2 = Math.sqrt(h), W2 = Math.atan2(a, u), d = c * c / h, E = o2 / h, T3 = r2.a2 / M2, F2 = r2.a3 - r2.a4 / M2, E > 0.3 ? (R = s4 / M2 * (1 + E * (r2.a1 + T3 + d * F2) / M2), g2 = Math.asin(R), w2 = R * R, m = Math.sqrt(1 - w2)) : (m = i / M2 * (1 - d * (r2.a5 - T3 - E * F2) / M2), g2 = Math.acos(m), w2 = 1 - m * m, R = Math.sqrt(w2)), C3 = 1 - t.eccentricitySquared * w2, I4 = t.radius / Math.sqrt(C3), P2 = r2.a6 * I4, T3 = i - I4 * m, F2 = s4 - P2 * R, j2 = m * T3 + R * F2, S2 = m * F2 - R * T3, q2 = S2 / (P2 / C3 + j2), g2 += q2, b2 = j2 + S2 * q2 / 2, c < 0 && (g2 = -g2), e2[t2++] = ln * W2, e2[t2++] = ln * g2, e2[t2] = b2;
}
...
//# sourceMappingURL=chunk-N5TAGEUX.js.map
