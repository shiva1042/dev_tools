...
import {
  t as t2
} from "./chunk-HCCQETZH.js";
import {
  t as t3
} from "./chunk-GE7HP35W.js";
...
var He = (m11) => {
  ...
  let He2 = class extends h3 {
    ...
    async calculateVolume(e5, t6) {
      if (!(await this._fetchCapabilities(t6?.signal)).operations.supportsCalculateVolume) throw new s2("imagery-layer:compute-pixel-space-locations", "this operation is not supported on the input image service");
    ...
    async computeAngles(e5, t6) {
      if (!(await this._fetchCapabilities(t6?.signal)).operations.supportsComputeAngles) throw new s2("imagery-layer:compute-angles", "this operation is not supported on the input image service");
      return z2(this.url, e5, this._getRequestOptions(t6));
    }
    async computePixelSpaceLocations(e5, t6) {
      if (!(await this._fetchCapabilities(t6?.signal)).operations.supportsComputePixelLocation) throw new s2("imagery-layer:compute-pixel-space-locations", "this operation is not supported on the input image service");
      return E2(this.url, e5, this._getRequestOptions(t6));
    }
    async computeHistograms(e5, t6) {
      if (!(await this._fetchCapabilities(t6?.signal)).operations.supportsComputeHistograms) throw new s2("imagery-layer:compute-histograms", "this operation is not supported on the input image service");
    ...
    async computeStatisticsHistograms(e5, t6) {
      if (!(await this._fetchCapabilities(t6?.signal)).operations.supportsComputeStatisticsHistograms) throw new s2("imagery-layer:compute-statistics-histograms", "this operation is not supported on the input image service");
    ...
    async measureLengthFromImage(e5, t6) {
      if (!(await this._fetchCapabilities(t6?.signal)).operations.supportsMeasureFromImage) throw new s2("imagery-layer:measure-length-from-image", "this operation is not supported on the input image service");
    ...
    async measureAreaFromImage(e5, t6) {
      if (!(await this._fetchCapabilities(t6?.signal)).operations.supportsMeasureFromImage) throw new s2("imagery-layer:measure-area-from-image", "this operation is not supported on the input image service");
    ...
    fetchRasterAttributeTable(e5) {
      return this.version < 10.1 ? Promise.reject(new s2("#fetchRasterAttributeTable()", "Failed to get rasterAttributeTable")) : H(Ge(this.parsedUrl) + "/rasterAttributeTable", { query: this._getQueryParams({ renderingRule: this.version >= 10.3 ? e5?.rasterFunction : null }) }).then((e6) => g.fromJSON(e6.data));
    }
    ...
    async getSamples(e5, t6) {
      const i12 = await this._fetchCapabilities(t6?.signal);
      if (!i12?.operations.supportsGetSamples) throw new s2("imagery-layer:get-samples", "getSamples operation is not supported on the input image service");
      e5 = a(e5);
      const { raster: r3 } = this;
      return r3 && null == e5.raster && (e5.raster = r3), Q(this.url, e5, this._getRequestOptions(t6));
    }
    async identify(e5, t6) {
      if (!(await this._fetchCapabilities(t6?.signal)).operations.supportsIdentify) throw new s2("imagery-layer:identify", "identify operation is not supported on the input image service");
    ...
    async imageToMap(e5, t6) {
      if (!(await this._fetchCapabilities(t6?.signal)).operations.supportsImageToMap) throw new s2("imagery-layer:image-to-map", "imageToMap operation is not supported on the input image service");
      return ut(Ge(this.parsedUrl), e5, this._getRequestOptions(t6));
    }
    async imageToMapMultiray(e5, t6) {
      if (!(await this._fetchCapabilities(t6?.signal)).operations.supportsImageToMapMultiray) throw new s2("imagery-layer:image-to-map-multiray", "imageToMapMultiray operation is not supported on the input image service");
      return ct(Ge(this.parsedUrl), e5, this._getRequestOptions(t6));
    }
    async mapToImage(e5, t6) {
      if (!(await this._fetchCapabilities(t6?.signal)).operations.supportsMapToImage) throw new s2("imagery-layer:map-to-image", "mapToImage operation is not supported on the input image service");
      return ft(Ge(this.parsedUrl), e5, this._getRequestOptions(t6));
    }
    async findImages(e5, t6) {
      if (!(await this._fetchCapabilities(t6?.signal)).operations.supportsFindImages) throw new s2("imagery-layer:find-images", "findImages operation is not supported on the input image service");
      return gt(Ge(this.parsedUrl), e5, this._getRequestOptions(t6));
    }
    async getImageUrl(e5, t6) {
      if (!(await this._fetchCapabilities(t6?.signal)).operations.supportsGetImageUrl) throw new s2("imagery-layer:get-image-url", "getImageUrl operation is not supported on the input image service");
    ...
    async queryBoundary(e5, t6) {
      if (!(await this._fetchCapabilities(t6?.signal)).operations.supportsQueryBoundary) throw new s2("imagery-layer:query-boundary", "queryBoundary operation is not supported on the input image service");
    ...
    async queryGPSInfo(e5, t6) {
      if (!(await this._fetchCapabilities(t6?.signal)).operations.supportsQueryGPSInfo) throw new s2("imagery-layer:query-gps-info", "queryGPSInfo operation is not supported on the input image service");
    ...
    async _prepareForQuery(e5, t6) {
      if (!(await this._fetchCapabilities(t6?.signal)).operations.supportsQuery) throw new s2("imagery-layer:query-rasters", "query operation is not supported on the input image service");
    ...
    async _fetchServiceInfo(e5) {
      ...
      if (t6.capabilities?.toLowerCase().split(",").map((e6) => e6.trim()).indexOf("tilesonly") > -1) throw new s2("imagery-layer:fetch-service-info", "use ImageryTileLayer to open tiles-only image services");
...
var $3 = class extends p(l6(t(b3(j(o5(He(i7(f3(s6(l5(l2(l3(b5))))))))))))) {
  constructor(...e5) {
    super(...e5), this.graphicOrigin = new s11(this), this.isReference = null, this.operationalLayerType = "ArcGISImageServiceLayer", this.popupEnabled = true, this.popupTemplate = null, this.screenSizePerspectiveEnabled = true, this.type = "imagery", this._debouncedSaveOperations = L(async (e6, r3, t6) => {
      const { save: o6, saveAs: i12 } = await import("./imageryUtils-JNFDTRR2.js");
      switch (e6) {
        case 0:
          return o6(this, r3);
        case 1:
...
//# sourceMappingURL=ImageryLayer-XXTJADSW.js.map
