...
var F = class extends b {
  ...
  updateModelTransform(t6) {
    ...
    const a4 = c(L, L, C);
    o(s7, a4[12], a4[13], a4[14]), e7.modelOrigin.setVec(t6, s7), n(i5, a4), e7.model.setMat(t6, i5);
    const r9 = g3(j, a4);
...
var M = class extends m3 {
  constructor(e7, t6, i5 = new t3(K, () => import("./DefaultMaterial.glsl-ZDZ3Z3XQ.js"))) {
    const s7 = [t(F2(t6))];
...
var o5 = class extends M {
  constructor(r9, o6) {
    super(r9, o6, new t3(z, () => import("./RealisticTree.glsl-FSXF4FWV.js")));
  }
};
...
//# sourceMappingURL=chunk-QH352EDI.js.map
