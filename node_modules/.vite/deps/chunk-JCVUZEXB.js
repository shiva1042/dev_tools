...
var g = (_a = class extends l(n) {
  ...
  static from(t) {
    return "string" == typeof t ? new m4({ url: t }) : t instanceof HTMLImageElement || t instanceof HTMLCanvasElement || t instanceof ImageData || t instanceof HTMLVideoElement ? new m4({ data: t }) : m2(m4, t);
  }
}, m4 = _a, _a);
function f(t) {
  let e = "";
...
__decorate([m3({ type: String, json: { write: h } })], g.prototype, "url", null), __decorate([m3({ clonable: "reference", json: { write: { overridePolicy() {
  return { enabled: !this.url };
} } } })], g.prototype, "data", null), __decorate([r("data")], g.prototype, "writeData", null), __decorate([o("data")], g.prototype, "readData", null), __decorate([m3({ type: Boolean, json: { write: { overridePolicy() {
  return { enabled: this._isOverridden("transparent") };
} } } })], g.prototype, "transparent", null), __decorate([m3({ json: { write: true } })], g.prototype, "wrap", void 0), __decorate([m3({ readOnly: true })], g.prototype, "contentHash", null), g = m4 = __decorate([a("esri.geometry.support.MeshTexture")], g);
...
__decorate([m3({ type: [Number], nonNullable: true, json: { write: true } })], p.prototype, "offset", void 0), __decorate([m3({ type: Number, nonNullable: true, json: { write: true } })], p.prototype, "rotation", void 0), __decorate([m3({ type: [Number], nonNullable: true, json: { write: true } })], p.prototype, "scale", void 0), p = __decorate([a("esri.geometry.support.MeshTextureTransform")], p);
...
__decorate([m3({ type: u, json: { write: true } })], n2.prototype, "color", void 0), __decorate([m3({ type: g, json: { write: true } })], n2.prototype, "colorTexture", void 0), __decorate([m3({ type: p, json: { write: true } })], n2.prototype, "colorTextureTransform", void 0), __decorate([m3({ type: g, json: { write: true } })], n2.prototype, "normalTexture", void 0), __decorate([m3({ type: p, json: { write: true } })], n2.prototype, "normalTextureTransform", void 0), __decorate([m3({ nonNullable: true, json: { write: true } })], n2.prototype, "alphaMode", void 0), __decorate([m3({ nonNullable: true, json: { write: true } })], n2.prototype, "alphaCutoff", void 0), __decorate([m3({ nonNullable: true, json: { write: true } })], n2.prototype, "doubleSided", void 0), n2 = __decorate([a("esri.geometry.support.MeshMaterial")], n2);
...
__decorate([m3({ type: u, json: { write: true } })], u4.prototype, "emissiveColor", void 0), __decorate([m3({ type: g, json: { write: true } })], u4.prototype, "emissiveTexture", void 0), __decorate([m3({ type: p, json: { write: true } })], u4.prototype, "emissiveTextureTransform", void 0), __decorate([m3({ type: g, json: { write: true } })], u4.prototype, "occlusionTexture", void 0), __decorate([m3({ type: p, json: { write: true } })], u4.prototype, "occlusionTextureTransform", void 0), __decorate([m3({ type: Number, nonNullable: true, json: { write: true }, range: { min: 0, max: 1 } })], u4.prototype, "metallic", void 0), __decorate([m3({ type: Number, nonNullable: true, json: { write: true }, range: { min: 0, max: 1 } })], u4.prototype, "roughness", void 0), __decorate([m3({ type: g, json: { write: true } })], u4.prototype, "metallicRoughnessTexture", void 0), __decorate([m3({ type: p, json: { write: true } })], u4.prototype, "metallicRoughnessTextureTransform", void 0), u4 = __decorate([a("esri.geometry.support.MeshMaterialMetallicRoughness")], u4);
...
//# sourceMappingURL=chunk-JCVUZEXB.js.map
