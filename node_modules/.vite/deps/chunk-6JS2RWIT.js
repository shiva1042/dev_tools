...
function A(t3, o4, e6, i4, s2) {
  ...
  if (U(t3.field)) return U(t3.stops) ? 2 === t3.stops.length && n(t3.stops[0].size) && n(t3.stops[1].size) ? (R(t3.stops[0].size, t3.stops[1].size, t3.stops[0].value, t3.stops[1].value, o4, e6), o4.type[e6] = 1, true) : (D(s2, "Could not convert size info: stops only supported with 2 elements"), false) : n(r4) && n(n5) && U(t3.minDataValue) && U(t3.maxDataValue) ? (R(r4, n5, t3.minDataValue, t3.maxDataValue, o4, e6), o4.type[e6] = 1, true) : "unknown" === t3.valueUnit ? (D(s2, "Could not convert size info: proportional size not supported"), false) : null != m2[t3.valueUnit] ? (o4.minSize[e6] = -1 / 0, o4.maxSize[e6] = 1 / 0, o4.offset[e6] = 0, o4.factor[e6] = 1 / m2[t3.valueUnit], o4.type[e6] = 1, true) : (D(s2, "Could not convert size info: scale-dependent size not supported"), false);
  if (!U(t3.field)) {
    if (t3.stops?.[0] && n(t3.stops[0].size)) return o4.minSize[e6] = t3.stops[0].size, o4.maxSize[e6] = t3.stops[0].size, o4.offset[e6] = o4.minSize[e6], o4.factor[e6] = 0, o4.type[e6] = 1, true;
    if (n(r4)) return o4.minSize[e6] = r4, o4.maxSize[e6] = r4, o4.offset[e6] = r4, o4.factor[e6] = 0, o4.type[e6] = 1, true;
  }
...
function Y(t3, s2) {
  const r4 = new X(t3);
  return r4.vvSize && (r4.vvSymbolAnchor = s2.anchor, o2(st), F(s2.rotation[2], s2.rotation[0], s2.rotation[1], st), r4.vvSymbolRotationMatrix = r4.vvSymbolRotationMatrix || e2(), n2(r4.vvSymbolRotationMatrix, st)), r4;
}
function Z(t3, o4, e6) {
...
//# sourceMappingURL=chunk-6JS2RWIT.js.map
