...
function x2(e6, o4, s4) {
  ...
  c10.origin = u3(n3(), c10.origin, u9);
}
function v(e6, t4, r4) {
...
async function m6(e6, o4, n6) {
  const { source: i6 } = o4, { loadGLTFMesh: a9 } = await p(import("./loadGLTFMesh-6KOAFPCW.js"), n6), l5 = await p4(i6, n6);
  s2(n6);
...
function G2(t4, e6, r4) {
  ...
  c10.scale = O2(n3(), q3), f(q3, q3, z2(K, c10.scale));
  const z5 = c10.rotationAxis;
  c10.rotation = d(q3), 0 === c10.rotationAngle && (c10.rotationAxis = z5), c10.translation = I(n3(), q3);
}
function H(t4, r4, o4) {
...
function z4(e6, s4, f8) {
  ...
  x6.scale = O2(n3(), z5), f(z5, z5, z2(T2, x6.scale));
  const L2 = x6.rotationAxis;
  x6.rotation = d(z5), 0 === x6.rotationAngle && (x6.rotationAxis = L2), x6.translation = I(n3(), z5);
}
function L(e6, t4, r4) {
...
var Y2 = Q3 = class extends l2(p2(m3(c))) {
  ...
  async toBinaryGLTF(e6) {
    const [{ toBinaryGLTF: t4 }] = await Promise.all([import("./gltfexport-SEAZLVVV.js"), this.load(e6)]);
  ...
  static async createFromGLTF(e6, t4, r4) {
    ...
    const { loadGLTFMesh: o4 } = await p(import("./loadGLTFMesh-6KOAFPCW.js"), r4);
...
//# sourceMappingURL=chunk-VSFBGVBQ.js.map
