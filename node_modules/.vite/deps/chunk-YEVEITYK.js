...
function i5(i7) {
  ...
  -1 === r8 && (r8 = t[1]), r8 = u2(r8), n5 = u2(n5), o9 = u2(o9);
...
var w = class extends o4 {
  ...
  _writePlacedMarkers(s9, n5) {
    ...
    if (!o9) return;
    const a8 = -1, c4 = e2.getPlacement(o9, a8, this.evaluatedMeshParams.placement, u2(1), s9.id);
    if (!c4) return;
...
var T3 = class extends C2 {
  ...
  _writePoly(s9, i7, n5) {
    ...
    if (null == h6) return;
    const { _currentWrite: l8, _tessellationOptions: m3 } = this, { baseSize: u7, capType: c4, joinType: d4, miterLimit: f6 } = this.evaluatedMeshParams, p3 = u2(0.5 * u7);
...
var F2 = class extends E {
  ...
  _placeStraightAlong(e4, i7, n5, a8) {
    ...
    if (l8.metricStart(this._createLineLabelMetric(c4, n5, a8, e4.x, e4.y)), x4) {
      const n6 = Math.max(i7, m3[0], 0), a9 = Math.min(_2, m3[1]), f7 = M(n2(), -e4.angle), g4 = { minZoom: n6, maxZoom: a9, clipAngle: p3, mapAligned: true, isLineLabel: true }, _6 = u2(this.evaluatedMeshParams.offsetX), x5 = u2(this.evaluatedMeshParams.offsetY);
      if (!this._verticalPlacement || this._verticalPlacement === this._current.offsetDirection) {
  ...
  _placeFirst(e4, i7, s9, a8, l8 = false) {
    const { out: c4, id: h6, shaping: m3, zoomRange: u7, referenceBounds: f6 } = this._current, g3 = m3.glyphs, _5 = u2(this.evaluatedMeshParams.offsetX), p3 = u2(this.evaluatedMeshParams.offsetY), b2 = r2(_5, p3), x4 = M(n2(), -e4.angle);
    S(b2, b2, x4);
    for (const t of g3) {
  ...
  _placeOnSegment(e4, i7, s9, a8, l8, c4, h6) {
    const { out: m3, id: u7, shaping: f6, referenceBounds: g3 } = this._current, _5 = f6.glyphs, p3 = e4.dx / e4.length, b2 = e4.dy / e4.length, x4 = { x: e4.x + s9 * -l8 * p3, y: e4.y + s9 * -l8 * b2 }, M3 = u2(this.evaluatedMeshParams.offsetX), P2 = u2(this.evaluatedMeshParams.offsetY), y3 = r2(M3, P2), w2 = M(n2(), -e4.angle);
    S(y3, y3, w2);
    for (const t of _5) {
...
function $(e4, t, i7) {
  ...
  for (let u7 = 0; u7 < s9.length; u7++) {
    ...
    for (let s10 = 0; s10 < t2; s10++) {
      ...
      s10 > 0 ? o2(o9, r8[u8], r8[u8 + 1]) : o2(o9, 0, 0), o2(n5, r8[x4], r8[x4 + 1]), s10 < t2 - 1 ? o2(d4, r8[v4], r8[v4 + 1]) : o2(d4, 0, 0), 0 === s10 ? o2(f6, 0, 0) : (B(f6, n5, o9), v(f6, f6), o2(f6, f6[1], -f6[0])), s10 === t2 - 1 ? o2(g3, 0, 0) : (B(g3, d4, n5), v(g3, g3), o2(g3, g3[1], -g3[0])), u(_5, f6, g3), v(_5, _5);
...
//# sourceMappingURL=chunk-YEVEITYK.js.map
