...
var n6;
function r() {
  assetPathChanged || setAssetPath2(_(n4(n6)));
}
function c2(t6) {
  const o5 = [];
...
var A = (_a = class extends m3(l) {
  ...
  _postInitialize() {
    ...
    this.addHandles([b(e7), l2(() => this.uiStrings, e7)]), this.addHandles(f2(() => this.container, (e8) => {
...
//# sourceMappingURL=chunk-MWKD63FN.js.map
