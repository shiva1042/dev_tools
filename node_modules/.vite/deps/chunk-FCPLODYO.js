import {
  ...
  l as l2,
  m as m3
} from "./chunk-UB5IRX4O.js";
import {
  m as m2
} from "./chunk-XMAZIR6D.js";
import {
  a as a3,
  c,
  p
...
__decorate([m({ type: String, json: { write: true } })], p2.prototype, "name", void 0), __decorate([m({ type: String, json: { write: true } })], p2.prototype, "title", void 0), __decorate([m({ type: String, json: { write: true } })], p2.prototype, "expression", void 0), __decorate([m({ type: ["string", "number"], json: { write: true } })], p2.prototype, "returnType", void 0), p2 = s2 = __decorate([a2("esri.popup.ExpressionInfo")], p2);
var i3 = p2;
...
var c2 = new o2({ asc: "ascending", desc: "descending" });
...
__decorate([m({ type: String, json: { write: true } })], p5.prototype, "title", void 0), __decorate([m({ type: String, json: { write: true } })], p5.prototype, "expression", void 0), __decorate([m({ type: ["dictionary"], readOnly: true, json: { read: false, write: true } })], p5.prototype, "returnType", void 0), p5 = s4 = __decorate([a2("esri.popup.ElementExpressionInfo")], p5);
var i7 = p5;
...
__decorate([m({ type: ["bar-chart", "column-chart", "line-chart", "pie-chart"], readOnly: true, json: { read: false, write: true } })], p10.prototype, "type", void 0), __decorate([m({ type: c4, json: { write: { isRequired: true } } })], p10.prototype, "value", void 0), p10 = __decorate([a2("esri.popup.content.mixins.ChartMediaInfo")], p10);
var i10 = p10;
...
__decorate([m({ type: ["column-chart"], readOnly: true, json: { type: ["columnchart"], read: false, write: { writer: c5.write, isRequired: true } } })], p12.prototype, "type", void 0), p12 = i12 = __decorate([a2("esri.popup.content.ColumnChartMediaInfo")], p12);
var a6 = p12;

// node_modules/@arcgis/core/popup/content/support/ImageMediaInfoValue.js
var s6;
var p13 = s6 = class extends n {
  constructor(o4) {
...
__decorate([m({ type: String, json: { write: true } })], p13.prototype, "linkURL", void 0), __decorate([m({ type: String, json: { write: { isRequired: true } } })], p13.prototype, "sourceURL", void 0), p13 = s6 = __decorate([a2("esri.popup.content.support.ImageMediaInfoValue")], p13);
var i13 = p13;
...
__decorate([m({ type: ["line-chart"], readOnly: true, json: { type: ["linechart"], read: false, write: { writer: c5.write, isRequired: true } } })], p15.prototype, "type", void 0), p15 = i15 = __decorate([a2("esri.popup.content.LineChartMediaInfo")], p15);
var a8 = p15;
...
__decorate([m({ type: ["pie-chart"], readOnly: true, json: { type: ["piechart"], read: false, write: { writer: c5.write, isRequired: true } } })], p16.prototype, "type", void 0), p16 = i16 = __decorate([a2("esri.popup.content.PieChartMediaInfo")], p16);
var a9 = p16;

// node_modules/@arcgis/core/popup/content/support/mediaInfoTypes.js
var m4 = { base: i9, key: "type", defaultKeyValue: "image", typeMap: { "bar-chart": p11, "column-chart": a6, "line-chart": a8, "pie-chart": a9, image: a7 } };
...
var u2 = l5 = class extends p3 {
  ...
  readMediaInfos(t2) {
    return t2 && t2.map((t3) => "image" === t3.type ? a7.fromJSON(t3) : "barchart" === t3.type ? p11.fromJSON(t3) : "columnchart" === t3.type ? a6.fromJSON(t3) : "linechart" === t3.type ? a8.fromJSON(t3) : "piechart" === t3.type ? a9.fromJSON(t3) : void 0).filter(Boolean);
  }
...
__decorate([m({ type: String, json: { write: true } })], p17.prototype, "field", void 0), __decorate([m({ type: ["asc", "desc"], json: { write: true } })], p17.prototype, "order", void 0), p17 = s7 = __decorate([a2("esri.popup.support.RelatedRecordsInfoFieldOrder")], p17);
var i17 = p17;
...
__decorate([m({ type: String, json: { write: true } })], p18.prototype, "text", void 0), __decorate([m({ type: ["text"], readOnly: true, json: { read: false, write: { isRequired: true } } })], p18.prototype, "type", void 0), p18 = s8 = __decorate([a2("esri.popup.content.TextContent")], p18);
var i18 = p18;
...
var a11 = { base: null, key: "type", typeMap: { attachment: n2, media: I, text: i18, expression: i8, field: l3, relationship: l6, utilityNetworkAssociations: a10 } };
var c8 = { base: null, key: "type", typeMap: { attachment: n2, media: I, text: i18, expression: i8, field: l3, relationship: l6 } };

// node_modules/@arcgis/core/popup/LayerOptions.js
var e;
var p19 = e = class extends n {
  constructor(o4) {
...
__decorate([m({ type: Boolean, json: { write: true } })], p19.prototype, "returnTopmostRaster", void 0), __decorate([m({ type: Boolean, json: { write: true } })], p19.prototype, "showNoDataRecords", void 0), p19 = e = __decorate([a2("esri.popup.LayerOptions")], p19);
var a12 = p19;
...
var P = { base: p3, key: "type", typeMap: { media: I, custom: c3, text: i18, attachments: n2, fields: l3, expression: i8, relationship: l6, utilityNetworkAssociations: a10 } };
...
var U = class extends l(n) {
  ...
  _readPopupInfo({ description: t2, mediaInfos: e2, showAttachments: o4, relatedRecordsInfo: s9 = { showRelatedRecords: false } }) {
    const i21 = [];
    t2 ? i21.push(new i18({ text: t2 })) : i21.push(new l3()), Array.isArray(e2) && e2.length && i21.push(I.fromJSON({ mediaInfos: e2 })), o4 && i21.push(n2.fromJSON({ displayType: "auto" }));
...
__decorate([m({ type: M })], U.prototype, "actions", void 0), __decorate([m()], U.prototype, "content", void 0), __decorate([s("content")], U.prototype, "castContent", null), __decorate([o("content", ["description", "fieldInfos", "popupElements", "mediaInfos", "showAttachments", "relatedRecordsInfo"])], U.prototype, "readContent", null), __decorate([r("web-scene", "content", { popupElements: { type: O.ofType(c8) }, showAttachments: { type: Boolean }, mediaInfos: { type: O.ofType(m4) }, description: { type: String }, relatedRecordsInfo: { type: i20 } })], U.prototype, "writeWebSceneContent", null), __decorate([r("content", { popupElements: { type: O.ofType(a11) }, showAttachments: { type: Boolean }, mediaInfos: { type: O.ofType(m4) }, description: { type: String }, relatedRecordsInfo: { type: i20 } })], U.prototype, "writeWebMapContent", null), __decorate([m({ type: [i3], json: { write: true } })], U.prototype, "expressionInfos", void 0), __decorate([m({ type: [f] })], U.prototype, "fieldInfos", void 0), __decorate([r("fieldInfos")], U.prototype, "writeFieldInfos", null), __decorate([m({ type: a12 })], U.prototype, "layerOptions", void 0), __decorate([r("layerOptions")], U.prototype, "writeLayerOptions", null), __decorate([m({ type: Boolean, json: { read: { source: "showLastEditInfo" }, write: { target: "showLastEditInfo" }, default: true } })], U.prototype, "lastEditInfoEnabled", void 0), __decorate([m()], U.prototype, "outFields", void 0), __decorate([m()], U.prototype, "overwriteActions", void 0), __decorate([m()], U.prototype, "returnGeometry", void 0), __decorate([m({ json: { type: String } })], U.prototype, "title", void 0), __decorate([r("title")], U.prototype, "writeTitle", null), U = __decorate([a2("esri.PopupTemplate")], U);
var q = U;

// node_modules/@arcgis/core/graphic/getPopupProvider.js
var n7 = /* @__PURE__ */ Symbol("popupProvider");
function o3(n8) {
...
//# sourceMappingURL=chunk-FCPLODYO.js.map
