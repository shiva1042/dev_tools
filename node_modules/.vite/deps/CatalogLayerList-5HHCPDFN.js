...
var p = class extends l {
  ...
  initialize() {
    this.addHandles([l2(() => [this.catalogLayer?.loaded, this.view?.ready], () => this._compileList(), h), a2(() => this.catalogLayer?.dynamicGroupLayer.layers, "change", () => this._compileList()), l2(() => [this.listItemCreatedFunction, this.checkPublishStatusEnabled, this.listModeDisabled], () => this._recompileList())]);
  }
  destroy() {
  ...
  _watchLayersListMode(t3) {
    this.removeHandles(m2.layerListMode), t3 && !this.listModeDisabled && this.addHandles(l2(() => t3.filter((t4) => "listMode" in t4).map((t4) => t4.listMode).toArray(), () => this._compileList()), m2.layerListMode);
  }
  _compileList() {
    ...
    s5?.length ? (this._createNewItems(s5), this._removeItems(s5), this._sortItems(s5)) : this._removeAllItems();
  }
  _createNewItems(t3) {
  ...
  _removeItems(t3) {
    ...
    e5.forEach((e6) => {
      e6 && t3?.includes(e6.layer) || s5.push(e6);
    }), e5.destroyMany(s5);
  }
  _sortItems(t3) {
    const { catalogItems: e5 } = this;
...
__decorate([m({ type: h2 })], p.prototype, "catalogItems", void 0), __decorate([m()], p.prototype, "checkPublishStatusEnabled", void 0), __decorate([m()], p.prototype, "catalogLayer", void 0), __decorate([m()], p.prototype, "listItemCreatedFunction", void 0), __decorate([m({ nonNullable: true })], p.prototype, "listModeDisabled", void 0), __decorate([m({ readOnly: true })], p.prototype, "state", null), __decorate([m()], p.prototype, "totalItems", null), __decorate([m()], p.prototype, "view", void 0), p = __decorate([a("esri.widgets.CatalogLayerList.CatalogLayerListViewModel")], p);
...
var P = M = class extends s2(B) {
  ...
  initialize() {
    this.addHandles([a2(() => this.openedLayers, "change", () => this._handleOpenedLayersChange(), h), a2(() => this.viewModel.catalogItems, "change", () => s3(this.selectedItems), h), l2(() => [this.filterPredicate, this._rootListEl], () => f(this._rootListEl, this.filterPredicate))]);
  }
  loadDependencies() {
  ...
  render() {
    const e5 = this.viewModel?.state, t3 = { [e2.hidden]: "loading" === e5, [e2.disabled]: "disabled" === e5 };
  ...
  _renderItems() {
    ...
    }, "data-layer-type": s5, displayMode: T, filterEnabled: i3, filterPlaceholder: c2, filterProps: t, filterText: i3 ? d : "", group: s5, key: "root-list", label: h3.widgetLabel, onmouseleave: this._clearActiveItem, onmouseover: this._setActiveItem, selectionAppearance: "border", selectionMode: p2, onCalciteListChange: (e6) => this._handleCalciteListChange(e6), onCalciteListFilter: (e6) => this.filterText = e6.currentTarget?.filterText ?? "" }, o.toArray().map((e6) => this._renderItem(e6)), i3 ? n("div", { class: e4.filterNoResults, slot: "filter-no-results" }, n("calcite-notice", { kind: "info", open: true, width: "full" }, this._renderNoItemsMessage())) : null)), this._renderPanelFlowItems(), this._renderedOpenLayerFlowItems];
  ...
  async _createTableList(e5) {
    const { default: t3 } = await import("./TableList-TIGPSHQ3.js"), { headingLevel: o, selectionMode: i3 } = this;
    return new t3({ headingLevel: o, selectionMode: i3, ...this._getTableListParams(e5) });
  }
  _renderItem(e5, t3, o) {
    return n(C, { activeItem: this._activeItem, css: e4, displayMode: T, dragEnabled: false, item: e5, key: `layerListItem-${e5.layer?.uid}`, layerTablesEnabled: this.layerTablesEnabled, listModeDisabled: this.viewModel.listModeDisabled, messages: this.messages, messagesCommon: this.messagesCommon, parent: t3, parentTitles: o, rootGroupUid: this._rootGroupUid, selectedItems: this.selectedItems, selectionMode: this.selectionMode, visibilityAppearance: this.visibilityAppearance, visibleElements: this.visibleElements, onAction: this._onTriggerAction, onCatalogOpen: this._onCatalogOpen, onPanelOpen: this._onPanelOpen, onTablesOpen: this._onTablesOpen, onTooltipReferenceChange: this._onTooltipReferenceChange });
  }
...
__decorate([m()], P.prototype, "_rootListEl", void 0), __decorate([m()], P.prototype, "_activeItem", void 0), __decorate([m()], P.prototype, "_tooltipReferenceMap", void 0), __decorate([m()], P.prototype, "_focusRootFlowItem", void 0), __decorate([m()], P.prototype, "_focusPanelFlowItem", void 0), __decorate([m()], P.prototype, "_focusLayerFlowItem", void 0), __decorate([m()], P.prototype, "_layerListMap", void 0), __decorate([m()], P.prototype, "_filterEnabled", null), __decorate([m()], P.prototype, "_visibleItems", null), __decorate([m()], P.prototype, "_openedPanelItems", null), __decorate([m()], P.prototype, "_renderedOpenLayerFlowItems", null), __decorate([m()], P.prototype, "catalogItems", null), __decorate([m()], P.prototype, "catalogLayer", null), __decorate([m({ readOnly: true })], P.prototype, "catalogLayerList", void 0), __decorate([m()], P.prototype, "catalogOptions", void 0), __decorate([m()], P.prototype, "collapsed", void 0), __decorate([m()], P.prototype, "filterPlaceholder", void 0), __decorate([m()], P.prototype, "filterPredicate", void 0), __decorate([m()], P.prototype, "filterText", void 0), __decorate([m()], P.prototype, "headingLevel", void 0), __decorate([m()], P.prototype, "icon", null), __decorate([m()], P.prototype, "knowledgeGraphOptions", void 0), __decorate([m()], P.prototype, "label", null), __decorate([m()], P.prototype, "layerTablesEnabled", void 0), __decorate([m()], P.prototype, "listItemCreatedFunction", null), __decorate([m()], P.prototype, "mapImageOptions", void 0), __decorate([m(), e("esri/widgets/CatalogLayerList/t9n/CatalogLayerList")], P.prototype, "messages", void 0), __decorate([m(), e("esri/t9n/common")], P.prototype, "messagesCommon", void 0), __decorate([m()], P.prototype, "minFilterItems", void 0), __decorate([m({ readOnly: true })], P.prototype, "openedLayers", void 0), __decorate([m({ readOnly: true })], P.prototype, "openedLayerLists", void 0), __decorate([m()], P.prototype, "onCatalogOpen", void 0), __decorate([m()], P.prototype, "onTablesOpen", void 0), __decorate([m({ type: O2 })], P.prototype, "selectedItems", void 0), __decorate([m()], P.prototype, "selectionMode", void 0), __decorate([m({ readOnly: true })], P.prototype, "tableList", void 0), __decorate([m()], P.prototype, "tileOptions", void 0), __decorate([m()], P.prototype, "view", null), __decorate([e3("trigger-action"), m({ type: p })], P.prototype, "viewModel", void 0), __decorate([m()], P.prototype, "visibilityAppearance", void 0), __decorate([m({ type: s4, nonNullable: true })], P.prototype, "visibleElements", void 0), P = M = __decorate([a("esri.widgets.CatalogLayerList")], P);
var A = P;
export {
  A as default
};
//# sourceMappingURL=CatalogLayerList-5HHCPDFN.js.map
