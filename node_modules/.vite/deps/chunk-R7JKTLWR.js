import {
  y as y2
} from "./chunk-YX3DDUDC.js";
import {
  a as a4,
  s as s3
} from "./chunk-BGIJBZPU.js";
import {
  m as m2
...
var x = (_a = class extends a3(u2) {
  ...
  async _loadLayersFromJSON(e, r2, t) {
    const s4 = this.resourceInfo?.context, a5 = this.portalItem?.portal || s4?.portal || null, o = O2[s4?.origin || ""] ?? "web-map", { populateOperationalLayers: i2 } = await import("./layersCreator-ULS6PZAC.js"), n3 = [];
...
//# sourceMappingURL=chunk-R7JKTLWR.js.map
