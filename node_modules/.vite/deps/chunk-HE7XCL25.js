...
var b = I = (_a = class extends a3(u2) {
  ...
  async queryElevation(r4, e2) {
    ...
    const { queryAll: o3 } = await import("./ElevationQuery-KSU62Q6W.js");
    s2(e2);
    return o3(this.layers.filter(A).toArray(), r4, e2);
  }
  async createElevationSampler(r4, e2) {
    await this.load({ signal: e2?.signal });
    const { createSampler: o3 } = await import("./ElevationQuery-KSU62Q6W.js");
    s2(e2);
    return o3(this.layers.filter(A).toArray(), r4, e2);
  }
  clone() {
  ...
  async _loadLayersFromJSON(r4, e2, o3) {
    const t3 = e2?.origin || "web-scene", s4 = e2?.portal || null, a5 = e2?.url || null, { populateOperationalLayers: i4 } = await import("./layersCreator-RNVRO7SQ.js");
    s2(o3);
    const n8 = [];
...
var d2 = class extends a3(f2) {
  constructor(e2) {
    super(e2), this.id = `focusarea-${n()}`, this.title = null, this.enabled = true, this.outline = null, this.geometries = new l5();
  }
...
//# sourceMappingURL=chunk-HE7XCL25.js.map
