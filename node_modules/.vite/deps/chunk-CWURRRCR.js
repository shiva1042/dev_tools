...
async function v(e) {
  ...
  const s3 = a.spatialReference, l3 = n ? g2.fromJSON(n) : oe(s3), m2 = s3 && (c(s3) || C(s3)) ? a : await f2(s3, N2).then(() => g(a, N2)), f3 = await import("./geodesicBufferOperator-FSV35NJV.js");
  await f3.load();
...
//# sourceMappingURL=chunk-CWURRRCR.js.map
