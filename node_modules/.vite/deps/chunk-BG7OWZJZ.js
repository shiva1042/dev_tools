...
var s = class {
  ...
  destroy() {
    this.clear(), Y.prune(), B.prune(), w.prune(), j.prune();
  }
  all(t2) {
    r3(this._data, t2);
  }
  ...
  clear() {
    return this._data = new y([]), this;
  }
  remove(i) {
    if (!i) return this;
    let e, h = this._data, s2 = null, a2 = 0, r4 = false;
    const o2 = this._toBBox(i);
    for (w.clear(), j.clear(); h || w.length > 0; ) {
      if (h || (h = w.pop(), s2 = w.data[w.length - 1], a2 = j.pop() ?? 0, r4 = true), h.leaf && (e = S(h.children, r(i), h.children.length, h.indexHint), -1 !== e)) return h.children.splice(e, 1), w.push(h), this._condense(w), this;
      r4 || h.leaf || !g(h, o2) ? s2 ? (a2++, h = s2.children[a2], r4 = false) : h = null : (w.push(h), j.push(a2), a2 = 0, s2 = h, h = h.children[0]);
    }
    return this;
  }
  toJSON() {
  ...
  _insert(t2, i, n) {
    ...
    w.clear();
    const s2 = a(h, this._data, i, w);
    for (s2.children.push(t2), m(s2, h); i >= 0 && w.data[i].children.length > this._maxEntries; ) this._split(w, i), i--;
    o(h, w, i);
  }
  _split(t2, i) {
    ...
    if (!s2) return;
    const a2 = n.children.splice(s2, n.children.length - s2), r4 = n.leaf ? new y(a2) : new F(a2);
    r4.height = n.height, l(n, this._toBBox), l(r4, this._toBBox), i ? t2.data[i - 1].children.push(r4) : this._splitRoot(n, r4);
  }
  _splitRoot(t2, i) {
    this._data = new F([t2, i]), this._data.height = t2.height + 1, l(this._data, this._toBBox);
  }
  ...
  _condense(i) {
    for (let n = i.length - 1; n >= 0; n--) {
      ...
      if (0 === e.children.length) if (n > 0) {
        ...
        s2.splice(S(s2, e, s2.length, h.indexHint), 1);
      } else this.clear();
...
function c(t2, i, n, e, h) {
  h || (h = new y([])), h.minX = 1 / 0, h.minY = 1 / 0, h.maxX = -1 / 0, h.maxY = -1 / 0;
...
function E() {
  Y.prune(), B.prune(), w.prune(), j.prune();
}
var b2 = class {
  constructor() {
...
var S2 = class extends b2 {
  constructor() {
    super(...arguments), this.height = 1, this.indexHint = new b();
  }
};
var y = class extends S2 {
  constructor(t2) {
...
//# sourceMappingURL=chunk-BG7OWZJZ.js.map
