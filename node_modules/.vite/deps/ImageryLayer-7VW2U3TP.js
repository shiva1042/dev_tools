...
import {
  ...
  n4 as n3,
  s as s7
} from "./chunk-KR62HYQ7.js";
import {
  l2 as l7,
  u as u3
} from "./chunk-ZDTRFVPR.js";
import {
  c as c2
} from "./chunk-67NO6EMD.js";
import "./chunk-7B7HLH5D.js";
...
import {
  s as s8
} from "./chunk-Z7AK2QMV.js";
import {
  l as l9
} from "./chunk-BAYY2B7B.js";
import "./chunk-FO4YKS4Y.js";
import {
  j
} from "./chunk-PVMT4MKF.js";
import "./chunk-LMKIEPJ7.js";
import {
  f as f4
} from "./chunk-3X7N4DRP.js";
import {
  b2 as b,
  d,
  l as l4,
  ...
  w,
  y
} from "./chunk-ZCW7R5GD.js";
import {
  l as l3
} from "./chunk-UCLEZH57.js";
...
import {
  p
} from "./chunk-TWELSXNH.js";
import {
  t
} from "./chunk-DAUO4TR7.js";
...
__decorate([m2({ type: Number, json: { write: true } })], i9.prototype, "area", void 0), __decorate([m2({ types: l5, json: { name: "shape", write: true } })], i9.prototype, "geometry", void 0), __decorate([o2("geometry")], i9.prototype, "readGeometry", null), i9 = __decorate([a3("esri.rest.support.ImageBoundaryResult")], i9);
...
__decorate([m2({ types: l5, json: { name: "Shape", read: f3, write: true } })], i11.prototype, "geometry", void 0), __decorate([m2({ json: { name: "Length", write: true } })], i11.prototype, "length", void 0), __decorate([m2({ json: { name: "Area", write: true } })], i11.prototype, "area", void 0), __decorate([m2({ type: _, json: { name: "Center", write: true } })], i11.prototype, "center", void 0), __decorate([o2("center")], i11.prototype, "readCenter", null), i11 = __decorate([a3("esri.rest.support.MeasureAreaFromImageResult")], i11);
...
__decorate([m2({ types: l5, json: { name: "fromGeometry", read: f3, write: true } })], y9.prototype, "geometry", void 0), __decorate([r("geometry")], y9.prototype, "writeGeometry", null), __decorate([m2({ json: { write: true } })], y9.prototype, "rasterId", void 0), y9 = c12 = __decorate([a3("esri.rest.support.MeasureFromImageParameters")], y9);
...
__decorate([m2({ types: l5, json: { name: "Shape", read: f3, write: true } })], m10.prototype, "geometry", void 0), __decorate([m2({ json: { name: "Length", write: true } })], m10.prototype, "length", void 0), m10 = __decorate([a3("esri.rest.support.MeasureLengthFromImageResult")], m10);
...
async function k(r3, o6, a10) {
  ...
  const p19 = f5(r3), u9 = u({ ...p19.query, f: "json", ...s13 }), c13 = s5(u9, a10), { data: f11 } = await H(`${p19.path}/calculateVolume`, c13);
...
async function z2(o6, a10, s13) {
  ...
  const u9 = f5(o6), l16 = u({ ...u9.query, f: "json", ...p19 }), g4 = s5(l16, s13), { data: y10 } = await H(`${u9.path}/computeAngles`, g4);
...
async function E2(r3, o6, a10) {
  ...
  const u9 = f5(r3), c13 = u({ ...u9.query, f: "json", ...s13 }), f11 = s5(c13, a10), { data: l16 } = await H(`${u9.path}/computePixelLocation`, f11);
...
async function Q(r3, o6, s13) {
  ...
  const f11 = f5(r3), l16 = u({ ...f11.query, f: "json", ...p19 }), g4 = s5(l16, s13), { data: y10 } = await H(`${f11.path}/getSamples`, g4), j4 = y10.samples.map((t6) => {
...
async function W2(r3, o6, s13) {
  ...
  return P2(u9).then((e5) => {
    ...
    const n11 = u({ ...p19.query, f: "json", ...r4 }), u10 = s5(n11, s13);
...
async function et(e5, r3, o6, s13) {
  ...
  const f11 = u({ ...p19.query, f: "json", ...c13 }), l16 = s5(f11, s13), { data: g4 } = await H(p19.path + "/measure", l16);
  return g4;
}
...
async function at(r3, o6, a10) {
  o6 = m(y9, o6);
  const s13 = f5(r3), p19 = o6.toJSON(), u9 = u({ ...s13.query, f: "json", ...p19 }), c13 = s5(u9, a10), { data: f11 } = await H(s13.path + "/measureFromImage", c13);
  return f11;
}
function st(t6) {
  const e5 = t6.toJSON();
...
async function it(r3, o6, a10) {
  ...
  const u9 = u({ ...s13.query, f: "json", ...p19 }), c13 = s5(u9, a10), { data: f11 } = await H(s13.path + "/queryBoundary", c13);
...
async function pt(r3, o6, s13) {
  ...
  f11 && (p19.inSR = mt(f11));
  const l16 = f5(r3), g4 = u({ ...l16.query, f: "json", ...p19 }), y10 = s5(g4, s13), { data: j4 } = await H(`${l16.path}/queryGPSInfo`, y10);
...
async function ut(r3, a10, s13) {
  ...
  const u9 = f5(r3), c13 = u({ ...u9.query, f: "json", ...p19 }), f11 = s5(c13, s13), { data: l16 } = await H(`${u9.path}/imageToMap`, f11);
  return f3(l16);
}
async function ct(r3, a10, s13) {
  const p19 = (a10 = m(l15, a10)).toJSON();
  a10.rasterIds?.length && (p19.rasterIds = a10.rasterIds.join(","));
  const u9 = f5(r3), c13 = u({ ...u9.query, f: "json", ...p19 }), f11 = s5(c13, s13), { data: l16 } = await H(`${u9.path}/imageToMapMultiray`, f11);
  return f3(l16);
}
async function ft(r3, s13, p19) {
  ...
  l16 && (u9.inSR = mt(l16));
  const g4 = f5(r3), y10 = u({ ...g4.query, f: "json", ...u9 }), j4 = s5(y10, p19), { data: d8 } = await H(`${g4.path}/mapToImage`, j4);
  return f3(d8);
}
async function lt(r3, o6, a10) {
  const s13 = (o6 = m(p17, o6)).toJSON(), p19 = f5(r3), u9 = u({ ...p19.query, f: "json", ...s13 }), c13 = s5(u9, a10), { data: f11 } = await H(`${p19.path}/getImageUrl`, c13);
...
async function gt(r3, o6, s13) {
  ...
  const l16 = f5(r3), g4 = u({ ...l16.query, f: "json", ...c13 }), y10 = s5(g4, s13), { data: j4 } = await H(`${l16.path}/find`, y10);
...
async function n10(n11, m11, p19) {
  const f11 = f5(n11), u9 = u({ ...f11?.query, f: "json" }), h3 = s5(u9, p19), d8 = `${f11?.path}/${m11}/info`, c13 = H(`${d8}`, h3), g4 = H(`${d8}/keyProperties`, h3), x3 = await Promise.allSettled([c13, g4]), y10 = "fulfilled" === x3[0].status ? x3[0].value.data : null, v4 = "fulfilled" === x3[1].status ? x3[1].value.data : null;
  let P4 = null;
  y10.statistics?.length && (P4 = y10.statistics.map((e5) => ({ min: e5[0], max: e5[1], avg: e5[2], stddev: e5[3] })));
  const S2 = z.fromJSON(y10.extent), j4 = Math.ceil(S2.width / y10.pixelSizeX - 0.1), w3 = Math.ceil(S2.height / y10.pixelSizeY - 0.1), b7 = S2.spatialReference, k2 = new _({ x: y10.pixelSizeX, y: y10.pixelSizeY, spatialReference: b7 }), z3 = y10.histograms?.length ? y10.histograms : null, L3 = new l6({ origin: y10.origin, blockWidth: y10.blockWidth, blockHeight: y10.blockHeight, firstPyramidLevel: y10.firstPyramidLevel, maximumPyramidLevel: y10.maxPyramidLevel });
  ...
  let He2 = class extends h3 {
    ...
    async internalFetchImage(e5, t6, i12, r3 = {}) {
      ...
      if (n11 && (s13.requestRawData = false), null == a10) {
        ...
        for (let e6 = 0; e6 < a11; e6++) u10.push(c2.createEmptyBand(l17, o7));
        return { pixelData: { pixelBlock: new c2({ width: t6, height: i12, pixels: u10, mask: new Uint8Array(o7), pixelType: l17 }), extent: e5 } };
      }
    ...
    async queryRasters(e5, t6) {
      ...
      const i12 = await s10(this.url, e5, t6), r3 = this.graphicOrigin;
      return i12.features.forEach((e6) => {
        e6.layer = this, e6.origin = r3;
      }), i12;
    }
    async queryObjectIds(e5, t6) {
      return { query: e5, requestOptions: t6 } = await this._prepareForQuery(e5, t6), i4(this.url, e5, t6);
    }
    ...
    async queryRasterCount(e5, t6) {
      return { query: e5, requestOptions: t6 } = await this._prepareForQuery(e5, t6), s9(this.url, e5, t6);
    }
    async queryVisibleRasters(e5, t6) {
      ...
      try {
        ...
        const m13 = this.objectIdField || "ObjectId", h5 = i13.catalogItems?.features ?? [], g5 = h5.map((e6) => e6.attributes?.[m13]), y11 = new b2({ objectIds: g5, returnGeometry: true, outSpatialReference: e5.outSpatialReference, outFields: [m13] }), R4 = await this.queryRasters(y11);
    ...
    _combineMosaicRuleWithTimeExtent(e5, t6) {
      ...
      if (a10.length) a10.forEach((e6) => {
        ...
        }) : e5.multidimensionalDefinition.push(new p2({ variableName: "", dimensionName: n11, isSlice: u9, values: p19 }));
      }
    ...
    async _prepareForQuery(e5, t6) {
      ...
      return e5 = null != e5 ? m(b2, e5) : this.createQuery(), t6 = this._getRequestOptions(t6), this.raster && (t6.query = { ...t6.query, raster: this.raster }), { query: e5, requestOptions: t6 };
    }
    ...
    _configRenderer(e5) {
      ...
      if (!t6 && !this.pixelFilter || this._isVectorDataSet()) {
        const t7 = this.mosaicRule?.multidimensionalDefinition?.[0].variableName, r3 = q({ variableName: t7, rasterFunctionName: this.rasterFunction?.functionName, presetRenderers: this.presetRenderers });
    ...
    _updateFeatureWithMagDirValues(e5, t6) {
      ...
      const i12 = t6.split(/,\s*/).map((e6) => parseFloat(e6)), r3 = i12.map((e6) => [e6]), s13 = i12.map((e6) => ({ minValue: e6, maxValue: e6, noDataValue: null })), n11 = new c2({ height: 1, width: 1, pixelType: "f32", pixels: r3, statistics: s13 });
      null != this.pixelFilter && this.pixelFilter({ pixelBlock: n11, extent: new z(0, 0, 0, 0, this.spatialReference) });
      const a10 = "esriImageServiceDataTypeVector-MagDir" === this.serviceDataType ? [n11.pixels[0][0], n11.pixels[1][0]] : l7([n11.pixels[0][0], n11.pixels[1][0]]);
...
var $3 = class extends p(l9(t(b(j(o5(He(i7(f4(s8(l8(l3(l2(b5))))))))))))) {
  constructor(...e5) {
    super(...e5), this.graphicOrigin = new s11(this), this.isReference = null, this.operationalLayerType = "ArcGISImageServiceLayer", this.popupEnabled = true, this.popupTemplate = null, this.screenSizePerspectiveEnabled = true, this.type = "imagery", this._debouncedSaveOperations = L(async (e6, r3, t6) => {
      const { save: o6, saveAs: i12 } = await import("./imageryUtils-L53KMLTU.js");
      switch (e6) {
        case 0:
          return o6(this, r3);
        case 1:
  ...
  createPopupTemplate(e5) {
    ...
    const p19 = d2({ fields: r3, title: this.title }, { ...e5, visibleFieldNames: t6 }), { rasterInfo: n11 } = this;
    return p19?.fieldInfos && n11 && b3(p19.fieldInfos, n11), p19;
  }
  queryFeatures(e5, r3) {
  ...
  _validateElevationInfo(e5) {
    j2(i.getLogger(this), $("Imagery layers", "relative-to-scene", e5)), j2(i.getLogger(this), R2("Imagery layers", e5));
  }
};
__decorate([m2({ type: c, value: null, json: { name: "layerDefinition.elevationInfo", write: true, origins: { "portal-item": { read: false, write: false }, "web-map": { read: false, write: false } } } })], $3.prototype, "elevationInfo", null), __decorate([m2({ readOnly: true, clonable: false })], $3.prototype, "graphicOrigin", void 0), __decorate([m2(d)], $3.prototype, "legendEnabled", null), __decorate([m2({ type: ["show", "hide"] })], $3.prototype, "listMode", null), __decorate([m2({ type: Boolean, json: { read: false, write: { enabled: true, overridePolicy: () => ({ enabled: false }) } } })], $3.prototype, "isReference", void 0), __decorate([m2({ type: ["ArcGISImageServiceLayer"], json: { origins: { "web-map": { type: ["ArcGISImageServiceLayer", "ArcGISImageServiceVectorLayer"], read: false, write: { target: "layerType", ignoreOrigin: true } } } } })], $3.prototype, "operationalLayerType", void 0), __decorate([r("web-map", "operationalLayerType")], $3.prototype, "writeOperationalLayerType", null), __decorate([m2(l4)], $3.prototype, "popupEnabled", void 0), __decorate([m2({ type: q2, json: { read: { source: "popupInfo" }, write: { target: "popupInfo" } } })], $3.prototype, "popupTemplate", void 0), __decorate([m2({ readOnly: true })], $3.prototype, "defaultPopupTemplate", null), __decorate([m2(s3)], $3.prototype, "screenSizePerspectiveEnabled", void 0), __decorate([m2({ readOnly: true, json: { read: false } })], $3.prototype, "type", void 0), __decorate([m2({ readOnly: true })], $3.prototype, "_isPreviewLayer", null), $3 = __decorate([a3("esri.layers.ImageryLayer")], $3);
var F2 = $3;
export {
  F2 as default
};
//# sourceMappingURL=ImageryLayer-7VW2U3TP.js.map
