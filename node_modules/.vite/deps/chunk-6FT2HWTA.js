...
async function s3(s4) {
  const r = import("./mask-svg-AMY64RYU.js"), i = import("./overlay-svg-ML3JVPEI.js"), o = t((await r).default, { signal: s4 }), e = t((await i).default, { signal: s4 }), m = { mask: await o, overlay: await e };
  return s(s4), m;
}
...
//# sourceMappingURL=chunk-6FT2HWTA.js.map
