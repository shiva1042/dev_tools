...
function B2(B3) {
  "async" === B3.mode && (B3.functions.disjoint = function(n2, t2) {
    ...
    return B3.standardFunctionAsync(n2, t2, (r2, o3, s) => {
      if (s = Je(s), oe(s, 3, 3, n2, t2), s[0] instanceof c && s[1] instanceof c) return a("relate", [s[0].toJSON(), s[1].toJSON(), ge(s[2])]);
      if (s[0] instanceof c && null === s[1]) return false;
      if (s[1] instanceof c && null === s[0]) return false;
    ...
    return B3.standardFunctionAsync(n2, t2, async (i, o3, s) => {
      if (0 === (s = Je(s)).length) throw new n(n2, "WrongNumberOfParameters", t2);
      const c2 = [];
      if (1 === s.length) if (o2(s[0])) {
        for (const r2 of Je(s[0])) if (null !== r2) {
          if (!(r2 instanceof c)) throw new n(n2, "InvalidParameter", t2);
          c2.push(r2.toJSON());
        }
      } else {
        if (!te(s[0])) {
          if (s[0] instanceof c) return De(o(s[0]), n2.spatialReference);
          if (null === s[0]) return null;
          throw new n(n2, "InvalidParameter", t2);
        }
        for (const r2 of Je(s[0].toArray())) if (null !== r2) {
          if (!(r2 instanceof c)) throw new n(n2, "InvalidParameter", t2);
          c2.push(r2.toJSON());
        }
      }
      else for (const r2 of s) if (null !== r2) {
        if (!(r2 instanceof c)) throw new n(n2, "InvalidParameter", t2);
        c2.push(r2.toJSON());
      }
    ...
    return B3.standardFunctionAsync(n2, t2, async (r2, o3, s) => {
      if (s = Je(s), oe(s, 2, 2, n2, t2), !(s[1] instanceof z) && null !== s[1]) throw new n(n2, "InvalidParameter", t2);
      if (null === s[0]) return null;
      if (!(s[0] instanceof c)) throw new n(n2, "InvalidParameter", t2);
      return null === s[1] ? null : f(await a("clip", [s[0].toJSON(), s[1].toJSON()]));
    });
  }, B3.functions.cut = function(n2, t2) {
    return B3.standardFunctionAsync(n2, t2, async (o3, s, c2) => {
    ...
    return B3.standardFunctionAsync(n2, t2, async (r2, o3, s) => {
      if (oe(s, 1, 2, n2, t2), s = Je(s), B(s[0])) {
        const r3 = await s[0].sumArea(z4(s[1]), null, n2.abortSignal);
        if (n2.abortSignal.aborted) throw new n(n2, "Cancelled", t2);
        return r3;
      }
      let c2 = s[0];
      if ((o2(c2) || te(c2)) && (c2 = Re(s[0], n2.spatialReference)), null === c2) return 0;
      if (!(c2 instanceof c)) throw new n(n2, "InvalidParameter", t2);
      return a("area", [c2.toJSON(), z4(s[1])]);
    });
    ...
    return B3.standardFunctionAsync(n2, t2, async (r2, o3, s) => {
      if (oe(s, 1, 2, n2, t2), s = Je(s), B(s[0])) {
        const r3 = await s[0].sumLength(z4(s[1]), null, n2.abortSignal);
        if (n2.abortSignal.aborted) throw new n(n2, "Cancelled", t2);
        return r3;
      }
      let c2 = s[0];
      if ((o2(s[0]) || te(s[0])) && (c2 = ve(s[0], n2.spatialReference)), null === c2) return 0;
      if (!(c2 instanceof c)) throw new n(n2, "InvalidParameter", t2);
      return a("length", [c2.toJSON(), z4(s[1])]);
    });
  }, B3.functions.length3d = function(n2, t2) {
    return B3.standardFunctionAsync(n2, t2, async (r2, o3, s) => {
      if (oe(s, 1, 2, n2, t2), null === (s = Je(s))[0]) return 0;
      let c2 = s[0];
      if ((o2(s[0]) || te(s[0])) && (c2 = ve(s[0], n2.spatialReference)), null === c2) return 0;
      if (!(c2 instanceof c)) throw new n(n2, "InvalidParameter", t2);
      if (true === c2.hasZ) {
        const { convertFromSpatialReferenceUnit: n3, toLengthUnit: t3 } = await import("./unitConversion-BXBFJY5G.js"), e = x(c2);
        return n3(c2.spatialReference, t3(s[1]), e);
      }
      return a("length", [c2.toJSON(), z4(s[1])]);
    });
    ...
    return B3.standardFunctionAsync(n2, t2, async (r2, o3, s) => {
      oe(s, 1, 3, n2, t2);
      let c2 = (s = Je(s))[0];
      (o2(s[0]) || te(s[0])) && (c2 = ve(s[0], n2.spatialReference));
      const l2 = z4(s[1]), f2 = D(s[2]);
      if (B(c2)) {
    ...
    return B3.standardFunctionAsync(n2, t2, async (r2, o3, s) => {
      s = Je(s), oe(s, 2, 3, n2, t2);
      let c2 = s[0];
      if ((o2(s[0]) || te(s[0])) && (c2 = Pe(s[0], n2.spatialReference)), !(c2 instanceof c)) throw new n(n2, "InvalidParameter", t2);
      let l2 = s[1];
      if ((o2(s[1]) || te(s[1])) && (l2 = Pe(s[1], n2.spatialReference)), !(l2 instanceof c)) throw new n(n2, "InvalidParameter", t2);
      return a("distance", [c2.toJSON(), l2.toJSON(), z4(s[2])]);
    });
  }, B3.functions.distancegeodetic = function(n2, t2) {
    return B3.standardFunctionAsync(n2, t2, async (r2, o3, s) => {
      s = Je(s), oe(s, 2, 4, n2, t2);
      const c2 = s[0];
      ...
      return u.addPath([c2, l2]), a("geodeticLength", [u.toJSON(), z4(s[2]), D(s[3])]);
    });
  }, B3.functions.densify = function(n2, t2) {
    return B3.standardFunctionAsync(n2, t2, async (r2, o3, s) => {
      if (s = Je(s), oe(s, 2, 3, n2, t2), null === s[0]) return null;
      if (!(s[0] instanceof c)) throw new n(n2, "InvalidParameter", t2);
      const c2 = Se(s[1]);
      ...
      switch (s[0].type) {
        ...
        case "polyline":
        case "extent":
          return f(await a("densify", [s[0].toJSON(), c2, z4(s[2])]));
        default:
          return s[0];
      }
    });
    ...
    return B3.standardFunctionAsync(n2, t2, async (r2, o3, s) => {
      if (s = Je(s), oe(s, 2, 4, n2, t2), null === s[0]) return null;
      if (!(s[0] instanceof c)) throw new n(n2, "InvalidParameter", t2);
      const c2 = Se(s[1]);
      if (isNaN(c2)) throw new n(n2, "InvalidParameter", t2);
      const l2 = Ae(z2(s[2], true));
      return f(await a("generalize", [s[0].toJSON(), c2, z4(s[3]), { removeDegenerateParts: l2 }]));
    });
    ...
    return B3.standardFunctionAsync(n2, t2, async (r2, o3, s) => {
      if (s = Je(s), oe(s, 2, 3, n2, t2), null === s[0]) return null;
      if (!(s[0] instanceof c)) throw new n(n2, "InvalidParameter", t2);
      const c2 = s[0] instanceof z ? P.fromExtent(s[0]) : s[0], l2 = Se(s[1]);
      if (isNaN(l2)) throw new n(n2, "InvalidParameter", t2);
      const u = z2(s[2], null);
      if (null === u) {
    ...
    return B3.standardFunctionAsync(n2, t2, async (r2, o3, s) => {
      if (s = Je(s), oe(s, 1, 2, n2, t2), null === s[0]) return null;
      const c2 = O(s[1]);
      let l2 = s[0];
      if ((o2(s[0]) || te(s[0])) && (l2 = "geometric" === c2 ? Pe(s[0], n2.spatialReference) : Re(s[0], n2.spatialReference), null === l2)) return null;
    ...
    return B3.standardFunctionAsync(n2, t2, (r2, o3, s) => {
      if (s = Je(s), oe(s, 1, 1, n2, t2), null === s[0]) return true;
      if (!(s[0] instanceof c)) throw new n(n2, "InvalidParameter", t2);
      return a("isSimple", [s[0].toJSON()]);
    });
  }, B3.functions.simplify = function(n2, t2) {
    return B3.standardFunctionAsync(n2, t2, async (r2, o3, s) => {
      if (s = Je(s), oe(s, 1, 1, n2, t2), null === s[0]) return null;
      if (!(s[0] instanceof c)) throw new n(n2, "InvalidParameter", t2);
      return f(await a("simplify", [s[0].toJSON()]));
    });
  }, B3.functions.convexhull = function(n2, t2) {
    return B3.standardFunctionAsync(n2, t2, async (r2, o3, s) => {
      if (s = Je(s), oe(s, 1, 1, n2, t2), null === s[0]) return null;
      if (!(s[0] instanceof c)) throw new n(n2, "InvalidParameter", t2);
      return f(await a("convexHull", [s[0].toJSON()]));
    });
  }, B3.functions.getuser = function(r2, a2) {
    return B3.standardFunctionAsync(r2, a2, async (o3, s, c2) => {
      oe(c2, 0, 2, r2, a2);
    ...
    return B3.standardFunctionAsync(n2, r2, async (o3, s, c2) => {
...
//# sourceMappingURL=chunk-7C67TT6O.js.map
