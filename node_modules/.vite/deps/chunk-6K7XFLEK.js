...
function d3(d4, u) {
  ...
  const v = d4.vertex;
  f(v, u), d(v, u), v.uniforms.add(new e2("viewport", (e3) => e3.camera.fullViewport), new r2("polygonOffset", (e3) => e3.shaderPolygonOffset), new r("cameraGroundRelative", (e3) => e3.camera.aboveGround ? 1 : -1)), u.hasVerticalOffset && d2(v), v.code.add(t`struct ProjectHUDAux {
vec3 posModel;
vec3 posView;
vec3 vnormal;
...
//# sourceMappingURL=chunk-6K7XFLEK.js.map
