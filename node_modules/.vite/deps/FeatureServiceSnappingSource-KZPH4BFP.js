import {
  d as d3
} from "./chunk-MHCIVVK7.js";
import {
  i as i2,
  o as o3
} from "./chunk-YCWSPVHC.js";
import "./chunk-XMXVRCJG.js";
import {
  Z,
  at,
  z as z2
...
var O = class extends b {
  ...
  get configuration() {
    ...
    return this._layerView && "effectiveDisplayFilter" in this._layerView && (s2.where = l3(s2.where, this._layerView.effectiveDisplayFilter?.where)), { filter: s2, customParameters: t3 ? { ...i3, token: t3 } : i3, viewType: r2 };
  }
  get availability() {
  ...
  _getOrLoadWhereFields(e5, t3) {
    ...
    if (!this._loadWhereModuleTask && !r2) {
      const e6 = d(async () => {
        const e7 = await import("./WhereClause-ECEI5BLV.js");
...
//# sourceMappingURL=FeatureServiceSnappingSource-KZPH4BFP.js.map
