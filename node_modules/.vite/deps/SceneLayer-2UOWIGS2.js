...
import {
  l as l6
} from "./chunk-ARLAB4P4.js";
import {
  j as j4
} from "./chunk-QAWFJWPR.js";
...
import {
  t as t2
} from "./chunk-HRN6QX3J.js";
import "./chunk-2FOY3FIB.js";
import {
  p as p2,
  s as s6
} from "./chunk-CHCJTWHM.js";
import {
  s as s7
} from "./chunk-TDBRXJHW.js";
import "./chunk-JW6DU3OK.js";
import {
  i as i3
} from "./chunk-PAPM4QPC.js";
import {
  n as n5,
  r as r2
...
var Te = class extends a7(F(_3(l3(b2(j2(t(l(s5(o3(l2(b3))))))))))) {
  ...
  async applyEdits(e3, t6) {
    const { applyEdits: r3 } = await import("./editingSupport-GFHNRMKO.js");
    let i6 = t6;
    await this.load();
  ...
  async convertMesh(e3, t6) {
    ...
    const n8 = this.spatialReference, p6 = t6.origin ?? t6.location, d5 = await H2(p6 ?? t6.defaultOrigin ?? new _({ x: 0, y: 0, z: 0, spatialReference: n8 }), n8, t6), y3 = d5.spatialReference.isGeographic ? "local" : "georeferenced", { default: u5 } = await import("./Mesh-B4HHH5IA.js");
    s2(t6);
...
//# sourceMappingURL=SceneLayer-2UOWIGS2.js.map
