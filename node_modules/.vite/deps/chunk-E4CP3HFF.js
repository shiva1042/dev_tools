...
var h2 = class _h extends b4 {
  ...
  static registerAction() {
    b4._featuresetFunctions.filter = function(e3) {
  ...
  evaluateNodeToWhereClause(e3, t4, r4 = null, s5 = null, a4) {
    ...
    switch (e3.type) {
      ...
      case "parameter": {
        ...
        if (m2(r5)) return A2(r5, t4);
        if (d(r5)) return E(r5, t4);
        if (a2(r5)) return y(r5, t4);
        if (f2(r5)) return T(r5, t4);
        if (Array.isArray(r5)) {
          const e4 = [];
          for (let s6 = 0; s6 < r5.length; s6++) "string" == typeof r5[s6] ? e4.push("'" + r5[s6].toString().replaceAll("'", "''") + "'") : c2(r5[s6]) || m2(r5[s6]) ? e4.push(A2(r5[s6], t4)) : d(r5[s6]) ? e4.push(E(r5[s6], t4)) : a2(r5[s6]) ? e4.push(y(r5[s6], t4)) : f2(r5[s6]) ? e4.push(T(r5[s6], t4)) : e4.push(r5[s6].toString());
          return e4;
        }
        return r5.toString();
      }
...
var b5 = class extends b4 {
  ...
  _reformulateWithoutAdaptions(e3) {
    ...
    if (null !== e3) {
      for (const r4 of this.adaptedFields) if (true === b3(e3, r4.field.name)) {
...
var i3 = class _i extends b4 {
  ...
  static registerAction() {
    b4._featuresetFunctions.orderBy = function(e3) {
...
var T2 = class _T extends b4 {
  ...
  async _getFilteredSet(e3, t4, i5, s5, n5) {
    ...
    if (await this._ensureLoaded(), null !== i5) {
      for (let r4 = 0; r4 < this._decodedStatsfield.length; r4++) if (true === b3(i5, this._decodedStatsfield[r4].tofieldname)) {
  ...
  static registerAction() {
    b4._featuresetFunctions.groupby = function(e3, t4) {
...
var s4 = class _s extends b4 {
  ...
  static registerAction() {
    b4._featuresetFunctions.top = function(t4) {
...
var y2 = class _y extends b4 {
  ...
  static create(e3, t4) {
    ...
    const d3 = [];
    for (const n5 of e3.layerDefinition.fields) n5 instanceof m ? d3.push(n5) : d3.push(m.fromJSON(n5));
    let p6 = a4;
    switch (p6 || (p6 = ""), p6) {
...
var j = class extends e {
  ...
  async featureSetByName(e3, t4 = true, a4 = null) {
    if (m3(this._map) && !this._map.loaded) return await this._map.load(), this.featureSetByName(e3, t4, a4);
  ...
  async featureSetById(e3, t4 = true, a4 = ["*"]) {
    if (m3(this._map) && !this._map.loaded) return await this._map.load(), this.featureSetById(e3, t4, a4);
    null === a4 && (a4 = ["*"]), a4 = (a4 = a4.slice()).sort();
    const r4 = JSON.stringify(a4);
    for (let l3 = 0; l3 < this._instantLayers.length; l3++) {
      const a5 = this._instantLayers[l3];
...
async function q(e3, t4, a4, r4, n5, l3, s5) {
  ...
  if ("Feature Service" === e3.type || "Map Service" === e3.type) i5 = await g(I(e3.url ?? "") + "/" + t4, ["*"], l3);
    ...
    } else i5 = await b2.fromPortalItem(e3);
  }
...
//# sourceMappingURL=chunk-E4CP3HFF.js.map
