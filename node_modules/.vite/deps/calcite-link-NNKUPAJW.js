...
// node_modules/@esri/calcite-components/dist/components/calcite-link/customElement.js
...
var _Link = class _Link extends LitElement {
  constructor() {
    super();
  ...
  render() {
    ...
    return InteractiveContainer({ disabled: this.disabled, children: html2`<${DynamicHtmlTag} class=${safeClassMap({ [CSS_UTILITY.rtl]: dir === "rtl" })} download=${(childElType === "a" ? download === true || download === "" ? "" : download || null : null) ?? nothing} href=${(childElType === "a" && this.href) ?? nothing} @click=${this.childElClickHandler} rel=${(childElType === "a" && this.rel) ?? nothing} tabindex=${tabIndex} target=${(childElType === "a" && this.target) ?? nothing} ${ref(
      this.childRef
...
_Link.properties = { disabled: [7, {}, { reflect: true, type: Boolean }], download: [3, { converter: stringOrBoolean }, { reflect: true }], href: [3, {}, { reflect: true }], iconEnd: [3, {}, { reflect: true }], iconFlipRtl: [3, {}, { reflect: true }], iconStart: [3, {}, { reflect: true }], rel: 1, target: 1 };
_Link.styles = styles;
var Link = _Link;
...
//# sourceMappingURL=calcite-link-NNKUPAJW.js.map
