...
function C(s, o2) {
  const i2 = s.advancedQueryCapabilities, a2 = s.ownershipBasedAccessControlForFeatures, c2 = s.archivingInfo, d3 = s.currentVersion, l2 = o2?.includes("MapServer"), y2 = !l2 || d3 >= has("mapserver-pbf-version-support"), m2 = g(o2), g3 = new Set((s.supportedQueryFormats ?? "").split(",").map((t2) => t2.toLowerCase().trim()));
...
//# sourceMappingURL=chunk-2UJKX5LD.js.map
