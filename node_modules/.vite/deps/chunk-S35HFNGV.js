...
async function o(o2) {
  const a2 = "portalItem" in o2 ? o2 : { portalItem: o2 }, { fromItem: e } = await import("./portalLayers-PEE4HBHR.js");
  try {
    return await e(a2);
  } catch (p) {
...
var b = class extends n(s3(u)) {
  ...
  static async fromArcGISServerUrl(t) {
    ...
    return (await import("./arcgisLayers-KYIBJ7HB.js")).fromUrl(e);
  }
...
//# sourceMappingURL=chunk-S35HFNGV.js.map
