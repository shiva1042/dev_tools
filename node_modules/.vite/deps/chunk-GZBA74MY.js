...
function A3(t2) {
  return x(jt, A2(0, 0, 0, E(t2).radius));
}
var b = 2 ** 50;
function g() {
...
function O(n4, o3, r2, i3) {
  return o3 !== i3 && n2(i3, o3), o(q, i3[12], i3[13], i3[14]), G(n4, q, r2, q), i3[12] = q[0], i3[13] = q[1], i3[14] = q[2], i3;
}
function T(t2, e, n4) {
  return t2.operations.elevate(t2.value, e, n4.value);
}
var q = n();
function w(t2, e, n4, o3, r2) {
  return r2[0] = P(t2, e), r2[1] = P(t2, n4), r2[2] = P(t2, o3), r2;
}
function z(t2, e, i3, u2, a2) {
  s(i3, t2), s(D, e), A(D, D), _(u2, D, i3), _(a2, u2, i3);
}
function B(t2, e) {
  return t2 ? a(e) : e.isGeographic ? f.PlateCarree : e;
}
var D = n();
...
var v = class _v {
  ...
  basisMatrixAtPosition(t2, e) {
    const o3 = this.worldBasisAtPosition(t2, 0, c.get()), i3 = this.worldBasisAtPosition(t2, 1, c.get()), s2 = this.worldBasisAtPosition(t2, 2, c.get());
    return r(e, o3[0], o3[1], o3[2], 0, i3[0], i3[1], i3[2], 0, s2[0], s2[1], s2[2], 0, 0, 0, 0, 1), e;
  }
  headingAtPosition(e, o3) {
    const r2 = this.worldUpAtPosition(e, c.get()), i3 = this.worldBasisAtPosition(e, 1, c.get()), s2 = u(o3, i3, r2);
    return M(s2);
  }
...
//# sourceMappingURL=chunk-GZBA74MY.js.map
