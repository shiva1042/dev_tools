...
function i3(i4, t4) {
  const { vertex: s3, fragment: p } = i4;
  i4.include(i2, t4), s3.include(l), s3.main.add(t2`vec4 posProjCenter;
...
function F(e8) {
  const i4 = new s2(), { signedDistanceFieldEnabled: F2, occlusionTestEnabled: M2, horizonCullingEnabled: U2, pixelSnappingEnabled: H2, hasScreenSizePerspective: E, debugDrawLabelBorder: _, hasVVSize: q, hasVVColor: R, hasRotation: k, occludedFragmentFade: I, sampleSignedDistanceFieldTexelCenter: G } = e8;
  i4.include(d3, e8), i4.vertex.include(m, e8);
  const { occlusionPass: J, output: K, oitPass: N } = e8;
  if (J) return i4.include(i3, e8), i4;
  const { vertex: Q, fragment: W } = i4;
  i4.include(s), i4.include(u, e8), i4.include(d, e8), M2 && i4.include(n3), W.include(e6), i4.varyings.add("vcolor", "vec4"), i4.varyings.add("vtc", "vec2"), i4.varyings.add("vsize", "vec2");
  const X = 9 === K, Y = X && M2;
  Y && i4.varyings.add("voccluded", "float"), Q.uniforms.add(new e5("viewport", (e9) => e9.camera.fullViewport), new e4("screenOffset", (e9, i5) => o(L, 2 * e9.screenOffset[0] * i5.camera.pixelRatio, 2 * e9.screenOffset[1] * i5.camera.pixelRatio)), new e4("anchorPosition", (e9) => B(e9)), new e("materialColor", (e9) => e9.color), new r4("materialRotation", (e9) => e9.rotation), new e3("tex", (e9) => e9.texture)), w(Q), F2 && (Q.uniforms.add(new e("outlineColor", (e9) => e9.outlineColor)), W.uniforms.add(new e("outlineColor", (e9) => T(e9) ? e9.outlineColor : a), new r4("outlineSize", (e9) => T(e9) ? e9.outlineSize : 0))), U2 && Q.uniforms.add(new e7("pointDistanceSphere", (e9, o3) => {
    const i5 = o3.camera.eye, r5 = e9.origin;
    return r2(r5[0] - i5[0], r5[1] - i5[1], r5[2] - i5[2], t.radius);
  })), H2 && Q.include(l), E && (t3(Q), i(Q)), _ && i4.varyings.add("debugBorderCoords", "vec4"), i4.attributes.add("uv0", "vec2"), i4.attributes.add("uvi", "vec4"), i4.attributes.add("color", "vec4"), i4.attributes.add("size", "vec2"), i4.attributes.add("rotation", "float"), (q || R) && i4.attributes.add("featureAttribute", "vec4"), Q.code.add(U2 ? t2`bool behindHorizon(vec3 posModel) {
...
posProj = alignToPixelOrigin(posProj, viewport.zw);
  ...
  switch (K) {
    case 0:
    case 1:
      i4.outputs.add("fragColor", "vec4", 0), 1 === K && i4.outputs.add("fragEmission", "vec4", 1), 1 === N && i4.outputs.add("fragAlpha", "float", 1 === K ? 2 : 1), W.main.add(t2`
        ${ie}
    ...
    case 10:
      ...
      break;
    case 9:
      i4.include(d2, e8), W.main.add(t2`
        ${ie}
...
function M(e8, i4, r5) {
  o(r5, e8[0] * (i4[2] - i4[0]) + i4[0], e8[1] * (i4[3] - i4[1]) + i4[1]);
}
var L = n();
var U = 32e3;
var V = t2.float(U);
...
//# sourceMappingURL=chunk-DP6DGSVJ.js.map
