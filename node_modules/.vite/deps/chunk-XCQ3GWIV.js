...
function u2(t2, r, e3 = null) {
  return null != e3 ? [t2, r, e3] : [t2, r];
}
function w(t2, r, e3 = null) {
  return null != e3 ? { x: t2, y: r, z: e3 } : { x: t2, y: r };
}
var g2 = class {
  constructor(t2) {
...
var R2 = class extends g2 {
  constructor(t2, a, o = null) {
    super(a), this._defaultZ = o, this.transform = e2(), this.transformInv = e2(), this.transform = t(t2), u(this.transformInv, this.transform);
  }
  makeMapPoint(t2, r) {
...
var v = class extends g2 {
  constructor(t2, r) {
    ...
    const s = n();
    g(s, this.tangentFrameForwardWS, P(e3, this.tangentFrameForwardWS)), c(this.localFrameRightWS, e3, s), A(this.localFrameRightWS, this.localFrameRightWS), _2(this.localFrameUpWS, this.tangentFrameForwardWS, this.localFrameRightWS), R(this.worldToLocalTransform, this.localFrameRightWS, this.tangentFrameRightWS), L(this.localToWorldTransform, this.worldToLocalTransform);
  }
  get doUnnormalization() {
  ...
  mapToLocal(t2) {
    ...
    const e3 = this.view.renderCoordsHelper.fromRenderCoords(r, new _({ spatialReference: this.view.spatialReference }));
  ...
  localToMap(t2) {
    ...
    const e3 = this.view.renderCoordsHelper.fromRenderCoords(r, new _({ spatialReference: this.view.spatialReference }));
    return null != e3 ? u2(e3.x, e3.y, this.defaultZ) : null;
  }
};
function W(t2, r) {
  if ("2d" === t2.type) return new R2(t2.state.transform, t2.spatialReference, r.length > 2 ? r[2] : null);
  if ("3d" === t2.type) {
    const e3 = r.length > 2 ? new _({ x: r[0], y: r[1], z: r[2], spatialReference: t2.spatialReference }) : new _({ x: r[0], y: r[1], spatialReference: t2.spatialReference });
    return new v(t2, e3);
  }
  return null;
}
...
//# sourceMappingURL=chunk-XCQ3GWIV.js.map
