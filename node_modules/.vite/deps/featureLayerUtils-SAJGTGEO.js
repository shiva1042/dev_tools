...
async function H(e) {
  ...
  e.forEach(({ type: e2 }) => {
    switch (l(e2)) {
      case "CatalogLayer":
        r.push(import("./CatalogLayer-NPUCHUKJ.js").then((e3) => e3.default));
        break;
      case "FeatureLayer":
        r.push(import("./@arcgis_core_layers_FeatureLayer.js").then((e3) => e3.default));
        break;
      case "OrientedImageryLayer":
        r.push(import("./OrientedImageryLayer-7QQX3YWO.js").then((e3) => e3.default));
    }
  });
...
//# sourceMappingURL=featureLayerUtils-SAJGTGEO.js.map
