...
var m4 = class extends X {
  ...
  async _updateClipGeometry() {
    ...
    if (e2 && "inside" === t3.clippingType) {
      const { extent: t4 } = this.rasterInfo, r5 = await import("./densifyOperator-Y2SRRBFC.js"), s4 = await import("./differenceOperator-VE5MUQBJ.js");
    ...
    async _getSampleLocations(e2) {
      ...
      if ("polyline" === r5) {
        ...
        if (e2.sampleCount || e2.sampleDistance) {
          const i6 = await import("./densifyOperator-Y2SRRBFC.js"), s5 = (await import("./lengthOperator-RQDPXZ5P.js")).execute(t3, { unit: "meters" }), n5 = Math.min(e2.sampleCount || 100, Q3);
...
//# sourceMappingURL=chunk-HYNH2VXK.js.map
