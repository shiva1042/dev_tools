...
async function m6(e6, o4, n6) {
  const { source: i6 } = o4, { loadGLTFMesh: a9 } = await p(import("./loadGLTFMesh-BCMRL4D2.js"), n6), l5 = await p4(i6, n6);
  s2(n6);
  const u9 = a9(new _2({ x: 0, y: 0, z: 0, spatialReference: e6.spatialReference }), l5.url, { resolveFile: f6(l5), signal: n6?.signal, expectedType: l5.type, unitConversionDisabled: o4.unitConversionDisabled });
...
function G2(t4, e6, r4) {
  t4.transform ??= new d2();
  const { vertexSpace: l5, transform: c10, spatialReference: f8 } = t4, [u9, x6, h5] = l5.origin, R3 = new _2({ x: u9, y: x6, z: h5, spatialReference: f8 }), d5 = K;
  if (R3.equals(r4)) o2(d5, 0, 0, 0);
  else if (!P3(d5, r4, t4)) return void k(O4(), r4.spatialReference, f8, b);
  b2(Z, w2(e6), z3(e6));
  const S2 = D(N2, Z, a4, _, d5), { localMatrix: U2 } = c10, q3 = c2(N2, S2, U2);
...
function z4(e6, s4, f8) {
  e6.transform ??= new d2();
  const { vertexSpace: u9, transform: x6, spatialReference: h5 } = e6, [A5, d5, y3] = u9.origin, w5 = new _2({ x: A5, y: d5, z: y3, spatialReference: h5 }), F3 = T2;
...
var Y2 = Q3 = class extends l2(p2(m3(c))) {
  ...
  get origin() {
    ...
    return new _2({ x: t4.x, y: t4.y, z: r4, spatialReference: this.spatialReference });
  }
  get extent() {
  ...
  async toBinaryGLTF(e6) {
    const [{ toBinaryGLTF: t4 }] = await Promise.all([import("./gltfexport-EB4TZXVQ.js"), this.load(e6)]);
  ...
  static createBox(e6, t4) {
    if (!(e6 instanceof _2)) return i.getLogger(this.prototype).error(".createBox()", s3), null;
    const r4 = new Q3(x5(c9(), e6, t4));
    return t4?.imageFace && "all" !== t4.imageFace ? f7(r4, t4.imageFace) : r4;
  }
  static createSphere(e6, t4) {
    return e6 instanceof _2 ? new Q3(x5(u8(t4?.densificationFactor || 0), e6, t4)) : (i.getLogger(this.prototype).error(".createSphere()", s3), null);
  }
  static createCylinder(e6, t4) {
    return e6 instanceof _2 ? new Q3(x5(h4(t4?.densificationFactor || 0), e6, t4)) : (i.getLogger(this.prototype).error(".createCylinder()", s3), null);
  }
  static createPlane(e6, t4) {
    if (!(e6 instanceof _2)) return i.getLogger(this.prototype).error(".createPlane()", s3), null;
  ...
  static async createFromGLTF(e6, t4, r4) {
    ...
    const { loadGLTFMesh: o4 } = await p(import("./loadGLTFMesh-BCMRL4D2.js"), r4);
...
__decorate([m2({ type: [h], json: { write: true } })], Y2.prototype, "components", void 0), __decorate([m2({ nonNullable: true, types: X2, constructOnly: true, json: { write: true }, clonable: (e6, t4) => n4(t4)?.vertexSpace ?? e6.clone(t4) })], Y2.prototype, "vertexSpace", void 0), __decorate([m2({ type: d2, clonable: (e6, t4) => {
  const r4 = n4(t4);
  return r4 && "transform" in r4 ? r4.transform : e6?.clone() ?? e6;
}, json: { write: true } })], Y2.prototype, "transform", void 0), __decorate([m2({ constructOnly: true, type: a8, clonable: (e6, t4) => n4(t4)?.metadata ?? e6.clone() })], Y2.prototype, "metadata", void 0), __decorate([m2()], Y2.prototype, "hasExtent", null), __decorate([m2()], Y2.prototype, "_transformedExtent", null), __decorate([m2()], Y2.prototype, "_untransformedBounds", null), __decorate([m2()], Y2.prototype, "origin", null), __decorate([m2({ readOnly: true, json: { read: false } })], Y2.prototype, "extent", null), __decorate([m2({ readOnly: true, json: { read: false, write: true, default: true } })], Y2.prototype, "hasZ", void 0), __decorate([m2({ readOnly: true, json: { read: false, write: true, default: false } })], Y2.prototype, "hasM", void 0), __decorate([m2({ type: c7, nonNullable: true, json: { write: true }, clonable: (e6, t4) => n4(t4)?.vertexAttributes ?? e6.clone(t4) })], Y2.prototype, "vertexAttributes", void 0), Y2 = Q3 = __decorate([a2("esri.geometry.Mesh")], Y2);
var $ = j();
...
//# sourceMappingURL=chunk-SSFCMBJE.js.map
