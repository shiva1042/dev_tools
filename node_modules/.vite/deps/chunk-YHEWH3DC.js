...
function x() {
  const x2 = new s();
  x2.include(o), x2.fragment.uniforms.add(new e("edgesTexture", (e2) => e2.inputTexture), new e("areaTexture", (e2) => e2.areaTexture), new e("searchTexture", (e2) => e2.searchTexture)), x2.fragment.constants.add("smaaAreaTexPixelSize", "vec2", [1 / 160, 1 / 560]);
  const d2 = 1 / 7;
  return x2.fragment.code.add(t`
    ...
    vec2 getArea(sampler2D areaTex, vec2 dist, float e1, float e2, float offset) {
      vec2 texcoord = float(${t.int(c)}) * round(4.0 * vec2(e1, e2)) + dist;
      texcoord = smaaAreaTexPixelSize * texcoord + (0.5 * smaaAreaTexPixelSize);
      texcoord.y += ${t.float(d2)} * offset;
      return texture(areaTex, texcoord).rg;
    }`), x2.fragment.main.add(t`
    ...
    vec4 maxOffset = vec4(offsets[0].xz, offsets[1].yw) + vec4(-2.0, 2.0, -2.0, 2.0) * resolution.xxyy * float(${t.int(s2)});
...
//# sourceMappingURL=chunk-YHEWH3DC.js.map
