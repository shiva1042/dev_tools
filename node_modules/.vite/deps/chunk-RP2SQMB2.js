...
async function C(e2) {
  const { computeObjectLayerResourceSize: t } = await import("./symbolLayerUtils-ELPHTYUI.js"), r = await t(e2, 10), { width: o, height: n, depth: l } = e2, i2 = [o, l, n];
  let c = 1;
  for (let s = 0; s < 3; s++) {
    const e3 = i2[s];
    if (null != e3) {
...
//# sourceMappingURL=chunk-RP2SQMB2.js.map
