...
var u7 = class extends l2(n) {
  ...
  set colorStops(o6) {
    this._set("colorStops", n3(o6, this._get("colorStops"), O.ofType(l6)));
  }
  set opacityStops(o6) {
    this._set("opacityStops", n3(o6, this._get("opacityStops"), O.ofType(i5)));
  }
  ...
  get rasterizedTransferFunction() {
    ...
    if (0 === this.opacityStops.length) for (const t5 of e3) r4.push({ color: t5.color, position: t5.position });
      ...
      for (const t5 of this.opacityStops) {
        const o8 = r2(t5.position, 0, 1), r5 = Math.round(255 * r2(1 - t5.opacity, 0, 1));
        let i7 = false;
    ...
    for (let c6 = 0; c6 < this._colorMapSize; ++c6) {
      ...
      }), f6.a = r2(1 - o2(a7.a, h2.a, s12) / 255, 0, 1), o6.push(f6);
    }
    return o6;
  }
...
var m6 = p10 = class extends n {
  ...
  set slices(e3) {
    this._set("slices", n3(e3, this._get("slices"), O.ofType(m4)));
  }
  set dynamicSections(e3) {
    this._set("dynamicSections", n3(e3, this._get("dynamicSections"), O.ofType(m5)));
  }
  clone() {
...
var _3 = class extends _2(l3(b2(j(t(l(s5(o4(b3)))))))) {
  ...
  _isPlaneValid(e3, t5, i6) {
    ...
    const o6 = r(e3.normal[0], e3.normal[1], e3.normal[2]);
    A(o6, o6);
    const r4 = 1e-6;
...
//# sourceMappingURL=VoxelLayer-77PZWUSX.js.map
