import {
  ...
  t as t4,
  u as u4
} from "./chunk-HYNH2VXK.js";
import "./chunk-CBZ55526.js";
import {
  c as c4,
  f as f4,
  o as o3
} from "./chunk-K77BIWDD.js";
import {
  N as N3,
  i2 as i5
} from "./chunk-6OE2U2QQ.js";
import {
  C as C2,
  p as p3
...
import {
  ...
  p as p2,
  v as v4
} from "./chunk-34GAODM5.js";
import {
  n as n2,
  u as u3
} from "./chunk-HDUQMOPG.js";
import {
  T,
  w
} from "./chunk-NBUQBISP.js";
import "./chunk-CRKGS5KF.js";
import "./chunk-XCUIOARM.js";
import {
  C,
  G,
  H,
...
var Y2 = class extends p(t(b2(j2(o3(s4(X2(i5(l5(l4(f3(l2(l3(b3))))))))))))) {
  constructor(...e3) {
    super(...e3), this._primaryRasters = [], this.graphicOrigin = new s6(this), this.legendEnabled = true, this.isReference = null, this.listMode = "show", this.sourceJSON = null, this.version = null, this.type = "imagery-tile", this.operationalLayerType = "ArcGISTiledImageServiceLayer", this.popupEnabled = true, this.popupTemplate = null, this.screenSizePerspectiveEnabled = true, this.fields = null, this.source = void 0, this._debouncedSaveOperations = L(async (e4, t7, r6) => {
      const { save: s7, saveAs: i8 } = await import("./imageryUtils-E7IWIF6G.js");
      switch (e4) {
        case 0:
          return s7(this, t7);
        case 1:
...
//# sourceMappingURL=ImageryTileLayer-IS45FY2Y.js.map
