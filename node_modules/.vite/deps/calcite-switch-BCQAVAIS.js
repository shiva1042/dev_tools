...
var _Switch = class _Switch extends LitElement {
  constructor() {
    super();
...
_Switch.properties = { checked: [7, {}, { reflect: true, type: Boolean }], disabled: [7, {}, { reflect: true, type: Boolean }], form: [3, {}, { reflect: true }], label: 1, labelTextEnd: 1, labelTextStart: 1, name: [3, {}, { reflect: true }], scale: [3, {}, { reflect: true }], value: 1 };
_Switch.styles = styles;
var Switch = _Switch;
customElement("calcite-switch", Switch);
export {
  Switch
};
//# sourceMappingURL=calcite-switch-BCQAVAIS.js.map
