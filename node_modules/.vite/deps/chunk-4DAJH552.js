...
function f2(a2, f4) {
  ...
  const { hasScreenSizePerspective: y, spherical: O } = f4;
  y ? (a2.include(s, f4), t3(S), d(S, f4), S.uniforms.add(new t2("inverseViewMatrix", (a3, t4) => h(z, i(z, t4.camera.viewMatrix, a3.origin)))), S.code.add(t`
...
return size;
}`), f4.hasVVSize ? (m.add("sizeFeatureAttribute", "float"), S.uniforms.add(new e2("vvSizeMinSize", (e4) => e4.vvSize.minSize), new e2("vvSizeMaxSize", (e4) => e4.vvSize.maxSize), new e2("vvSizeOffset", (e4) => e4.vvSize.offset), new e2("vvSizeFactor", (e4) => e4.vvSize.factor), new e2("vvSizeFallback", (e4) => e4.vvSize.fallback)), S.code.add(t`
    ...
    `)), f4.hasVVOpacity ? (m.add("opacityFeatureAttribute", "float"), S.constants.add("vvOpacityNumber", "int", 8), S.uniforms.add(new r2("vvOpacityValues", (e4) => e4.vvOpacity.values, u2), new r2("vvOpacityOpacities", (e4) => e4.vvOpacity.opacityValues, u2), new r3("vvOpacityFallback", (e4) => e4.vvOpacity.fallback, { supportsNaN: true })), S.code.add(t`
    ...
    vec4 applyOpacity(vec4 color) {
      if (isnan(opacityFeatureAttribute)) {
        ...
        return ${n(f4.hasVVColor, "color", "vec4(color.rgb, vvOpacityFallback)")};
      }
...
return color;
}`), f4.hasVVColor ? (a2.include(u, f4), m.add("colorFeatureAttribute", "float"), S.code.add(t`vec4 getColor() {
...
var a = 0.25;
function f3(p2, a2) {
  const f4 = f(p2, i2, s2, n2), u3 = new h2(i2);
  return u3.internalFormat = E.R16F, u3.dataType = N.FLOAT, u3.pixelFormat = 6403, u3.wrapMode = 33071, new A(a2, u3, f4);
}
...
//# sourceMappingURL=chunk-4DAJH552.js.map
