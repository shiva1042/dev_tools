...
var m4 = class extends X {
  ...
  async _open(t3) {
    ...
    "Table" === l6?.functionName && (r5.rasterInfo.attributeTable = g2.fromJSON(l6.functionArguments.attributeTableAsRecordSet)), await this.syncJobHandler();
    const p6 = a3[0];
  ...
  async _updateClipGeometry() {
    ...
    if (e2 && "inside" === t3.clippingType) {
      const { extent: t4 } = this.rasterInfo, r5 = await import("./densifyOperator-KY2HJUOU.js"), s4 = await import("./differenceOperator-KYZAO7VK.js");
    ...
    async _getSampleLocations(e2) {
      ...
      if ("polyline" === r5) {
        ...
        if (e2.sampleCount || e2.sampleDistance) {
          const i6 = await import("./densifyOperator-KY2HJUOU.js"), s5 = (await import("./lengthOperator-GUPHTW4V.js")).execute(t3, { unit: "meters" }), n5 = Math.min(e2.sampleCount || 100, Q3);
...
//# sourceMappingURL=chunk-CWY6USYJ.js.map
