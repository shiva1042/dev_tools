...
import {
  h
} from "./chunk-D73FKH63.js";
import {
  c as c7
} from "./chunk-AE4NBBYG.js";
import {
  a as a7,
  c as c6,
  n as n4
...
async function m6(e6, o4, n6) {
  const { source: i6 } = o4, { loadGLTFMesh: a9 } = await p(import("./loadGLTFMesh-KULRZLCH.js"), n6), l5 = await p4(i6, n6);
  s2(n6);
...
var Y2 = Q3 = class extends l2(p2(m3(c))) {
  ...
  async toBinaryGLTF(e6) {
    const [{ toBinaryGLTF: t4 }] = await Promise.all([import("./gltfexport-UTY7KHMK.js"), this.load(e6)]);
  ...
  static async createFromGLTF(e6, t4, r4) {
    ...
    const { loadGLTFMesh: o4 } = await p(import("./loadGLTFMesh-KULRZLCH.js"), r4);
...
//# sourceMappingURL=chunk-V53BKL4R.js.map
