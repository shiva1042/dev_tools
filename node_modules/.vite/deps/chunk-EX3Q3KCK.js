...
var S = class extends b {
  ...
  async featureSetFromJSON(e, t, r) {
    ...
    const { meshFeatureSetFromJSON: s3 } = await p(import("./meshFeatureSet-5RM6CGMV.js"), r);
  ...
  async executeRelationshipQuery(e, t) {
    const [{ default: r }, { executeRelationshipQuery: s3 }] = await p(Promise.all([import("./RelationshipQuery-BEYV3K5K.js"), import("./executeRelationshipQuery-NW76MXKF.js")]), t);
  ...
  async executeRelationshipQueryForCount(e, t) {
    const [{ default: r }, { executeRelationshipQueryForCount: s3 }] = await p(Promise.all([import("./RelationshipQuery-BEYV3K5K.js"), import("./executeRelationshipQuery-NW76MXKF.js")]), t);
    return e = r.from(e), (this.gdbVersion || this.dynamicDataSource) && ((e = e.clone()).gdbVersion = e.gdbVersion || this.gdbVersion, e.dynamicDataSource = e.dynamicDataSource || this.dynamicDataSource), s3(this.url, e, t);
  }
  async executeAttachmentQuery(e, t) {
    const { executeAttachmentQuery: r, fetchAttachments: s3, processAttachmentQueryResult: i2 } = await p(import("./queryAttachments-XAMCWR3U.js"), t), u = f(this.url);
    return i2(u, await (this.queryAttachmentsSupported ? r(u, e, t) : s3(u, e, t)));
  }
  async executeAttributeBinsQuery(e, t) {
    const { executeAttributeBinsQuery: r } = await p(import("./executeAttributeBinsQuery-VABIS64E.js"), t);
    return r(this.parsedUrl, e, t);
  }
  async executePivotQuery(e, t) {
    const { executePivotQuery: r } = await p(import("./executePivotQuery-I2TLOURX.js"), t);
    return r(this.parsedUrl, e, t);
  }
  async executeTopFeaturesQuery(e, t) {
    const { executeTopFeaturesQuery: r } = await p(import("./executeTopFeaturesQuery-LJQ6OHGW.js"), t);
    return r(this.parsedUrl, e, this.sourceSpatialReference, t);
  }
  async executeForTopIds(e, t) {
    const { executeForTopIds: r } = await p(import("./executeForTopIds-SGMI2TJV.js"), t);
    return r(this.parsedUrl, e, t);
  }
  async executeForTopExtents(e, t) {
    const { executeForTopExtents: r } = await p(import("./executeForTopExtents-7OHSYMPG.js"), t);
    return r(this.parsedUrl, e, t);
  }
  async executeForTopCount(e, t) {
    const { executeForTopCount: r } = await p(import("./executeForTopCount-52WR47IT.js"), t);
    return r(this.parsedUrl, e, t);
  }
  _normalizeQuery(e) {
    let t = b2.from(e);
...
//# sourceMappingURL=chunk-EX3Q3KCK.js.map
