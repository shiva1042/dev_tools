...
var g = class extends h {
  ...
  async _queryBuddy(e) {
    const t = new (await import("./@arcgis_core_layers_FeatureLayer.js")).default({ url: e }), { capabilities: r2 } = await t.load(), i3 = r2.query.supportsMaxRecordCountFactor, o3 = r2.query.supportsPagination, s2 = r2.query.supportsCentroid, n = this._config.maxRecordCountFactor, c = t.capabilities.query.maxRecordCount, u = i3 ? c * n : c, h3 = new b();
...
//# sourceMappingURL=chunk-VK3WBGVC.js.map
