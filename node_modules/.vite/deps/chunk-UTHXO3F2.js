...
async function u() {
  if (!s2()) {
    const [e, t] = await Promise.all([import("./OperatorGeodesicBuffer-KPRDURDW.js"), import("./SpatialReference-KY6PQW5P.js").then(({ injectPe: e2 }) => e2), n()]);
...
//# sourceMappingURL=chunk-UTHXO3F2.js.map
