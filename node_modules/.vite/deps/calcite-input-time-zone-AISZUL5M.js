import "./chunk-RLQIFPAU.js";
import "./chunk-CXEMS4PU.js";
import "./chunk-2NAGSEVI.js";
import "./chunk-MMRMX5CV.js";
import {
  SLOTS
} from "./chunk-OTNAOJ3G.js";
import "./chunk-O5YJYMOH.js";
import {
  repeat
} from "./chunk-5UU5JHLH.js";
import "./chunk-J32B4LML.js";
import "./chunk-GSPWVGNX.js";
import "./chunk-AC6BS5YN.js";
import "./chunk-TTISTEBR.js";
import {
  getDateTimeFormat
} from "./chunk-ZNBLLYEC.js";
import "./chunk-4XNOWHF3.js";
import "./chunk-2MXQDMG6.js";
import {
  connectLabel,
  disconnectLabel
...
async function getNormalizer(mode) {
  ...
  const { normalize } = await import("./time-zones-2W7B7PGA.js");
  return normalize;
}
async function createTimeZoneItems(locale, messages, mode, referenceDate, standardTime) {
  if (mode === "name") {
    const { groupByName } = await import("./groupByName-YP6ZDLP7.js");
  ...
  if (mode === "region") {
    const [{ groupByRegion }, { getCountry, global: globalLabel }] = await Promise.all([
      import("./groupByRegion-OCX5GUVT.js"),
      import("./region-YGAZCL46.js")
    ]);
  ...
  const [{ groupByOffset }, { DateEngine }] = await Promise.all([
    import("./groupByOffset-SFMSJA3H.js"),
    import("./native-KIDGHGRP.js")
  ]);
...
//# sourceMappingURL=calcite-input-time-zone-AISZUL5M.js.map
