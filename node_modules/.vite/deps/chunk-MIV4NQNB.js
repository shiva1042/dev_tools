...
var N3 = class extends b {
  ...
  async refreshCacheContent(e7, t7, n12, a9 = true, r7) {
    ...
    if (await Promise.all(d7), r7?.signal?.aborted) throw u2();
  }
  removeFromLayer(e7) {
  ...
  async retrieveDataFromService(e7, t7, n12) {
    ...
    if (null != e7.geometry) {
      ...
      if (null != e7.where && "1=1" !== e7.where) {
        const i10 = await u3(e7.where.toUpperCase(), t7.fieldsIndex);
      ...
      let i10 = "";
      if (null != e7.where && "1=1" !== e7.where) {
        const n14 = await u3(e7.where, t7.fieldsIndex);
        t7.fields.forEach((e8) => {
...
var M2 = "#8f8f82";
function R(t7) {
  return t7 < 0 || t7 >= A3.length ? new u(M2) : new u(A3[t7]);
}
function T3(e7) {
  const t7 = e7.toArray();
...
//# sourceMappingURL=chunk-MIV4NQNB.js.map
