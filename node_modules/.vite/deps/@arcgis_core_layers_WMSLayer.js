...
var Y = class extends p(l3(f3(t2(b2(j(l2(b3))))))) {
  ...
  async _fetchService(e) {
    ...
    if (this.parsedUrl) {
      const e2 = new x(this.parsedUrl.path), { httpsDomains: r2 } = s.request;
