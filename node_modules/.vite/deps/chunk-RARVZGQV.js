...
var j2 = class extends a2 {
  ...
  render(e4) {
    ...
    const l5 = this.renderingContext, d2 = this.view.qualitySettings.fadeDuration, f3 = this.bindParameters, T2 = f3.camera, _ = T2.relativeElevation, j3 = r((o2 - _) / (o2 - e2), 0, 1), x = d2 > 0 ? Math.min(d2, performance.now() - this._enableTime) / d2 : 1, q = x * j3;
...
//# sourceMappingURL=chunk-RARVZGQV.js.map
