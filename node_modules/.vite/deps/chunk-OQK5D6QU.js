...
var i2 = class {
  ...
  intersect(e2, t, r, s, n, i3, o2, m2) {
    const a2 = this.bufferWriter, c3 = this.buffer;
    a2.intersect(c3, this.material.parameters, null, e2, r, s, (r2, s2, a3) => u(r2, s2, a3, e2, t, i3, o2, n, m2));
  }
};
var o = class {
  constructor(e2) {
    this.engineGeometry = e2;
    const t = this.material, r = this.engineGeometry, s = r.attributes, n = r.boundingInfo, o2 = t.createBufferWriter(), u2 = o2.layout, m2 = o2.elementCount(s), a2 = u2.createBuffer(m2);
    o2.write(null, null, s, null, a2, 0), this.renderGeometry = new i2(t, a2.buffer, m2, n);
  }
  get material() {
  ...
  intersect(e2, t, r, s, n, i3, o2, m2) {
    ...
    this.material.intersect(a2, e2.transform.transform, e2, r, s, (r2, s2, a3) => u(r2, s2, a3, e2, t, i3, o2, n, m2));
  }
};
function u(e2, t, r, i3, o2, u2, m2, a2, c3) {
  if (e2 < 0) return;
  if (o2 && !o2(i3.rayBegin, i3.rayEnd, e2)) return;
  const l = new e(u2.layerViewUid, u2.graphicUid(a2), r, m2, c3);
  if ((null == i3.results.min.distance || e2 < i3.results.min.distance) && i3.results.min.set(3, l, e2, t, i3.transform.transform), (null == i3.results.max.distance || e2 > i3.results.max.distance) && i3.results.max.set(3, l, e2, t, i3.transform.transform), 2 === i3.options.store) {
    const r2 = new f(i3.results.min.ray);
    r2.set(3, l, e2, t, i3.transform.transform), i3.results.all.push(r2);
  }
}
var m = class {
...
//# sourceMappingURL=chunk-OQK5D6QU.js.map
