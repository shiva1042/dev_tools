...
__decorate([m2({ json: { read: { source: "string" } } })], c6.prototype, "text", void 0), __decorate([r2(q, { name: "stringType" })], c6.prototype, "type", void 0), c6 = __decorate([a("esri.rest.support.DirectionsString")], c6);
var i5 = c6;
...
var me = O.ofType(d2);
var ye = O.ofType(S);
var fe = class extends p(t2(b(j(l2(b4))))) {
  constructor(e2) {
  ...
  _getNetworkFeatures(e2, t4, s5, n6) {
    ...
    const { layerDefinition: u6, popupInfo: p8, featureSet: c11 } = l8, m13 = u6.drawingInfo.renderer, { features: y3 } = c11, f7 = c11.spatialReference ?? u6.spatialReference ?? u6.extent.spatialReference ?? N2, d4 = m13 && o4(m13), h3 = f.fromJSON(f7), w2 = y3.map((e3) => {
      ...
      const n7 = s5(i6);
      return n7.symbol ??= d4?.getSymbol(i6) ?? this._getNetworkSymbol(t4), n7.popupTemplate ??= p8 && q2.fromJSON(p8), n7;
    });
...
//# sourceMappingURL=RouteLayer-IB7RSNL6.js.map
