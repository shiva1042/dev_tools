...
var i = class {
  ...
  updateFloatArray(t2) {
    const s2 = [];
    for (const n2 of t2) isNaN(n2) ? s2.push("NaN") : n2 === 1 / 0 ? s2.push("Infinity") : n2 === -1 / 0 ? s2.push("-Infinity") : 0 === n2 ? s2.push("0") : s2.push(n2.toString(16));
  ...
  digest() {
    ...
    let s2 = 0;
    for (const n2 of this._bufs) t2.set(n2, s2), s2 += n2.length;
...
//# sourceMappingURL=chunk-KQB3BCRF.js.map
