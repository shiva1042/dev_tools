import "./chunk-ARJRGISD.js";
import "./chunk-GW4PY4F4.js";
import "./chunk-YRO4KRRY.js";
import "./chunk-RYDN6N2U.js";
import "./chunk-Y352UNQY.js";
import {
  SLOTS
...
import "./chunk-Y3EPFBDI.js";
import "./chunk-EF3BSNKC.js";
import "./chunk-BSAXEGBR.js";
...
async function getNormalizer(mode) {
  ...
  const { normalize } = await import("./time-zones-ESNFOR3J.js");
  return normalize;
}
async function createTimeZoneItems(locale, messages, mode, referenceDate, standardTime) {
  if (mode === "name") {
    const { groupByName } = await import("./groupByName-P3FNRVPL.js");
  ...
  if (mode === "region") {
    const [{ groupByRegion }, { getCountry, global: globalLabel }] = await Promise.all([
      import("./groupByRegion-FRG4EHSY.js"),
      import("./region-5JX5DZJG.js")
    ]);
  ...
  const [{ groupByOffset }, { DateEngine }] = await Promise.all([
    import("./groupByOffset-P3A3OUSH.js"),
    import("./native-WKTJZAA5.js")
  ]);
...
var _InputTimeZone = class _InputTimeZone extends LitElement {
  constructor() {
    super(...arguments);
