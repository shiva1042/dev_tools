...
function a(r5, t3, o3, i2, l2, y3, a2 = t3, h4 = o3) {
  ...
  if (l2) {
    ...
    return y3 && (i3 = gt(m2, i3, p4, G4, r5, y3)), c[r5]?.(i3, p4, G4) ?? null;
  }
  if (y3) {
    const n3 = gt(m2, g2, t3, o3, r5, y3, a2, h4);
    return c[r5]?.(n3, p4, G4) ?? null;
  }
  return Gt(u, g2, t3, o3, a2, h4), c[r5]?.(u, p4, G4) ?? null;
}
function h(n3) {
...
var g = { esriSpatialRelIntersects: () => import("./intersectsOperator-PTQB7BCT.js"), esriSpatialRelContains: () => import("./containsOperator-CQZOHDUM.js"), esriSpatialRelCrosses: () => import("./crossesOperator-YXLQIMEE.js"), esriSpatialRelDisjoint: () => import("./disjointOperator-26SNH6SM.js"), esriSpatialRelEnvelopeIntersects: null, esriSpatialRelIndexIntersects: null, esriSpatialRelOverlaps: () => import("./overlapsOperator-ZEDEFA7J.js"), esriSpatialRelTouches: () => import("./touchesOperator-EMXUSNOZ.js"), esriSpatialRelWithin: () => import("./withinOperator-N3N2P6EU.js"), esriSpatialRelRelation: null };
function h3(e4) {
  const r5 = g[e4];
...
async function w(r5, t3, i2) {
  ...
  if (s3) {
    ...
    if (p(s3.spatialReference) && p(i2)) {
      ...
      if (r5.outSR) return f(r5.geometry?.spatialReference, r5.outSR);
    }
  }
}
function d(e4) {
...
//# sourceMappingURL=chunk-X5Z4Z3SN.js.map
