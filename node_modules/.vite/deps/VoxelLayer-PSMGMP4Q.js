...
var i4 = /* @__PURE__ */ Symbol("isVoxelGraphicOrigin");
...
function g(o6, a7) {
  return b(u6, h, u3(o6 - 270)), b(p, j3, u3(a7 - 90)), x2(l4, u6, p), s3(f4, x3), Q(f4, f4, l4), A(f4, f4), [f4[0], f4[1], f4[2]];
}
...
var l5 = class extends l2(n) {
  constructor() {
    super(...arguments), this.color = u.fromArray([0, 0, 0, 0]), this.value = 0, this.enabled = true, this.label = "", this.colorLocked = false;
  }
};
...
__decorate([m({ type: u, json: { type: [x], write: { enabled: true, isRequired: true } } })], c4.prototype, "color", void 0), __decorate([m({ type: Number, json: { write: { enabled: true, isRequired: true } } })], c4.prototype, "position", void 0), c4 = __decorate([a3("esri.layers.voxel.VoxelColorStop")], c4);
var l6 = c4;
...
var u7 = class extends l2(n) {
  ...
  get rasterizedTransferFunction() {
      ...
      for (let t5 = 0; t5 < o7; ++t5) {
        ...
        if (3 !== r5.type) if (1 === r5.type) {
          ...
          if (-1 !== s12 && i7 !== o7) {
            ...
            r5.color.a = Math.round(o(e3[s12].color.a, e3[i7].color.a, o8));
          ...
          if (-1 !== s12 && i7 !== o7) {
            ...
            g2.forEach((e4) => {
              r5.color[e4] = Math.round(o(t6[e4], p11[e4], o8));
            });
    ...
    for (let c6 = 0; c6 < this._colorMapSize; ++c6) {
      ...
      const s12 = (e4 - r4[i6].position) / (r4[l8].position - r4[i6].position), a7 = r4[i6].color, h2 = r4[l8].color, f6 = new u();
      g2.forEach((o7) => {
        f6[o7] = Math.round(o(a7[o7], h2[o7], s12));
      }), f6.a = r(1 - o(a7.a, h2.a, s12) / 255, 0, 1), o6.push(f6);
    }
    return o6;
  }
...
} } } })], u7.prototype, "opacityStops", null), __decorate([m({ type: a5, json: { write: true } })], u7.prototype, "rangeFilter", void 0), __decorate([m({ type: [u], clonable: false, json: { read: false } })], u7.prototype, "rasterizedTransferFunction", null), u7 = __decorate([a3("esri.layers.voxel.VoxelTransferFunctionStyle")], u7);
var y3 = u7;
var g2 = ["r", "g", "b"];
...
var l7 = class extends l2(n) {
  constructor() {
    super(...arguments), this.color = u.fromArray([0, 0, 0, 0]), this.value = 0, this.enabled = true, this.label = "";
  }
};
...
var f5 = class extends n {
  ...
  computeLayerSpaceLocation(e3) {
    ...
    const i6 = u2(e3);
    if (e(i6, i6, this.voxelSizeInLayerSpaceSigned), u4(i6, i6, this.originInLayerSpace3D), "xyt" === this.volumeType) return new _({ x: i6[0], y: i6[1], spatialReference: this.spatialReference });
...
__decorate([m({ type: ["Voxel"] })], _3.prototype, "operationalLayerType", void 0), __decorate([m(d2)], _3.prototype, "legendEnabled", void 0), __decorate([m({ json: { write: true } })], _3.prototype, "title", void 0), __decorate([m(y2)], _3.prototype, "url", null), __decorate([m({ type: O.ofType(d3), json: { origins: { "web-scene": { name: "layerDefinition.sections", write: true } } } })], _3.prototype, "sections", void 0), __decorate([m({ type: x, json: { origins: { "web-scene": { name: "layerDefinition.style.currentVariableId", write: { enabled: true, isRequired: true, ignoreOrigin: true } }, service: { name: "style.currentVariableId" } } } })], _3.prototype, "currentVariableId", void 0), __decorate([m({ type: O.ofType(m6), json: { origins: { "web-scene": { name: "layerDefinition.style.volumeStyles", write: true }, service: { name: "style.volumeStyles" } } } })], _3.prototype, "volumeStyles", void 0), __decorate([m({ type: ["volume", "surfaces"], json: { origins: { "web-scene": { name: "layerDefinition.style.renderMode", write: true }, service: { name: "style.renderMode" } } } })], _3.prototype, "renderMode", void 0), __decorate([m({ type: O.ofType(c5), json: { origins: { "web-scene": { name: "layerDefinition.style.variableStyles", write: true }, service: { name: "style.variableStyles" } } } })], _3.prototype, "variableStyles", void 0), __decorate([m({ type: Boolean, json: { origins: { "web-scene": { name: "layerDefinition.style.enableSlices", write: true }, service: { name: "style.enableSlices" } } } })], _3.prototype, "enableSlices", void 0), __decorate([m({ type: Boolean, json: { origins: { "web-scene": { name: "layerDefinition.style.enableSections", write: true }, service: { name: "style.enableSections" } } } })], _3.prototype, "enableSections", void 0), __decorate([m({ type: Boolean, json: { origins: { "web-scene": { name: "layerDefinition.style.enableDynamicSections", write: true }, service: { name: "style.enableDynamicSections" } } } })], _3.prototype, "enableDynamicSections", void 0), __decorate([m({ type: Boolean, json: { origins: { "web-scene": { name: "layerDefinition.style.enableIsosurfaces", write: true }, service: { name: "style.enableIsosurfaces" } } } })], _3.prototype, "enableIsosurfaces", void 0), __decorate([m({ readOnly: true })], _3.prototype, "graphicOrigin", void 0), __decorate([m({ type: s7, json: { origins: { "web-scene": { name: "layerDefinition.style.shading", write: true }, service: { name: "style.shading" } } } })], _3.prototype, "shading", void 0), __decorate([m({ type: ["show", "hide"] })], _3.prototype, "listMode", void 0), __decorate([m({ type: Number, range: { min: 0, max: 1 }, nonNullable: true, json: { read: false, write: false, origins: { "web-scene": { read: false, write: false }, "portal-item": { read: false, write: false } } } })], _3.prototype, "opacity", void 0), __decorate([m({ type: O.ofType(p3) })], _3.prototype, "variables", void 0), __decorate([m({ type: O.ofType(f5) })], _3.prototype, "volumes", void 0), __decorate([m({ type: d4 })], _3.prototype, "index", void 0), __decorate([m({ type: Number, json: { name: "layerDefinition.minScale", write: true, origins: { service: { read: false, write: false } } } })], _3.prototype, "minScale", void 0), __decorate([m({ type: Number, json: { name: "layerDefinition.maxScale", write: true, origins: { service: { read: false, write: false } } } })], _3.prototype, "maxScale", void 0), __decorate([m({ json: { read: false }, readOnly: true })], _3.prototype, "type", void 0), __decorate([m({ readOnly: true, json: { name: "serviceVersion" } })], _3.prototype, "version", void 0), __decorate([o2("service", "version")], _3.prototype, "readVersion", null), __decorate([m({ type: z })], _3.prototype, "fullExtent", void 0), __decorate([o2("service", "fullExtent", ["fullExtent"])], _3.prototype, "readFullExtent", null), __decorate([m({ readOnly: true, clonable: false, json: { read: false } })], _3.prototype, "fields", null), __decorate([m({ readOnly: true })], _3.prototype, "fieldsIndex", null), __decorate([m({ type: Boolean, json: { name: "disablePopup", read: { reader: (e3, t5) => !t5.disablePopup }, write: { enabled: true, ignoreOrigin: true, writer(e3, t5, i6) {
  t5[i6] = !e3;
...
//# sourceMappingURL=VoxelLayer-PSMGMP4Q.js.map
