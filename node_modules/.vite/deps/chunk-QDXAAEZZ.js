...
import {
  n as n2
} from "./chunk-GZLXDWHM.js";
import {
  i as i3
} from "./chunk-V5KB2LA3.js";
import {
  c as c2
...
var i6 = /* @__PURE__ */ Symbol("isTileGraphicOriginSymbol");
...
var _a;
var le = (_a = class extends l3(s5(u)) {
  constructor(e4) {
  ...
  readCapabilities(e4, r4) {
    ...
    const { attachment: t2, operations: { supportsQuery: i7, supportsQueryAttachments: o3 }, query: { supportsFormatPBF: s9, supportsOrderBy: a4, supportsPagination: l6 }, data: { supportsAttachment: n5 }, queryRelated: p4 } = c2(r4, this.url);
  ...
  async createFeatureLayer() {
    ...
    const e4 = (await import("./@arcgis_core_layers_FeatureLayer.js")).default, { layer: r4, url: t2 } = this;
    let i7;
  ...
  toExportImageJSON(e4) {
    const r4 = { id: this.id, source: this.source?.toJSON() || { mapLayerId: this.id, type: "mapLayer" } }, t2 = l2(e4, this.definitionExpression);
    ...
    if (o3) {
      ...
      if (i7.renderer > 2 && (e5.renderer = this.renderer ? this.renderer.toJSON() : null), i7.labelsVisible > 2 && (e5.showLabels = this.labelsVisible), this.labelsVisible && i7.labelingInfo > 2) if (this.labelingInfo) {
        ...
        null != this.geometryType && (r5 = c4(this.labelingInfo, y.toJSON(this.geometryType))), e5.showLabels = true, e5.labelingInfo = r5.filter((e6) => e6.labelPlacement).map((e6) => e6.toJSON({ origin: "service", layer: this.layer }));
...
var m5 = (m6) => {
  ...
  let v = class extends S3 {
    constructor(...e4) {
      super(...e4), this.allSublayers = new l5({ getCollections: () => [this.sublayers], getChildrenFunction: (e5) => e5.sublayers }), this.sublayersSourceJSON = { 2: {}, 3: {}, 4: {}, 5: {}, 6: {} }, this.subtables = null, this.addHandles([l(() => this.sublayers, (e5, r4) => this._handleSublayersChange(e5, r4), U), l(() => this.subtables, (e5, r4) => this._handleSublayersChange(e5, r4), U)]);
    }
    destroy() {
...
//# sourceMappingURL=chunk-QDXAAEZZ.js.map
