...
var m4 = class extends X {
  ...
  async _updateClipGeometry() {
    ...
    if (e2 && "inside" === t3.clippingType) {
      const { extent: t4 } = this.rasterInfo, r5 = await import("./densifyOperator-TELP5QIG.js"), s4 = await import("./differenceOperator-I3T2IYTE.js");
    ...
    async _getSampleLocations(e2) {
      ...
      if ("polyline" === r5) {
        ...
        if (e2.sampleCount || e2.sampleDistance) {
          const i6 = await import("./densifyOperator-TELP5QIG.js"), s5 = (await import("./lengthOperator-URTJQPTS.js")).execute(t3, { unit: "meters" }), n5 = Math.min(e2.sampleCount || 100, Q3);
...
//# sourceMappingURL=chunk-QAMCJL36.js.map
