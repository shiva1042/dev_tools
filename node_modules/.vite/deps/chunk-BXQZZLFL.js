...
__decorate([m2(a4)], l3.prototype, "value", void 0), __decorate([m2(a4)], l3.prototype, "value2", void 0), __decorate([m2(a4)], l3.prototype, "value3", void 0), l3 = __decorate([a2("esri.renderers.support.UniqueValue")], l3);
...
__decorate([m2({ type: String, json: { write: true } })], u2.prototype, "description", void 0), __decorate([m2({ type: String, json: { write: true } })], u2.prototype, "label", void 0), __decorate([m2(y2)], u2.prototype, "symbol", void 0), __decorate([m2({ type: [l3], json: { type: [[String]], read: { reader: (r3) => r3 ? r3.map((r4) => new l3({ value: r4[0], value2: r4[1], value3: r4[2] })) : null }, write: { writer: (r3, e2) => {
  const t = [];
  for (const s3 of r3) {
...
__decorate([m2({ type: String, json: { write: true } })], i3.prototype, "heading", void 0), __decorate([m2({ type: [u2], json: { write: { isRequired: true } } })], i3.prototype, "classes", void 0), i3 = __decorate([a2("esri.renderers.support.UniqueValueGroup")], i3);
...
__decorate([m2({ type: String, json: { write: true } })], p2.prototype, "description", void 0), __decorate([m2({ type: String, json: { write: true } })], p2.prototype, "label", void 0), __decorate([m2(m3)], p2.prototype, "symbol", void 0), __decorate([m2(a4)], p2.prototype, "value", void 0), p2 = l4 = __decorate([a2("esri.renderers.support.UniqueValueInfo")], p2);
...
function P(e2) {
  ...
  return [{ classes: (l5 ?? []).map((e3) => {
    const { symbol: l6, label: n4, value: a5, description: p3 } = e3, [f, d2, c] = u3 ? a5?.toString()?.split(o2 || "") || [] : [a5], h = [];
...
var $ = E = class extends v(a3) {
  ...
  addUniqueValueInfo(e2, t) {
    ...
    let s3;
    s3 = "object" == typeof e2 ? L(e2) : new p2({ value: e2, symbol: z(t) }), this.uniqueValueInfos?.push(s3), this._valueInfoMap[C(s3.value)] = s3, this._updateGroupsFromInfos(), this._isInfosSource = true, this._watchUniqueValueInfos();
  }
  ...
  _updateGroupsFromInfos(e2 = false) {
    ...
    const r3 = !(!t || !s3), u3 = l5.map((e3) => {
      const { symbol: t2, label: s4, value: i5, description: l6 } = e3, [u4, n5, a5] = r3 ? i5?.toString()?.split(o2 || "") || [] : [i5];
  ...
  static fromPortalStyle(e2, t) {
    const s3 = new E(t?.properties);
    s3._set("styleOrigin", Object.freeze({ styleName: e2 })), s3._set("portal", t?.portal || M.getDefault());
...
__decorate([m2({ readOnly: true })], $.prototype, "_cache", null), __decorate([r2({ uniqueValue: "unique-value" })], $.prototype, "type", void 0), __decorate([m2(n3)], $.prototype, "backgroundFillSymbol", void 0), __decorate([m2({ value: null, json: { type: String, read: { source: "field1" }, write: { target: "field1" } } })], $.prototype, "field", null), __decorate([s2("field")], $.prototype, "castField", null), __decorate([r("field")], $.prototype, "writeField", null), __decorate([m2({ type: String, value: null, json: { write: true } })], $.prototype, "field2", null), __decorate([m2({ type: String, value: null, json: { write: true } })], $.prototype, "field3", null), __decorate([m2({ type: Boolean, json: { name: "drawInClassOrder", default: false, write: true, origins: { "web-scene": { write: false } } } })], $.prototype, "orderByClassesEnabled", void 0), __decorate([m2({ type: String, value: null, json: { write: true } })], $.prototype, "valueExpression", null), __decorate([m2({ type: String, json: { write: true } })], $.prototype, "valueExpressionTitle", void 0), __decorate([m2({ type: d, json: { write: true } })], $.prototype, "legendOptions", void 0), __decorate([m2({ type: String, json: { write: true } })], $.prototype, "defaultLabel", void 0), __decorate([m2(n({ ...y2 }, { json: { write: { overridePolicy() {
  return { enabled: !this._isDefaultSymbolDerived };
} }, origins: { "web-scene": { write: { overridePolicy() {
  return { enabled: !this._isDefaultSymbolDerived };
} } } } } }))], $.prototype, "defaultSymbol", null), __decorate([m2({ type: String, value: null, json: { write: true } })], $.prototype, "fieldDelimiter", null), __decorate([m2({ type: M, readOnly: true })], $.prototype, "portal", void 0), __decorate([o("portal", ["styleName"])], $.prototype, "readPortal", null), __decorate([m2({ readOnly: true, json: { write: { enabled: false, overridePolicy: () => ({ enabled: true }) } } })], $.prototype, "styleOrigin", void 0), __decorate([o("styleOrigin", ["styleName", "styleUrl"])], $.prototype, "readStyleOrigin", null), __decorate([r("styleOrigin", { styleName: { type: String }, styleUrl: { type: String } })], $.prototype, "writeStyleOrigin", null), __decorate([m2({ type: [i3], json: { read: { source: ["uniqueValueGroups", "uniqueValueInfos"], reader: (e2, t, s3) => (t.uniqueValueGroups || P(t)).map((e3) => i3.fromJSON(e3, s3)) }, write: { overridePolicy() {
  return this.styleOrigin ? { enabled: false } : { enabled: true };
} } } })], $.prototype, "uniqueValueGroups", null), __decorate([m2({ type: [p2], json: { read: false, write: { isRequired: true, overridePolicy() {
...
//# sourceMappingURL=chunk-BXQZZLFL.js.map
