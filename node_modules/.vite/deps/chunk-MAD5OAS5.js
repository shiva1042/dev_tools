...
var i2 = class extends b {
  ...
  add(e4, t4) {
    let r = false;
    for (const s5 of e4) {
      const e5 = e(this._idToCounters, s5, () => (r = true, /* @__PURE__ */ new Map())), i3 = e5.get(t4) ?? 0;
      i3 || (r = true), e5.set(t4, i3 + 1);
    }
    return r;
  }
  delete(e4, t4) {
...
__decorate([m({ types: c2, json: { read: f, write: true } })], n4.prototype, "geometry", void 0), n4 = y = __decorate([a("esri.views.layers.support.Geometry")], n4);
...
var S = O.ofType({ key: "type", base: null, typeMap: { rect: s4, path: e3, geometry: n4 } });
  ...
  let w2 = class extends v {
    ...
    get _mergedHighlights() {
      ...
      for (const e4 of this.highlights) {
        const i3 = t4.find((t5) => t5.name === e4.name);
        i3 && i3.assignFrom(e4);
      }
      return t4;
    }
    ...
    _getHighlights() {
      ...
      for (const [e4, i3] of this._highlightCounter.highlightNamesByObjectId) {
        const s5 = this._getHighlightBits(i3);
    ...
    _getHighlightBits(t4) {
      ...
      for (const { name: h } of r) e4.delete(h) && (s5 = i3), i3 <<= 1;
      return s5;
    }
  };
...
//# sourceMappingURL=chunk-MAD5OAS5.js.map
