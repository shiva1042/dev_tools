...
function n(e2, { accentColor: n3, contrastColor: o2 }) {
...
var a2 = 64;
function l(r2, l2) {
  const { accentColor: n3, contrastColor: c, preMultiplyAlpha: i } = l2;
  return r2.fromData(`heading-rotate:[accent:${n3},contrast:${c},size:${a2}]`, () => new M(e(I, { accentColor: n3, contrastColor: c, size: a2 }), { mipmap: true, reloadable: true, preMultiplyAlpha: i }));
}
function n2(o2, l2) {
  const { accentColor: n3, contrastColor: c, preMultiplyAlpha: i } = l2;
  return o2.fromData(`tilt-rotate:[accent:${n3},contrast:${c},size:${a2}]`, () => new M(e(I2, { accentColor: n3, contrastColor: c, size: a2 }), { mipmap: true, reloadable: true, preMultiplyAlpha: i }));
}
...
//# sourceMappingURL=chunk-OBFZWB56.js.map
