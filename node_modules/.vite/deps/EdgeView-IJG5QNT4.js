import {
  L as L2
} from "./chunk-TMHRGI7M.js";
import {
  a as a2
} from "./chunk-KSVSCMGW.js";
import "./chunk-QEXLTOAS.js";
import "./chunk-4A7YQ7KO.js";
...
import "./chunk-RBYRXUQN.js";
import "./chunk-F75XORHS.js";
import {
  t as t3
} from "./chunk-W3VYNHUX.js";
import "./chunk-75YN4M5B.js";
...
function n5(n7, o6) {
  const t8 = -n7[0], c3 = -n7[1], f4 = -n7[2], i7 = o6[3], s3 = o6[7], u5 = o6[11], e10 = o6[15];
  o6[0] += i7 * t8, o6[1] += i7 * c3, o6[2] += i7 * f4, o6[4] += s3 * t8, o6[5] += s3 * c3, o6[6] += s3 * f4, o6[8] += u5 * t8, o6[9] += u5 * c3, o6[10] += u5 * f4, o6[12] += e10 * t8, o6[13] += e10 * c3, o6[14] += e10 * f4;
}
function o2(n7, o6) {
  const t8 = n7[0], c3 = n7[1], f4 = n7[2];
  o6[12] += t8 * o6[0] + c3 * o6[4] + f4 * o6[8], o6[13] += t8 * o6[1] + c3 * o6[5] + f4 * o6[9], o6[14] += t8 * o6[2] + c3 * o6[6] + f4 * o6[10], o6[14] += t8 * o6[3] + c3 * o6[7] + f4 * o6[11];
}

// node_modules/@arcgis/core/views/3d/webgl-engine/lib/LocalOriginManager.js
var e7 = class {
  constructor(i7) {
    this._factory = i7, this._originData = /* @__PURE__ */ new Map();
  }
  acquire(i7) {
    return this.register(this._factory.getOrigin(i7));
  }
  register(i7) {
    const t8 = this._originData.get(i7.id) || new o3(i7);
    return t8.refCount++, this._originData.has(t8.origin.id) || this._originData.set(t8.origin.id, t8), t8;
  }
  release(i7) {
    i7 && (i7.refCount--, 0 === i7.refCount && this._originData.delete(i7.origin.id));
  }
  updateViewMatrices(t8) {
    this._originData.forEach((e10) => {
      n2(e10.viewMatrix, t8), o2(e10.origin.vec3, e10.viewMatrix);
    });
  }
};
var o3 = class {
  constructor(i7) {
    this.origin = i7, this.refCount = 0, this.viewMatrix = e2();
  }
};

// node_modules/@arcgis/core/views/3d/webgl-engine/lib/edgeRendering/EdgeShaderParameters.js
var a3 = class extends v {
  constructor(o6, s3) {
    super(), this.distanceFalloffFactor = o6, this.transparency = s3, this.transformNormalViewFromGlobal = e();
  }
};
var e8 = class extends F {
  constructor() {
    super(...arguments), this.transformNormalViewFromGlobal = e(), this.slicePlaneLocalOrigin = n(), this.transformNormalGlobalFromModel = e();
  }
};

// node_modules/@arcgis/core/views/3d/webgl-engine/lib/edgeRendering/EdgeShaderTechnique.js
var a4 = class extends m3 {
  constructor(r8, i7) {
    super(r8, i7, new t6(L2, () => import("./EdgeShader.glsl-27H6I3LR.js")), i7.silhouette ? u3 : p);
  }
  initializePipeline() {
    return T({ blending: e4(1, 1, 0, 1, 32774, 32776), depthTest: { func: 515 }, colorWrite: d2 });
  }
};

// node_modules/@arcgis/core/views/3d/webgl-engine/lib/edgeRendering/EdgeShaderTechniqueConfiguration.js
var i4 = class extends e3 {
  constructor() {
    super(...arguments), this.type = 0, this.silhouette = false, this.legacy = false, this.terrainDepthTest = false, this.cullAboveTerrain = false, this.spherical = false, this.occlusionPass = false, this.normalType = 1;
  }
};
__decorate([i3({ count: 3 })], i4.prototype, "type", void 0), __decorate([i3()], i4.prototype, "silhouette", void 0), __decorate([i3()], i4.prototype, "legacy", void 0), __decorate([i3()], i4.prototype, "terrainDepthTest", void 0), __decorate([i3()], i4.prototype, "cullAboveTerrain", void 0), __decorate([i3()], i4.prototype, "spherical", void 0);

// node_modules/@arcgis/core/views/3d/webgl-engine/lib/edgeRendering/EdgeRenderer.js
var c = 8;
var m4 = 128;
var _2 = { type: 0, hasSlicePlane: false, strokesTexture: null, legacy: true, spherical: true };
var g = class _g {
  constructor(r8, t8, s3) {
    this.rctx = r8, this._techniques = t8, this._configuration = new i4(), this.refCount = 0, this._renderables = /* @__PURE__ */ new Set(), this._sortedRenderables = { 0: { 0: new r3(), 1: new r3() }, 1: { 0: new r3(), 1: new r3() } }, this._renderablesDirty = false, this._drawParameters = new e8(), this._settings = { ..._2, ...s3 }, this.key = _g.getKey(this._settings.type, this._settings.hasSlicePlane, this._settings.legacy);
    const i7 = this._settings.strokesTexture.variants;
    this.writerSettings = { variants: i7, reducedPrecision: t5.TESTS_DISABLE_OPTIMIZATIONS }, this._configuration.legacy = this._settings.legacy, this._configuration.type = this._settings.type, this._configuration.silhouette = false, this._configuration.hasSlicePlane = this._settings.hasSlicePlane, this._configuration.spherical = s3.spherical;
  }
  addRenderable(e10) {
    this._renderables.add(e10), this._renderablesDirty = true;
  }
  removeRenderable(e10) {
    this._renderables.delete(e10), this._renderablesDirty = true;
  }
  setRenderablesDirty() {
    this._renderablesDirty = true;
  }
  forEachRenderable(e10, r8) {
    this._renderablesDirty && this._sortRenderables();
    const t8 = this._sortedRenderables[r8];
    t8[0].forAll(e10), t8[1].forAll(e10);
  }
  acquireTechnique(e10, r8) {
    return this._lastOriginId = null, this._configuration.terrainDepthTest = e10.terrainDepthTest, this._configuration.cullAboveTerrain = e10.cullAboveTerrain, this._configuration.silhouette = r8, this._techniques.get(a4, this._configuration);
  }
  renderRegularEdges(e10, r8, t8, s3, i7) {
    this._render(e10, r8, r8.regular.vao, t8, s3, i7);
  }
  renderSilhouetteEdges(e10, r8, t8, s3, i7) {
    this._render(e10, r8, r8.silhouette.vao, t8, s3, i7);
  }
  _render(e10, r8, t8, s3, i7, a6) {
    a6 > 0 && (this._bindDraw(e10, r8, s3, i7), this.rctx.bindVAO(t8), this.rctx.drawArraysInstanced(_.TRIANGLE_FAN, 0, 4, a6));
  }
  _bindDraw(e10, s3, a6, n7) {
    this._drawParameters.componentDataTexture = s3.components.buffer.textureBuffer.texture, this._drawParameters.strokesTexture = this._settings.strokesTexture;
    const l2 = s3.transform.origin;
    if (l2) {
      const r8 = l2.origin.id;
      this._lastOriginId !== r8 && (e10.setUniformMatrix4fv("localView", l2.viewMatrix), this._lastOriginId = r8), e10.setUniformMatrix4fv("model", s3.transform.modelMatrix), this._drawParameters.slicePlaneLocalOrigin = l2.origin.vec3;
    } else {
      const e11 = new e6(s3.transform.position), a7 = u2(f3, s(f3, s3.transform.rotationScale));
      this._drawParameters.transformWorldFromModelTL = e11.low, this._drawParameters.transformWorldFromModelTH = e11.high, this._drawParameters.transformWorldFromModelRS = s3.transform.rotationScale, this._drawParameters.transformNormalGlobalFromModel = a7;
      const l3 = n7.camera.viewInverseTransposeMatrix;
      o(this._drawParameters.slicePlaneLocalOrigin, l3[3], l3[7], l3[11]);
    }
    e10.bindDraw(n7, a6, this._drawParameters);
  }
  _sortRenderables() {
    this._renderablesDirty = false, this._sortedRenderables[0][0].clear(), this._sortedRenderables[0][1].clear(), this._sortedRenderables[1][0].clear(), this._sortedRenderables[1][1].clear(), this._renderables.forEach((e11) => this._sortedRenderables[e11.objectTransparency][e11.edgeTransparency].push(e11));
    const e10 = (e11, r8) => e11.transform.origin ? r8.transform.origin ? e11.transform.origin.origin.id < r8.transform.origin.origin.id ? -1 : e11.transform.origin.origin.id > r8.transform.origin.origin.id ? 1 : 0 : 1 : 0;
    this._sortedRenderables[0][0].sort(e10), this._sortedRenderables[0][1].sort(e10), this._sortedRenderables[1][0].sort(e10), this._sortedRenderables[1][1].sort(e10);
  }
  static getKey(e10, r8, t8) {
    return `edges-t:${e10}:${r8}:${t8}`;
  }
};
var f3 = e5();
...
function o4(e10) {
  const o6 = c2.resolution, l2 = o6 / 2, u5 = new Float32Array(o6 * o6), p2 = o6 * l2, m5 = c2.amplitude, h5 = o6, d3 = Math.log2(o6) + 1, f4 = c2.strokes.length;
  let g2 = (d3 - 1) * f4 * h5;
  for (const { distance: t8, pressure: s3 } of c2.strokes) {
    let e11 = t8, r8 = s3, n7 = g2;
    for (let t9 = 0; t9 < d3; t9++) {
      0 !== t9 && (e11 = i5(e11, 0), r8 = i5(r8, 1));
      for (let t10 = 0; t10 < c2.resolution; t10++) {
        const s4 = e11[t10 % e11.length], o7 = r8?.[t10 % r8.length] ?? 1;
        u5[n7] = s4, u5[n7 + p2] = o7, ++n7;
      }
      n7 -= h5 * (f4 + 1);
    }
    g2 += h5;
  ...
  const w2 = new h4(o6);
  w2.dataType = N.FLOAT, w2.pixelFormat = 6403, w2.internalFormat = E.R16F;
  const x = new A(e10, w2, u5);
  return new a5(o6, m5, f4, x);
}
function i5(e10, t8) {
  if (!e10) return null;
  const s3 = e10.length / 2, r8 = l * s3, n7 = new Array(s3);
  let o6 = 0;
  const i7 = 1 === t8;
  for (let l2 = 0; l2 < e10.length; l2 += 2) {
    const t9 = (e10[l2] + e10[l2 + 1]) / 2;
    n7[o6++] = i7 ? Math.min(r8, 1 - (1 - t9) * u4) : Math.min(r8, t9 * u4);
  }
  return n7;
}
var l = 0.1;
...
function r7(t8) {
  let r8 = 0;
  for (const { material: e10 } of t8) if (n6(e10)) {
    if (e10.color[3] * e10.opacity < 1) return 0;
    r8 = 1;
  }
  return r8;
}
function e9(t8) {
  let r8 = 0;
  for (const { material: e10 } of t8) if (n6(e10)) {
    switch (e10.objectTransparency) {
      case 0:
        return 0;
      case 1:
        if (e10.opacity < 1) return 0;
    }
    r8 = 1;
  }
  return r8;
...
function n6(t8) {
  return t8.size * t8.color[3] * t8.opacity > 0;
}
function o5(t8) {
  return t8.size * t8.color[3] > 0;
}
function i6(t8, r8, e10, n7) {
  for (let o6 = 0; o6 < t8.length; o6++) {
    const i7 = t8[o6].index, f4 = r8[o6], c3 = r8[o6 + 1];
    if (n7) for (let t9 = f4; t9 < c3; t9++) {
      const r9 = n7[t9];
      e10.set(r9, i7);
    }
    else for (let t9 = f4; t9 < c3; t9++) e10.set(t9, i7);
  }
}
...
var $ = class extends b {
  constructor(e10) {
    super(e10), this._updatingHandles = new h3(), this._objectEntries = /* @__PURE__ */ new Map(), this._pendingDeletions = /* @__PURE__ */ new Map(), this._renderers = /* @__PURE__ */ new Map(), this._gpuMemoryUsage = 0, this._workerAbort = new AbortController(), this._tmpModelPosition = n(), this._localOrigins = new e7(new f2(e10.renderSR));
    const t8 = i2.createBuffer(4);
    for (let r8 = 0; r8 < 4; r8++) t8.sideness.set(r8, 0, 0 === r8 || 3 === r8 ? 0 : 1), t8.sideness.set(r8, 1, 0 === r8 || 1 === r8 ? 0 : 1);
    this._vertexBuffer = new r4(e10.rctx, n4, t8.buffer);
  }
  initialize() {
    this._workerHandle = new a2(this.schedule), this._componentColorManager = new r6(this.rctx, 3);
  }
  destroy() {
    this.destroyed || (this._objectEntries.forEach((e10) => this._discardObjectEntry(e10)), this._objectEntries.clear(), this._pendingDeletions.forEach((e10) => this._discardObjectEntry(e10)), this._pendingDeletions.clear(), this._strokesTexture = r2(this._strokesTexture), this._componentColorManager = u(this._componentColorManager), this._workerAbort.abort(), this._workerHandle.destroy(), this._vertexBuffer.dispose(), this._renderers.clear(), this._updatingHandles.destroy(), this._set("schedule", _e));
  }
  get updating() {
  ...
  async addComponentObject(e10, t8, r8, s3, n7, i7, o6) {
    if (this.hasObject(e10)) return this._getObjectMemoryUsage(e10);
    let a6;
    const c3 = new re(null, new Promise((e11) => a6 = e11), e10.obb.center, e10.obb.radius);
    this._objectEntries.set(e10, c3);
    const l2 = await this._updatingHandles.addPromise(this._addComponentGeometry(e10.transform, c3, t8, r8, s3, n7, i7, o6));
    return this.setNeedsRender(), a6(), l2;
  }
  async addOrUpdateObject3D(e10, t8, r8, s3) {
    if (this.destroyed) return void i.getLogger(this).warn("Attempt to add an object to a destroyed instance");
    const i7 = new AbortController();
    let o6;
    const a6 = e10.boundingVolumeWorldSpace.bounds, l2 = new re(i7, new Promise((e11) => o6 = e11), z(a6, n()), L(a6)), d3 = this._objectEntries.get(e10);
    d3 && (this._pendingDeletions.has(e10) ? this._discardObjectEntry(d3) : this._pendingDeletions.set(e10, d3)), this._objectEntries.set(e10, l2);
    try {
      const n7 = new Array();
      if (e10.geometries.length > 1 && te(e10)) n7.push(this._addObjectMergedGeometries(e10, l2, t8, r8, s3));
      else for (const i8 of e10.geometries) i8.material.supportsEdges && n7.push(this._addGeometry(e10, l2, i8, t8, r8, s3));
      await this._updatingHandles.addPromise(Promise.all(n7)), this._removePendingDeletion(e10);
    } catch (h5) {
      d(h5) ? this._discardObjectEntry(l2) : this._removePendingDeletion(e10);
    } finally {
      this.setNeedsRender(), o6();
    }
  }
  removeObject(e10) {
    const t8 = this._objectEntries.get(e10);
    this._objectEntries.delete(e10), this._discardObjectEntry(t8), this._removePendingDeletion(e10);
  }
  _removePendingDeletion(e10) {
    const t8 = this._pendingDeletions.get(e10);
    this._pendingDeletions.delete(e10), this._discardObjectEntry(t8);
  }
  async _getObjectEntry(e10) {
    const t8 = this._objectEntries.get(e10);
    if (!t8) throw new Error("no object");
    return await t8.loaded, null == t8.loaded ? null : t8;
  }
  fastUpdateObject3DEdgesTransform(e10) {
    if (this.destroyed) return false;
    const t8 = this._objectEntries.get(e10);
    if (!t8) return false;
    const { geometries: r8 } = e10, { renderables: s3 } = t8;
    if (0 === r8.length || 0 === s3.length) return true;
    if (s3.length > 1) return false;
    const [n7] = s3, i7 = n7.transform;
    if (!(i7 instanceof ie)) return false;
    const [o6] = r8;
    if (o6.localOrigin !== i7.origin.origin) return false;
    const a6 = e2(), c3 = this._computeModelTransformWithLocalOrigin(e10, o6, a6);
    return n7.transform = new ie(a6, c3), this.setNeedsRender(), true;
  }
  _discardObjectEntry(e10) {
    e10 && (e10.abort?.abort(), e10.renderables.length && (e10.renderables.forEach((e11) => this._removeRenderable(e11)), this.setNeedsRender()), e10.loaded = null);
  }
  hasObject(e10) {
    return this._objectEntries.has(e10);
  }
  async updateAllComponentOpacities(e10, t8) {
    const r8 = await this._updatingHandles.addPromise(this._getObjectEntry(e10));
    if (null == r8) return;
    const s3 = Array.isArray(t8) ? (e11) => t8[e11] : () => t8;
    r8.renderables.forEach((e11) => {
      const t9 = e11.components.meta.length;
      for (let r9 = 0; r9 < t9; r9++) {
        const t10 = s3(r9), n7 = e11.components.meta[r9], i7 = n7.index;
        n7.material.opacity = t10, e11.components.buffer.textureBuffer.setDataElement(i7, 1, 3, 255 * t10);
      }
      this._updateTransparency(e11);
    }), this.setNeedsRender();
  }
  async _getObjectMemoryUsage(e10) {
    const t8 = await this._getObjectEntry(e10);
    return t8 ? t8.renderables.reduce((e11, t9) => e11 + t9.statistics.gpuMemoryUsage, 0) : 0;
  }
  async updateAllComponentMaterials(e10, t8, r8, s3) {
    const n7 = e10 instanceof W, i7 = t7(t8), o6 = g.getKey(i7, r8, n7), a6 = await this._updatingHandles.addPromise(this._getObjectEntry(e10));
    null != a6 && (a6.renderables.forEach((e11) => {
      if (o6 !== e11.rendererKey) {
        const t9 = this._renderers.get(e11.rendererKey), s4 = this._acquireRenderer(i7, r8, n7);
        t9.removeRenderable(e11), --t9.refCount, e11.rendererKey = o6, s4.addRenderable(e11);
      }
      if (Array.isArray(t8)) for (let r9 = 0; r9 < t8.length; r9++) e11.components.meta[r9].material = t8[r9];
      else e11.components.meta[0].material = t8;
      s3 && ce(e11.components), this._updateTransparency(e11);
    }), this.setNeedsRender());
  }
  async updateAllVerticalOffsets(e10, t8) {
    const r8 = await this._updatingHandles.addPromise(this._getObjectEntry(e10));
    null != r8 && this._updateAllVerticalOffsets(r8, t8);
  }
  _updateAllVerticalOffsets(e10, t8) {
    e10.renderables.forEach((e11) => {
      const r8 = e11.components.meta;
      for (let s3 = 0; s3 < r8.length; s3++) e11.components.meta[s3].verticalOffset = t8?.[s3] ?? 0;
      ce(e11.components);
    }), this.setNeedsRender();
  }
  async updateObjectVisibility(e10, t8) {
    const r8 = await this._updatingHandles.addPromise(this._getObjectEntry(e10));
    r8 && (r8.renderables.forEach((e11) => e11.visible = t8), this.setNeedsRender());
  }
  render(e10, t8) {
    if (null == this._componentColorManager) return;
    this._localOrigins.updateViewMatrices(e10.camera.viewMatrix);
    const r8 = e10.camera.viewInverseTransposeMatrix, s3 = n(), n7 = new e6();
    let i7 = 0, o6 = 0;
    if (this._renderers.forEach((r9) => {
      0 !== r9.refCount ? (++this.techniques.precompiling, r9.forEachRenderable((t9) => {
        t9.visible && (i7 += t9.statistics.averageEdgeLength, o6++, t9.regular && r9.acquireTechnique(e10, false), t9.silhouette && r9.acquireTechnique(e10, true));
      }, t8), --this.techniques.precompiling) : this._renderers.delete(r9.key);
    }), this._componentColorManager.garbageCollect(), this._componentColorManager.updateTextures(), 0 === o6) return;
    const a6 = new a3(40 * i7 / o6, t8);
    o(s3, r8[3], r8[7], r8[11]), n7.set(s3), s2(a6.transformWorldFromViewTH, n7.high), s2(a6.transformWorldFromViewTL, n7.low), n3(a6.transformViewFromCameraRelativeRS, e10.camera.viewMatrix), u2(fe, a6.transformViewFromCameraRelativeRS), s(a6.transformNormalViewFromGlobal, fe), a6.transformProjFromView = e10.camera.projectionMatrix, this._updateObjectCameraDistances(e10), this._renderers.forEach((t9) => {
      le(t9, e10, a6), de(t9, e10, a6);
    });
  }
  _updateTransparency(e10) {
    const t8 = r7(e10.components.meta), r8 = e9(e10.components.meta);
    t8 === e10.edgeTransparency && r8 === e10.objectTransparency || (e10.edgeTransparency = t8, e10.objectTransparency = r8, this._renderers.get(e10.rendererKey).setRenderablesDirty());
  }
  _computeModelTransformWithLocalOrigin(e10, t8, r8) {
    e10.getCombinedShaderTransformation(t8, r8);
    const s3 = null != t8.localOrigin ? this._localOrigins.register(t8.localOrigin) : this._localOrigins.acquire(o(this._tmpModelPosition, r8[12], r8[13], r8[14]));
    return t8.localOrigin = s3.origin, n5(s3.origin.vec3, r8), s3;
  }
  _createComponentBuffers(e10) {
    if (null == this._componentColorManager) return null;
    const t8 = new Array(), r8 = this._componentColorManager.getBuffer(e10.length);
    for (let n7 = 0; n7 < e10.length; n7++) {
      const s4 = e10[n7], i7 = r8.acquireIndex();
      t8.push({ index: i7, verticalOffset: 0, material: s4 });
    }
    const s3 = new se(r8, t8);
    return ce(s3), s3;
  }
  _extractEdges(e10, t8, r8, s3, n7, i7, o6 = i7.length) {
    return o6 < Z && (n7 = true), this._workerHandle.process({ data: r8, indices: i7, indicesLength: o6, writerSettings: t8, skipDeduplicate: s3 }, e10, n7);
  }
  _createRenderable(e10, t8, r8, s3, n7) {
    const i7 = (t9) => new ne(new r5(this.rctx, /* @__PURE__ */ new Map([["vertices", this._vertexBuffer], ["instances", 0 === t9 ? new r4(this.rctx, f, e10.regular.instancesData.buffer) : new r4(this.rctx, m2, e10.silhouette.instancesData.buffer)]])), 0 === t9 ? e10.regular.lodInfo : e10.silhouette.lodInfo), o6 = e10.regular.lodInfo.lengths.length > 0 ? i7(0) : null, a6 = e10.silhouette.lodInfo.lengths.length > 0 ? i7(1) : null, c3 = (o6?.vao.usedMemory ?? 0) + (a6?.vao.usedMemory ?? 0);
    return new oe(o6, a6, { gpuMemoryUsage: c3, externalMemoryUsage: n7, averageEdgeLength: e10.averageEdgeLength }, r8, r7(t8.meta), e9(t8.meta), t8, s3);
  }
  async _addGeometry(e10, t8, r8, s3, n7, i7) {
    if (r8.edgeIndicesLength <= 0) return;
    const o6 = r8.attributes.get("position"), a6 = e2(), c3 = this._computeModelTransformWithLocalOrigin(e10, r8, a6), l2 = new pe(o6, a6, c3);
    return this._addPositionData(t8, l2, r8.edgeIndicesLength, s3, n7, i7);
  }
  async _addPositionData(e10, t8, r8, s3, n7, i7 = false) {
    if (null == e10.loaded) return;
    const o6 = this._createComponentBuffers([s3]);
    if (null == o6) return;
    const a6 = this._acquireRenderer(s3.type, n7, true), { modelTransform: c3, origin: l2 } = t8, d3 = t8.position.indices, h5 = t8.position, u5 = h5.data.length / h5.size, m5 = t2.createBuffer(u5);
    for (let f4 = 0; f4 < u5; f4++) m5.position.set(f4, 0, h5.data[f4 * h5.size]), m5.position.set(f4, 1, h5.data[f4 * h5.size + 1]), m5.position.set(f4, 2, h5.data[f4 * h5.size + 2]);
    i6(o6.meta, [0, m5.componentIndex.count], m5.componentIndex);
    const g2 = await this._updatingHandles.addPromise(this._extractEdges(e10.abort?.signal || this._workerAbort.signal, a6.writerSettings, m5, false, i7, d3, r8));
    if (null == e10.loaded) return;
    const p2 = this._createRenderable(g2, o6, new ie(c3, l2), a6.key, false);
    e10.renderables.push(p2), a6.addRenderable(p2), this._gpuMemoryUsage += p2.statistics.gpuMemoryUsage;
  }
  async _addComponentGeometry(e10, t8, r8, s3, n7, i7, o6, a6) {
    if (null == t8.loaded) return 0;
    const c3 = this._createComponentBuffers(i7);
    if (null == c3) return 0;
    const l2 = t7(i7), d3 = this._acquireRenderer(l2, o6 || false, false), h5 = t2.createBuffer(r8.length / 3);
    t3(h5.position.typedBuffer, r8, h5.position.typedBufferStride, 3), i6(c3.meta, n7, h5.componentIndex, s3);
    const u5 = true, m5 = d3.writerSettings, g2 = await this._updatingHandles.addPromise(this._extractEdges(this._workerAbort.signal, m5, h5, u5, false, s3));
    if (null == t8.loaded) return 0;
    const p2 = this._createRenderable(g2, c3, e10, d3.key, true);
    return t8.renderables.push(p2), d3.addRenderable(p2), this._updateAllVerticalOffsets(t8, a6), p2.statistics.gpuMemoryUsage;
  }
  async _addObjectMergedGeometries(e10, t8, r8, s3, n7) {
    const i7 = /* @__PURE__ */ new Map();
    let o6 = 0, a6 = 0, c3 = null;
    const l2 = e10.geometries.filter((e11) => {
      if (e11.edgeIndicesLength <= 0 || !e11.material.supportsEdges) return false;
      !c3 && e11.localOrigin && (c3 = e11);
      const t9 = e11.positionAttribute;
      return a6 += t9.data.length / t9.size, o6 += e11.edgeIndicesLength, true;
    });
    if (0 === l2.length) return;
    const d3 = a6 >= 65536 ? Uint32Array : Uint16Array, h5 = o6 ? new d3(o6) : null, u5 = [];
    let m5 = 0;
    l2.forEach((e11) => {
      const t9 = e11.attributes.get("position"), r9 = t9.indices;
      let s4 = i7.get(t9.data);
      if (null == s4) {
        s4 = u5.length / 3;
        for (let e12 = 0; e12 < t9.data.length; e12 += t9.size) u5.push(t9.data[e12]), u5.push(t9.data[e12 + 1]), u5.push(t9.data[e12 + 2]);
        i7.set(t9.data, s4);
      }
      for (let n8 = 0; n8 < e11.edgeIndicesLength; n8++) h5[m5++] = s4 + r9[n8];
    });
    const g2 = c3 || e10.geometries[0], p2 = e2(), _3 = this._computeModelTransformWithLocalOrigin(e10, g2, p2);
    for (let f4 = 0; f4 < e10.geometries.length; f4++) e10.geometries[f4].localOrigin = _3.origin;
    const b2 = new pe(new t4(u5, h5, 3), p2, _3);
    await this._updatingHandles.addPromise(this._addPositionData(t8, b2, h5.length, r8, s3, n7));
  }
  _acquireRenderer(e10, t8, r8) {
    const s3 = g.getKey(e10, t8, r8);
    let n7 = this._renderers.get(s3);
    return null == this._strokesTexture && (this._strokesTexture = o4(this.rctx)), n7 || (n7 = new g(this.rctx, this.techniques, { type: e10, hasSlicePlane: t8, strokesTexture: this._strokesTexture, legacy: r8, spherical: 1 === this.viewingMode }), this._renderers.set(s3, n7)), ++n7.refCount, n7;
  }
  _removeRenderable(e10) {
    ee(e10.regular), ee(e10.silhouette);
    const t8 = this._renderers.get(e10.rendererKey);
    if (t8) {
      t8.removeRenderable(e10), --t8.refCount, this._localOrigins.release(e10.transform.origin), this._gpuMemoryUsage -= e10.statistics.externalMemoryUsage ? 0 : e10.statistics.gpuMemoryUsage;
      for (const t9 of e10.components.meta) e10.components.buffer.releaseIndex(t9.index);
    }
  }
  _updateObjectCameraDistances(e10) {
    const t8 = e10.camera.eye, r8 = e10.camera.viewForward, s3 = n(), n7 = (e11) => {
      R(s3, e11.center, t8);
      const n8 = P(s3, r8), i7 = e11.radius, o6 = n8 < -i7 ? 1 / 0 : n8 < i7 ? 0 : n8 - i7;
      e11.renderables.forEach((e12) => e12.distanceToCamera = o6);
    };
    this._objectEntries.forEach(n7), this._pendingDeletions.forEach(n7);
  }
  get test() {
  }
};
function ee(e10) {
  e10?.vao && (e10.vao.buffer("instances")?.dispose(), e10.vao.disposeVAOOnly(), e10.vao = null);
}
function te(e10) {
  let t8 = null, s3 = null;
  for (const n7 of e10.geometries) {
    if (n7.material.supportsEdges) {
      if (t8) {
        if (!h(t8, n7.transformation)) return false;
      } else t8 = n7.transformation;
      if (s3 || null == n7.localOrigin) {
        if (null != s3?.localOrigin && null != n7.localOrigin && s3.localOrigin.id !== n7.localOrigin.id) return false;
      } else s3 = n7;
    }
  }
  return true;
}
__decorate([m({ constructOnly: true })], $.prototype, "rctx", void 0), __decorate([m({ constructOnly: true })], $.prototype, "renderSR", void 0), __decorate([m({ constructOnly: true })], $.prototype, "viewingMode", void 0), __decorate([m({ constructOnly: true })], $.prototype, "techniques", void 0), __decorate([m({ constructOnly: true })], $.prototype, "setNeedsRender", void 0), __decorate([m({ constructOnly: true })], $.prototype, "schedule", void 0), __decorate([m({ readOnly: true })], $.prototype, "_updatingHandles", void 0), __decorate([m({ readOnly: true })], $.prototype, "updating", null), $ = __decorate([a("esri.views.3d.webgl-engine.lib.edgeRendering.EdgeView")], $);
var re = class {
  constructor(e10, t8, r8, s3) {
    this.abort = e10, this.radius = s3, this.renderables = new Array();
    const n7 = e10 ? h2(e10.signal, () => e10.abort()) : null;
    this.loaded = t8, this.loaded.then(() => {
      null != this.loaded && (this.loaded = true), this.abort = null, n7?.remove();
    }), this.center = t(r8);
  }
};
var se = class {
  constructor(e10, t8) {
    this.buffer = e10, this.meta = t8;
  }
};
var ne = class {
  constructor(e10, t8) {
    this.vao = e10, this.lod = t8;
  }
};
var ie = class {
  constructor(e10, t8) {
    this.modelMatrix = e10, this.origin = t8;
  }
};
var oe = class {
  constructor(e10, t8, r8, s3, n7, i7, o6, a6) {
    this.regular = e10, this.silhouette = t8, this.statistics = r8, this.transform = s3, this.edgeTransparency = n7, this.objectTransparency = i7, this.components = o6, this.rendererKey = a6, this.distanceToCamera = 0, this.visible = true;
  }
};
var ae = class extends oe {
};
function ce(e10) {
  const { meta: t8, buffer: r8 } = e10, s3 = new Uint8Array(4);
  for (let n7 = 0; n7 < t8.length; n7++) {
    const e11 = t8[n7].material, o6 = t8[n7].index, a6 = r(Math.round(e11.size * c), 0, 255), c3 = r(e11.extensionLength, -m4, 255 - m4) + m4, l2 = 255 * e11.opacity, d3 = e11.color, h5 = 255 * d3[0], u5 = 255 * d3[1], m5 = 255 * d3[2], g2 = 255 * d3[3];
    r8.textureBuffer.setData(o6, 0, h5, u5, m5, g2), r8.textureBuffer.setData(o6, 1, a6, c3, e11.type, l2), C(t8[n7].verticalOffset, s3), r8.textureBuffer.setData(o6, 2, s3[0], s3[1], s3[2], s3[3]);
  }
}
function le(e10, t8, r8) {
  let s3, n7;
  const i7 = r8.transparency, o6 = t8.camera.perScreenPixelRatio;
  e10.forEachRenderable((i8) => {
    if (!he(i8) || !i8.visible) return;
    s3 ??= e10.acquireTechnique(t8, false), n7 ??= e10.rctx.bindTechnique(s3, t8, r8);
    const a6 = ge(i8.regular.lod.lengths, i8.distanceToCamera, o6);
    e10.renderRegularEdges(n7, i8, r8, t8, a6);
  }, i7);
}
function de(e10, t8, r8) {
  let s3, n7;
  const i7 = r8.transparency, o6 = t8.camera.perScreenPixelRatio;
  e10.forEachRenderable((i8) => {
    if (!me(i8) || !i8.visible) return;
    s3 ??= e10.acquireTechnique(t8, true), n7 ??= e10.rctx.bindTechnique(s3, t8, r8);
    const a6 = ge(i8.silhouette.lod.lengths, i8.distanceToCamera, o6);
    e10.renderSilhouetteEdges(n7, i8, r8, t8, a6);
  }, i7);
}
function he(e10) {
  return null != e10.regular;
}
var ue = class extends oe {
};
function me(e10) {
  return null != e10.silhouette;
}
function ge(e10, t8, r8) {
  const n7 = t8 * r8, i7 = w(e10, n7, true);
  return -1 === i7 ? n7 < e10[0] ? e10.length : 0 : e10.length - i7;
}
var pe = class {
  constructor(e10, t8, r8) {
    this.position = e10, this.modelTransform = t8, this.origin = r8;
  }
};
var fe = e();
var _e = () => Promise.reject();
export {
  $ as EdgeView,
  ie as LegacyTransform,
  ae as RegularRenderable,
  oe as Renderable,
  ue as SilhouetteRenderable
};
//# sourceMappingURL=EdgeView-IJG5QNT4.js.map
