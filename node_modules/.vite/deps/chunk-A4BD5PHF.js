...
function a3(t, r2) {
  ...
  return s4.length ? s4.map((r3) => {
    const i3 = n2(t, r3), s5 = l(i3, r3.definitionExpression);
...
async function f4(u7, i2, f5) {
  ...
  return l4.path += "/identify", P(c2).then((e4) => {
    const t = o3(i2, { geometry: e4?.[0] }), u8 = u({ ...l4.query, f: "json", ...t }), a5 = s3(u8, f5);
...
var P2 = class extends b {
  ...
  _updatePointSymbology(e4) {
    ...
    r2 && "getSymbolAsync" in r2 ? r2.getSymbolAsync(e4).then(async (i3) => {
      ...
      n4 && (G || (G = (await import("./visualVariableUtils-XV53R3R5.js")).getSize), l4 = G(n4, e4, { view: o4.type, scale: o4.scale, shape: "simple-marker" === i3.type ? i3.style : null })), l4 ||= "width" in i3 && "height" in i3 && null != i3.width && null != i3.height ? Math.max(i3.width, i3.height) : "size" in i3 ? i3.size : 16, s4?.includes(e4) && (this._setGraphicSymbol(e4, new u3({ style: "square", size: l4, color: new u2([255, 255, 255, 1 / 255]), xoffset: "xoffset" in i3 ? i3.xoffset : 0, yoffset: "yoffset" in i3 ? i3.yoffset : 0 })), a5(e4));
    }) : a5(e4);
  }
  get _updateContext() {
...
//# sourceMappingURL=chunk-A4BD5PHF.js.map
