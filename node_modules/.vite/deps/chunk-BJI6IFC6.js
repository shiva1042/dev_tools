...
function s(e2) {
  return e2 && e2.enabled && (e(e2) || t(e2)) && null != e2.edges;
}
function c(e2) {
...
function u4(r2, i) {
  ...
  const s2 = null != r2.color ? u3(u2.toUnitRGBA(r2.color)) : r(0, 0, 0, 0), c2 = u(r2.size), l2 = u(r2.extensionLength);
  switch (r2.type) {
    case "solid":
      return a({ color: s2, size: c2, extensionLength: l2, ...i });
    case "sketch":
      return f({ color: s2, size: c2, extensionLength: l2, ...i });
    default:
      return;
  }
}
...
//# sourceMappingURL=chunk-BJI6IFC6.js.map
