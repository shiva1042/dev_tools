import {
  h as h7
} from "./chunk-KBTKGAQ5.js";
import {
  j as j3
} from "./chunk-FYUVL3YM.js";
import {
  i as i4,
  p as p4
...
async function F3(e8, i7) {
  if ("3d" === e8.type) {
    const t5 = new e6({ graphic: i7 }), r3 = e8.trackGraphicState(t5);
    await j(() => t5.displaying || t5.error), r3.remove();
  } else await j(() => i7.visible);
}
async function b2(e8, i7) {
  const t5 = m3(i7) || p3(i7) ? i7.parent : i7;
...
function w4(t5, o, n5, { automaticLengthMeasurementUtils: i7 }) {
  if (!n5) return;
  const { x: a4, y: s4 } = n5.origin, c3 = o.toMap(n5), l7 = o.toMap(i3(a4, s4)), p5 = i7.autoDistanceBetweenPoints2D(l7, c3);
...
var T2 = { vertices: { default: new u5({ style: "circle", size: E.vertex.size, color: E.vertex.color, outline: { color: E.vertex.outlineColor, width: 1 } }), hover: new u5({ style: "circle", size: E.vertex.hoverSize, color: E.vertex.hoverColor, outline: { color: E.vertex.hoverOutlineColor, width: 1 } }), selected: new u5({ style: "circle", size: E.selected.size, color: E.selected.color, outline: { color: E.selected.outlineColor, width: 1 } }) }, controlPoints: { default: new u5({ style: "diamond", size: E.vertex.size, color: E.vertex.color, outline: { color: E.vertex.outlineColor, width: 1 } }), hover: new u5({ style: "diamond", size: E.vertex.hoverSize, color: E.vertex.hoverColor, outline: { color: E.vertex.hoverOutlineColor, width: 1 } }), selected: new u5({ style: "diamond", size: E.selected.size, color: E.selected.color, outline: { color: E.selected.outlineColor, width: 1 } }) }, midpoints: { default: new u5({ style: "circle", size: E.midpoint.size, color: E.midpoint.color, outline: { color: E.midpoint.outlineColor, width: 1 } }), hover: new u5({ style: "circle", size: E.midpoint.size, color: E.midpoint.color, outline: { color: E.midpoint.outlineColor, width: 1 } }) }, constructionLines: new m2({ style: "solid", width: 1, color: E.vertex.color }) };
function K(t5, o, r3) {
  const n5 = [];
...
function M2(e8, t5, r3) {
  ...
  if (i2(t5)) return new _({ x: w5, y: j6, z: P3, m: S, spatialReference: l7 });
  if (t3(t5)) {
    const [e9, r4] = p(i7, t5, 0.5);
  ...
  const C2 = p2(i7, t5), [R3, U4] = d(C2, 0.5);
...
function V(e8, t5) {
  ...
  const o = t5.some((e9) => e9.some((e10) => !i2(e10)));
...
var _t = class extends l {
  ...
  _saveSnappingContextForHandle(t5, e8) {
    ...
    n(i7), this._snappingContext = new e7({ editGeometryOperations: i7, elevationInfo: { mode: "on-the-ground", offset: 0 }, pointer: e8.viewEvent?.pointerType || "mouse", excludeFeature: this.graphic, feature: this.graphic, visualizer: new f6(this._snappingGraphicsLayer), vertexHandle: this._getVertexFromEditGeometry(t5) });
  }
  _reset() {
  ...
  _onHandleMove(t5, e8, s4, o, r3) {
    ...
    if (a4 && s3(a4)) if (null != this.snappingManager && this.selectedManipulators.length < 2 && !h9) {
      ...
      this._stagedVertex = o2.update({ point: a4, context: n5 }), this._syncGeometryAfterVertexMove(t5, new _(this._stagedVertex), e8, s4, h9), r3(), this._snappingTask = d2(async (i7) => {
...
function St(t5, e8, i7, s4, o) {
  ...
  const a4 = f3(r3);
  if (i2(r3)) r3.splice(0, r3.length, ...s4);
...
//# sourceMappingURL=Reshape-2HZXRTCB.js.map
