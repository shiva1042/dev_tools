...
async function b2(e8, i7) {
  const t5 = m2(i7) || p3(i7) ? i7.parent : i7;
...
function G3(t5, o, n5) {
  ...
  for (let l7 = 0; l7 < t5.length; l7++) {
    ...
    for (let t6 = 1; t6 < n6.length; t6++) {
      ...
      i7.push(new _2({ geometry: new y({ paths: [[[m4[0], m4[1]], p5]], spatialReference: s4 }), symbol: o?.constructionLines, attributes: { ...f7, [R2.controlPointKind]: U3.bezier.line1 } }), new _2({ geometry: new y({ paths: [[[a4[0], a4[1]], u6]], spatialReference: s4 }), symbol: o?.constructionLines, attributes: { ...f7, [R2.controlPointKind]: U3.bezier.line2 } }));
    }
  }
  return i7;
}
...
var _t = class extends l {
  ...
  _setup() {
    ...
    "mesh" !== i7.type && "extent" !== i7.type ? ("polygon" === i7.type && y2(i7), this._setUpHighlights(), this._setupGraphics(), this._setupMover(), this._setupConnectedReshapeManager()) : this._logGeometryTypeError();
  }
  _setUpHighlights() {
  ...
  _updateCurveGraphicLocations(t5) {
    ...
    for (const s4 of this.selectedManipulators) {
      const [t6, e9] = Et(s4);
      null != t6 && null != e9 && s4.getAttribute(R2.controlPointKind) && e3(i7, t6, () => /* @__PURE__ */ new Set())?.add(e9);
    }
    ...
    for (const s4 of this.constructionLineGraphics) {
      ...
      i8 === U3.bezier.line1 ? s4.geometry = new y({ paths: [[[a4[0], a4[1]], [...p5.b[1]]]], spatialReference: e8 }) : s4.geometry = new y({ paths: [[[h9[0], h9[1]], [...p5.b[2]]]], spatialReference: e8 });
    }
  }
...
function Ct(t5, e8, i7) {
  const s4 = x2(new y({ curvePaths: [[t5, e8]], spatialReference: i7 })), { curvePaths: o } = j2(s4, i7), r3 = o[0][1];
...
//# sourceMappingURL=Reshape-I6J5E7KY.js.map
