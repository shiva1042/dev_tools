...
function o(r2) {
  if ("string" == typeof r2) {
    const u2 = r2.match(n);
    if (u2) {
      const n2 = Number(u2[1]), t2 = u2[3] && u2[3].toLowerCase(), o2 = r2.startsWith("-"), i2 = "px" === t2 ? e(n2) : n2;
      return o2 ? -i2 : i2;
    }
...
function i(n2 = 0, t2 = 0) {
  return { x: n2, y: t2 };
}
function c(n2) {
  return n2 ? i(n2.x, n2.y) : null;
}
function f(n2 = 0, t2 = 0) {
  return [n2, t2];
}
function x(n2 = 0, t2 = 0) {
  return l([n2, t2]);
}
...
//# sourceMappingURL=chunk-CSMCPN64.js.map
