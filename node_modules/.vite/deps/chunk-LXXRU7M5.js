...
var n5 = null;
function r5() {
  return n5 || (n5 = import("./lerc-wasm-TGPE2X3B.js").then((e7) => e7.l).then(({ default: t8 }) => t8({ locateFile: (t9) => n2(`esri/layers/support/rasterFormats/${t9}`) })).then((e7) => {
    l2(e7);
  }), n5);
}
...
var e3;
function o7() {
  return e3 ??= import("./qb3-wasm-GPKP645L.js").then(({ default: n15 }) => n15({ locateFile: (n16) => n2(`esri/layers/support/rasterFormats/${n16}`) })).then((t8) => {
    u4(t8);
  }), e3;
}
...
//# sourceMappingURL=chunk-LXXRU7M5.js.map
