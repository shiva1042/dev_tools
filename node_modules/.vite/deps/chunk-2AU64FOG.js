...
async function S(e, t, r2) {
  ...
  if (V(t, i2, r2, !!n, !!o, `${e.type}-layer`), !i2.data.isVersioned && r2?.gdbVersion) throw new s(`${e.type}-layer:invalid-parameter`, "'gdbVersion' is applicable only if the layer supports versioned data. See: 'capabilities.data.isVersioned'");
  ...
  const u = G2(t, i2, `${e.type}-layer`), p3 = r2?.globalIdUsed || l, c3 = e.fields.filter((e2) => "big-integer" === e2.type || "oid" === e2.type && (e2.length || 0) >= 8);
  if (p3) {
...
function D(e) {
  return { addFeatures: Array.from(e?.addFeatures ?? []), updateFeatures: Array.from(e?.updateFeatures ?? []), deleteFeatures: e && O.isCollection(e.deleteFeatures) ? e.deleteFeatures.toArray() : e.deleteFeatures || [], addAttachments: e.addAttachments || [], updateAttachments: e.updateAttachments || [], deleteAttachments: e.deleteAttachments || [] };
}
function G2(e, t, r2) {
  const s2 = D(e);
...
function V(e, t, r2, s2, i2, n) {
  if (!(e && (s2 || i2) || r2?.usingTelecomOperations)) throw new s(`${n}:missing-parameters`, "'addFeatures', 'updateFeatures', 'deleteFeatures', 'addAttachments', 'updateAttachments' or 'deleteAttachments' parameter is required");
...
//# sourceMappingURL=chunk-2AU64FOG.js.map
