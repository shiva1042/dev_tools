...
var p = class extends h(r) {
  ...
  get allFields() {
    const { longitude: o, latitude: t, x: e, y: r2, elevation: s, area: i2, totalLength: l, geometryType: p2 } = this;
    return [o, t, e, r2, s, ..."multipoint" === p2 ? [] : ["polygon" === p2 ? i2 : l]];
  }
};
...
//# sourceMappingURL=chunk-TZJSWCDQ.js.map
