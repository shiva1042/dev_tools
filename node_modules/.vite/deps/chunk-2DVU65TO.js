...
function l4(r4) {
  const { spatialReference: f8, vertexSpace: l5, untransformedBounds: d5 } = r4, g5 = f2(d5, u6);
  if (t(l5) && r4.transform && r2(g5, g5, r4.transform.localMatrix), "georeferenced" === l5.type) {
    const r5 = l5.origin;
    return r5 && a6(g5, g5, r5), c2(m4(g5), f8);
  }
  ...
  return f4(f8, B2, x3, y3), r2(g5, g5, x3), o(g5, y3, 0, g5, f8, 0), c2(m4(g5), f8);
}
var x3 = e2();
var u6 = e3(24);
...
async function m6(e6, o4, n6) {
  const { source: i6 } = o4, { loadGLTFMesh: a9 } = await p(import("./loadGLTFMesh-GF7KIRQR.js"), n6), l5 = await p4(i6, n6);
  s2(n6);
...
function G2(t4, e6, r4) {
  ...
  b2(Z, w2(e6), z3(e6));
  const S2 = D(N2, Z, a4, _2, d5), { localMatrix: U2 } = c10, q3 = c3(N2, S2, U2);
  c10.scale = O2(n3(), q3), f3(q3, q3, z2(K, c10.scale));
...
function z4(e6, s4, f8) {
  ...
  const S2 = o2(V2, s4, s4, s4), U2 = D(D2, r3, a4, S2, F3), { localMatrix: q3 } = x6, z5 = c3(D2, U2, q3);
  x6.scale = O2(n3(), z5), f3(z5, z5, z2(T2, x6.scale));
...
var Y2 = Q3 = class extends l2(p2(m3(c))) {
  ...
  async toBinaryGLTF(e6) {
    const [{ toBinaryGLTF: t4 }] = await Promise.all([import("./gltfexport-S3J5RQU6.js"), this.load(e6)]);
  ...
  static async createFromGLTF(e6, t4, r4) {
    ...
    const { loadGLTFMesh: o4 } = await p(import("./loadGLTFMesh-GF7KIRQR.js"), r4);
...
//# sourceMappingURL=chunk-2DVU65TO.js.map
