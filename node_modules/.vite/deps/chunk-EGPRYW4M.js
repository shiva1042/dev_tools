...
var j = class _j {
  ...
  _onOpenedMessage(e3) {
    ...
    r3 && (this._outJobs.delete(t2), l2(r3.abortHandle), r3.resolve(s6));
  }
  _onResponseMessage(t2) {
    const { jobId: s6, error: r3, data: n3 } = t2, a7 = this._outJobs.get(s6);
    a7 && (this._outJobs.delete(s6), l2(a7.abortHandle), r3 ? a7.reject(s2.fromJSON(JSON.parse(r3))) : a7.resolve(n3));
  }
  _post(e3, t2, o2) {
...
//# sourceMappingURL=chunk-EGPRYW4M.js.map
