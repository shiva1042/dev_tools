...
var c = class extends b {
  ...
  async update(t, r) {
    const { addOrUpdateResources: e } = await import("./resourceUtils-G2E6S7KI.js");
...
var k = v = class extends a3(u) {
  ...
  async fetchResources(e = {}, t) {
    const { fetchResources: i2 } = await import("./resourceUtils-G2E6S7KI.js");
    return i2(this, e, t);
  }
  async addResource(e, t, i2) {
    const { addOrUpdateResources: r } = await import("./resourceUtils-G2E6S7KI.js");
  ...
  async removeResource(e, t) {
    const { removeResource: r } = await import("./resourceUtils-G2E6S7KI.js");
  ...
  async removeAllResources(e) {
    const { removeAllResources: t } = await import("./resourceUtils-G2E6S7KI.js");
    return t(this, e);
  }
  resourceFromPath(e) {
...
//# sourceMappingURL=chunk-XEVN3NFF.js.map
