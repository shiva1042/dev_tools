...
import {
  ...
  p as p4,
  y as y2
} from "./chunk-2SYJ5NSJ.js";
import {
  _ as _3
} from "./chunk-DPNSXZO2.js";
import "./chunk-L54ODCLH.js";
import "./chunk-HSGAIOKM.js";
import "./chunk-WVAXXVEK.js";
import "./chunk-C6ZAHCET.js";
import "./chunk-MHBIAIJ3.js";
import {
  t as t3
} from "./chunk-JDJ3RJJL.js";
import {
  s as s8
} from "./chunk-B6QFZJU6.js";
import "./chunk-Y5VJJD7K.js";
...
import {
  p as p2,
  s as s5
} from "./chunk-ATC6PQTN.js";
import {
  s as s6
} from "./chunk-I73JTYWI.js";
import {
  f as f2
} from "./chunk-L7CJGVKE.js";
import {
  u as u3
} from "./chunk-QIEUOOJS.js";
import {
  c
...
var Te = class extends a7(F(_3(l3(b2(j2(t(l(s4(o3(l2(b3))))))))))) {
  ...
  async applyEdits(e3, t6) {
    const { applyEdits: r3 } = await import("./editingSupport-WNSNV4EB.js");
    let i6 = t6;
    await this.load();
  ...
  async convertMesh(e3, t6) {
    ...
    const n8 = this.spatialReference, p6 = t6.origin ?? t6.location, d5 = await H2(p6 ?? t6.defaultOrigin ?? new _({ x: 0, y: 0, z: 0, spatialReference: n8 }), n8, t6), y3 = d5.spatialReference.isGeographic ? "local" : "georeferenced", { default: u5 } = await import("./Mesh-BH3ZMZBE.js");
    s2(t6);
...
//# sourceMappingURL=SceneLayer-P6QZN67Q.js.map
