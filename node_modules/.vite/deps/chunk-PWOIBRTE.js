...
function P(e2, n3, o3) {
  if (oe(e2, 2, 2, n3, o3), e2[0] instanceof c && e2[1] instanceof c) ;
  else if (e2[0] instanceof c && null === e2[1]) ;
  else if (e2[1] instanceof c && null === e2[0]) ;
  else if (null !== e2[0] || null !== e2[1]) throw new n(n3, "InvalidParameter", o3);
}
function x(e2) {
  ...
  if (e2.spatialReference.vcsWkid || e2.spatialReference.latestVcsWkid) {
    n3 = i(e2.spatialReference) / ae(e2.spatialReference);
  }
  let t = 0;
...
var I = (n3, o3, i2) => {
  ...
  let u = i2[0];
  if ((o2(i2[0]) || te(i2[0])) && (u = ve(i2[0], n3.spatialReference)), null === u) return null;
  if (!(u instanceof c)) throw new n(n3, "InvalidParameter", o3);
  if (!(u instanceof y)) throw new n(n3, "InvalidParameter", o3);
  if (!n2(i2[1])) throw new n(n3, "InvalidParameter", o3);
  const c2 = M(u, i2[1]);
  return c2 ? p.convertObjectToArcadeDictionary(c2, Ke(n3), false, true) : null;
};
var R = (n3, o3, i2) => {
  if (i2 = Je(i2), oe(i2, 2, 2, n3, o3), null === i2[0]) return null;
  let u = i2[0];
  ...
  if (!(c2 instanceof _)) throw new n(n3, "InvalidParameter", o3);
  const m = W(u, c2);
...
var k = new o(["geodesic", "great-elliptic", "loxodrome", "normal-section", "shape-preserving"]);
function D(e2) {
  return null == e2 ? "geodesic" : k.get(ge(e2));
}
var A = new o(["geometric", "labelPoint"]);
function O(e2) {
...
//# sourceMappingURL=chunk-PWOIBRTE.js.map
