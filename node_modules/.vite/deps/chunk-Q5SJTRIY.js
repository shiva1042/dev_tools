...
var G = class extends u {
  ...
  async uploadAssets(e2, t3) {
    const { uploadAssets: r2 } = await import("./uploadAssets-HJ3NER3J.js");
  ...
  async _uploadMeshesAndGetAssetMapEditsJSON(e2) {
    ...
    for (const i5 of t3) {
      ...
      if (t(t4)) s4.push(e3);
        ...
        const t5 = e3.origin, { convertMeshVertexSpace: r3 } = await import("./convertMeshVertexSpace-7VQBBUOH.js"), n = await r3(e3, new i2({ origin: [t5.x, t5.y, t5.z ?? 0] }));
...
//# sourceMappingURL=chunk-Q5SJTRIY.js.map
