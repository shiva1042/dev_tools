...
var e5 = class extends i3 {
  constructor(r4, e6, o4, s2) {
    super(r4, "vec4", 1, (o5, t3, c4) => o5.setUniform4fv(r4, e6(t3, c4), s2), o4);
  }
};
...
function F(t3, o4, e6, i4 = e3()) {
  const s2 = t3 || 0, r4 = o4 || 0, n5 = e6 || 0;
  return 0 !== s2 && x(i4, i4, -s2 / 180 * Math.PI), 0 !== r4 && l(i4, i4, r4 / 180 * Math.PI), 0 !== n5 && m(i4, i4, n5 / 180 * Math.PI), i4;
}
function A(t3, o4, e6, i4, s2) {
  const r4 = t3.minSize, n5 = t3.maxSize;
  ...
  if (U(t3.field)) return U(t3.stops) ? 2 === t3.stops.length && n4(t3.stops[0].size) && n4(t3.stops[1].size) ? (R(t3.stops[0].size, t3.stops[1].size, t3.stops[0].value, t3.stops[1].value, o4, e6), o4.type[e6] = 1, true) : (D(s2, "Could not convert size info: stops only supported with 2 elements"), false) : n4(r4) && n4(n5) && U(t3.minDataValue) && U(t3.maxDataValue) ? (R(r4, n5, t3.minDataValue, t3.maxDataValue, o4, e6), o4.type[e6] = 1, true) : "unknown" === t3.valueUnit ? (D(s2, "Could not convert size info: proportional size not supported"), false) : null != m2[t3.valueUnit] ? (o4.minSize[e6] = -1 / 0, o4.maxSize[e6] = 1 / 0, o4.offset[e6] = 0, o4.factor[e6] = 1 / m2[t3.valueUnit], o4.type[e6] = 1, true) : (D(s2, "Could not convert size info: scale-dependent size not supported"), false);
  if (!U(t3.field)) {
    if (t3.stops?.[0] && n4(t3.stops[0].size)) return o4.minSize[e6] = t3.stops[0].size, o4.maxSize[e6] = t3.stops[0].size, o4.offset[e6] = o4.minSize[e6], o4.factor[e6] = 0, o4.type[e6] = 1, true;
    if (n4(r4)) return o4.minSize[e6] = r4, o4.maxSize[e6] = r4, o4.offset[e6] = r4, o4.factor[e6] = 0, o4.type[e6] = 1, true;
  }
  return D(s2, "Could not convert size info: unsupported variant of sizeInfo"), false;
}
function R(t3, o4, e6, i4, s2, r4) {
  const n5 = Math.abs(i4 - e6) > 0 ? (o4 - t3) / (i4 - e6) : 0;
  s2.minSize[r4] = n5 > 0 ? t3 : o4, s2.maxSize[r4] = n5 > 0 ? o4 : t3, s2.offset[r4] = t3 - e6 * n5, s2.factor[r4] = n5;
}
...
function q(t3, o4, e6, i4) {
  ...
  if (e2(t3.field)) {
    if (!t3.stops) return D(i4, "Could not convert color info: missing stops or colors"), null;
    {
      ...
      a(o4.color.fallback, e6.fallbackColor);
    }
  } else {
...
function L(t3, o4, e6) {
  if (!e2(t3.field)) return D(e6, "Could not convert rotation info: field is not a string"), null;
  if (o4.rotation) {
...
var G = class {
  constructor({ supports: t3, modelSize: o4, symbolSize: e6, unitInMeters: i4, anchor: s2, scale: r4, rotation: n5, fallbackColor: l2, fallbackSize: a2 }) {
    this.supports = t3, this.modelSize = o4 ?? c(), this.symbolSize = e6 ?? c(), this.unitInMeters = i4 ?? 1, this.anchor = s2 ?? o(), this.scale = r4 ?? c(), this.rotation = n5 ?? o(), this.fallbackColor = l2 ?? i2(), this.fallbackSize = a2 ?? c();
  }
};
function H(t3, o4, e6) {
  if (!t3) return null;
...
function Y(t3, s2) {
  const r4 = new X(t3);
  return r4.vvSize && (r4.vvSymbolAnchor = s2.anchor, o2(st), F(s2.rotation[2], s2.rotation[0], s2.rotation[1], st), r4.vvSymbolRotationMatrix = r4.vvSymbolRotationMatrix || e(), n2(r4.vvSymbolRotationMatrix, st)), r4;
}
function Z(t3, o4, e6) {
...
function tt(o4, e6, i4) {
  ...
  for (let s2 = 0; s2 < 3; ++s2) {
    const r4 = e6.vvSize.offset[s2] + i4[0] * e6.vvSize.factor[s2];
    o4[s2] = r(r4, e6.vvSize.minSize[s2], e6.vvSize.maxSize[s2]);
  }
  return o4;
}
function ot(t3, o4) {
...
//# sourceMappingURL=chunk-WRKEMHFL.js.map
