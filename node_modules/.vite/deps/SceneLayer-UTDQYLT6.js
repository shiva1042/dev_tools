...
import {
  ...
  p as p4,
  y as y2
} from "./chunk-QKEXC7EE.js";
import {
  _ as _3
} from "./chunk-NWGGQEDO.js";
import "./chunk-6BVIY2LF.js";
import {
  a as a5
} from "./chunk-MQWZZCFT.js";
import "./chunk-E4BIOPJF.js";
...
import {
  s as s3
} from "./chunk-CMXBYI7Z.js";
import "./chunk-HY4CI6EO.js";
...
import {
  l as l6
} from "./chunk-YJL27WJW.js";
import {
  j as j4
} from "./chunk-5JV7H2OM.js";
...
import {
  t as t2
} from "./chunk-GW3UXJZC.js";
import "./chunk-RTFBLPGL.js";
import {
  p as p2,
  s as s6
} from "./chunk-SUWOGZYM.js";
import {
  s as s7
} from "./chunk-AMUIEF6L.js";
import "./chunk-JW6DU3OK.js";
import {
  i as i3
} from "./chunk-HBUMKB76.js";
import {
  n as n5,
  r as r2
...
import {
  o as o3
} from "./chunk-SBHWVPAY.js";
import {
  l as l3
} from "./chunk-VYRLEE3T.js";
import {
  s as s5
} from "./chunk-NJFSAAYL.js";
...
import {
  f as f2
} from "./chunk-FLFQWBHK.js";
import {
  u as u3
} from "./chunk-GDVTKNZH.js";
import {
  c
} from "./chunk-ZALUGQVG.js";
import {
  I,
  b2,
  d as d3,
  ...
  p as p3,
  s as s8
} from "./chunk-52JTMLYN.js";
import {
  j as j2
} from "./chunk-Y7UPO3E6.js";
import {
  l
...
var n7 = /* @__PURE__ */ Symbol("isSceneGraphicOrigin");
...
async function t5(e3) {
  const { BlobReader: t6, ZipReader: r3, BlobWriter: n8 } = await import("./zipjs-wrapper-MGUMXAOV.js"), a8 = [], i6 = new r3(new t6(e3));
...
var Pe = s7();
var Te = class extends a7(F(_3(l3(b2(j2(t(l(s5(o3(l2(b3))))))))))) {
  constructor(...e3) {
  ...
  async applyEdits(e3, t6) {
    const { applyEdits: r3 } = await import("./editingSupport-4UAZMCRH.js");
    let i6 = t6;
    await this.load();
  ...
  async convertMesh(e3, t6) {
    t6 ??= {}, null != t6.location && m(i.getLogger(this), "The 'location' option of convertMesh() has been deprecated in favour of 'origin'.", { version: "4.34", replacement: "origin", warnOnce: true });
    const r3 = (e4) => {
    ...
    const n8 = this.spatialReference, p6 = t6.origin ?? t6.location, d5 = await H2(p6 ?? t6.defaultOrigin ?? new _({ x: 0, y: 0, z: 0, spatialReference: n8 }), n8, t6), y3 = d5.spatialReference.isGeographic ? "local" : "georeferenced", { default: u5 } = await import("./Mesh-TOFY6JBW.js");
    s2(t6);
  ...
  async _setAssociatedFeatureLayer(e3) {
    if (["mesh-pyramids", "points"].includes(this.profile)) try {
      const { serverUrl: t6, layerId: r3, portalItem: i6 } = await s3(`${this.url}/layers/${this.layerId}`, { sceneLayerItem: this.portalItem, customParameters: this.customParameters, apiKey: this.apiKey, signal: e3 }), s10 = await a5.FeatureLayer();
...
//# sourceMappingURL=SceneLayer-UTDQYLT6.js.map
