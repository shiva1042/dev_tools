...
import {
  h as h2
} from "./chunk-XFWUJDSA.js";
import {
  V
} from "./chunk-EPTHMV7G.js";
import {
  F
} from "./chunk-AUYTCWBC.js";
import {
  i as i3
} from "./chunk-FCFT4QGU.js";
import {
  t as t3
} from "./chunk-X7ZEPSO7.js";
import {
  F as F2
} from "./chunk-RJHJ7LOQ.js";
import {
  t as t4
} from "./chunk-DTQDF4FM.js";
import {
  c as c3
} from "./chunk-PN5NAFG4.js";
import {
  c as c4
} from "./chunk-LFQC5JX7.js";
import {
  t as t2
} from "./chunk-CVSE3DIY.js";
import {
  o as o3
} from "./chunk-3O3TIN46.js";
import {
  l as l5
} from "./chunk-TUGL3YBE.js";
import {
  e as e2
...
var T3 = class extends p3(m3(O)) {
  ...
  async _applyEdits(e4) {
    ...
    i3(r3 ? r3.features : null, i4, this.layer.spatialReference);
...
__decorate([n2({ Type: _, ensureType: w2(_) })], T3.prototype, "itemType", void 0), __decorate([m2()], T3.prototype, "type", void 0), __decorate([m2({ constructOnly: true })], T3.prototype, "layer", void 0), __decorate([m2({ readOnly: true })], T3.prototype, "_workerGeometryType", null), __decorate([m2()], T3.prototype, "sourceJSON", void 0), T3 = __decorate([a2("esri.layers.graphics.sources.MemorySource")], T3);
...
__decorate([m2()], e3.prototype, "updating", void 0), __decorate([m2()], e3.prototype, "status", void 0), e3 = __decorate([a2("esri.layers.support.PublishingInfo")], e3);

// node_modules/@arcgis/core/layers/mixins/PublishableLayer.js
var o6 = /* @__PURE__ */ Symbol();
var n7 = (i4) => {
  var _a;
  var n8;
  const c6 = i4;
  ...
  return __decorate([m2({ readOnly: true, clonable: false })], a8.prototype, "publishingInfo", null), a8 = __decorate([a2("esri.layers.mixins.PublishableLayer")], a8), a8;
};
...
__decorate([m2({ type: String, json: { write: true } })], p8.prototype, "alias", void 0), __decorate([m2({ type: String, nonNullable: true, json: { write: { isRequired: true } } })], p8.prototype, "name", void 0), __decorate([m2({ types: l4, json: { write: true } })], p8.prototype, "fieldFormat", void 0), p8 = __decorate([a2("esri.layers.support.FieldConfiguration")], p8);
...
var et = class extends V(f5(c2(n7(F2(a4(p4(p5(l6(e2(t(f3(l5(b4(j2(l(s4(o3(l2(b5))))))))))))))))))) {
  constructor(...e4) {
    super(...e4), this.attributeTableTemplate = null, this.charts = null, this.copyright = null, this.displayField = null, this.dynamicDataSource = null, this.fields = null, this.fieldsIndex = null, this.formTemplate = null, this.fullExtent = null, this.geometryType = null, this.graphicOrigin = new a6(this), this.hasM = void 0, this.hasZ = void 0, this.infoFor3D = null, this.isTable = false, this.labelsVisible = true, this.labelingInfo = null, this.legendEnabled = true, this.objectIdField = null, this.operationalLayerType = "ArcGISFeatureLayer", this.outFields = null, this.path = null, this.popupEnabled = true, this.popupTemplate = null, this.resourceInfo = null, this.screenSizePerspectiveEnabled = true, this.spatialReference = f2.WGS84, this.subtypeCode = null, this.supportedSourceTypes = /* @__PURE__ */ new Set(["Feature Layer", "Oriented Imagery Layer", "Table", "Catalog Layer"]), this.templates = null, this.timeInfo = null, this.title = null, this.sublayerTitleMode = "item-title", this.type = "feature", this.typeIdField = null, this.types = null, this.visible = true, this._debouncedSaveOperations = L(async (e5, t5, r3) => {
      const { save: i4, saveAs: o7 } = await import("./featureLayerUtils-CKQIL3CD.js");
      switch (e5) {
        case 0:
          return i4(this, t5);
        case 1:
  ...
  readTitle(e4, t5) {
    ...
    if (r3) {
      ...
      if ("item-title" === this.sublayerTitleMode) return this.url ? w(this.url, r3) : r3;
      let t6 = r3;
      if (!t6 && this.url) {
      ...
      if (!t6) return;
      return "item-title-and-service-name" === this.sublayerTitleMode && e5 && e5 !== t6 && (t6 = e5 + " - " + t6), m(t6);
    }
  ...
  async createGraphicsSource(e4) {
    ...
    const { default: t5 } = await p(import("./FeatureLayerSource-HZH6KNLE.js"), e4);
  ...
  async queryPivot(e4, t5) {
    ...
    const o7 = await import("./PivotQuery-LZOLDOLA.js"), a8 = await r3.queryPivot(o7.default.from(e4), t5);
  ...
  async queryTopFeatures(e4, t5) {
    ...
    const o7 = await import("./TopFeaturesQuery-O44QDCFT.js"), a8 = await r3.queryTopFeatures(o7.default.from(e4), t5);
    if (a8?.features) for (const s7 of a8.features) s7.layer = s7.sourceLayer = this;
    return a8;
  }
  async queryAttributeBins(e4, t5) {
    ...
    ae(e4, i4, ze);
    const o7 = await import("./AttributeBinsQuery-HEWA3SMN.js"), a8 = await r3.queryAttributeBins(o7.default.from(e4), t5);
    if (a8.features) for (const s7 of a8.features) s7.layer = s7.sourceLayer = this;
    return a8;
  }
  async queryTopObjectIds(e4, t5) {
    ...
    const o7 = await import("./TopFeaturesQuery-O44QDCFT.js");
...
__decorate([m2({ clonable: false, readOnly: true })], et.prototype, "_titleCreator", null), __decorate([m2(I)], et.prototype, "attributeTableTemplate", void 0), __decorate([o("service", "capabilities")], et.prototype, "readCapabilities", null), __decorate([m2({ json: { origins: { "web-scene": { write: false } }, write: true } })], et.prototype, "charts", void 0), __decorate([m2({ readOnly: true })], et.prototype, "createQueryVersion", null), __decorate([m2({ json: { read: { source: "layerDefinition.copyrightText" } } })], et.prototype, "copyright", void 0), __decorate([m2({ json: { read: { source: "layerDefinition.displayField" } } })], et.prototype, "displayField", void 0), __decorate([m2({ types: x, readOnly: true })], et.prototype, "defaultSymbol", void 0), __decorate([m2({ type: R })], et.prototype, "dynamicDataSource", void 0), __decorate([m2({ type: Boolean })], et.prototype, "editingEnabled", null), __decorate([o(["portal-item", "web-scene"], "editingEnabled", ["layerDefinition.capabilities"])], et.prototype, "readEditingEnabled", null), __decorate([o("web-map", "editingEnabled", ["capabilities", "layerDefinition.capabilities"])], et.prototype, "readEditingEnabledFromWebMap", null), __decorate([r(["portal-item", "web-scene"], "editingEnabled", { "layerDefinition.capabilities": { type: String } })], et.prototype, "writeEditingEnabled", null), __decorate([r("web-map", "editingEnabled", { capabilities: { type: String }, "layerDefinition.capabilities": { type: String } })], et.prototype, "writeEditingEnabledToWebMap", null), __decorate([m2({ readOnly: true })], et.prototype, "effectiveEditingEnabled", null), __decorate([m2({ clonable: false, readOnly: true })], et.prototype, "featureTitleFields", null), __decorate([m2({ type: [p8], json: { name: "layerDefinition.fieldConfigurations", write: { overridePolicy(e4, t5, r3) {
  return { enabled: !r3?.writeLayerSchema, ignoreOrigin: 1 === this.originIdOf(t5) };
} } } })], et.prototype, "fieldConfigurations", null), __decorate([m2({ ...Xe.fields, json: { read: { source: "layerDefinition.fields" }, origins: { service: { name: "fields" }, "web-map": { write: { target: "layerDefinition.fields", overridePolicy: Ye } } } } })], et.prototype, "fields", void 0), __decorate([m2(Xe.fieldsIndex)], et.prototype, "fieldsIndex", void 0), __decorate([m2({ type: F, json: { name: "formInfo", write: true, origins: { "web-scene": { read: false, write: false } } } })], et.prototype, "formTemplate", void 0), __decorate([m2({ json: { read: { source: "layerDefinition.extent" } } })], et.prototype, "fullExtent", void 0), __decorate([m2({ json: { origins: { "web-map": { write: { target: "layerDefinition.geometryType", overridePolicy: Ye, writer(e4, t5, r3) {
  const i4 = e4 ? j.toJSON(e4) : null;
  i4 && e(r3, i4, t5);
} } } }, read: { source: "layerDefinition.geometryType", reader: j.read } } })], et.prototype, "geometryType", void 0), __decorate([m2({ readOnly: true, clonable: false })], et.prototype, "graphicOrigin", void 0), __decorate([m2({ json: { read: { source: "layerDefinition.hasM" } } })], et.prototype, "hasM", void 0), __decorate([m2({ json: { read: { source: "layerDefinition.hasZ" } } })], et.prototype, "hasZ", void 0), __decorate([m2(u4)], et.prototype, "id", void 0), __decorate([m2({ readOnly: true, json: { origins: { service: { read: true } }, read: false } })], et.prototype, "infoFor3D", void 0), __decorate([m2({ json: { origins: { "web-map": { write: { target: "layerDefinition.type" } } } } })], et.prototype, "isTable", void 0), __decorate([o("service", "isTable", ["type", "geometryType"]), o("isTable", ["layerDefinition.type", "layerDefinition.geometryType"])], et.prototype, "readIsTable", null), __decorate([r("web-map", "isTable")], et.prototype, "writeIsTable", null), __decorate([m2(p7)], et.prototype, "labelsVisible", void 0), __decorate([m2({ type: [A2], json: { origins: { service: { name: "drawingInfo.labelingInfo", read: l7, write: false } }, name: "layerDefinition.drawingInfo.labelingInfo", read: l7, write: { layerContainerTypes: a3 } } })], et.prototype, "labelingInfo", void 0), __decorate([m2((() => {
  const e4 = a(b3);
  return e4.json.origins["portal-item"] = { write: { target: "layerDefinition.drawingInfo.transparency", writer(e5, t5, r3) {
    e(r3, n6(e5), t5);
  } } }, e4;
})())], et.prototype, "opacity", void 0), __decorate([m2(d2)], et.prototype, "legendEnabled", void 0), __decorate([m2({ type: ["show", "hide"], json: (() => {
  const e4 = a(T2.json);
  return e4.origins["portal-item"] = { read: false, write: false }, e4;
})() })], et.prototype, "listMode", void 0), __decorate([o("globalIdField", ["layerDefinition.globalIdField", "layerDefinition.fields"])], et.prototype, "readGlobalIdField", null), __decorate([m2({ json: { origins: { "web-map": { write: { target: "layerDefinition.objectIdField", overridePolicy: Ye } } } } })], et.prototype, "objectIdField", void 0), __decorate([o("objectIdField", ["layerDefinition.objectIdField", "layerDefinition.fields"])], et.prototype, "readObjectIdField", null), __decorate([m2({ type: ["ArcGISFeatureLayer"], json: { write: { target: "layerType", ignoreOrigin: true, layerContainerTypes: a3 } } })], et.prototype, "operationalLayerType", void 0), __decorate([m2(Xe.outFields)], et.prototype, "outFields", void 0), __decorate([m2({ type: String, json: { origins: { "web-scene": { read: true, write: true } }, read: false } })], et.prototype, "path", void 0), __decorate([m2(l8)], et.prototype, "popupEnabled", void 0), __decorate([m2({ type: q, json: { name: "popupInfo", write: true } })], et.prototype, "popupTemplate", void 0), __decorate([r("popupTemplate")], et.prototype, "writePopupTemplate", null), __decorate([m2({ readOnly: true })], et.prototype, "defaultPopupTemplate", null), __decorate([m2({ types: m5, json: { origins: { service: { write: { target: "drawingInfo.renderer", enabled: false } }, "web-scene": { types: u2, name: "layerDefinition.drawingInfo.renderer", write: { layerContainerTypes: a3, overridePolicy: (e4, t5, r3) => ({ ignoreOrigin: r3?.writeLayerSchema, layerContainerTypes: a3 }) } } }, write: { target: "layerDefinition.drawingInfo.renderer", overridePolicy: (e4, t5, r3) => ({ ignoreOrigin: r3?.writeLayerSchema, layerContainerTypes: a3 }) } } })], et.prototype, "renderer", null), __decorate([o("service", "renderer", ["drawingInfo.renderer", "defaultSymbol"]), o("renderer", ["layerDefinition.drawingInfo.renderer", "layerDefinition.defaultSymbol"])], et.prototype, "readRenderer", null), __decorate([m2()], et.prototype, "resourceInfo", void 0), __decorate([m2((() => {
  const e4 = a(s6);
  return e4.json.origins["portal-item"] = { read: false, write: false }, e4;
})())], et.prototype, "screenSizePerspectiveEnabled", void 0), __decorate([m2({ clonable: false })], et.prototype, "source", null), __decorate([s2("source")], et.prototype, "castSource", null), __decorate([o("portal-item", "source", ["featureSet"]), o("web-map", "source", ["featureSet"])], et.prototype, "readSource", null), __decorate([m2({ json: { read: { source: "layerDefinition.extent.spatialReference" } } })], et.prototype, "spatialReference", void 0), __decorate([m2({ type: Number })], et.prototype, "subtypeCode", void 0), __decorate([m2({ type: [a5] })], et.prototype, "templates", void 0), __decorate([o("templates", ["editFieldsInfo", "creatorField", "editorField", "templates"])], et.prototype, "readTemplates", null), __decorate([m2({ type: u3 })], et.prototype, "timeInfo", void 0), __decorate([m2()], et.prototype, "title", void 0), __decorate([o("service", "title", ["name"]), o("portal-item", "title", ["layerDefinition.title", "layerDefinition.name", "title"])], et.prototype, "readTitle", null), __decorate([o("web-map", "title", ["layerDefinition.name", "title"])], et.prototype, "readTitleFromWebMap", null), __decorate([m2({ type: String })], et.prototype, "sublayerTitleMode", void 0), __decorate([m2({ json: { read: false } })], et.prototype, "type", void 0), __decorate([m2({ type: String })], et.prototype, "typeIdField", void 0), __decorate([o("service", "typeIdField"), o("typeIdField", ["layerDefinition.typeIdField"])], et.prototype, "readTypeIdField", null), __decorate([m2({ type: [c4] })], et.prototype, "types", void 0), __decorate([o("service", "types", ["types"]), o("types", ["layerDefinition.types"])], et.prototype, "readTypes", null), __decorate([m2({ type: Boolean, json: { origins: { "portal-item": { write: { target: "layerDefinition.defaultVisibility", layerContainerTypes: a3 } } } } })], et.prototype, "visible", void 0), __decorate([o("portal-item", "visible", ["visibility", "layerDefinition.defaultVisibility"])], et.prototype, "readVisible", null), et = __decorate([a2("esri.layers.FeatureLayer")], et);

export {
  et
};
//# sourceMappingURL=chunk-IF5PTQMJ.js.map
