...
function u7(r7) {
  ...
  c6.objectIdFieldName = i10.objectid_field_name, c6.exceededTransferLimit = i10.exceeded_transfer_limit, c6.hasM = i10.has_m, c6.hasZ = i10.has_z, c6.geometryType = o(i4, i10.geometry_type.value), c6.globalIdFieldName = i10.globalid_field_name, c6.geohashFieldName = i10.geohash_field_name;
...
function m4(t7) {
  const a9 = new u6();
  a9.geometryType = o(i4, t7.geometry_type.value);
  const s8 = [], r7 = [];
...
function g3(t7) {
  const a9 = f7(t7);
  return a9.geometryType = o(i4, t7.geometry_type.value), a9;
}
function p9(t7) {
  const a9 = new h();
  ...
  writeToStore(o9, n12, p13) {
    ...
    return o9.forEach((o10) => {
      ...
      if (p13 && o10.properties[p13] && (c6 = ut(o10.properties[p13])), "originId" in o10 && "destinationId" in o10 && (o10.properties[I] = o10.originId, o10.properties[t4] = o10.destinationId), o10.properties[n12] = o10.id, o10.id && this._featureLookup.has(o10.id) && this._featureLookup.get(o10.id).attributes) {
        ...
        p13 && o10.properties[p13] && (i10[p13] = f2(o10.properties[p13])), u9 = new s2(c6 ? JSON.parse(JSON.stringify(c6)) : t7?.geometry ? JSON.parse(JSON.stringify(t7.geometry)) : null, i10, null, o10.properties[n12]);
...
var n9 = null;
function r4() {
  return e5 || (e5 = import("./lclayout-GH6KZP6S.js").then((t7) => t7.l).then(({ default: e7 }) => e7({ locateFile: (e8) => n(`esri/libs/linkchartlayout/${e8}`) })).then((t7) => {
    s6(t7);
  }), e5);
}
function s6(t7) {
...
async function g4(o9, e7, t7) {
  ...
  const a9 = s8.join(" UNION "), l12 = new p7({ openCypherQuery: a9, bindParameters: i10 }), m7 = (await ie(e7, l12, t7?.requestOptions)).resultRowsStream.getReader();
  for (; ; ) {
...
var N3 = class extends b {
  ...
  async getConnectedRecordIds(e7, t7, i10) {
    ...
    const p13 = r7.join(" UNION "), d7 = (await ie(this.knowledgeGraph, new p7({ openCypherQuery: p13, bindParameters: a9 }), { signal: i10?.signal })).resultRowsStream.getReader();
    for (; ; ) {
  ...
  async getRelationshipsBetweenNodes(e7, t7, i10) {
    ...
    const a9 = s8.join(" UNION "), r7 = [], p13 = (await ie(this.knowledgeGraph, new p7({ openCypherQuery: a9, bindParameters: o9 }), { signal: i10?.signal })).resultRowsStream.getReader();
    for (; ; ) {
  ...
  async getRelationshipsFromNodes(e7, t7, i10, n12) {
    ...
    const r7 = a9.join(" UNION "), p13 = /* @__PURE__ */ new Map(), d7 = (await ie(this.knowledgeGraph, new p7({ openCypherQuery: r7, bindParameters: s8 }), { signal: n12?.signal })).resultRowsStream.getReader();
    for (; ; ) {
      const { done: e8, value: t8 } = await d7.read();
      if (e8) break;
      for (let i11 = 0; i11 < t8.length; i11++) {
    ...
    for (const [s8, h3] of m7) {
      const e8 = new Set(h3), m8 = new Promise((d8, m9) => {
        const c6 = async () => {
          ...
          c7 = new p7(h3 ? { openCypherQuery: u9, bindParameters: { ids: h3 } } : { openCypherQuery: u9 });
  ...
  async retrieveDataFromService(e7, t7, n12) {
    ...
    if (null != e7.geometry) {
      ...
      u9 = g5 ? `Match ()-[n:${t7.objectType.name}]->() WHERE esri.graph.ST_Intersects($param_filter_geom, n.${t7.geometryFieldName}) return ID(n), id(startNode(r)), id(endNode(r))` : `Match (n:${t7.objectType.name}) WHERE esri.graph.ST_Intersects($param_filter_geom, n.${t7.geometryFieldName}) return ID(n)`, t7.geometryFieldName && s8.add(t7.geometryFieldName), s8.forEach((e8) => {
        u9 += `, n.${e8}`, r7.push(e8);
      }), p13 = new p7({ openCypherQuery: u9, bindParameters: { param_filter_geom: new P({ rings: S2(o10) }) } });
    } else {
      let i10 = "";
      if (null != e7.where && "1=1" !== e7.where) {
      ...
      N5 && (o10 = true, n13 += " WHERE ID(n) IN $ids"), i10 && (n13 += o10 ? " AND" : " WHERE", n13 += ` ${i10}`), n13 += " return ID(n)", g5 && (n13 += ", id(startNode(n)), id(endNode(n))"), e7.returnGeometry && t7.geometryFieldName && s8.add(t7.geometryFieldName), s8.forEach((e8) => {
        n13 += `, n.${e8}`, r7.push(e8);
      }), p13 = new p7(N5 ? { openCypherQuery: n13, bindParameters: { ids: N5 } } : { openCypherQuery: n13 });
    }
...
var M2 = "#8f8f82";
function R(t7) {
  return t7 < 0 || t7 >= A3.length ? new u3(M2) : new u3(A3[t7]);
}
function T3(e7) {
  const t7 = e7.toArray();
...
async function U(e7, s8) {
  ...
  for (const t7 of e7.addFeatures ?? []) {
    ...
    p8(t7.sourceLayer) && t7.sourceLayer.graphTypeName === i10 && ("entity" === l12 ? (o9.entityAdds || (o9.entityAdds = []), c6 && t7.geometry && (e8[c6] = await f10(t7.geometry)), o9.entityAdds.push(new p6({ properties: e8, typeName: i10 }))) : (o9.relationshipAdds || (o9.relationshipAdds = []), o9.relationshipAdds.push(new i5({ properties: e8, typeName: i10 }))));
  }
  for (const t7 of e7.updateFeatures ?? []) {
    const e8 = t7.attributes[_2], s9 = y7(t7.attributes);
    p8(t7.sourceLayer) && t7.sourceLayer.graphTypeName === i10 && ("entity" === l12 ? (o9.entityUpdates || (o9.entityUpdates = []), c6 && d7 && t7.geometry && (s9[c6] = await f10(t7.geometry)), o9.entityUpdates.push(new p6({ id: e8, properties: s9, typeName: i10 }))) : (o9.relationshipUpdates || (o9.relationshipUpdates = []), o9.relationshipUpdates.push(new i5({ id: e8, properties: s9, typeName: i10 }))));
  }
...
var n11 = /* @__PURE__ */ Symbol("isKnowledgeGraphGraphicOriginSymbol");

// node_modules/@arcgis/core/graphic/KnowledgeGraphGraphicOrigin.js
var o8;
var a8 = class extends s3 {
  get [(o8 = n11, n4)]() {
...
var i9 = /* @__PURE__ */ Symbol("isLinkChartGraphicOriginSymbol");
...
var Ne = class extends p12(a3(f5(c(p(p5(l6(t(f3(l(b3)))))))))) {
  constructor(e7) {
  ...
  get renderer() {
    ...
    if ("link-chart" === this.parentCompositeLayer?.type) {
      if ("relationship" === this.graphType) return new p2({ type: "simple", symbol: T3(r7) });
      const e8 = t3(u4(y2.toJSON("point")).renderer);
      return L(e8.symbol, r7), e8;
    }
    const i10 = t3(u4(y2.toJSON(this.geometryType)).renderer);
...
}, isRequired: true, ignoreOrigin: true, writerEnsuresNonNull: true } } })], Ne.prototype, "layerType", void 0), __decorate([m(Ie(a(d)))], Ne.prototype, "legendEnabled", void 0), __decorate([m(Ie(a(v)))], Ne.prototype, "maxScale", void 0), __decorate([m(Ie(a(j)))], Ne.prototype, "minScale", void 0), __decorate([m()], Ne.prototype, "objectIdField", void 0), __decorate([m()], Ne.prototype, "objectType", void 0), __decorate([m(Ie(a(w)))], Ne.prototype, "opacity", void 0), __decorate([m(Ie(a(c2)))], Ne.prototype, "orderBy", void 0), __decorate([m({ clonable: false })], Ne.prototype, "parent", void 0), __decorate([m()], Ne.prototype, "parentCompositeLayer", void 0), __decorate([m(Ie(a(l3)))], Ne.prototype, "popupEnabled", void 0), __decorate([m({ type: q, json: { name: "popupInfo", write: { ignoreOrigin: true } } })], Ne.prototype, "popupTemplate", void 0), __decorate([m({ type: Number, json: { write: { overridePolicy: Le } } })], Ne.prototype, "refreshInterval", void 0), __decorate([m({ types: m3, json: { name: "layerDefinition.drawingInfo.renderer", write: Se() } })], Ne.prototype, "renderer", null), __decorate([m()], Ne.prototype, "source", void 0), __decorate([m()], Ne.prototype, "spatialReference", null), __decorate([m()], Ne.prototype, "templates", null), __decorate([m({ type: u5, json: { name: "layerDefinition.timeInfo", write: { overridePolicy: Le }, origins: { "web-document": { name: "layerDefinition.timeInfo", read: true, write: { overridePolicy: Le } }, "portal-item": { name: "layerDefinition.timeInfo", read: true, write: { overridePolicy: Le } } } } })], Ne.prototype, "timeInfo", null), __decorate([m({ type: String, json: { write: { isRequired: true, ignoreOrigin: true, writerEnsuresNonNull: true } } })], Ne.prototype, "title", null), __decorate([r("title")], Ne.prototype, "writeTitle", null), __decorate([m({ json: { read: false } })], Ne.prototype, "type", void 0), __decorate([m(Ie(a(f6)))], Ne.prototype, "useViewTime", void 0), __decorate([m({ type: Boolean, json: { name: "visibility", write: Se() } })], Ne.prototype, "visible", void 0), Ne = __decorate([a2("esri.layers.knowledgeGraph.KnowledgeGraphSublayer")], Ne);
...
//# sourceMappingURL=chunk-MRSQWKJU.js.map
