  ...
  *[Symbol.iterator]() {
  ...
  on(e3, t3) {
    ...
    if ("change" === e3) {
      ...
      return e4.push(s2), this._notifications && this._notifications.push({ listeners: e4.slice(), items: this._items.slice(), changes: [] }), e2(() => {
  ...
  _splice(e3, t3, s2) {
    ...
    if ((s2?.length || o?.length) && this._notifyChangeEvent(s2, o), this.hasEventListener("after-splice")) {
...
//# sourceMappingURL=chunk-GR7BAG77.js.map
