...
function u4(e2) {
  ...
  if (e2) switch (e2.type) {
    ...
    case l:
      ...
      break;
    case i:
      s = { type: "pattern", src: e2.url, width: u2(e2.width) * e2.xscale, height: u2(e2.height) * e2.yscale, x: u2(e2.xoffset), y: u2(e2.yoffset) };
      break;
    case h:
      s = e2.color;
      break;
...
function y(t) {
  ...
  switch (t.type) {
    ...
    case a: {
      const o = u2(t.width);
      null != t.style && "none" !== t.style && 0 !== o && (e2 = { color: t.color, style: w(t.style), width: o, cap: t.cap, join: "miter" === t.join ? u2(t.miterLimit) : t.join }, e2.dashArray = g(e2).join(",") || "none");
      break;
    }
    default:
      e2 = null;
...
//# sourceMappingURL=chunk-GQBXF7TC.js.map
