...
async function t(l, o, r2) {
  ...
  return (await Promise.all(u3.map(async (e, r3) => {
    const n2 = "opacity" === l.type ? await a(e, l, o) : (await import("./visualVariableUtils-36OMH36Q.js")).getColor(l, e), u4 = t2 ? s2[r3] : p?.[r3] ?? "";
    return null == n2 ? null : { value: e, color: n2, label: u4 };
  }))).filter(N).reverse();
}
async function a(e, o, n2) {
  const t2 = new u(n2 ?? r), a2 = (await import("./visualVariableUtils-36OMH36Q.js")).getOpacity(o, e);
...
//# sourceMappingURL=chunk-4UPBAMMU.js.map
