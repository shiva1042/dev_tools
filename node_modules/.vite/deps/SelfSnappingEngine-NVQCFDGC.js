...
function v2(i2, o2, n3, a3, { spatialReference: l2 }, p4) {
  const h4 = y3(o2, n3, l2, l2);
  if (null == h4) return false;
  const c4 = y3(n3, a3, l2, l2);
  ...
  return U2(i2, n3, l2, v(d4, "meters"), c3(m5, "radians", "geographic"), "geodesic"), i2[2] = a3[2], true;
}
...
var d3 = class extends l {
  ...
  _checkEdgeForParallelLines(t, i2, a3, c4, h4, d4) {
    ...
    if (y2(v3, s2(i2), s2(x), s2(L)), b2(v3, s2(i2)) < p3.parallelLineThreshold) return;
    y2(v3, s2(a3), s2(x), s2(L), s2(i2));
...
function u(t, r3) {
  ...
  for (const o2 of r3) if (y2(v3, s2(n3), s2(o2.constraint.start), s2(o2.constraint.end), s2(i2)), b2(v3, s2(n3)) < p3.parallelLineThreshold) return o2.addReferenceLine(t), true;
  return false;
}
var v3 = n2();
...
var y4 = class extends l {
  ...
  _checkForSnappingCandidateAlongProjectedRay(e2, t, r3, a3, p4, g2, f2, j4) {
    ...
    t.push(new r2({ targetPoint: R2, constraint: new Dt(a3, c2(U4)), previousVertex: r3, otherVertex: a3, otherVertexType: 1, selfSnappingType: e2, isDraped: "on-the-ground" === j4.elevationInfo?.mode }));
  }
};
...
function R(i2, n3, s4, o2, { spatialReference: a3 }, c4) {
  const g2 = y3(n3, s4, a3, a3);
  if (null == g2) return false;
  const l2 = y3(s4, o2, a3, a3);
  if (null == l2) return false;
  const m5 = Math.sign(r.shortestSignedDiff(g2, l2)) * Math.PI * 0.5, f2 = c3(g2 + m5, "radians", "geographic"), d4 = n(), u2 = c4.geodesicDistance(s4, o2, a3);
...
//# sourceMappingURL=SelfSnappingEngine-NVQCFDGC.js.map
