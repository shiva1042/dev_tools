import {
  p as p4
} from "./chunk-77PUDE5A.js";
import {
  e as e2,
  i,
  p as p3,
  p2 as p5
} from "./chunk-DHKD2L5V.js";
import {
  l
...
async function F(e3, r) {
  ...
  return await t2.load(), null === J && (J = await import("./knowledgeGraphService-YFJCK5CN.js")), await J.fetchKnowledgeGraph(t2.url);
}
...
function K2(e3) {
  "async" === e3.mode && (e3.functions.knowledgegraphbyportalitem = function(t2, i2) {
    ...
    return e3.standardFunctionAsync(r, a, async (e4, l2, c3) => {
      ...
      null === J && (J = await import("./knowledgeGraphService-YFJCK5CN.js"));
      let m = null;
      const d = z(c3[2], null);
...
//# sourceMappingURL=knowledgegraph-3RRDSNRN.js.map
