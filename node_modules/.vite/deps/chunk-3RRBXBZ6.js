...
var o3 = P2(() => import("./bufferOperator-YAPLXHUH.js"));
var s7 = P2(() => import("./convexHullOperator-4L26YQCT.js"));
var m2 = P2(() => import("./lengthOperator-PE5RMK4H.js"));
var i8 = P2(() => import("./generalizeOperator-HQWXWDKD.js"));
var n5 = P2(() => import("./graphicBufferOperator-IW5VMJHG.js"));
var p3 = P2(() => import("./offsetOperator-F3IAI5BN.js"));
var f4 = P2(() => import("./simplifyOperator-RPXKKPVK.js"));
var c3 = 512;
var a3;
function l7(e17) {
  switch (e17.type) {
...
var s14 = class {
  ...
  _computeTextWidth(t16, i18) {
    ...
    const s17 = i18.font;
    return ("italic" === s17.style || "oblique" === s17.style || "string" == typeof s17.weight && ("bold" === s17.weight || "bolder" === s17.weight) || "number" == typeof s17.weight && s17.weight > 600) && (n23 += 0.3 * t16.measureText("w").width), n23 += 2 * u2(this._parameters.halo.size), Math.round(n23);
  }
  ...
  _computeLineHeight() {
    ...
    return i18 && "underline" === i18 && (t16 *= 1.3), Math.round(t16 + 2 * u2(this._parameters.halo.size));
  }
...
function r11(t16, i18) {
  const n23 = Math.max(i18.size, 0.5), s17 = i18.font, r13 = `${s17.style} ${s17.weight} ${u2(n23).toFixed(1)}px ${s17.family}, sans-serif`;
  let o9;
...
var mt = class extends lt {
  ...
  drawPictureStroke(t16, r13) {
    ...
    if (y2(t16)) f6 = t16.rings;
      ...
      if (!m(t16)) return u(t16) ? void console.log("CanvasDrawHelper.drawPictureStroke - No implementation!") : void 0;
      f6 = pt(t16).rings;
    }
    c5 || (c5 = m5.width);
    ...
    const g5 = Math.max(this.transformSize(u2(c5)), 0.5), p6 = g5 / d.width, _4 = this._ctx, x3 = _4.createPattern(d, "repeat-y");
    let M3, b2;
  ...
  drawGradientFill(t16, e17) {
    ...
    switch (C2.save(), o9) {
      case "Buffered":
        ...
        break;
      case "Linear": {
        const t17 = (M3 + k) / 2, r14 = "Absolute" === l12 ? this.transformSize(u2(a11)) : ee(a11, h8.gradientSize) * (b2 - x3), [i18, s18] = "Discrete" === p6 ? [b2, b2 - r14] : [x3 + r14, x3], o10 = t12([i18, t17], _4), c5 = t12([s18, t17], _4), m5 = C2.createLinearGradient(o10[0], o10[1], c5[0], c5[1]);
        p2(m5, e17), C2.fillStyle = m5, C2.fill("evenodd");
        break;
      }
      case "Circular": {
        const t17 = g(w3), r14 = j(w3) / 2, i18 = "Absolute" === l12 ? this.transformSize(u2(a11)) : ee(a11, h8.gradientSize) * r14, [s18, o10] = "Discrete" === p6 ? [r14, r14 - i18] : [i18, 0], c5 = C2.createRadialGradient(t17[0], t17[1], s18, t17[0], t17[1], o10);
      ...
      case "Rectangular": {
        ...
        let m5 = "Absolute" === l12 ? this.transformSize(u2(a11)) : ee(a11, h8.gradientSize) * (l(w3) / 2), [g5, y6] = "Discrete" === p6 ? [b2, b2 - m5] : [i18 + m5, i18];
        c5(g5, s18, y6, s18, b2, M3, b2, k), [g5, y6] = "Discrete" === p6 ? [x3, x3 + m5] : [i18 - m5, i18], c5(g5, s18, y6, s18, x3, k, x3, M3), m5 = "Absolute" === l12 ? this.transformSize(u2(a11)) : ee(a11, h8.gradientSize) * (y(w3) / 2);
  ...
  drawGradientStroke(t16, r13) {
    ...
    const f6 = r13.gradientType ?? o2.CIMGradientStroke.gradientType, u9 = Math.max(this.transformSize(u2(c5)), 0.5), d = this._ctx;
    let g5, p6;
    ...
    for (let _4 of m5) {
      ...
      const i19 = "Absolute" === a11 ? this.transformSize(u2(o9)) : ee(o9, o2.CIMGradientStroke.gradientSize) * ("AcrossLine" === s17 ? u9 : t17);
      let l13 = 0;
      g5 = this.transformPt(_4[0]);
      for (let e17 = 1; e17 < _4.length; e17++) {
        p6 = this.transformPt(_4[e17]);
...
var V2 = class {
  ...
  static _getTextInflatedSize(e17, t16, r13) {
    ...
    const { lineGapType: s17, lineGap: i18 } = t16, n23 = s17 ? _t2(s17, i18 ?? 0, o9) : 0, l12 = "CIMBackgroundCallout" === t16.callout?.type, c5 = z(a11.glyphMosaicItems, { scale: o9 / q, angle: I2(t16.angle), xOffset: I2(t16.offsetX), yOffset: I2(t16.offsetY), horizontalAlignment: t16.horizontalAlignment, verticalAlignment: t16.verticalAlignment, maxLineWidth: a10(t16.lineWidth), lineHeight: l5 * Math.max(0.25, Math.min(n23 || 1, 4)), decoration: t16.font.decoration || "none", useCIMAngleBehavior: true, hasBackground: l12 }).boundsT, m5 = Math.sqrt(c5.width * c5.width + c5.height * c5.height);
  ...
  static fetchFonts(e17, t16, r13) {
    if (e17 && t16) {
      if ("symbolLayers" in e17 && e17.symbolLayers) {
        ...
        const { style: s17, weight: i18 } = L(a11), n23 = A(e17), c5 = new l4({ family: o9, style: s17, weight: i18, decoration: n23 });
...
//# sourceMappingURL=chunk-3RRBXBZ6.js.map
