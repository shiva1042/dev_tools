...
var n9 = null;
function r4() {
  return e5 || (e5 = import("./lclayout-RWZTH5GB.js").then((t7) => t7.l).then(({ default: e7 }) => e7({ locateFile: (e8) => n(`esri/libs/linkchartlayout/${e8}`) })).then((t7) => {
    s6(t7);
  }), e5);
}
function s6(t7) {
...
//# sourceMappingURL=chunk-YMWGAYWA.js.map
