...
async function o(o2) {
  const a2 = "portalItem" in o2 ? o2 : { portalItem: o2 }, { fromItem: e } = await import("./portalLayers-BD7ER7OP.js");
  try {
    return await e(a2);
  } catch (p) {
...
var b = class extends n(s3(u)) {
  ...
  static async fromArcGISServerUrl(t) {
    ...
    return (await import("./arcgisLayers-NXGIL2FS.js")).fromUrl(e);
  }
...
//# sourceMappingURL=chunk-IBD26XKQ.js.map
