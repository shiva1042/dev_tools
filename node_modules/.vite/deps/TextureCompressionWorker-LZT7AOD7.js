...
function s() {
  return t ??= (async () => {
    const s3 = await import("./basis_encoder-W6KJUY3I.js"), t2 = await s3.default({ locateFile: (s4) => n(`esri/libs/basisu/${s4}`) });
...
function e() {
  return n2 ??= (async () => {
    const e2 = await import("./dxt_encoder-VHYUPDSW.js");
...
//# sourceMappingURL=TextureCompressionWorker-LZT7AOD7.js.map
