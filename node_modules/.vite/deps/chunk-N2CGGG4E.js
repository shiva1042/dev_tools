...
function l(i2) {
  i2.include(f), i2.fragment.uniforms.add(new t2("inverseViewMatrix", (i3, t5) => {
    const a2 = i(e2(), t5.camera.viewMatrix, i3.localOrigin);
    return e(a2, a2);
...
//# sourceMappingURL=chunk-N2CGGG4E.js.map
