  ...
  let b = class extends _2 {
    ...
    async loadFromPortal(e, t) {
      if (this.portalItem?.id) try {
        const { load: r2 } = await import("./layersLoader-M3R6Z5QL.js");
        return s4(t), await r2({ instance: this, supportedTypes: e.supportedTypes, validateItem: e.validateItem, supportsData: e.supportsData, layerModuleTypeMap: e.layerModuleTypeMap, populateGroupLayer: e.populateGroupLayer }, t);
      } catch (r2) {
  ...
  ${r2}`), r2;
    ...
    async _fetchUserPrivileges(e, t) {
      ...
      try {
        ...
        l = await s3?.getCredential(`${a2}/sharing`, { prompt: false, signal: e2 });
      } catch (m2) {
        f(m2);
      }
...
//# sourceMappingURL=chunk-Y2PMXZKN.js.map
