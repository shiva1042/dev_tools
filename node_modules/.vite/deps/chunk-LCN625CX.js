...
function J(t, n, r, u2) {
  let c = new _(0);
  const i = new _(0);
  return c = K(c, t, i), c = K(c, n, i), c = K(c, r, i), c = K(c, u2, i), c;
}
function K(t, n, r) {
  const u2 = n.subtract(r), c = t.add(u2);
  return r = c.subtract(t).subtract(u2), c;
}
...
//# sourceMappingURL=chunk-LCN625CX.js.map
