...
var w2 = class extends b {
  ...
  fetchCandidatesSync(t2, e) {
    ...
    const S = W(t2, g), w3 = l(S.x, S.y, S.z), x = P(w3, -o, s2, -n2), C = f2 / c * u3, U = R(x, C, s2), { shouldSnapX: b3, shouldSnapY: L2 } = j(U, x, e, a2, c);
    if (!b3 && !L2) return [];
    const z = l((b3 ? U : x)[0], (L2 ? U : x)[1]), E = P(z, o, s2, n2), F = P(U, o, s2, n2);
    if (L2) {
...
var M = (t2, e, r, i3) => {
  if ("y" === i3) {
    ...
    return l(t2[0] + r * i4, t2[1]);
  }
  const n2 = e[1] > t2[1] ? 1 : -1;
  return l(t2[0], t2[1] + r * n2);
};
export {
  w2 as GridSnappingEngine
};
//# sourceMappingURL=GridSnappingEngine-JHXL27UN.js.map
