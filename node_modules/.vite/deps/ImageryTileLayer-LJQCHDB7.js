...
import {
  ...
  t as t4,
  u as u4
} from "./chunk-CWY6USYJ.js";
import "./chunk-5C2P7W5P.js";
import {
  c as c4,
  f as f4,
  o as o3
...
import {
  n as n2,
  u as u3
} from "./chunk-FEGVP6Q4.js";
import {
  T,
  w
} from "./chunk-M3W6C6TQ.js";
import "./chunk-LSCERJLX.js";
import "./chunk-BOCSSWUC.js";
import {
  C,
  G,
  H,
...
function p4(e3) {
  ...
  for (let o6 = 0; o6 < r6.length; o6++) {
    ...
    for (let i9 = 0; i9 < j5; i9++) {
      const e5 = c2.createEmptyBand(y3, x2), r7 = new Uint8Array(x2).fill(255);
      let u10 = false;
      const m11 = i9 * x2;
      ...
      if (0 === o6 || a2?.length) {
        const l9 = new c2({ width: t7, height: n5, mask: u10 ? r7 : null, pixels: [e5], pixelType: y3 });
        if (l9.updateStatistics(), a2?.length) {
          h3[f5(g5, b6, i9) + p7] = l9;
        } else h3.push(l9);
      } else {
        const t8 = h3[i9];
        t8.pixels.push(e5), u10 ? t8.mask && (t8.mask = c2.combineBandMasks([t8.mask, r7])) : t8.mask = u10 ? r7 : null;
      }
    }
  }
...
var f6 = class extends X {
  ...
  async _buildMDimStats(t7, e3, s7) {
    for (let i8 = 0; i8 < e3.variables.length; i8++) {
      ...
      const o6 = r6.dimensions.map((t8) => new p2({ variableName: r6.name, dimensionName: t8.name, values: [t8.values?.[0] ?? t8.extent?.[0]], isSlice: true })), a2 = C2(o6, e3), n5 = null == a2 ? null : t7[a2];
      if (null == n5) continue;
...
var b4 = class extends X {
  ...
  async fetchRawTile(t7, e3, r6, s7 = {}) {
    ...
    if (0 === m9[0].from && 0 === m9[0].to) {
      ...
      return new c2({ width: o6, height: i8, pixels: void 0, mask: t8, validPixelCount: 0 });
    }
...
function k4(e3) {
  ...
  const D2 = new z({ ...t7.extent, spatialReference: E3 }), v7 = new _(D2 ? { x: D2.xmin, y: D2.ymax, spatialReference: E3 } : { x: 0, y: 0 }), P = new l4({ blockWidth: s7, blockHeight: u8, pyramidBlockWidth: g4, pyramidBlockHeight: x2, compression: d7, origin: v7, firstPyramidLevel: m9, maximumPyramidLevel: y3, pyramidResolutions: w3, blockBoundary: T2 }), B = new _({ x: (D2.xmax - D2.xmin) / i8, y: (D2.ymax - D2.ymin) / r6, spatialReference: E3 }), C3 = _2 ? { BandProperties: _2.bandProperties, DataType: _2.dataType } : {};
  let L3 = null;
...
var Y2 = class extends p(t(b(j2(o3(s5(X2(i4(l6(l5(f3(l3(l2(b3))))))))))))) {
  constructor(...e3) {
    super(...e3), this._primaryRasters = [], this.graphicOrigin = new s6(this), this.legendEnabled = true, this.isReference = null, this.listMode = "show", this.sourceJSON = null, this.version = null, this.type = "imagery-tile", this.operationalLayerType = "ArcGISTiledImageServiceLayer", this.popupEnabled = true, this.popupTemplate = null, this.screenSizePerspectiveEnabled = true, this.fields = null, this.source = void 0, this._debouncedSaveOperations = L(async (e4, t7, r6) => {
      const { save: s7, saveAs: i8 } = await import("./imageryUtils-L53KMLTU.js");
      switch (e4) {
        case 0:
          return s7(this, t7);
        case 1:
  ...
  get rasterFields() {
    const e3 = [o2("Pixel Value"), c3("Raw Pixel Value")], t7 = this.raster?.rasterInfo ?? this.serviceRasterInfo, r6 = t7?.attributeTable;
    if (r6) {
      const t8 = v4(r6);
      e3.push(...t8);
    }
    ...
    if (("vector-magdir" === s7 || "vector-uv" === s7) && null != i8) {
      const t8 = i8.variables[0].unit?.trim(), r7 = d3(t8), s8 = $2();
      e3.push(r7, s8);
    }
    if (i8) {
      const t8 = p3(i8);
  ...
  createPopupTemplate(e3) {
    const { rasterFields: t7 } = this, r6 = e3?.visibleFieldNames ?? new Set(t7.map(({ name: e4 }) => e4).filter((e4) => e4 !== i3.rawServicePixelValue)), s7 = d2({ fields: t7, title: this.title }, { ...e3, visibleFieldNames: r6 }), { rasterInfo: i8 } = this.raster;
    return s7?.fieldInfos && i8 && b2(s7.fieldInfos, i8), s7;
  }
