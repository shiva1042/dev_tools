...
function z(t, n2, s2, o3) {
  ...
  let u, h, M, f, l, m2 = s2[0], p2 = s2[1], q2 = s2[2], d = s2[3];
  return h = r2 * m2 + e4 * p2 + c * q2 + i * d, h < 0 && (h = -h, m2 = -m2, p2 = -p2, q2 = -q2, d = -d), 1 - h > e() ? (u = Math.acos(h), M = Math.sin(u), f = Math.sin((1 - o3) * u) / M, l = Math.sin(o3 * u) / M) : (f = 1 - o3, l = o3), t[0] = f * r2 + l * m2, t[1] = f * e4 + l * p2, t[2] = f * c + l * q2, t[3] = f * i + l * d, t;
}
function E2(t) {
...
//# sourceMappingURL=chunk-64FKIDP2.js.map
