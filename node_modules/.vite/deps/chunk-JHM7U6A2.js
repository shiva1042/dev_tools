...
async function v(e) {
  ...
  const s3 = a.spatialReference, l3 = n ? g2.fromJSON(n) : oe(s3), m2 = s3 && (c(s3) || C(s3)) ? a : await f2(s3, N2).then(() => g(a, N2)), f3 = await import("./geodesicBufferOperator-MZSBEEV3.js");
  await f3.load();
...
//# sourceMappingURL=chunk-JHM7U6A2.js.map
