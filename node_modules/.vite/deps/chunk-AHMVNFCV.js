...
var t = class {
  ...
  set isDecoration(e) {
    this._isDecoration = e, this.forEachMaterial((t2) => t2?.setParameters({ isDecoration: e }));
  }
  constructor(t2) {
    this._isDecoration = false, this._attached = false, this._resourcesCreated = false, this._visible = true, this.view = t2.view, this._handle = l(() => t2.view.ready, (e) => {
...
//# sourceMappingURL=chunk-AHMVNFCV.js.map
