...
import {
  ...
  calciteSize32,
  calciteSize44
} from "./chunk-GW4PY4F4.js";
import {
  useCancelable
} from "./chunk-BSAXEGBR.js";
import {
  repeat
} from "./chunk-OQY7COTG.js";
import {
...
import {
  throttle
} from "./chunk-HBMFXA7T.js";
import "./chunk-Y2GASPSM.js";
import "./chunk-ZNBLLYEC.js";
import "./chunk-ODJR3AZF.js";
import "./chunk-Z2HDBXNH.js";
import "./chunk-PLAFWZPZ.js";
import {
  isActivationKey
...
import "./chunk-UAXDYM5V.js";
import "./chunk-ZT7YBARA.js";
import "./chunk-D3PSI7WN.js";
import "./chunk-DGAORJRT.js";
import {
...
function clamp2(number_, min, max) {
...
var _Swatch = class _Swatch extends LitElement {
  ...
  renderEmptyDisplay() {
    ...
    return html`<div class=${safeClassMap(CSS2.internalSvgContainer)}><svg fill=none height=${scale} viewBox=${`0 0 ${scale} ${scale}`} width=${scale} xmlns=http://www.w3.org/2000/svg>${svg`<path class=${safeClassMap(CSS2.internalSvgEmpty)} d=${`M${scale} 0L0 ${scale}`} />`}</svg></div>`;
  }
...
_Swatch.properties = { hasImage: [16, {}, { state: true }], color: 1, disabled: [7, {}, { reflect: true, type: Boolean }], interactive: [5, {}, { type: Boolean }], label: 1, parentSwatchGroup: [0, {}, { attribute: false }], scale: [3, {}, { reflect: true }], selected: [7, {}, { reflect: true, type: Boolean }], selectionMode: 1, value: 1 };
_Swatch.styles = styles;
var Swatch = _Swatch;
...
var styles2 = css`:host{--calcite-internal-color-focus: var( --calcite-color-focus, var(--calcite-ui-focus-color, var(--calcite-color-brand)) )}.hex-input{--calcite-input-text-background-color: var(--calcite-color-picker-input-background-color);--calcite-input-text-border-color: var(--calcite-color-picker-input-border-color);--calcite-input-text-text-color: var(--calcite-color-picker-input-text-color);--calcite-input-prefix-background-color: var(--calcite-color-picker-input-prefix-background-color);--calcite-input-prefix-text-color: var(--calcite-color-picker-input-prefix-text-color)}.opacity-input{--calcite-input-number-background-color: var(--calcite-color-picker-input-background-color);--calcite-input-number-border-color: var(--calcite-color-picker-input-border-color);--calcite-input-number-text-color: var(--calcite-color-picker-input-text-color);--calcite-input-suffix-background-color: var(--calcite-color-picker-input-suffix-background-color);--calcite-input-suffix-text-color: var(--calcite-color-picker-input-suffix-text-color)}:host{display:block}.container{display:flex;inline-size:100%;flex-wrap:nowrap;align-items:center}.hex-input{flex-grow:1;text-transform:uppercase}.opacity-input{inline-size:100px;margin-inline-start:-1px}:host([hidden]){display:none}[hidden]{display:none}`;
...
_ColorPickerHexInput.styles = styles2;
...
var styles3 = css`:host{--calcite-internal-color-focus: var( --calcite-color-focus, var(--calcite-ui-focus-color, var(--calcite-color-brand)) )}:host{display:flex;flex-direction:column}:host([bordered]){box-shadow:inset 0 1px 0 var(--calcite-tab-border-color, var(--calcite-color-border-1));background-color:var(--calcite-tab-background-color, var(--calcite-color-foreground-1))}:host([bordered]) section{border-color:var(--calcite-tab-border-color, var(--calcite-color-border-1));border-style:solid}section{display:flex;flex-grow:1;overflow:hidden;border-width:1px;border-block-start-style:solid;border-block-start-color:var(--calcite-tab-border-color, var(--calcite-color-border-1))}:host([bordered][position=bottom]){box-shadow:inset 0 1px 0 var(--calcite-tab-border-color, var(--calcite-color-border-1)),inset 0 -1px 0 var(--calcite-tab-border-color, var(--calcite-color-border-1))}:host([bordered]:not([position=bottom])) ::slotted(calcite-tab-nav){margin-block-end:-1px}:host([position=bottom]){flex-direction:column-reverse}:host([position=bottom]) section{flex-direction:column-reverse;border-block-start-width:0px;border-block-end-width:1px}:host([bordered][scale=s]) section{padding:.75rem}:host([bordered][scale=m]) section{padding:.5rem}:host([bordered][scale=l]) section{padding:1rem}:host([position=bottom]:not([bordered])) section{border-block-end-style:solid;border-block-end-color:var(--calcite-tab-border-color, var(--calcite-color-border-1))}@media (forced-colors: active){:host([bordered]) section{border-block-start-width:0px;border-block-end-width:1px}:host([position=bottom][bordered]) section{border-block-start-width:1px;border-block-end-width:0px}}:host([hidden]){display:none}[hidden]{display:none}`;
var _Tabs = class _Tabs extends LitElement {
  ...
  render() {
    return html`<slot name=${SLOTS2.titleGroup}></slot><section class=${safeClassMap(CSS4.section)}><slot @slotchange=${this.defaultSlotChangeHandler} ${ref(this.slotRef)}></slot></section>`;
  }
};
...
var _TabNav = class _TabNav extends LitElement {
  ...
  render() {
    ...
    return html`<div class=${safeClassMap({
      [CSS5.container]: true,
      [CSS5.containerHasStartTabTitleOverflow]: !!this.hasOverflowingStartTabTitle,
      [CSS5.containerHasEndTabTitleOverflow]: !!this.hasOverflowingEndTabTitle,
      [CSS5.scale(this.scale)]: true,
      [CSS5.position(this.position)]: true,
      [CSS_UTILITY.rtl]: this.effectiveDir === "rtl"
    })}>${this.renderScrollButton("start")}<div class=${safeClassMap({
      [CSS5.tabTitleSlotWrapper]: true
  ...
  renderScrollButton(overflowDirection) {
    ...
    return keyed(overflowDirection, html`<div class=${safeClassMap({
      [CSS5.scrollButtonContainer]: true,
      [CSS5.scrollBackwardContainerButton]: !isEnd,
      [CSS5.scrollForwardContainerButton]: isEnd
...
_TabNav.properties = { hasOverflowingEndTabTitle: [16, {}, { state: true }], hasOverflowingStartTabTitle: [16, {}, { state: true }], selectedTabId: [16, {}, { state: true }], bordered: [7, {}, { reflect: true, type: Boolean }], layout: [3, {}, { reflect: true }], messageOverrides: [0, {}, { attribute: false }], position: 1, scale: 1, selectedTitle: [0, {}, { attribute: false }], storageId: [3, {}, { reflect: true }], syncId: [3, {}, { reflect: true }] };
_TabNav.styles = styles4;
var TabNav = _TabNav;
...
var _SwatchGroup = class _SwatchGroup extends LitElement {
  ...
  render() {
    ...
    const { disabled } = this;
    return InteractiveContainer({ disabled, children: html`<div .ariaLabel=${this.label} class=${safeClassMap(CSS6.container)} .role=${role}><slot @slotchange=${this.updateItems} ${ref(this.slotRefEl)}></slot></div>` });
  }
};
...
var _TabTitle = class _TabTitle extends LitElement {
  ...
  render() {
    ...
    const iconStartEl = html`<calcite-icon class=${safeClassMap({ [CSS7.titleIcon]: true, [CSS7.iconStart]: true })} .flipRtl=${this.iconFlipRtl === "start" || this.iconFlipRtl === "both"} .icon=${this.iconStart} .scale=${getIconScale(this.scale)}></calcite-icon>`;
    const iconEndEl = html`<calcite-icon class=${safeClassMap({ [CSS7.titleIcon]: true, [CSS7.iconEnd]: true })} .flipRtl=${this.iconFlipRtl === "end" || this.iconFlipRtl === "both"} .icon=${this.iconEnd} .scale=${getIconScale(this.scale)}></calcite-icon>`;
    ...
    return InteractiveContainer({ disabled: this.disabled, children: html`<div class=${safeClassMap({
      [CSS7.container]: true,
      [CSS7.containerBottom]: this.position === "bottom",
      [CSS7.iconPresent]: !!this.iconStart || !!this.iconEnd,
      [CSS7.scale(this.scale)]: true
    })} .hidden=${closed} ${ref(this.setContainerRef)}><div class=${safeClassMap({ [CSS7.content]: true, [CSS7.contentHasText]: this.hasText })}>${this.iconStart ? iconStartEl : null}<slot></slot>${this.iconEnd ? iconEndEl : null}</div>${this.renderCloseButton()}<div class=${safeClassMap(CSS7.selectedIndicator)}></div></div>` });
  }
  renderCloseButton() {
...
var _ColorPicker = class _ColorPicker extends LitElement {
  ...
  colorFromValue(value, clearable = false, mode) {
    ...
    return color_default(value != null && typeof value === "object" && alphaCompatible(mode) ? normalizeColor(value) : value);
  }
