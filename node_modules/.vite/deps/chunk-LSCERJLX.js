...
async function r(t, e, n) {
  ...
  if (!(await import("./intersectsOperator-F2DXUZGU.js")).execute(e, n)) return new c({ pixelType: t.pixelType, width: a2, height: r2, mask: h2, maskIsAlpha: false, pixels: [...t.pixels] });
  if ("polyline" === n.type) return s(t, e, n);
  return (await import("./containsOperator-PBIZBWFN.js")).execute(n, e) ? t : o(t, e, n);
}
function o(t, e, n) {
  if (!t) return t;
...
//# sourceMappingURL=chunk-LSCERJLX.js.map
