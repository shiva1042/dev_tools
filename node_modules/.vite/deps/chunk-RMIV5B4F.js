...
function a(a4, n4, c) {
  return a4.canvas || (a4.canvas = document.createElement("canvas")), a4.canvas.width = n4, a4.canvas.height = c, a4.canvas;
}

// node_modules/@arcgis/core/views/3d/webgl-engine/lib/FontMetrics.js
function e(e2) {
  const { size: c } = e2.definition, a4 = e2.fontString(c);
  let i2 = n.get(a4);
  if (!i2) {
    const u2 = a(o2, 0, 0).getContext("2d");
    e2.setFontProperties(u2, c);
    const x = u2.measureText(r4);
    i2 = new s(x.actualBoundingBoxAscent, x.actualBoundingBoxDescent), n.set(a4, i2);
  }
  return i2;
}
...
var r5 = class {
  ...
  get _metrics() {
    if (null == this._metricsCached) {
      ...
      let a4 = 0, l4 = 0, c = 0, g = 0, m2 = 0;
      this._lines.forEach((i2, s3) => {
        const n5 = t2.measureText(i2), h3 = n5.width / e2, o4 = h3 + r6;
        this._textWidths.push(h3), this._lineWidths.push(o4), a4 = Math.max(a4, o4), g = Math.max(g, n5.actualBoundingBoxAscent / e2), m2 = Math.max(m2, n5.actualBoundingBoxDescent / e2), 0 === s3 && (l4 = n5.actualBoundingBoxAscent / e2), s3 === this._lines.length - 1 && (c = n5.actualBoundingBoxDescent / e2);
      });
      const f2 = e(this._parameters), u2 = Math.max(g, f2.maxAscent), p = Math.max(m2, f2.maxDescent), x = l4, R = "underline" === this._parameters.definition.font.decoration ? p : c, S = a4;
  ...
  _renderHalo(t2, e2, i2, n4, r6) {
    const h2 = this.renderedWidth, a4 = this.renderedHeight, l4 = a(o3, Math.max(h2, d), Math.max(a4, d)), _2 = l4.getContext("2d");
    _2.clearRect(0, 0, h2, a4), this._parameters.setFontProperties(_2, this._renderedFontSize), _2.fillStyle = this._parameters.haloStyle, _2.strokeStyle = this._parameters.haloStyle;
    ...
    t2.globalAlpha = this._parameters.definition.halo.color[3], t2.drawImage(l4, 0, 0, h2, a4, this._toRenderUnit(e2), this._toRenderUnit(i2), h2, a4), t2.globalAlpha = 1;
  }
  ...
  _renderHaloNative(t2, e2, i2) {
    ...
    for (let n4 = 0; n4 < this._lines.length; ++n4) {
      const r6 = this._lines[n4], h2 = this._getLineXOffset(n4), o4 = 5, a4 = 0.1;
      for (let n5 = 0; n5 < o4; n5++) {
        const d2 = 1 - (o4 - 1) * a4 + n5 * a4;
  ...
  _drawBox(t2, e2, i2) {
    const s3 = this._toRenderUnit(e2[0]), n4 = this._toRenderUnit(e2[1]), r6 = this._toRenderUnit(i2[0]), h2 = this._toRenderUnit(i2[1]), o4 = Math.floor(s3) + 0.5, a4 = Math.ceil(s3 + r6) - 0.5, d2 = Math.floor(n4) + 0.5, l4 = Math.ceil(n4 + h2) - 0.5;
    t2.beginPath(), t2.moveTo(o4, d2), t2.lineTo(a4, d2), t2.lineTo(a4, l4), t2.lineTo(o4, l4), t2.lineTo(o4, d2), t2.stroke();
  }
};
var h = [];
{
...
//# sourceMappingURL=chunk-RMIV5B4F.js.map
