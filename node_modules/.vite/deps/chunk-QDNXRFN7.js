...
function Y(t3, s2) {
  const r4 = new X(t3);
  return r4.vvSize && (r4.vvSymbolAnchor = s2.anchor, o2(st), F(s2.rotation[2], s2.rotation[0], s2.rotation[1], st), r4.vvSymbolRotationMatrix = r4.vvSymbolRotationMatrix || e(), n(r4.vvSymbolRotationMatrix, st)), r4;
}
function Z(t3, o4, e6) {
...
//# sourceMappingURL=chunk-QDNXRFN7.js.map
