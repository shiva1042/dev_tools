...
async function o(o2) {
  const a2 = "portalItem" in o2 ? o2 : { portalItem: o2 }, { fromItem: e } = await import("./portalLayers-7BGM4E4M.js");
  try {
    return await e(a2);
  } catch (p) {
...
var b = class extends n(s3(u)) {
  ...
  static async fromArcGISServerUrl(t) {
    ...
    return (await import("./arcgisLayers-BYMBI32I.js")).fromUrl(e);
  }
...
//# sourceMappingURL=chunk-PESOUZGI.js.map
