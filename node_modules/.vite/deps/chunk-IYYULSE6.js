...
var u = class _u {
  ...
  static toUnitRGBA(t, r2) {
    return null == t ? null : (r2 ??= [0, 0, 0, 0], r2[0] = t.r / 255, r2[1] = t.g / 255, r2[2] = t.b / 255, r2[3] = null != t.a ? t.a : 1, r2);
  }
  constructor(t) {
  ...
  toArray(t = 0) {
    ...
    return 0 === t || 1 !== this.a ? [r2, s3, i, e(255 * this.a)] : [r2, s3, i];
  }
  clone() {
...
//# sourceMappingURL=chunk-IYYULSE6.js.map
