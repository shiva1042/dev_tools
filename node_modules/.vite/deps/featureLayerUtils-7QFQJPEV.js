...
async function H(e) {
  ...
  e.forEach(({ type: e2 }) => {
    switch (l2(e2)) {
      case "CatalogLayer":
        r.push(import("./CatalogLayer-25CJHEG3.js").then((e3) => e3.default));
        break;
      case "FeatureLayer":
        r.push(import("./@arcgis_core_layers_FeatureLayer.js").then((e3) => e3.default));
        break;
      case "OrientedImageryLayer":
        r.push(import("./OrientedImageryLayer-ICXIQBTF.js").then((e3) => e3.default));
    }
  });
...
//# sourceMappingURL=featureLayerUtils-7QFQJPEV.js.map
