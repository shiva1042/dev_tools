import {
  L as L2
} from "./chunk-E2QZR4S3.js";
import {
  a as a2
} from "./chunk-2HD5E3DA.js";
import "./chunk-S67OZ64S.js";
import "./chunk-RKZK6Q23.js";
...
var e7 = class {
  ...
  updateViewMatrices(t8) {
    this._originData.forEach((e10) => {
      n3(e10.viewMatrix, t8), o2(e10.origin.vec3, e10.viewMatrix);
    });
  }
};
var o3 = class {
...
var e8 = class extends F {
  constructor() {
    super(...arguments), this.transformNormalViewFromGlobal = e(), this.slicePlaneLocalOrigin = n2(), this.transformNormalGlobalFromModel = e();
  }
};
...
var a4 = class extends m3 {
  constructor(r8, i7) {
    super(r8, i7, new t5(L2, () => import("./EdgeShader.glsl-XV6Z2CFI.js")), i7.silhouette ? u3 : p);
  }
  initializePipeline() {
...
var g = class _g {
  constructor(r8, t8, s3) {
    this.rctx = r8, this._techniques = t8, this._configuration = new i4(), this.refCount = 0, this._renderables = /* @__PURE__ */ new Set(), this._sortedRenderables = { 0: { 0: new r2(), 1: new r2() }, 1: { 0: new r2(), 1: new r2() } }, this._renderablesDirty = false, this._drawParameters = new e8(), this._settings = { ..._2, ...s3 }, this.key = _g.getKey(this._settings.type, this._settings.hasSlicePlane, this._settings.legacy);
    const i7 = this._settings.strokesTexture.variants;
    this.writerSettings = { variants: i7, reducedPrecision: t4.TESTS_DISABLE_OPTIMIZATIONS }, this._configuration.legacy = this._settings.legacy, this._configuration.type = this._settings.type, this._configuration.silhouette = false, this._configuration.hasSlicePlane = this._settings.hasSlicePlane, this._configuration.spherical = s3.spherical;
  }
  addRenderable(e10) {
...
var $ = class extends b {
  constructor(e10) {
    super(e10), this._updatingHandles = new h3(), this._objectEntries = /* @__PURE__ */ new Map(), this._pendingDeletions = /* @__PURE__ */ new Map(), this._renderers = /* @__PURE__ */ new Map(), this._gpuMemoryUsage = 0, this._workerAbort = new AbortController(), this._tmpModelPosition = n2(), this._localOrigins = new e7(new f2(e10.renderSR));
  ...
  destroy() {
    this.destroyed || (this._objectEntries.forEach((e10) => this._discardObjectEntry(e10)), this._objectEntries.clear(), this._pendingDeletions.forEach((e10) => this._discardObjectEntry(e10)), this._pendingDeletions.clear(), this._strokesTexture = r(this._strokesTexture), this._componentColorManager = u(this._componentColorManager), this._workerAbort.abort(), this._workerHandle.destroy(), this._vertexBuffer.dispose(), this._renderers.clear(), this._updatingHandles.destroy(), this._set("schedule", _e));
  }
  get updating() {
  ...
  async addOrUpdateObject3D(e10, t8, r8, s3) {
    ...
    let o6;
    const a6 = e10.boundingVolumeWorldSpace.bounds, l2 = new re(i7, new Promise((e11) => o6 = e11), z(a6, n2()), L(a6)), d3 = this._objectEntries.get(e10);
  ...
  render(e10, t8) {
    ...
    const r8 = e10.camera.viewInverseTransposeMatrix, s3 = n2(), n7 = new e6();
    let i7 = 0, o6 = 0;
  ...
  async _addComponentGeometry(e10, t8, r8, s3, n7, i7, o6, a6) {
    ...
    t6(h5.position.typedBuffer, r8, h5.position.typedBufferStride, 3), i6(c3.meta, n7, h5.componentIndex, s3);
  ...
  async _addObjectMergedGeometries(e10, t8, r8, s3, n7) {
    ...
    const b2 = new pe(new t3(u5, h5, 3), p2, _3);
  ...
  _updateObjectCameraDistances(e10) {
    const t8 = e10.camera.eye, r8 = e10.camera.viewForward, s3 = n2(), n7 = (e11) => {
      R(s3, e11.center, t8);
...
function ce(e10) {
  ...
  for (let n7 = 0; n7 < t8.length; n7++) {
    const e11 = t8[n7].material, o6 = t8[n7].index, a6 = r3(Math.round(e11.size * c), 0, 255), c3 = r3(e11.extensionLength, -m4, 255 - m4) + m4, l2 = 255 * e11.opacity, d3 = e11.color, h5 = 255 * d3[0], u5 = 255 * d3[1], m5 = 255 * d3[2], g2 = 255 * d3[3];
...
//# sourceMappingURL=EdgeView-A6TFDO5M.js.map
