...
var l = class _l {
  static create(r2, e4, s3 = null) {
    const n2 = G(r2.spatialReference), a2 = e4.origin || i(r2.origin.x, r2.origin.y), h2 = i(r2.size[0] * e4.resolution, r2.size[1] * e4.resolution), u = i(-1 / 0, -1 / 0), c = i(1 / 0, 1 / 0), m = i(1 / 0, 1 / 0);
    ...
    let d, f, p, z;
    return !s3 && g && w && (o(u, g[0], w[0]), o(c, g[1], w[1]), o(m, g[1] - g[0] + 1, w[1] - w[0] + 1)), r2.isWrappable ? (d = i(Math.ceil(Math.round((n2.valid[1] - n2.valid[0]) / e4.resolution) / r2.size[0]), m[1]), f = true, p = n2.origin, z = n2.valid) : (d = m, f = false), new _l(e4.level, e4.resolution, e4.scale, a2, u, c, m, h2, d, f, p, z);
  }
...
var h = class {
  ...
  normalizeBounds(t, o3, l2) {
    if (t[0] = o3[0], t[1] = o3[1], t[2] = o3[2], t[3] = o3[3], this._wrap) {
      const o4 = G(this.tileInfo.spatialReference), s3 = -l2 * (o4.valid[1] - o4.valid[0]);
      t[0] += s3, t[2] += s3;
    }
    return t;
  }
...
//# sourceMappingURL=chunk-6HDPX4IB.js.map
