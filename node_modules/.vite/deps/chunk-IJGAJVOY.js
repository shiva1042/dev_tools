...
var e5 = { handleInterceptedEvent: (e7, p, t6, n9) => (e7.scheduleRender(), p.properties[`on${n9.type}`].apply(p.properties.bind || t6, [n9])) };
...
var s3 = (n9) => {
  let s4;
  const c3 = { ...e5, ...n9 }, i2 = t4(c3), a3 = i2.performanceLogger;
...
var x = s3({ postProcessProjectionOptions(e7) {
  ...
  (a3 && d3 in a3 || (d3 = `on${i2[0].toUpperCase()}${i2.slice(1)}${n9 ? "Capture" : ""}`, a3 && d3 in a3)) && (t(), e7.scheduleRender(), a3[d3].call(a3.bind || r2, s4));
} });
var O = false;
var _a;
...
//# sourceMappingURL=chunk-IJGAJVOY.js.map
