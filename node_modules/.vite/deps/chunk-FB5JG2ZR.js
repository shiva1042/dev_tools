...
function s(s2) {
  ...
  return s2 ? ("cim" === s2.type && s2.data.symbol && "symbolLayers" in s2.data.symbol && s2.data.symbol.symbolLayers && s2.data.symbol.symbolLayers.map((o) => {
    "CIMVectorMarker" === o.type && o.anchorPoint && (Math.abs(o.anchorPoint.x) > t && (t = o.anchorPoint.x), Math.abs(o.anchorPoint.y) > a3 && (a3 = o.anchorPoint.y), null != o.size && o.size > e && (e = o.size));
  }), t = u(t), a3 = u(a3), e = u(e), { offsetX: t, offsetY: a3, size: e }) : { offsetX: t, offsetY: a3, size: e };
}
...
var S = class extends b {
  ...
  get elevationInfo() {
    const { layer: t } = this.graphic, e = t && "elevationInfo" in t ? t.elevationInfo : null, o = a2(this.graphic), i4 = e ? e.offset : 0;
  ...
  intersectionDistance(t) {
    ...
    const i4 = this._get("focusedSymbol"), s2 = null != i4 ? i4 : e.symbol;
  ...
  _intersectDistance2D(t, e, o, i4) {
    if (null == (i4 = i4 || J(o))) return null;
    const s2 = 1;
    ...
    if ("point" === o.type && "cim" === i4.type && "CIMPointSymbol" === i4.data.symbol?.type && i4.data.symbol.symbolLayers) {
      const { offsetX: l2, offsetY: n3, size: a3 } = s(i4), c2 = g(e, j), p2 = a3 / 2, m2 = t.toScreen(o), u2 = m2.x + l2, y = m2.y + n3;
      return b2(c2, [u2, y]) < p2 * p2 ? s2 : null;
    }
    if ("point" !== o.type || "simple-marker" !== i4.type) return i3(e, o, t) ? s2 : null;
    if (null == n2 || !n2.originalPoint.equals(o)) {
      const e2 = o, s3 = t.spatialReference;
      if (J2(e2.spatialReference, s3)) {
        const t2 = W(e2, s3);
        n2 = { originalPoint: e2.clone(), mapPoint: t2, radiusPx: u(i4.size) }, this._circleCollisionCache = n2;
      }
    }
    if (null != n2) {
      const o2 = g(e, j), a3 = t.toScreen?.(n2.mapPoint);
      if (!a3) return null;
      const c2 = n2.radiusPx, p2 = a3.x + u(i4.xoffset), m2 = a3.y - u(i4.yoffset);
      return b2(o2, [p2, m2]) < c2 * c2 ? s2 : null;
    }
    return null;
  }
  _intersectDistance3D(t, e, o) {
    const i4 = t.toMap(e, { include: [o] });
...
//# sourceMappingURL=chunk-FB5JG2ZR.js.map
