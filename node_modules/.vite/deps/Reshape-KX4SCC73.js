import {
  h as h7
} from "./chunk-SFZRM2DT.js";
import {
  j as j3
} from "./chunk-PK3FQY56.js";
import {
  i as i4,
  p as p4
...
import {
  h as h6,
  x as x3
} from "./chunk-7ZUCCVNP.js";
import "./chunk-DNRLLNXP.js";
import {
  C2 as C,
  F as F2,
  H2 as H,
...
async function L(e8, i7, a4) {
  ...
  if (null == d5) return _3().error("editing:cannot-hide-graphic", "Unable to hide original graphic because it has no objectId."), e3();
  let c3 = null;
  function h9(e9) {
  ...
  return await F3(a4, i7), h9(false), t([j4(a4, i7, (e9) => h9(!e9)), e3(async () => {
    h9(true);
...
//# sourceMappingURL=Reshape-KX4SCC73.js.map
