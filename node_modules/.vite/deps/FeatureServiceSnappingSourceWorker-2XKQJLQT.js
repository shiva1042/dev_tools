import {
  ...
  n,
  r
} from "./chunk-SWMH45R5.js";
import {
  f as f6
} from "./chunk-P3J55KE4.js";
import {
  o as o3
} from "./chunk-TRXUJYVY.js";
...
var s2 = class {
  ...
  _gotoFetchCount(s3, r3) {
    return { type: 1, previous: s3, task: d2(async (t2) => {
  ...
  _gotoFetchFeatures(s3, a4) {
    return { type: 3, previous: s3, task: d2(async (t2) => {
...
var j2 = class extends b {
  ...
  async handleEdits(e5) {
    ...
    const t2 = { ...e5, deletedFeatures: e5.deletedFeatures.map(({ objectId: e6, globalId: t3 }) => e6 && -1 !== e6 ? e6 : this._lookupObjectIdByGlobalId(t3)) }, i5 = d2(async (e6) => {
      try {
  ...
  async _queryFeatures(e5, t2) {
    return 0 === e5.num ? new e3() : this.capabilities.query.supportsFormatPBF ? this._queryFeaturesPBF(e5, t2) : this._queryFeaturesJSON(e5, t2);
  }
...
var m2 = class extends b {
  ...
  process(e5, t2 = () => true, s3) {
    if (null == this.tileInfo || !e5.extent || null != this.extent && !d(o2(this.extent, this._tmpBoundingRect), e5.extent)) return new v(e5);
...
var C2 = class {
  ...
  addMissing(e5, t2, s3, i5) {
    const r3 = new e4(e5, t2, s3);
    this._tileInfo.updateTileInfo(r3, 1) && (null == this._extent || d(this._extent, r3.extent)) && (this.info.missingTiles.push({ data: r3, resolution: i5 }), this.info.coveredArea -= p(r3.extent));
  }
};
var S = 0.18751;
...
var w2 = class extends l {
  ...
  async updateTiles(e5, t2) {
    return await this._updatingHandles.addPromise(this._whenSetup.promise), s(t2), this._featureFetcher.tileSize = e5.tileSize, this._featureFetcher.tilesOfInterest = e5.tiles.map((e6) => e4.fromJSON(e6)), this._featureFetcher.tileInfo = null != e5.tileInfo ? z2.fromJSON(e5.tileInfo) : null, C3;
  }
  async refresh(e5, t2) {
...
//# sourceMappingURL=FeatureServiceSnappingSourceWorker-2XKQJLQT.js.map
