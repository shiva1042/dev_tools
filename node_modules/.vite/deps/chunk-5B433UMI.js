...
async function i2(e, r, n2 = false) {
  if (!e || !r) return true;
  const a5 = e.replace(/\/FeatureServer/i, "/VersionManagementServer").replace(/\/\d*$/, ""), o3 = s.get(a5)?.entries();
  if (o3) {
    for (const [s2, i3] of o3) if (i3.name === r) {
      const e2 = !i3.stack?.hasForwardEdits();
      if (!e2 && n2) {
        const [{ deleteForwardEdits: e3 }, { default: r2 }] = await Promise.all([import("./deleteForwardEdits-3NV3SHCQ.js"), import("./DeleteForwardEditsParameters-3N7TXV2H.js")]), n3 = await e3(a5, s2, new r2({ sessionId: t, moment: i3.moment }));
        return n3.success && i3.stack?.clearForwardEdits(), n3.success;
      }
      return e2;
    }
  }
...
function c2(t2, e, i3 = null, r = false) {
  const d = $();
  return r = null == e || r, a4.emit("apply-edits", { serviceUrl: t2, layerId: e, gdbVersion: i3, mayReceiveServiceEdits: r, result: d.promise }), d;
}
function u(t2, e, i3 = null, s2) {
  a4.emit("update-moment", { serviceUrl: t2, layerId: e, gdbVersion: i3, moment: s2 });
}
...
var F = (e) => {
  ...
  var s2;
  const n2 = e;
  let a5 = (_a = class extends n2 {
    constructor(...t2) {
      super(...t2), this[s2] = true, this._applyEditsHandler = (t3) => {
        const { serviceUrl: e2, layerId: s3, gdbVersion: r, mayReceiveServiceEdits: d, result: o3 } = t3, n3 = e2 === this.url, a6 = null != s3 && null != this.layerId && s3 === this.layerId, l2 = b(this), h2 = b(this) && g(e2, r, this.gdbVersion);
        if (!n3 || l2 && !h2 || !a6 && !d) return;
        const c3 = o3.then((t4) => {
          if (this.lastEditsEventDate = /* @__PURE__ */ new Date(), a6 && (t4.addedFeatures.length || t4.updatedFeatures.length || t4.deletedFeatures.length || t4.addedAttachments.length || t4.updatedAttachments.length || t4.deletedAttachments.length)) return this.emit("edits", a(t4)), t4;
  ...
  return __decorate([m()], a5.prototype, "lastEditsEventDate", void 0), a5 = __decorate([a2("esri.layers.mixins.EditBusLayer")], a5), a5;
};
...
//# sourceMappingURL=chunk-5B433UMI.js.map
