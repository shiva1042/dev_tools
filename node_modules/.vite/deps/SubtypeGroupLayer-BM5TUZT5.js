...
var f4 = { key: "type", base: a4, errorContext: "renderer", typeMap: { simple: p4, "unique-value": $, "class-breaks": j2 } };
var i2 = s2({ types: f4 });
function c3(e3, r2) {
...
function a7(r2, s7) {
  return S2(u6, r2, { offset: true, shuffle: true }).reverse().map((e3) => {
    const r3 = s7.clone();
    return "cim" === r3.type ? k(r3, e3) : L3(r3, e3), new p4({ symbol: r3 });
  });
}

// node_modules/@arcgis/core/graphic/isSubtypeGroupGraphicOrigin.js
var i3 = /* @__PURE__ */ Symbol("isSubtypeGroupGraphicOriginSymbol");
...
var X = class extends l5(l2(s3(u2))) {
  constructor(e3) {
  ...
  createQuery() {
    ...
    return e3.where = l3(t3, this.parent.definitionExpression), e3;
  }
...
__decorate([m({ clonable: false, readOnly: true })], X.prototype, "_titleCreator", null), __decorate([m({ type: c, json: B2({ name: "attributeTableInfo" }) })], X.prototype, "attributeTableTemplate", void 0), __decorate([m({ readOnly: true, json: { read: false } })], X.prototype, "capabilities", null), __decorate([m({ readOnly: true, json: { read: false } })], X.prototype, "effectiveCapabilities", null), __decorate([m({ json: B2() })], X.prototype, "charts", void 0), __decorate([m({ type: Boolean, nonNullable: true, json: B2({ name: "enableEditing" }) })], X.prototype, "editingEnabled", void 0), __decorate([m({ type: Boolean, readOnly: true })], X.prototype, "effectiveEditingEnabled", null), __decorate([m({ readOnly: true, json: { read: false } })], X.prototype, "elevationInfo", null), __decorate([m({ clonable: false, readOnly: true })], X.prototype, "featureTitleFields", null), __decorate([m({ json: { name: "layerDefinition.fieldOverrides", origins: { service: { read: false } }, write: { ignoreOrigin: true, allowNull: true } } })], X.prototype, "fieldOverrides", void 0), __decorate([r("fieldOverrides")], X.prototype, "writeFieldOverrides", null), __decorate([m({ ...M.fields, readOnly: true, json: { read: false } })], X.prototype, "fields", null), __decorate([m(M.fieldsIndex)], X.prototype, "fieldsIndex", void 0), __decorate([m({ readOnly: true, json: { read: false } })], X.prototype, "floorInfo", null), __decorate([m({ type: F, json: B2({ name: "formInfo" }) })], X.prototype, "formTemplate", void 0), __decorate([m({ readOnly: true, clonable: false })], X.prototype, "graphicOrigin", void 0), __decorate([m({ type: String, clonable: false, json: { origins: { service: { read: false }, "portal-item": { read: false } }, write: { ignoreOrigin: true } } })], X.prototype, "id", void 0), __decorate([m({ readOnly: true, json: { read: false } })], X.prototype, "isTable", null), __decorate([m({ readOnly: true, json: { read: false } })], X.prototype, "geometryType", null), __decorate([m({ readOnly: true, json: { read: false } })], X.prototype, "globalIdField", null), __decorate([m({ readOnly: true, json: { read: false } })], X.prototype, "type", void 0), __decorate([m(k2(a(p3)))], X.prototype, "labelsVisible", void 0), __decorate([m({ type: [A2], json: { name: "layerDefinition.drawingInfo.labelingInfo", origins: { service: { read: false } }, read: { reader: l9 }, write: { ignoreOrigin: true, layerContainerTypes: a3 } } })], X.prototype, "labelingInfo", void 0), __decorate([m({ type: ["ArcGISFeatureLayer"], readOnly: true, json: { read: false, write: { ignoreOrigin: true, layerContainerTypes: a3 } } })], X.prototype, "layerType", void 0), __decorate([m(k2(a(d)))], X.prototype, "legendEnabled", void 0), __decorate([m({ type: ["show", "hide"] })], X.prototype, "listMode", void 0), __decorate([m((() => {
  const e3 = a(j);
  return e3.json.origins.service.read = false, k2(e3, { spatialOnly: true });
})())], X.prototype, "minScale", void 0), __decorate([m((() => {
  const e3 = a(v);
  return e3.json.origins.service.read = false, k2(e3, { spatialOnly: true });
})())], X.prototype, "maxScale", void 0), __decorate([m({ readOnly: true })], X.prototype, "effectiveScaleRange", null), __decorate([m({ readOnly: true, json: { read: false } })], X.prototype, "objectIdField", null), __decorate([m({ type: Number, range: { min: 0, max: 1 }, nonNullable: true, json: B2({ spatialOnly: true }) })], X.prototype, "opacity", void 0), __decorate([m({ clonable: false })], X.prototype, "parent", void 0), __decorate([m(k2(a(l6)))], X.prototype, "popupEnabled", void 0), __decorate([m({ type: q2, json: B2({ name: "popupInfo" }) })], X.prototype, "popupTemplate", void 0), __decorate([m({ readOnly: true })], X.prototype, "defaultPopupTemplate", null), __decorate([m({ readOnly: true, json: { read: false } })], X.prototype, "relationships", null), __decorate([m({ types: f4, json: B2({ target: "layerDefinition.drawingInfo.renderer", spatialOnly: true }) })], X.prototype, "renderer", null), __decorate([o("service", "renderer", ["drawingInfo.renderer", "subtypeField", "type"])], X.prototype, "readRendererFromService", null), __decorate([o("renderer", ["layerDefinition.drawingInfo.renderer"])], X.prototype, "readRenderer", null), __decorate([m({ readOnly: true, json: { read: false } })], X.prototype, "spatialReference", null), __decorate([m({ type: Number, json: { origins: { service: { read: false } }, write: { ignoreOrigin: true } } })], X.prototype, "subtypeCode", void 0), __decorate([m({ readOnly: true, json: { read: false } })], X.prototype, "subtypeField", null), __decorate([m({ type: [a6], json: B2({ name: "layerDefinition.templates" }) })], X.prototype, "templates", void 0), __decorate([o("service", "templates", ["geometryType", "subtypeField", "subtypes", "type"])], X.prototype, "readTemplatesFromService", null), __decorate([m({ type: String, json: B2() })], X.prototype, "title", void 0), __decorate([o("service", "title", ["subtypes"])], X.prototype, "readTitleFromService", null), __decorate([m({ readOnly: true, json: { read: false } })], X.prototype, "url", null), __decorate([m({ readOnly: true })], X.prototype, "userHasUpdateItemPrivileges", null), __decorate([m({ type: Boolean, nonNullable: true, json: B2({ name: "visibility", spatialOnly: true }) })], X.prototype, "visible", void 0), X = __decorate([a2("esri.layers.support.SubtypeSublayer")], X);
var Y2 = (e3, t3, r2) => {
...
var Z = (e3, t3, r2) => {
  ...
  return i4.test(n4) ? n4.replace(i4, o5) : l3(o5, n4);
};
...
var ue = class extends V(a5(F2(p2(l8(t(f3(l7(b(j3(l5(s5(o3(l2(b4)))))))))))))) {
  constructor(...e3) {
    super(...e3), this._sublayerLookup = /* @__PURE__ */ new Map(), this.fields = null, this.fieldsIndex = null, this.outFields = null, this.sublayers = new (O.ofType(X))(), this.useUniqueColorsForSublayers = true, this.supportedSourceTypes = /* @__PURE__ */ new Set(["Feature Layer", "Table"]), this.timeInfo = null, this.title = "Layer", this.type = "subtype-group", this._debouncedSaveOperations = L(async (e4, t3, r2) => {
      const { save: s7, saveAs: i4 } = await import("./featureLayerUtils-U5DXY4XV.js");
      switch (e4) {
        case 0:
          return s7(this, t3);
        case 1:
  ...
  async createGraphicsSource(e3) {
    const { default: t3 } = await p(import("./FeatureLayerSource-MORQH7QX.js"), e3);
  ...
  createQuery() {
    ...
    return e3.where = l3(`${this.subtypeField} IN (${t3.join(",")})`, this.definitionExpression), e3;
  }
  async deleteAttachments(e3, t3) {
    const r2 = await v2(this, e3, t3, se);
    return this.lastEditsEventDate = /* @__PURE__ */ new Date(), r2;
  }
  ...
  async queryFeatures(e3, t3) {
    const r2 = await this.load(), s7 = b2.from(e3) ?? r2.createQuery(), i4 = s7.outFields ?? [];
...
__decorate([m({ readOnly: true })], ue.prototype, "createQueryVersion", null), __decorate([m({ readOnly: true })], ue.prototype, "editingEnabled", null), __decorate([m({ readOnly: true })], ue.prototype, "effectiveEditingEnabled", null), __decorate([m({ ...ae.fields, readOnly: true, json: { origins: { service: { read: true } }, read: false } })], ue.prototype, "fields", void 0), __decorate([m(ae.fieldsIndex)], ue.prototype, "fieldsIndex", void 0), __decorate([m(u3)], ue.prototype, "id", void 0), __decorate([m({ type: ["show", "hide", "hide-children"], json: { origins: { "portal-item": { read: false, write: false } } } })], ue.prototype, "listMode", void 0), __decorate([m({ type: ["SubtypeGroupLayer", "SubtypeGroupTable"], json: { ...ne(), origins: { "web-document": ne(), "portal-item": ne() } } })], ue.prototype, "operationalLayerType", null), __decorate([m(ae.outFields)], ue.prototype, "outFields", void 0), __decorate([m({ clonable: false })], ue.prototype, "source", null), __decorate([m({ type: O.ofType(X), json: { origins: { service: { read: { source: "subtypes", reader(e3, t3, s7) {
  let i4 = null;
...
} } } })], ue.prototype, "sublayers", void 0), __decorate([m()], ue.prototype, "useUniqueColorsForSublayers", void 0), __decorate([m({ type: u5 })], ue.prototype, "timeInfo", void 0), __decorate([m({ json: { origins: { "portal-item": { write: { enabled: true, ignoreOrigin: true, writerEnsuresNonNull: true } } } } })], ue.prototype, "title", void 0), __decorate([o("service", "title", ["name"])], ue.prototype, "readTitleFromService", null), __decorate([m({ json: { read: false } })], ue.prototype, "type", void 0), __decorate([m({ clonable: false, readOnly: true })], ue.prototype, "featureTitleFields", null), ue = __decorate([a2("esri.layers.SubtypeGroupLayer")], ue);
var le = ue;
export {
  le as default
};
//# sourceMappingURL=SubtypeGroupLayer-BM5TUZT5.js.map
