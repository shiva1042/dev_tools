...
async function H(e) {
  ...
  e.forEach(({ type: e2 }) => {
    switch (l(e2)) {
      case "CatalogLayer":
        r.push(import("./CatalogLayer-GH4NTFWE.js").then((e3) => e3.default));
        break;
      case "FeatureLayer":
        r.push(import("./@arcgis_core_layers_FeatureLayer.js").then((e3) => e3.default));
        break;
      case "OrientedImageryLayer":
        r.push(import("./OrientedImageryLayer-6WXI5UXP.js").then((e3) => e3.default));
    }
  });
...
//# sourceMappingURL=featureLayerUtils-YJP2PEYQ.js.map
