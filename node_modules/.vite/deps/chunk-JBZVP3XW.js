import {
  ...
  s3 as s6,
  u
} from "./chunk-7H5AXDVN.js";
import {
  T
} from "./chunk-3HUBUYC2.js";
import {
  D,
  I as I3,
  O,
...
import {
  ...
  q as q2,
  w
} from "./chunk-2AIIGID3.js";
import {
  I as I2
} from "./chunk-SJMQ6OPN.js";
import {
  p
...
var G;
async function H3() {
  null == G && (G = await import("./operators-JIFQK3XU.js"), await G.loadAll());
}
function F(H6, F4) {
  H6.disjoint = function(e5, n7) {
    ...
    return F4(e5, n7, (t5, r5, u3) => (oe(u3, 2, 2, e5, n7), u3[0] === u3[1] || (u3[0] instanceof c2 && u3[1] instanceof c2 ? G.equals.execute(u3[0], u3[1]) : (ne(u3[0]) && ne(u3[1]) || ie(u3[0]) && ie(u3[1]) || !(!re(u3[0]) || !re(u3[1]))) && u3[0].equals(u3[1]))));
  }, H6.relate = function(e5, t5) {
    return F4(e5, t5, (a3, l4, o6) => {
      if (o6 = Je(o6), oe(o6, 3, 3, e5, t5), o6[0] instanceof c2 && o6[1] instanceof c2) return G.relate.execute(o6[0], o6[1], ge(o6[2]));
      if (o6[0] instanceof c2 && null === o6[1]) return false;
      if (o6[1] instanceof c2 && null === o6[0]) return false;
    ...
    return F4(e5, i7, (a3, l4, o6) => {
      ...
      if (1 === o6.length) if (o2(o6[0])) {
        for (const t5 of Je(o6[0])) if (null !== t5) {
          if (!(t5 instanceof c2)) throw new n3(e5, "InvalidParameter", i7);
          u3.push(t5);
        }
      } else {
        if (!te(o6[0])) {
          if (o6[0] instanceof c2) return De(o(o6[0]), e5.spatialReference);
    ...
    return F4(e5, t5, (a3, l4, o6) => {
      ...
      if (null === o6[0]) return null;
      if (!(o6[0] instanceof c2)) throw new n3(e5, "InvalidParameter", t5);
    ...
    return F4(e5, a3, (l4, o6, u3) => {
      ...
      if (null === u3[0]) return [];
      if (!(u3[0] instanceof c2)) throw new n3(e5, "InvalidParameter", a3);
    ...
    return F4(e5, t5, (a3, l4, o6) => {
      ...
      if (!(u3 instanceof c2)) throw new n3(e5, "InvalidParameter", t5);
      return p3(u3.spatialReference, q2(o6[1]), G.area.execute(u3));
    });
    ...
    return F4(e5, t5, (a3, l4, o6) => {
      ...
      if (!(u3 instanceof c2)) throw new n3(e5, "InvalidParameter", t5);
      return p3(u3.spatialReference, d3(o6[1]), G.length.execute(u3));
    });
    ...
    return F4(e5, t5, (a3, l4, o6) => {
      ...
      if ((o2(o6[0]) || te(o6[0])) && (u3 = ve(o6[0], e5.spatialReference)), null === u3) return 0;
      if (!(u3 instanceof c2)) throw new n3(e5, "InvalidParameter", t5);
      return true === u3.hasZ ? p3(u3.spatialReference, d3(o6[1]), x(u3)) : p3(u3.spatialReference, d3(o6[1]), G.length.execute(u3));
    });
    ...
    return F4(e5, t5, (a3, l4, o6) => {
      ...
      let u3 = o6[0];
      if ((o2(o6[0]) || te(o6[0])) && (u3 = Pe(o6[0], e5.spatialReference)), !(u3 instanceof c2)) throw new n3(e5, "InvalidParameter", t5);
      let s9 = o6[1];
      if ((o2(o6[1]) || te(o6[1])) && (s9 = Pe(o6[1], e5.spatialReference)), !(s9 instanceof c2)) throw new n3(e5, "InvalidParameter", t5);
      return p3(u3.spatialReference, d3(o6[2]), G.distance.execute(u3, s9));
    });
    ...
    return F4(e5, t5, (e6, t6, a3) => {
      ...
      if (!(o6 instanceof c2)) throw new n3(e6, "InvalidParameter", t6);
    ...
    return F4(t5, a3, (l4, o6, u3) => {
      if (u3 = Je(u3), oe(u3, 2, 2, t5, a3), !(u3[0] instanceof c2 || null === u3[0])) throw new n3(t5, "InvalidParameter", a3);
...
Ze([p4], "sync"), Ze([p4], "async"), Ze([T], "async");
var Je2 = /* @__PURE__ */ Symbol("uninitialized");
...
async function nn() {
  return Ze([await import("./geomasync-XKC6TDMM.js")], "async"), true;
}
...
var X = /* @__PURE__ */ Symbol("uninitialized");
function ee2(e5) {
  ...
  try {
    ...
    if (false === t5.computed) {
      if ("Identifier" === t5.property.type) {
        ...
        if (n7 instanceof c2) return d(n7, t5.property.name, e5, t5);
...
async function q3() {
  await nn(), x2 = await import("./arcadeAsyncRuntime-DJ5MMRSX.js");
...
async function X2() {
  await N2();
  const [e5, t5, n7, s9, a3, o6] = await Promise.all([import("./featureSetUtils-KX6BKH4S.js"), import("./featuresetbase-JYXF6EK2.js"), import("./featuresetgeom-HBZZW7SN.js"), import("./featuresetstats-FM6YQWGU.js"), import("./featuresetstring-S6ZDIOSJ.js"), import("./knowledgegraph-X6XYMIMJ.js")]);
...
//# sourceMappingURL=chunk-JBZVP3XW.js.map
