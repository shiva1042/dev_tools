...
var m2 = class extends B {
  constructor(e2, o) {
    super(e2, o), this._isFeatureCountNoticeOpen = true, this._observer = new IntersectionObserver(([e3]) => {
      e3?.isIntersecting && this._increaseFeaturePage();
  ...
  loadDependencies() {
    return c2({ icon: () => import("./calcite-icon-3IEDG7YE.js"), input: () => import("./calcite-input-4FG7NLDV.js"), loader: () => import("./calcite-loader-PDFV646E.js"), notice: () => import("./calcite-notice-AY3YEGXC.js") });
  }
  destroy() {
    this.tooltipReferenceMap.clear();
  }
  get associatedFeatureCount() {
    const e2 = this.viewModel.associationViewModels, t = this.selectedLayer ? e2.get(this.selectedLayer) : null;
    return t ? t.length : 0;
  }
  set currentFeaturePage(e2) {
    const { featuresPerPage: t, associatedFeatureCount: o } = this, i = Math.ceil(o / t) || 1, r = Math.max(Math.min(e2, i), 1);
  ...
  get endIndex() {
    const { currentFeaturePage: e2, featuresPerPage: t, maxFeatureCount: o } = this;
    return Math.min(e2 * t, o);
  }
  renderConnectivityIcon(e2, t) {
  ...
  renderFilter() {
    return n("div", { class: p.filterContainer, key: "filter" }, n("calcite-input", { icon: "search", placeholder: this.messagesFeature.associationFilterPlaceholder, type: "search", onCalciteInputInput: (e2) => {
      this.filterText = e2.currentTarget.value.trim().toLowerCase(), this.currentFeaturePage = 1;
    } }));
  }
  renderLoading() {
  ...
  _onObserverChange() {
    ...
    const { state: e2, showAllEnabled: t } = this.viewModel;
    this._observerNode && "ready" === e2 && t && this._observer.observe(this._observerNode);
  }
  _onObserverCreate(e2) {
    this._observerNode = e2;
  }
};
...
function n2(n5) {
  ...
  return null == r ? "" : c(r, { style: "percent", maximumFractionDigits: 2 });
}
...
//# sourceMappingURL=chunk-GEVK4IWL.js.map
