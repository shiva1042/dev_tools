...
__decorate([m({ type: ["cluster"], readOnly: true, json: { write: true } })], I.prototype, "type", void 0), __decorate([m({ cast: (e2) => "auto" === e2 ? e2 : a2(o2(e2)), json: { write: true } })], I.prototype, "clusterRadius", void 0), __decorate([m({ type: Number, cast: o2, json: { write: true } })], I.prototype, "clusterMinSize", void 0), __decorate([m({ type: Number, cast: o2, json: { write: true } })], I.prototype, "clusterMaxSize", void 0), __decorate([m({ type: Number, json: { default: 0, name: "visibilityInfo.maxScale" } })], I.prototype, "maxScale", void 0), __decorate([m(l3)], I.prototype, "popupEnabled", void 0), __decorate([m({ type: q, json: { read: { source: "popupInfo" }, write: { target: "popupInfo" } } })], I.prototype, "popupTemplate", void 0), __decorate([m({ types: m2, json: { write: { target: "drawingInfo.renderer" } } })], I.prototype, "renderer", void 0), __decorate([o("renderer", ["drawingInfo.renderer"])], I.prototype, "readRenderer", null), __decorate([m({ types: g })], I.prototype, "symbol", void 0), __decorate([o("symbol", ["drawingInfo.renderer"])], I.prototype, "readSymbol", null), __decorate([r("symbol")], I.prototype, "writeSymbol", null), __decorate([m({ type: [A], json: { read: { source: "drawingInfo.labelingInfo" }, write: { target: "drawingInfo.labelingInfo" } } })], I.prototype, "labelingInfo", void 0), __decorate([m(p)], I.prototype, "labelsVisible", void 0), __decorate([m({ type: [n3], json: { write: true } })], I.prototype, "fields", void 0), __decorate([r("fields")], I.prototype, "writeFields", null), __decorate([o("fields")], I.prototype, "readFields", null), I = S = __decorate([a3("esri.layers.support.FeatureReductionCluster")], I);

// node_modules/@arcgis/core/layers/support/featureReductionUtils.js
var n4 = { key: "type", base: s3, typeMap: { cluster: I, binning: v } };
var a5 = { types: { key: "type", base: s3, typeMap: { selection: p3, cluster: I, binning: v } }, json: { name: "layerDefinition.featureReduction", write: { allowNull: true }, origins: { "web-map": { types: n4 }, "portal-item": { types: n4 }, "web-scene": { types: { key: "type", base: s3, typeMap: { selection: p3 } }, name: "layerDefinition.featureReduction", write: { allowNull: true, layerContainerTypes: a4 } } } } };
...
function d(e2, r4) {
  let s4 = r4.clone();
  if (!m3(s4)) return s4;
  if (r4.symbols.some((e3) => p6.has(e3.type)) && (s4 = new p2({ symbol: new u() })), s4.authoringInfo || (s4.authoringInfo = new b()), s4.authoringInfo.isAutoGenerated = true, "visualVariables" in s4) {
  ...
  let m4 = class extends p7 {
    ...
    _withClusterVariable(e2, r4, t) {
      ...
      if ("visualVariables" in i2) {
        ...
        i2.visualVariables.some((e3) => "size" === e3.type) || i2.visualVariables.push(new V({ field: "cluster_count", stops: [new l4({ value: 1 }), new l4({ useMinValue: true, size: r4 }), new l4({ useMaxValue: true, size: t })] }));
      }
      return i2;
    }
    _normalizeFeatureReduction(e2) {
      ...
      if (e2.symbol) {
        ...
        const s5 = d(t, this.renderer), o4 = this._withClusterVariable(s5, a6, n5), l7 = "visualVariables" in o4 && o4.visualVariables ? o4.visualVariables : [], c3 = new p2({ symbol: e2.symbol, visualVariables: l7 });
...
//# sourceMappingURL=chunk-XKCDWY2H.js.map
