...
var E2 = class {
  ...
  async _getAggregateGeometry(e5, r5) {
    ...
    if ("EnvelopeAggregate" === l7) {
      ...
      const e6 = g4 ? l4(g4) : r2(l3(o2(d6, y5)));
  ...
  async _createAutoIntervalBinsResponse(e5, t6, i3) {
    const { field: s7, normalizationField: a4, numBins: r5, normalizationType: n5, normalizationTotal: o2, start: l7, end: u5 } = e5, c4 = await this._getDataValues({ field: e5.field, normalizationField: e5.normalizationField, normalizationType: e5.normalizationType, normalizationTotal: e5.normalizationTotal, timeZone: t6.outTimeReference?.ianaTimeZone }, i3), m8 = G2(c4, { field: s7, normalizationField: a4, normalizationType: n5, normalizationTotal: o2, numBins: r5, minValue: h2(l7, false), maxValue: h2(u5, false) }), d6 = this._calculateHistogramBins(c4, m8, i3);
  ...
  async _createFixedIntervalBinsResponse(e5, t6, i3) {
    const { field: s7, interval: a4, start: r5, end: n5 } = e5, o2 = await this._getDataValues({ field: e5.field, normalizationField: e5.normalizationField, normalizationType: e5.normalizationType, normalizationTotal: e5.normalizationTotal, timeZone: t6.outTimeReference?.ianaTimeZone }, i3), l7 = xe(this.fieldsIndex.get(s7)), u5 = G2(o2, { field: s7, classificationMethod: "defined-interval", definedInterval: a4, minValue: h2(r5, l7), maxValue: h2(n5, l7) }, true), c4 = this._calculateHistogramBins(o2, u5, i3);
...
var W = class {
  ...
  *_runSpatialFilter(e5, t6) {
  ...
  async _project(e5, t6) {
    ...
    const r5 = this.featureAdapter, s7 = G() ? await this._getFullExtent() : void 0, a4 = await M2(e5.items.map((e6) => a2(this.geometryType, this.hasZ, this.hasM, r5.getGeometry(e6))), this.spatialReference, t6, { areaOfInterestExtent: s7 });
...
//# sourceMappingURL=chunk-I5BWTJ46.js.map
