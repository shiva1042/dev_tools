...
async function C(e2) {
  const { computeObjectLayerResourceSize: t } = await import("./symbolLayerUtils-DRERWJLK.js"), r = await t(e2, 10), { width: o, height: n, depth: l } = e2, i2 = [o, l, n];
  let c = 1;
  for (let s = 0; s < 3; s++) {
    const e3 = i2[s];
    if (null != e3) {
...
function q(e2, t) {
  if (!e2) return null;
  const r = (t ? e2.effects : e2.effects.filter((e3) => "bloom" !== e3.type)).map((e3) => e3.toJSON());
  return i(r);
}
function A(e2) {
...
//# sourceMappingURL=chunk-FYRECMRT.js.map
