...
function t2(t3, r4) {
  return new Proxy({}, { get: (e4, i3, s5) => (...e5) => {
    ...
    n3(a4) && (s6 = a4.signal, o3 = a4.transferList, e5.pop());
...
var r3 = { statsWorker: () => import("./statsWorker-B2U64N5R.js"), geometryEngineWorker: () => import("./geometryEngineWorker-J4EWPUTO.js"), arcadeGeometryOperatorsWorker: () => import("./operatorsWorker-LI4QCG45.js"), CSVSourceWorker: () => import("./CSVSourceWorker-LDHBZQUA.js"), EdgeProcessingWorker: () => import("./EdgeProcessingWorker-3N2UAMYH.js"), ElevationSamplerWorker: () => import("./ElevationSamplerWorker-ZZ5PY6U3.js"), FeatureServiceSnappingSourceWorker: () => import("./FeatureServiceSnappingSourceWorker-4YEEKN7R.js"), GaussianSplatSortWorker: () => import("./GaussianSplatSortWorker-P5KLXWAJ.js"), GeoJSONSourceWorker: () => import("./GeoJSONSourceWorker-YGNFBVS3.js"), LercWorker: () => import("./LercWorker-D6SFXUSK.js"), MemorySourceWorker: () => import("./MemorySourceWorker-ESOLONR7.js"), PBFDecoderWorker: () => import("./PBFDecoderWorker-7EVLJAS5.js"), FeaturePipelineWorker: () => import("./FeaturePipelineWorker-CSLCIR6D.js"), PointCloudWorker: () => import("./PointCloudWorker-TEJBD4EJ.js"), RasterWorker: () => import("./RasterWorker-W22JVA5G.js"), SceneLayerSnappingSourceWorker: () => import("./SceneLayerSnappingSourceWorker-I4BMBV2X.js"), SceneLayerWorker: () => import("./SceneLayerWorker-O4LZGEYL.js"), WFSSourceWorker: () => import("./WFSSourceWorker-AV42NQ4S.js"), WorkerTileHandler: () => import("./WorkerTileHandler-VFADCH7C.js"), Lyr3DWorker: () => import("./Lyr3DWorker-2EU53FSR.js"), Feature3DPipelineWorker: () => import("./Feature3DPipelineWorker-53OHH7WK.js"), TextureCompressionWorker: () => import("./TextureCompressionWorker-LZT7AOD7.js"), FlowWorker: () => import("./FlowWorker-3HVUT3ES.js"), ParquetSourceWorker: () => import("./ParquetSourceWorker-NUFE3PR5.js"), PanoramicMeshWorker: () => import("./PanoramicMeshWorker-PE5XGYZ6.js") };
...
var _E = class _E {
  ...
  apply(e4, t3, o3) {
    ...
    return new Promise((s5, o4) => {
      if (a2(h)) return this._processWork(), void o4(u());
      const p = w(h, () => {
...
_E.kernelInfo = { buildDate: a, fullVersion: r, revision: c };
...
//# sourceMappingURL=chunk-T2VT2MPU.js.map
