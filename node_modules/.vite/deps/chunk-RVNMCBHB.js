...
var c = class extends b {
  ...
  async update(t, r) {
    const { addOrUpdateResources: e } = await import("./resourceUtils-OVD4VWDD.js");
...
var k = v = class extends a3(u) {
  ...
  async fetchResources(e = {}, t) {
    const { fetchResources: i2 } = await import("./resourceUtils-OVD4VWDD.js");
    return i2(this, e, t);
  }
  async addResource(e, t, i2) {
    const { addOrUpdateResources: r } = await import("./resourceUtils-OVD4VWDD.js");
  ...
  async removeResource(e, t) {
    const { removeResource: r } = await import("./resourceUtils-OVD4VWDD.js");
  ...
  async removeAllResources(e) {
    const { removeAllResources: t } = await import("./resourceUtils-OVD4VWDD.js");
    return t(this, e);
  }
  resourceFromPath(e) {
...
//# sourceMappingURL=chunk-RVNMCBHB.js.map
