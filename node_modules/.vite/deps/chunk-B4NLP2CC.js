...
function b2(t, n2, r4) {
  r4 = r4 || t;
  const o2 = P(t, n2);
  o(r4, t[0] - o2 * n2[0], t[1] - o2 * n2[1], t[2] - o2 * n2[2]), A(r4, r4);
}
function j(t, n2, s2) {
  Math.abs(t[0]) > Math.abs(t[1]) ? o(n2, 0, 1, 0) : o(n2, 1, 0, 0), _(s2, t, n2), _(n2, s2, t), A(s2, s2), A(n2, n2);
}
function p(t, n2, s2, r4, o2, a) {
  const c3 = t + (n2 - t) * o2;
  return c3 + (s2 + (r4 - s2) * o2 - c3) * a;
}
...
function x(t, c3, i, f2 = n(), M = n()) {
  const l = r2(t), m2 = r2(c3), g3 = P(t, c3) / (l * m2);
  if (g3 < 0.9999999999999999) {
    const n2 = Math.acos(g3), s2 = Math.sin(n2), a = Math.sin(i * n2), u2 = Math.sin((1 - i) * n2), h = (1 - i) * l + i * m2;
    {
      const n3 = h / s2, i2 = n3 / m2 * a;
      g(A2, t, n3 / l * u2), g(B, c3, i2), u(f2, A2, B);
    }
    {
      const e = 1 / l * (-Math.cos((1 - i) * n2) * n2 * h + u2 * (-l + m2));
      g(A2, t, e);
      const f3 = 1 / m2 * (Math.cos(i * n2) * n2 * h + a * (-l + m2));
      g(B, c3, f3), u(M, A2, B), g(M, M, 1 / s2);
    }
    return M;
  }
  return I(f2, t, c3, i), c(M, c3, t), A(M, M), M;
}
function v(n2, r4, o2) {
  n2 = A(A2, n2), r4 = A(B, r4);
  const a = b(P(n2, r4));
  if (o2) {
    const t = _(z, n2, r4);
    if (P(t, o2) < 0) return -a;
  }
  return a;
}
function k(t) {
  ...
  return (s2) => {
    ...
    let r4 = 1;
    for (; s2 > t[r4][0]; ) r4++;
    const o2 = t[r4 - 1][0], a = t[r4][0], c3 = (a - s2) / (a - o2);
    return c3 * t[r4 - 1][1] + (1 - c3) * t[r4][1];
  };
}
function U(t, n2, r4, o2) {
  c(w, n2, t), c(y, r4, t), _(o2, w, y), A(o2, o2), o2[3] = -P(t, o2);
}
function d(t, n2) {
  if (o(n2, 0, 0, 0), t.length > 0) {
    for (let s2 = 0; s2 < t.length; ++s2) u(n2, n2, t[s2]);
    g(n2, n2, 1 / t.length);
  }
}
var w = n();
...
function d2(t = $[0], n2 = $[1], r4 = $[2], o2 = $[3]) {
...
function P2(t, r4) {
  const o2 = P(k2(t), r4.ray.direction), e = -X(t, r4.ray.origin);
...
function R(t, n2, e) {
  const u2 = g(c2.get(), k2(t), -t[3]), i = V(t, c(c2.get(), n2, u2), c2.get());
  return u(e, i, u2), e;
}
function T(t, n2, r4, o2) {
  const e = k2(t), u2 = c2.get(), i = c2.get();
  j(e, u2, i);
  const f2 = c(c2.get(), r4, n2), a = f(u2, f2), m2 = f(i, f2), g3 = f(e, f2);
  return o(o2, a, m2, g3);
}
function V(t, r4, e) {
  const u2 = g(c2.get(), k2(t), P(k2(t), r4));
  return c(e, r4, u2), e;
}
function W(t, n2) {
...
function X(t, r4) {
  return P(k2(t), r4) + t[3];
}
function Y(t) {
  return 0 === t || 1 === t;
}
function Z(e, c3, u2, i, s2) {
  const f2 = P(k2(e), u2), a = X(e, c3);
...
//# sourceMappingURL=chunk-B4NLP2CC.js.map
