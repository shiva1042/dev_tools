...
var e2 = class extends i {
  constructor(r, e4) {
    super(r, "ivec2", 0, (o2, s) => o2.setUniform2iv(r, e4(s)));
  }
};
...
var e3 = class extends i {
  constructor(r, e4) {
    super(r, "usampler2D", 0, (s, o2) => s.bindTexture(r, e4(o2)));
  }
};

// node_modules/@arcgis/core/views/3d/webgl-engine/core/shaderLibrary/output/OutputHighlight.glsl.js
function d(d2, o2) {
  const { fragment: u } = d2, { output: r, draped: c, hasHighlightMixTexture: n } = o2;
...
//# sourceMappingURL=chunk-FQFAOSSS.js.map
