...
function x(e, t2) {
  return t(e?.parent) && e.parent[t2].includes(e);
}
function T(e) {
  return x(e, "baseLayers");
}
function U(e) {
  return x(e, "referenceLayers");
}
function M(e) {
...
function z(e) {
  if (!e) return [];
  return ("subtypes" in e ? e.subtypes : d(e.parent) ? e.parent.subtypes : []) ?? [];
}
function A(e) {
  return ("imagery" === e.type || "imagery-tile" === e.type) && "flow" === e.renderer?.type;
}
function K(e, t2) {
  return null;
}
...
//# sourceMappingURL=chunk-COQXIONW.js.map
