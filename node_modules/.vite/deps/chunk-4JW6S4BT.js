...
var P2 = class extends b {
  ...
  _updatePointSymbology(e4) {
    ...
    r2 && "getSymbolAsync" in r2 ? r2.getSymbolAsync(e4).then(async (i3) => {
      ...
      n4 && (G || (G = (await import("./visualVariableUtils-UYKAJG77.js")).getSize), l4 = G(n4, e4, { view: o4.type, scale: o4.scale, shape: "simple-marker" === i3.type ? i3.style : null })), l4 ||= "width" in i3 && "height" in i3 && null != i3.width && null != i3.height ? Math.max(i3.width, i3.height) : "size" in i3 ? i3.size : 16, s4?.includes(e4) && (this._setGraphicSymbol(e4, new u3({ style: "square", size: l4, color: new u2([255, 255, 255, 1 / 255]), xoffset: "xoffset" in i3 ? i3.xoffset : 0, yoffset: "yoffset" in i3 ? i3.yoffset : 0 })), a5(e4));
    }) : a5(e4);
  }
  get _updateContext() {
...
//# sourceMappingURL=chunk-4JW6S4BT.js.map
