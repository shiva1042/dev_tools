...
async function r(t, e, n) {
  ...
  if (!(await import("./intersectsOperator-QWO5SKYX.js")).execute(e, n)) return new c({ pixelType: t.pixelType, width: a2, height: r2, mask: h2, maskIsAlpha: false, pixels: [...t.pixels] });
  if ("polyline" === n.type) return s(t, e, n);
  return (await import("./containsOperator-L5Q3RQDE.js")).execute(n, e) ? t : o(t, e, n);
}
function o(t, e, n) {
  if (!t) return t;
...
//# sourceMappingURL=chunk-ZG5C5TVA.js.map
