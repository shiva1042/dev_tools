...
function B2(B3) {
  "async" === B3.mode && (B3.functions.disjoint = function(n2, t2) {
    ...
    return B3.standardFunctionAsync(n2, t2, async (r2, o3, s) => {
      ...
      if (!(c2 instanceof c)) throw new n(n2, "InvalidParameter", t2);
      if (true === c2.hasZ) {
        const { convertFromSpatialReferenceUnit: n3, toLengthUnit: t3 } = await import("./unitConversion-EY5SFXMW.js"), e = x(c2);
...
//# sourceMappingURL=chunk-ROP3EZJA.js.map
