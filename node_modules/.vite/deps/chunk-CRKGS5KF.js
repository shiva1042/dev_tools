...
async function r(t, e, n) {
  ...
  if (!(await import("./intersectsOperator-UEFJZVMR.js")).execute(e, n)) return new c({ pixelType: t.pixelType, width: a2, height: r2, mask: h2, maskIsAlpha: false, pixels: [...t.pixels] });
  if ("polyline" === n.type) return s(t, e, n);
  return (await import("./containsOperator-IVG4PUGH.js")).execute(n, e) ? t : o(t, e, n);
}
function o(t, e, n) {
  if (!t) return t;
...
//# sourceMappingURL=chunk-CRKGS5KF.js.map
