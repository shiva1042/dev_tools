...
// node_modules/@esri/calcite-components/dist/components/calcite-autocomplete-item/customElement.js
var CSS = {
  container: "container",
...
var idPrefix = "autocomplete-item";
var IDS = {
  host: (id) => `${idPrefix}-${id}`
};
...
var _AutocompleteItem = class _AutocompleteItem extends LitElement {
  constructor() {
    super(...arguments);
    this.active = false;
    this.disabled = false;
...
_AutocompleteItem.properties = { active: [5, {}, { type: Boolean }], description: 1, disabled: [7, {}, { reflect: true, type: Boolean }], guid: 1, heading: 1, iconEnd: [3, {}, { reflect: true }], iconFlipRtl: [3, {}, { reflect: true }], iconStart: [3, {}, { reflect: true }], inputValueMatchPattern: [2, {}, { reflect: true, attribute: false }], label: 1, scale: 1, value: 1 };
_AutocompleteItem.styles = styles;
var AutocompleteItem = _AutocompleteItem;
customElement("calcite-autocomplete-item", AutocompleteItem);
export {
  AutocompleteItem
};
//# sourceMappingURL=calcite-autocomplete-item-SFXWIZLA.js.map
