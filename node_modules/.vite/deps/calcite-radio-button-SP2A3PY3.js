...
var _RadioButton = class _RadioButton extends LitElement {
  constructor() {
    super();
...
_RadioButton.properties = { checked: [7, {}, { reflect: true, type: Boolean }], disabled: [7, {}, { reflect: true, type: Boolean }], focused: [7, {}, { reflect: true, type: Boolean }], form: [3, {}, { reflect: true }], hovered: [7, {}, { reflect: true, type: Boolean }], label: 1, labelText: 1, name: [3, {}, { reflect: true }], required: [7, {}, { reflect: true, type: Boolean }], scale: [3, {}, { reflect: true }], value: 1 };
_RadioButton.styles = styles;
var RadioButton = _RadioButton;
customElement("calcite-radio-button", RadioButton);
export {
  RadioButton
};
//# sourceMappingURL=calcite-radio-button-SP2A3PY3.js.map
