...
var m4 = class extends X {
  ...
  async _updateClipGeometry() {
    ...
    if (e2 && "inside" === t3.clippingType) {
      const { extent: t4 } = this.rasterInfo, r5 = await import("./densifyOperator-HXZRFWE5.js"), s4 = await import("./differenceOperator-EGOPUWOM.js");
    ...
    async _getSampleLocations(e2) {
      ...
      if ("polyline" === r5) {
        ...
        if (e2.sampleCount || e2.sampleDistance) {
          const i6 = await import("./densifyOperator-HXZRFWE5.js"), s5 = (await import("./lengthOperator-FZEC33OJ.js")).execute(t3, { unit: "meters" }), n5 = Math.min(e2.sampleCount || 100, Q3);
...
//# sourceMappingURL=chunk-CKQXVF35.js.map
