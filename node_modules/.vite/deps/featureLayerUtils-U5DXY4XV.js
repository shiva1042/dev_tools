...
import {
  l,
  n
} from "./chunk-JM3PZVYT.js";
import {
  o
} from "./chunk-2VEXWPTO.js";
...
async function H(e) {
  ...
  e.forEach(({ type: e2 }) => {
    switch (l(e2)) {
      case "CatalogLayer":
        r.push(import("./CatalogLayer-GAMFGXXX.js").then((e3) => e3.default));
        break;
      case "FeatureLayer":
        r.push(import("./@arcgis_core_layers_FeatureLayer.js").then((e3) => e3.default));
        break;
      case "OrientedImageryLayer":
        r.push(import("./OrientedImageryLayer-SVCUUUI6.js").then((e3) => e3.default));
    }
  });
...
//# sourceMappingURL=featureLayerUtils-U5DXY4XV.js.map
