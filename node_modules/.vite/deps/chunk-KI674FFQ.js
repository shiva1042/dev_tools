...
function Re(e4, t3) {
  if (o(e4) || te(e4)) {
    ...
    return h2(i4) || (i4 = i4.slice().reverse()), new P({ rings: [i4], spatialReference: o2, hasZ: n4, hasM: r4 });
  }
  return e4;
}
function ve(e4, t3) {
...
function Pe(e4, t3) {
  if (o(e4) || te(e4)) {
    ...
    return 0 === i4.length ? null : new m2({ points: i4, spatialReference: a, hasZ: n4, hasM: r4 });
  }
  return e4;
}
...
//# sourceMappingURL=chunk-KI674FFQ.js.map
