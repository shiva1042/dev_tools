...
var i4 = /* @__PURE__ */ Symbol("isWCSGraphicOrigin");
  ...
  async _getPixelTypeAndBandCount(e4) {
    ...
    if (null != r3) {
      ...
      d6 = [], e5.dimensions.forEach((t4) => {
        d6.push(new p2({ variableName: e5.name, dimensionName: t4.name, values: t4.hasRegularIntervals ? t4.extent?.[0] : t4.values?.[0], isSlice: true }));
      });
    }
...
var T2 = class extends p(t(b(j(s3(X2(i2(l5(f2(l3(l2(b2))))))))))) {
  constructor(...e4) {
    super(...e4), this.coverageId = null, this.version = null, this.isReference = null, this.graphicOrigin = new s4(this), this.legendEnabled = true, this.noData = 0, this.operationalLayerType = "WCS", this.type = "wcs", this.popupEnabled = true, this.popupTemplate = null, this.fields = null, this._debouncedSaveOperations = L(async (e5, r3, t4) => {
      const { save: o4, saveAs: s5 } = await import("./imageryUtils-L53KMLTU.js");
      switch (e5) {
        case 0:
          return o4(this, r3);
        case 1:
  ...
  createPopupTemplate(e4) {
    return d3({ fields: this.rasterFields, title: this.title }, e4);
  }
  async save(e4) {
