...
import {
  ...
  p as p4,
  y as y2
} from "./chunk-X3A3LZRT.js";
import {
  _ as _3
} from "./chunk-IG4EK255.js";
import "./chunk-MCYPNB4Z.js";
import "./chunk-RQFUQOP2.js";
import {
  a as a5
} from "./chunk-GAKRCLHL.js";
...
import {
  s as s3
} from "./chunk-7LZCDYFD.js";
import "./chunk-SBQVP4E3.js";
...
import {
  l as l6
} from "./chunk-XTLFWO7A.js";
import {
  j as j4
} from "./chunk-2YDOVIEU.js";
...
async function t5(e3) {
  const { BlobReader: t6, ZipReader: r3, BlobWriter: n8 } = await import("./zipjs-wrapper-CZMSQWBE.js"), a8 = [], i6 = new r3(new t6(e3));
...
var Te = class extends a7(F(_3(l3(b2(j2(t(l(s5(o3(l2(b3))))))))))) {
  ...
  async applyEdits(e3, t6) {
    const { applyEdits: r3 } = await import("./editingSupport-SATG2ZMW.js");
    let i6 = t6;
    await this.load();
  ...
  async convertMesh(e3, t6) {
    ...
    const n8 = this.spatialReference, p6 = t6.origin ?? t6.location, d5 = await H2(p6 ?? t6.defaultOrigin ?? new _({ x: 0, y: 0, z: 0, spatialReference: n8 }), n8, t6), y3 = d5.spatialReference.isGeographic ? "local" : "georeferenced", { default: u5 } = await import("./Mesh-QEWUJCKY.js");
    s2(t6);
...
//# sourceMappingURL=SceneLayer-LOMOPK3I.js.map
