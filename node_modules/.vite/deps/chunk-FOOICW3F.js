...
import {
  e as e2
} from "./chunk-D6LRNF5R.js";
import {
  f as f4
} from "./chunk-XKCDWY2H.js";
import {
  c
...
var p8 = class extends l(n) {
  constructor(o7) {
    super(o7), this.alias = null, this.name = void 0, this.fieldFormat = null;
  }
};
__decorate([m({ type: String, json: { write: true } })], p8.prototype, "alias", void 0), __decorate([m({ type: String, nonNullable: true, json: { write: { isRequired: true } } })], p8.prototype, "name", void 0), __decorate([m({ types: l7, json: { write: true } })], p8.prototype, "fieldFormat", void 0), p8 = __decorate([a2("esri.layers.support.FieldConfiguration")], p8);
...
function r2(n8) {
  ...
  for (const l9 of f6) {
    ...
    if (!f7) continue;
    const r3 = t6 && t6 !== f7.alias ? t6 : null, a8 = c4(l9, f7);
...
function c5(e4, o7, s7) {
  ...
  for (const n8 of s7) {
    ...
    n8.label = s8?.alias || o8.alias, n8.format = h(o8) && s8?.fieldFormat ? D2(s8.fieldFormat, o8) : null, i4 = true, l9.delete(o8.name);
  }
...
function m6(n8, e4) {
  ...
  if (!a8 || !s7 && !r3) return;
  const u6 = s7 || a8.alias, c6 = h(a8) && r3 ? D2(r3, a8) : null;
  return new f5({ fieldName: a8.name, label: u6, format: c6, visible: false, isEditable: H3(a8, n8) });
}
...
var et = class extends V(f4(c(n7(F2(a4(p4(p7(l6(e2(t(f3(l5(b3(j2(l3(s5(o4(l(b5))))))))))))))))))) {
  constructor(...e4) {
    super(...e4), this.attributeTableTemplate = null, this.charts = null, this.copyright = null, this.displayField = null, this.dynamicDataSource = null, this.fields = null, this.fieldsIndex = null, this.formTemplate = null, this.fullExtent = null, this.geometryType = null, this.graphicOrigin = new a6(this), this.hasM = void 0, this.hasZ = void 0, this.infoFor3D = null, this.isTable = false, this.labelsVisible = true, this.labelingInfo = null, this.legendEnabled = true, this.objectIdField = null, this.operationalLayerType = "ArcGISFeatureLayer", this.outFields = null, this.path = null, this.popupEnabled = true, this.popupTemplate = null, this.resourceInfo = null, this.screenSizePerspectiveEnabled = true, this.spatialReference = f2.WGS84, this.subtypeCode = null, this.supportedSourceTypes = /* @__PURE__ */ new Set(["Feature Layer", "Oriented Imagery Layer", "Table", "Catalog Layer"]), this.templates = null, this.timeInfo = null, this.title = null, this.sublayerTitleMode = "item-title", this.type = "feature", this.typeIdField = null, this.types = null, this.visible = true, this._debouncedSaveOperations = L(async (e5, t5, r3) => {
      const { save: i4, saveAs: o7 } = await import("./featureLayerUtils-U5DXY4XV.js");
      switch (e5) {
        case 0:
          return i4(this, t5);
        case 1:
  ...
  readTypes(e4, t5) {
    ...
    const r3 = t5.editFieldsInfo, i4 = r3?.creatorField, o7 = r3?.editorField;
    return e4?.map((e5) => (e5 = c3.fromJSON(e5), this._fixTemplates(e5.templates, i4), this._fixTemplates(e5.templates, o7), e5));
  }
  readVisible(e4, t5) {
  ...
  async createGraphicsSource(e4) {
    ...
    const { default: t5 } = await p(import("./FeatureLayerSource-MORQH7QX.js"), e4);
  ...
  createQuery() {
    ...
    const t5 = null != this.subtypeCode ? `${this.subtypeField} = ${this.subtypeCode}` : null, r3 = l2(this.definitionExpression, t5);
  ...
  async queryFeatures(e4, t5) {
    const r3 = await this.load(), i4 = await r3.source.queryFeatures(b4.from(e4) ?? r3.createQuery(), t5), o7 = this.graphicOrigin;
  ...
  async queryExtent(e4, t5) {
    return D(this, e4, t5, ze);
  }
  async queryRelatedFeatures(e4, t5) {
    return T2(this, e4, t5, ze);
  }
  ...
  async queryPivot(e4, t5) {
    ...
    const o7 = await import("./PivotQuery-NJZO4BEE.js"), a8 = await r3.queryPivot(o7.default.from(e4), t5);
  ...
  async queryTopFeatures(e4, t5) {
    ...
    const o7 = await import("./TopFeaturesQuery-V3PIFFCY.js"), a8 = await r3.queryTopFeatures(o7.default.from(e4), t5);
    if (a8?.features) for (const s7 of a8.features) s7.layer = s7.sourceLayer = this;
    return a8;
  }
  async queryAttributeBins(e4, t5) {
    ...
    ae(e4, i4, ze);
    const o7 = await import("./AttributeBinsQuery-R4YB5DD3.js"), a8 = await r3.queryAttributeBins(o7.default.from(e4), t5);
    if (a8.features) for (const s7 of a8.features) s7.layer = s7.sourceLayer = this;
    return a8;
  }
  async queryTopObjectIds(e4, t5) {
    ...
    const o7 = await import("./TopFeaturesQuery-V3PIFFCY.js");
...
__decorate([m({ clonable: false, readOnly: true })], et.prototype, "_titleCreator", null), __decorate([m(I)], et.prototype, "attributeTableTemplate", void 0), __decorate([o("service", "capabilities")], et.prototype, "readCapabilities", null), __decorate([m({ json: { origins: { "web-scene": { write: false } }, write: true } })], et.prototype, "charts", void 0), __decorate([m({ readOnly: true })], et.prototype, "createQueryVersion", null), __decorate([m({ json: { read: { source: "layerDefinition.copyrightText" } } })], et.prototype, "copyright", void 0), __decorate([m({ json: { read: { source: "layerDefinition.displayField" } } })], et.prototype, "displayField", void 0), __decorate([m({ types: x, readOnly: true })], et.prototype, "defaultSymbol", void 0), __decorate([m({ type: R })], et.prototype, "dynamicDataSource", void 0), __decorate([m({ type: Boolean })], et.prototype, "editingEnabled", null), __decorate([o(["portal-item", "web-scene"], "editingEnabled", ["layerDefinition.capabilities"])], et.prototype, "readEditingEnabled", null), __decorate([o("web-map", "editingEnabled", ["capabilities", "layerDefinition.capabilities"])], et.prototype, "readEditingEnabledFromWebMap", null), __decorate([r(["portal-item", "web-scene"], "editingEnabled", { "layerDefinition.capabilities": { type: String } })], et.prototype, "writeEditingEnabled", null), __decorate([r("web-map", "editingEnabled", { capabilities: { type: String }, "layerDefinition.capabilities": { type: String } })], et.prototype, "writeEditingEnabledToWebMap", null), __decorate([m({ readOnly: true })], et.prototype, "effectiveEditingEnabled", null), __decorate([m({ clonable: false, readOnly: true })], et.prototype, "featureTitleFields", null), __decorate([m({ type: [p8], json: { name: "layerDefinition.fieldConfigurations", write: { overridePolicy(e4, t5, r3) {
  ...
  i4 && e(r3, i4, t5);
} } } }, read: { source: "layerDefinition.geometryType", reader: j.read } } })], et.prototype, "geometryType", void 0), __decorate([m({ readOnly: true, clonable: false })], et.prototype, "graphicOrigin", void 0), __decorate([m({ json: { read: { source: "layerDefinition.hasM" } } })], et.prototype, "hasM", void 0), __decorate([m({ json: { read: { source: "layerDefinition.hasZ" } } })], et.prototype, "hasZ", void 0), __decorate([m(u2)], et.prototype, "id", void 0), __decorate([m({ readOnly: true, json: { origins: { service: { read: true } }, read: false } })], et.prototype, "infoFor3D", void 0), __decorate([m({ json: { origins: { "web-map": { write: { target: "layerDefinition.type" } } } } })], et.prototype, "isTable", void 0), __decorate([o("service", "isTable", ["type", "geometryType"]), o("isTable", ["layerDefinition.type", "layerDefinition.geometryType"])], et.prototype, "readIsTable", null), __decorate([r("web-map", "isTable")], et.prototype, "writeIsTable", null), __decorate([m(p5)], et.prototype, "labelsVisible", void 0), __decorate([m({ type: [A2], json: { origins: { service: { name: "drawingInfo.labelingInfo", read: l8, write: false } }, name: "layerDefinition.drawingInfo.labelingInfo", read: l8, write: { layerContainerTypes: a3 } } })], et.prototype, "labelingInfo", void 0), __decorate([m((() => {
  const e4 = a(b2);
  return e4.json.origins["portal-item"] = { write: { target: "layerDefinition.drawingInfo.transparency", writer(e5, t5, r3) {
    e(r3, n4(e5), t5);
  } } }, e4;
})())], et.prototype, "opacity", void 0), __decorate([m(d)], et.prototype, "legendEnabled", void 0), __decorate([m({ type: ["show", "hide"], json: (() => {
  const e4 = a(T.json);
  return e4.origins["portal-item"] = { read: false, write: false }, e4;
})() })], et.prototype, "listMode", void 0), __decorate([o("globalIdField", ["layerDefinition.globalIdField", "layerDefinition.fields"])], et.prototype, "readGlobalIdField", null), __decorate([m({ json: { origins: { "web-map": { write: { target: "layerDefinition.objectIdField", overridePolicy: Ye } } } } })], et.prototype, "objectIdField", void 0), __decorate([o("objectIdField", ["layerDefinition.objectIdField", "layerDefinition.fields"])], et.prototype, "readObjectIdField", null), __decorate([m({ type: ["ArcGISFeatureLayer"], json: { write: { target: "layerType", ignoreOrigin: true, layerContainerTypes: a3 } } })], et.prototype, "operationalLayerType", void 0), __decorate([m(Xe.outFields)], et.prototype, "outFields", void 0), __decorate([m({ type: String, json: { origins: { "web-scene": { read: true, write: true } }, read: false } })], et.prototype, "path", void 0), __decorate([m(l4)], et.prototype, "popupEnabled", void 0), __decorate([m({ type: q2, json: { name: "popupInfo", write: true } })], et.prototype, "popupTemplate", void 0), __decorate([r("popupTemplate")], et.prototype, "writePopupTemplate", null), __decorate([m({ readOnly: true })], et.prototype, "defaultPopupTemplate", null), __decorate([m({ types: m5, json: { origins: { service: { write: { target: "drawingInfo.renderer", enabled: false } }, "web-scene": { types: u3, name: "layerDefinition.drawingInfo.renderer", write: { layerContainerTypes: a3, overridePolicy: (e4, t5, r3) => ({ ignoreOrigin: r3?.writeLayerSchema, layerContainerTypes: a3 }) } } }, write: { target: "layerDefinition.drawingInfo.renderer", overridePolicy: (e4, t5, r3) => ({ ignoreOrigin: r3?.writeLayerSchema, layerContainerTypes: a3 }) } } })], et.prototype, "renderer", null), __decorate([o("service", "renderer", ["drawingInfo.renderer", "defaultSymbol"]), o("renderer", ["layerDefinition.drawingInfo.renderer", "layerDefinition.defaultSymbol"])], et.prototype, "readRenderer", null), __decorate([m()], et.prototype, "resourceInfo", void 0), __decorate([m((() => {
  const e4 = a(s3);
  return e4.json.origins["portal-item"] = { read: false, write: false }, e4;
})())], et.prototype, "screenSizePerspectiveEnabled", void 0), __decorate([m({ clonable: false })], et.prototype, "source", null), __decorate([s2("source")], et.prototype, "castSource", null), __decorate([o("portal-item", "source", ["featureSet"]), o("web-map", "source", ["featureSet"])], et.prototype, "readSource", null), __decorate([m({ json: { read: { source: "layerDefinition.extent.spatialReference" } } })], et.prototype, "spatialReference", void 0), __decorate([m({ type: Number })], et.prototype, "subtypeCode", void 0), __decorate([m({ type: [a5] })], et.prototype, "templates", void 0), __decorate([o("templates", ["editFieldsInfo", "creatorField", "editorField", "templates"])], et.prototype, "readTemplates", null), __decorate([m({ type: u4 })], et.prototype, "timeInfo", void 0), __decorate([m()], et.prototype, "title", void 0), __decorate([o("service", "title", ["name"]), o("portal-item", "title", ["layerDefinition.title", "layerDefinition.name", "title"])], et.prototype, "readTitle", null), __decorate([o("web-map", "title", ["layerDefinition.name", "title"])], et.prototype, "readTitleFromWebMap", null), __decorate([m({ type: String })], et.prototype, "sublayerTitleMode", void 0), __decorate([m({ json: { read: false } })], et.prototype, "type", void 0), __decorate([m({ type: String })], et.prototype, "typeIdField", void 0), __decorate([o("service", "typeIdField"), o("typeIdField", ["layerDefinition.typeIdField"])], et.prototype, "readTypeIdField", null), __decorate([m({ type: [c3] })], et.prototype, "types", void 0), __decorate([o("service", "types", ["types"]), o("types", ["layerDefinition.types"])], et.prototype, "readTypes", null), __decorate([m({ type: Boolean, json: { origins: { "portal-item": { write: { target: "layerDefinition.defaultVisibility", layerContainerTypes: a3 } } } } })], et.prototype, "visible", void 0), __decorate([o("portal-item", "visible", ["visibility", "layerDefinition.defaultVisibility"])], et.prototype, "readVisible", null), et = __decorate([a2("esri.layers.FeatureLayer")], et);

export {
  et
};
//# sourceMappingURL=chunk-FOOICW3F.js.map
