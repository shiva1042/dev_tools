...
// node_modules/@esri/calcite-components/dist/components/calcite-combobox-item-group/customElement.js
var CSS = {
  list: "list",
  label: "label",
  title: "title",
...
_ComboboxItemGroup.properties = { afterEmptyGroup: [7, {}, { reflect: true, type: Boolean }], ancestors: [0, {}, { attribute: false }], label: 1, scale: 1, itemHidden: [7, {}, { reflect: true, type: Boolean }] };
_ComboboxItemGroup.styles = styles;
var ComboboxItemGroup = _ComboboxItemGroup;
customElement("calcite-combobox-item-group", ComboboxItemGroup);

export {
  ComboboxItemGroup
};
//# sourceMappingURL=chunk-Y352UNQY.js.map
