...
async function u() {
  if (!s2()) {
    const [e, t] = await Promise.all([import("./OperatorGeodesicBuffer-ZOMIWRYF.js"), import("./SpatialReference-27E6BVNE.js").then(({ injectPe: e2 }) => e2), n()]);
...
//# sourceMappingURL=chunk-MH6MWI57.js.map
