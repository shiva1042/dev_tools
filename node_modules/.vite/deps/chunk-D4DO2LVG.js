...
function e(n, t, r3, u2, a2 = i()) {
  return a2[0] = n, a2[1] = t, a2[2] = r3, a2[3] = u2, a2;
}
function o(n, t = i()) {
...
function x(n, t, r3 = n) {
  const i2 = t.length;
  let u2 = n[0], a2 = n[1], e2 = n[2], o2 = n[3];
  for (let c2 = 0; c2 < i2; c2++) {
    const n2 = t[c2];
    u2 = Math.min(u2, n2[0]), a2 = Math.min(a2, n2[1]), e2 = Math.max(e2, n2[0]), o2 = Math.max(o2, n2[1]);
  }
  return r3[0] = u2, r3[1] = a2, r3[2] = e2, r3[3] = o2, r3;
}
function s(n) {
...
function q(n, t) {
  const r3 = t[3], i2 = 0.5 * (n[0] + n[2]), u2 = Math.abs(t[0] - i2), a2 = 0.5 * (n[2] - n[0]);
  if (u2 > r3 + a2) return false;
  const e2 = 0.5 * (n[1] + n[3]), o2 = 0.5 * (n[3] - n[1]), c2 = Math.abs(t[1] - e2);
  if (c2 > r3 + o2) return false;
  if (u2 < a2 || c2 < o2) return true;
  const f2 = u2 - a2, m2 = c2 - o2;
  return f2 * f2 + m2 * m2 <= r3 * r3;
}
function w(n, t, r3) {
  const i2 = n[0], u2 = n[1], a2 = n[2], e2 = n[3], { x: o2, y: c2 } = t, { x: f2, y: m2 } = r3, h2 = (n2, t2) => (m2 - c2) * n2 + (o2 - f2) * t2 + (f2 * c2 - o2 * m2) < 0, M2 = h2(i2, e2), x2 = h2(a2, e2), s2 = h2(a2, u2), l2 = h2(i2, u2);
  return !(M2 === x2 && x2 === s2 && s2 === l2 && l2 === M2 || o2 < i2 && f2 < i2 || o2 > a2 && f2 > a2 || c2 > e2 && m2 > e2 || c2 < u2 && m2 < u2);
}
function k(n, t) {
...
function B(t, r3, i2) {
  if (null == r3) return a(i2, t);
  const u2 = r3[0], e2 = r3[1], o2 = r3[2], c2 = r3[3];
  return i2[0] = r(t[0], u2, o2), i2[1] = r(t[1], e2, c2), i2[2] = r(t[2], u2, o2), i2[3] = r(t[3], e2, c2), i2;
}
function C(n, t) {
  const r3 = (n[0] + n[2]) / 2, i2 = (n[1] + n[3]) / 2, u2 = Math.max(Math.abs(t[0] - r3) - l(n) / 2, 0), a2 = Math.max(Math.abs(t[1] - i2) - y(n) / 2, 0);
  return Math.sqrt(u2 * u2 + a2 * a2);
}
function G(n, t, r3, i2) {
  return i2 ??= n, i2[0] = n[0] + t, i2[1] = n[1] + r3, i2[2] = n[2] + t, i2[3] = n[3] + r3, i2;
}
function H(n, t, r3 = n) {
  return r3[0] = n[0] - t, r3[1] = n[1] - t, r3[2] = n[2] + t, r3[3] = n[3] + t, r3;
}
function K(n) {
  return n ? a(n, Q) : i(Q);
}
...
function N(n) {
  return !(0 !== l(n) && isFinite(n[0]) || 0 !== y(n) && isFinite(n[1]));
}
function O(n, t) {
...
var T = r2([0, 0, 1, 1]);
function V(n, t, r3) {
  return null != t && (r3 ? r3.contains(n[0], n[2], t[0]) && r3.contains(n[0], n[2], t[2]) && t[1] > n[1] && t[3] < n[3] : z2(n, t));
}
function W(n, t, r3) {
  return null != n && (r3 ? (r3.contains(t[0], t[2], n[0]) || r3.contains(t[0], t[2], n[2]) || r3.contains(n[0], n[2], t[0])) && !(n[1] > t[3] || n[3] < t[1]) : d(n, t));
}
...
//# sourceMappingURL=chunk-D4DO2LVG.js.map
